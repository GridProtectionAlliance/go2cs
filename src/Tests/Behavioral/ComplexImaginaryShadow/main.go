...
// converter must emit the QUALIFIED `builtin.i(...)` for the `0i` literal — a bare `i(0F)`
// binds the parameter (a non-callable int) and fails with CS0149 "Method name expected".
