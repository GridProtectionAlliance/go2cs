...
public static partial class main_package
{
    ...
    public partial struct Uncommon_uᴛ1
    {
        ...
        private readonly ж<global::go.main_package.ΔFuncType> ᏑʗFuncType;

        // Promoted Struct Accessors
        public partial ref global::go.main_package.ΔFuncType FuncType => ref ᏑʗFuncType.val;

        // Promoted Struct Field Accessors
        public ref global::go.main_package.Type Type => ref FuncType.Type;
        ...
        public static ref global::go.main_package.Type ᏑType(ref Uncommon_uᴛ1 instance) => ref instance.FuncType.Type;
        ...
        // Field References
        public static ref global::go.main_package.ΔFuncType ᏑFuncType(ref Uncommon_uᴛ1 instance) => ref instance.FuncType;
        public static ref global::go.main_package.UncommonType Ꮡu(ref Uncommon_uᴛ1 instance) => ref instance.u;
        
        // Constructors
        public Uncommon_uᴛ1(NilType _)
        {
            ᏑʗFuncType = new ж<global::go.main_package.ΔFuncType>(new global::go.main_package.ΔFuncType(nil));
            this.u = default!;
        }
    ...
    public static go.ж<go.main_package.Type> In(this ref Uncommon_uᴛ1 target, nint i) => target.FuncType.In(i);
    public static go.ж<go.main_package.Type> In(this ж<Uncommon_uᴛ1> Ꮡtarget, nint i)
    {
    ...
    public static go.ж<go.main_package.Type> Out(this ref Uncommon_uᴛ1 target, nint i) => target.FuncType.Out(i);
    public static go.ж<go.main_package.Type> Out(this ж<Uncommon_uᴛ1> Ꮡtarget, nint i)
    {
        ref var target = ref Ꮡtarget.val;
        return target.Out(i);
    }
    public static go.slice<go.ж<go.main_package.Type>> InSlice(this ref Uncommon_uᴛ1 target) => target.FuncType.InSlice();
    public static go.slice<go.ж<go.main_package.Type>> InSlice(this ж<Uncommon_uᴛ1> Ꮡtarget)
    {
        ref var target = ref Ꮡtarget.val;
        return target.InSlice();
    }
    public static go.slice<go.ж<go.main_package.Type>> OutSlice(this ref Uncommon_uᴛ1 target) => target.FuncType.OutSlice();
    public static go.slice<go.ж<go.main_package.Type>> OutSlice(this ж<Uncommon_uᴛ1> Ꮡtarget)
    {
        ref var target = ref Ꮡtarget.val;
