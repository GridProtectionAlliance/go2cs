...
namespace @internal
{
    public static partial class gcimporter_package
    {
        ...
        {
            return new iimporter(value.ipath, ref value.ipkg, value.version, value.stringData, value.stringCache, value.pkgCache, value.declData, value.pkgIndex, value.typCache, value.fake, value.interfaceList);
        }
    }
}}}}}}