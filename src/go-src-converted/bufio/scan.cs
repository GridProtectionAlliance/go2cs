...
namespace go
{
    public static partial class bufio_package
    {
        ...
        public static readonly long MaxScanTokenSize = (long)64L * 1024L;

        private static readonly long startBufSize = (long)4096L; // Size of initial allocation for buffer.
        ...
        // scanners.
        private static bool Scan(this ptr<Scanner> _addr_s) => func((_, panic, __) =>
        {
            ref Scanner s = ref _addr_s.val;
        ...
        private static bool advance(this ptr<Scanner> _addr_s, long n)
        {
            ref Scanner s = ref _addr_s.val;
        ...
        private static void Buffer(this ptr<Scanner> _addr_s, slice<byte> buf, long max) => func((_, panic, __) =>
        {
            ref Scanner s = ref _addr_s.val;
        ...
        private static void Split(this ptr<Scanner> _addr_s, SplitFunc split) => func((_, panic, __) =>
        {
            ref Scanner s = ref _addr_s.val;
        ...
        public static (long, slice<byte>, error) ScanBytes(slice<byte> data, bool atEOF)
        {
            ...
            return (1L, data[0L..1L], error.As(null!)!);
        ...
        public static (long, slice<byte>, error) ScanRunes(slice<byte> data, bool atEOF)
        {
            ...
            { 
                ...
                // non-ASCII rune.
                return (width, data[0L..width], error.As(null!)!);
            ...
            return (1L, errorRune, error.As(null!)!);
        ...
        public static (long, slice<byte>, error) ScanLines(slice<byte> data, bool atEOF)
        {
...

            {
                ...
                { 
                    ...
                    return (i + 1L, dropCR(data[0L..i]), error.As(null!)!);
        ...
        public static (long, slice<byte>, error) ScanWords(slice<byte> data, bool atEOF)
        {
            ...
            // Scan until space, marking end of word.
            {
                ...
                while (i < len(data))
                {
                    ...
                    if (isSpace(r))
                    {
                        return (i + width, data[start..i], error.As(null!)!);
                    i += width;
                    }
            ...
            {
                return (len(data), data[start..], error.As(null!)!);
            } 
            // Request more data.
