...
// package label -- go2cs converted at 2020 October 08 04:54:53 UTC
...
// allocations.
        ...
        {
            Label Valid(long index); // Label returns the label at the given index.
            Label Label(long index);
        }
        ...
        public static void Format(this Label t, fmt.State f, int r)
        {
            ...
            t.Key().Format(f, buf[..0L], t);

        }

        private static bool Valid(this ptr<list> _addr_l, long index)
        {
            ref list l = ref _addr_l.val;

            return index >= 0L && index < len(l.labels);
        }

        private static Label Label(this ptr<list> _addr_l, long index)
        {
            ref list l = ref _addr_l.val;
        ...
        private static bool Valid(this ptr<filter> _addr_f, long index)
        {
        ...
        private static Label Label(this ptr<filter> _addr_f, long index)
        {
            ref filter f = ref _addr_f.val;
