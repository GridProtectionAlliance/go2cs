...
namespace go
{
    public static partial class ssa_package
    {
        ...
        public partial struct MakeInterface
        {
            ...
            // Constructors
            public MakeInterface(NilType _)
            {
                this.m_registerRef = new ptr<register>(new register(nil));
                this.X = default;
            }

            public MakeInterface(register register = default, Value X = default)
            {
                this.m_registerRef = new ptr<register>(register);
                this.X = X;
            }

            // Enable comparisons between nil and MakeInterface struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(MakeInterface value, NilType nil) => value.Equals(default(MakeInterface));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(MakeInterface value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, MakeInterface value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, MakeInterface value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MakeInterface(NilType nil) => default(MakeInterface);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        public static MakeInterface MakeInterface_cast(dynamic value)
        {
            return new MakeInterface(value.register, value.X);
        }
    }
}}}}}