...
// If not nil, it overrides Name and Line.
            ...
            public long Line; // Description is a human-readable description of the problem.
            public @string Description;
        }

        // ErrorCode is a code for a kind of error.
        public partial struct ErrorCode // : long
        {
        }
        ...
        private static @string Error(this ref Error e)
        {
            ...
            if (e.Node != null) 
                var (loc, _) = (parse.Tree.Value)(null).ErrorContext(e.Node);
        ...
        private static ref Error errorf(ErrorCode k, parse.Node node, long line, @string f, params object[] args)
        {
            args = args.Clone();

            return ref new Error(k,node,"",line,fmt.Sprintf(f,args...));
        }
    }
}}
