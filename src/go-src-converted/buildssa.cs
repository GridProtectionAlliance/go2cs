...
// package buildssa -- go2cs converted at 2022 March 06 23:32:58 UTC
...
private static (object, error) run(ptr<analysis.Pass> _addr_pass) => func((_, panic, _) => {
    object _p0 = default;
    error _p0 = default!;
