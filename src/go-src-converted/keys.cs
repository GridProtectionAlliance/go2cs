...
namespace @event
{
    public static partial class keys_package
    {
        ...
        private static void Format(this ptr<Int> _addr_k, io.Writer w, slice<byte> buf, label.Label l)
        {
            ...
            w.Write(strconv.AppendInt(buf, int64(k.From(l)), 10L));
        }

        // Of creates a new Label with this key and the supplied value.
        private static label.Label Of(this ptr<Int> _addr_k, long v)
        {
            ref Int k = ref _addr_k.val;
        ...
        // Get can be used to get a label for the key from a label.Map.
        private static long Get(this ptr<Int> _addr_k, label.Map lm)
        {
            ref Int k = ref _addr_k.val;
        ...
        // From can be used to get a value from a Label.
        private static long From(this ptr<Int> _addr_k, label.Label t)
        {
            ref Int k = ref _addr_k.val;
        ...
        private static void Format(this ptr<Int64> _addr_k, io.Writer w, slice<byte> buf, label.Label l)
        {
            ...
            w.Write(strconv.AppendInt(buf, k.From(l), 10L));
        }
        ...
        private static void Format(this ptr<UInt> _addr_k, io.Writer w, slice<byte> buf, label.Label l)
        {
            ...
            w.Write(strconv.AppendUint(buf, uint64(k.From(l)), 10L));
        }

        // Of creates a new Label with this key and the supplied value.
        private static label.Label Of(this ptr<UInt> _addr_k, ulong v)
        {
            ref UInt k = ref _addr_k.val;
        ...
        // Get can be used to get a label for the key from a label.Map.
        private static ulong Get(this ptr<UInt> _addr_k, label.Map lm)
        {
            ref UInt k = ref _addr_k.val;
        ...
        // From can be used to get a value from a Label.
        private static ulong From(this ptr<UInt> _addr_k, label.Label t)
        {
            ref UInt k = ref _addr_k.val;
        ...
        private static void Format(this ptr<UInt64> _addr_k, io.Writer w, slice<byte> buf, label.Label l)
        {
            ...
            w.Write(strconv.AppendUint(buf, k.From(l), 10L));
        }
        ...
        private static void Format(this ptr<Float32> _addr_k, io.Writer w, slice<byte> buf, label.Label l)
        {
            ...
            w.Write(strconv.AppendFloat(buf, float64(k.From(l)), 'E', -1L, 32L));
        }
        ...
        private static void Format(this ptr<Float64> _addr_k, io.Writer w, slice<byte> buf, label.Label l)
        {
            ...
            w.Write(strconv.AppendFloat(buf, k.From(l), 'E', -1L, 64L));
        }
        ...
        private static label.Label Of(this ptr<Boolean> _addr_k, bool v)
        {
            ...
            if (v)
            {
                return label.Of64(k, 1L);
            }

            return label.Of64(k, 0L);
