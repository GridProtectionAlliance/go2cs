...
// package loopclosure -- go2cs converted at 2020 October 09 06:04:03 UTC
...
namespace passes
{
    public static partial class loopclosure_package
    {
        ...
        //        }()
        //    }
        public static readonly @string Doc = (@string)@"check references to loop variables from within nested functions
