...
// package syscall -- go2cs converted at 2022 March 06 22:28:15 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Program Files\Go\src\syscall\zsyscall_linux_arm.go
...
public static error Setfsgid(nint gid) {
    ...
    var (_, _, e1) = Syscall(SYS_SETFSGID32, uintptr(gid), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
public static error Setfsuid(nint uid) {
    ...
    var (_, _, e1) = Syscall(SYS_SETFSUID32, uintptr(uid), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
