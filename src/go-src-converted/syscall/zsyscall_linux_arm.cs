...
// package syscall -- go2cs converted at 2020 August 29 08:40:03 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_linux_arm.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        {
            var (_, _, e1) = RawSyscall6(SYS_SOCKETPAIR, uintptr(domain), uintptr(typ), uintptr(flags), uintptr(@unsafe.Pointer(fd)), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static (long, error) Pread(long fd, slice<byte> p, long offset)
        {
            ...
            var (r0, _, e1) = Syscall6(SYS_PREAD64, uintptr(fd), uintptr(_p0), uintptr(len(p)), 0L, uintptr(offset), uintptr(offset >> (int)(32L)));
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static (long, error) Pwrite(long fd, slice<byte> p, long offset)
        {
            ...
            var (r0, _, e1) = Syscall6(SYS_PWRITE64, uintptr(fd), uintptr(_p0), uintptr(len(p)), 0L, uintptr(offset), uintptr(offset >> (int)(32L)));
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static error Truncate(@string path, long length)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_TRUNCATE64, uintptr(@unsafe.Pointer(_p0)), 0L, uintptr(length), uintptr(length >> (int)(32L)), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        {
            var (_, _, e1) = Syscall6(SYS_FTRUNCATE64, uintptr(fd), 0L, uintptr(length), uintptr(length >> (int)(32L)), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
