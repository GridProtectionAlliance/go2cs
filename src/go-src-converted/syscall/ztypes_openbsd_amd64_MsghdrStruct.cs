...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Msghdr
        {
            ...
            public Msghdr(ref ptr<byte> Name = default, uint Namelen = default, array<byte> Pad_cgo_0 = default, ref ptr<Iovec> Iov = default, uint Iovlen = default, array<byte> Pad_cgo_1 = default, ref ptr<byte> Control = default, uint Controllen = default, int Flags = default)
            {
                this.Name = Name;
