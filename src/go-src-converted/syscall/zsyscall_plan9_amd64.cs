...
// package syscall -- go2cs converted at 2020 August 29 08:41:44 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_plan9_amd64.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        private static error pipe(ref array<int> p)
        {
        ...
        private static (long, error) stat(@string path, slice<byte> edir)
        {
            ...
            if (len(edir) > 0L)
            {
                _p1 = @unsafe.Pointer(ref edir[0L]);
            }
            else
            {
        ...
        public static (long, error) Fstat(long fd, slice<byte> edir)
        {
            ...
            if (len(edir) > 0L)
            {
                _p0 = @unsafe.Pointer(ref edir[0L]);
            }
            else
            {
                _p0 = @unsafe.Pointer(ref _zero);
