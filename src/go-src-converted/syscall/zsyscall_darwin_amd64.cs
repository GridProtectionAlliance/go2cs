...
// package syscall -- go2cs converted at 2020 October 09 05:02:20 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_darwin_amd64.go
...
;
        ...
        public static error Fstat(long fd, ptr<Stat_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall(funcPC(libc_fstat64_trampoline), uintptr(fd), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
...
;
        ...
        public static error Fstatfs(long fd, ptr<Statfs_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall(funcPC(libc_fstatfs64_trampoline), uintptr(fd), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
...
;
        ...
        public static error Lstat(@string path, ptr<Stat_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall(funcPC(libc_lstat64_trampoline), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
...
;
        ...
        public static error Stat(@string path, ptr<Stat_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall(funcPC(libc_stat64_trampoline), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
...
;
        ...
        public static error Statfs(@string path, ptr<Statfs_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall(funcPC(libc_statfs64_trampoline), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
...
;
        ...
        private static error fstatat(long fd, @string path, ptr<Stat_t> _addr_stat, long flags)
        {
            ...
            _p0, err = BytePtrFromString(path);
            if (err != null)
            {>>MARKER:FUNCTION_libc_statfs64_trampoline_BLOCK_PREFIX<<
                return ;
            }

            var (_, _, e1) = syscall6(funcPC(libc_fstatat64_trampoline), uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), uintptr(flags), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
...
;
        ...
        private static error ptrace(long request, long pid, System.UIntPtr addr, System.UIntPtr data)
        {
            ...
            var (_, _, e1) = syscall6(funcPC(libc_ptrace_trampoline), uintptr(request), uintptr(pid), uintptr(addr), uintptr(data), 0L, 0L);
            if (e1 != 0L)
