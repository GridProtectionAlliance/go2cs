...
// package syscall -- go2cs converted at 2020 August 29 08:40:10 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_linux_arm64.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public static error Fstatat(long fd, @string path, ref Stat_t stat, long flags)
        {
            ref byte _p0 = default;
            _p0, err = BytePtrFromString(path);
            if (err != null)
