...
// package syscall -- go2cs converted at 2020 October 08 03:28:58 UTC
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public static (long, error) EpollWait(long epfd, slice<EpollEvent> events, long msec)
        {
            ...
            var (r0, _, e1) = Syscall6(SYS_EPOLL_PWAIT, uintptr(epfd), uintptr(_p0), uintptr(len(events)), uintptr(msec), 0L, 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        private static error fstatat(long dirfd, @string path, ptr<Stat_t> _addr_stat, long flags)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_FSTATAT, uintptr(dirfd), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), uintptr(flags), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error getrlimit(long resource, ptr<Rlimit> _addr_rlim)
        {
            error err = default!;
        ...
        private static error setrlimit(long resource, ptr<Rlimit> _addr_rlim)
        {
            error err = default!;
            ref Rlimit rlim = ref _addr_rlim.val;
        ...
        private static (long, error) pselect(long nfd, ptr<FdSet> _addr_r, ptr<FdSet> _addr_w, ptr<FdSet> _addr_e, ptr<Timespec> _addr_timeout, ptr<sigset_t> _addr_sigmask)
        {
            long n = default;
            error err = default!;
