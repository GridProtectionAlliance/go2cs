...
// package syscall -- go2cs converted at 2020 August 29 08:39:48 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_linux_386.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        {
            var (_, _, e1) = Syscall6(SYS_FALLOCATE, uintptr(fd), uintptr(mode), uintptr(off), uintptr(off >> (int)(32L)), uintptr(len), uintptr(len >> (int)(32L)));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static (long, error) Tee(long rfd, long wfd, long len, long flags)
        {
            ...
            n = int64(int64(r1) << (int)(32L) | int64(r0));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error pipe(ref array<_C_int> p)
        {
        ...
        {
            var (_, _, e1) = Syscall(SYS_FTRUNCATE64, uintptr(fd), uintptr(length), uintptr(length >> (int)(32L)));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        {
            var (r0, _, _) = RawSyscall(SYS_GETEGID32, 0L, 0L, 0L);
            egid = int(r0);
            return;
        }
        ...
        {
            var (r0, _, _) = RawSyscall(SYS_GETEUID32, 0L, 0L, 0L);
            euid = int(r0);
            return;
        }
        ...
        {
            var (r0, _, _) = RawSyscall(SYS_GETGID32, 0L, 0L, 0L);
            gid = int(r0);
            return;
        }
        ...
        {
            var (r0, _, _) = RawSyscall(SYS_GETUID32, 0L, 0L, 0L);
            uid = int(r0);
            return;
        }
        ...
        public static (long, error) Pread(long fd, slice<byte> p, long offset)
        {
            ...
            var (r0, _, e1) = Syscall6(SYS_PREAD64, uintptr(fd), uintptr(_p0), uintptr(len(p)), uintptr(offset), uintptr(offset >> (int)(32L)), 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static (long, error) Pwrite(long fd, slice<byte> p, long offset)
        {
            ...
            var (r0, _, e1) = Syscall6(SYS_PWRITE64, uintptr(fd), uintptr(_p0), uintptr(len(p)), uintptr(offset), uintptr(offset >> (int)(32L)), 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        {
            var (_, _, e1) = Syscall(SYS_SETFSGID32, uintptr(gid), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        {
            var (_, _, e1) = Syscall(SYS_SETFSUID32, uintptr(uid), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        {
            var (_, _, e1) = RawSyscall(SYS_SETREGID32, uintptr(rgid), uintptr(egid), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        {
            var (_, _, e1) = RawSyscall(SYS_SETREUID32, uintptr(ruid), uintptr(euid), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        {
            var (_, _, e1) = Syscall6(SYS_SYNC_FILE_RANGE, uintptr(fd), uintptr(off), uintptr(off >> (int)(32L)), uintptr(n), uintptr(n >> (int)(32L)), uintptr(flags));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static error Truncate(@string path, long length)
        {
            ...
            var (_, _, e1) = Syscall(SYS_TRUNCATE64, uintptr(@unsafe.Pointer(_p0)), uintptr(length), uintptr(length >> (int)(32L)));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        {
            var (r0, _, e1) = RawSyscall(SYS_GETGROUPS32, uintptr(n), uintptr(@unsafe.Pointer(list)), 0L);
            nn = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        {
            var (_, _, e1) = RawSyscall(SYS_SETGROUPS32, uintptr(n), uintptr(@unsafe.Pointer(list)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error getrlimit(long resource, ref rlimit32 rlim)
        {
        ...
        private static error setrlimit(long resource, ref rlimit32 rlim)
        {
