...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Flock_t
        {
            ...
            public Flock_t(short Type = default, short Whence = default, long Start = default, long Len = default, int Pid = default)
            {
                this.Type = Type;
                this.Whence = Whence;
                this.Start = Start;
        ...
        {
            return new Flock_t(value.Type, value.Whence, value.Start, value.Len, value.Pid);
        }
    }
}