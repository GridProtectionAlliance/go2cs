...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Termios
        {
            ...
            public Termios(uint Iflag = default, uint Oflag = default, uint Cflag = default, uint Lflag = default, byte Line = default, array<byte> Cc = default, array<byte> Pad_cgo_0 = default)
            {
                this.Iflag = Iflag;
                this.Oflag = Oflag;
                this.Cflag = Cflag;
        ...
        {
            return new Termios(value.Iflag, value.Oflag, value.Cflag, value.Lflag, value.Line, value.Cc, value.Pad_cgo_0);
        }
    }
}