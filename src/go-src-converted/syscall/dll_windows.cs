...
// package syscall -- go2cs converted at 2020 October 09 04:45:24 UTC
...
;
        ...
        public static (ptr<DLL>, error) LoadDLL(@string name)
        {
            ...
            if (err != null)
            {>>MARKER:FUNCTION_Syscall18_BLOCK_PREFIX<<
        ...
        private static (System.UIntPtr, System.UIntPtr, error) Call(this ptr<Proc> _addr_p, params System.UIntPtr[] a) => func((_, panic, __) =>
        {
            ...
            switch (len(a))
            {
                ...
                case 15L: 
                    ...
                    break;
                case 16L: 
                    return Syscall18(p.Addr(), uintptr(len(a)), a[0L], a[1L], a[2L], a[3L], a[4L], a[5L], a[6L], a[7L], a[8L], a[9L], a[10L], a[11L], a[12L], a[13L], a[14L], a[15L], 0L, 0L);
                    break;
                case 17L: 
                    return Syscall18(p.Addr(), uintptr(len(a)), a[0L], a[1L], a[2L], a[3L], a[4L], a[5L], a[6L], a[7L], a[8L], a[9L], a[10L], a[11L], a[12L], a[13L], a[14L], a[15L], a[16L], 0L);
                    break;
                case 18L: 
                    return Syscall18(p.Addr(), uintptr(len(a)), a[0L], a[1L], a[2L], a[3L], a[4L], a[5L], a[6L], a[7L], a[8L], a[9L], a[10L], a[11L], a[12L], a[13L], a[14L], a[15L], a[16L], a[17L]);
                    break;
                default: 
