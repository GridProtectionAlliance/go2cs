...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct RtMetrics
        {
            ...
            public RtMetrics(uint Locks = default, uint Mtu = default, uint Hopcount = default, uint Expire = default, uint Recvpipe = default, uint Sendpipe = default, uint Ssthresh = default, uint Rtt = default, uint Rttvar = default, uint Pksent = default, uint Weight = default, array<uint> Filler = default)
            {
                this.Locks = Locks;
                this.Mtu = Mtu;
