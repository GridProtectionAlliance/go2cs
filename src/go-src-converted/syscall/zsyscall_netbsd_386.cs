...
// package syscall -- go2cs converted at 2020 October 08 03:29:46 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_netbsd_386.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        private static (long, error) paccept(long fd, ptr<RawSockaddrAny> _addr_rsa, ptr<_Socklen> _addr_addrlen, ptr<sigset> _addr_sigmask, long flags)
        {
            long nfd = default;
            error err = default!;
            ref RawSockaddrAny rsa = ref _addr_rsa.val;
            ...
            var (r0, _, e1) = Syscall6(SYS_PACCEPT, uintptr(fd), uintptr(@unsafe.Pointer(rsa)), uintptr(@unsafe.Pointer(addrlen)), uintptr(@unsafe.Pointer(sigmask)), uintptr(flags), 0L);
            nfd = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        private static (long, error) getdents(long fd, slice<byte> buf)
        {
            long n = default;
            error err = default!;
