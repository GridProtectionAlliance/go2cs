...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Flock_t
        {
            ...
            public Flock_t(short Type = default, short Whence = default, array<byte> Pad_cgo_0 = default, long Start = default, long Len = default, int Sysid = default, int Pid = default, array<long> Pad = default)
            {
                this.Type = Type;
                this.Whence = Whence;
        ...
        {
            return new Flock_t(value.Type, value.Whence, value.Pad_cgo_0, value.Start, value.Len, value.Sysid, value.Pid, value.Pad);
        }
    }
}