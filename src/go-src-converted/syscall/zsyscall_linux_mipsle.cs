...
// package syscall -- go2cs converted at 2020 August 29 08:40:41 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_linux_mipsle.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        {
            var (r0, r1, e1) = Syscall6(SYS_SPLICE, uintptr(rfd), uintptr(@unsafe.Pointer(roff)), uintptr(wfd), uintptr(@unsafe.Pointer(woff)), uintptr(len), uintptr(flags));
            n = int64(int64(r1) << (int)(32L) | int64(r0));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        {
            var (_, _, e1) = Syscall9(SYS_SYNC_FILE_RANGE, uintptr(fd), 0L, uintptr(off), uintptr(off >> (int)(32L)), uintptr(n), uintptr(n >> (int)(32L)), uintptr(flags), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
