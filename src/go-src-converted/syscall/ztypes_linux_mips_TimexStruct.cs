...
namespace go
{
    public static partial class syscall_package
    {
        ...
        {
            return new Timex(value.Modes, value.Offset, value.Freq, value.Maxerror, value.Esterror, value.Status, value.Constant, value.Precision, value.Tolerance, value.Time, value.Tick, value.Ppsfreq, value.Jitter, value.Shift, value.Stabil, value.Jitcnt, value.Calcnt, value.Errcnt, value.Stbcnt, value.Tai, value.Pad_cgo_0);
        }
    }
}