...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct SecurityAttributes
        {
            ...
            public SecurityAttributes(uint Length = default, System.UIntPtr SecurityDescriptor = default, uint InheritHandle = default)
            {
                this.Length = Length;
        ...
        {
            return new SecurityAttributes(value.Length, value.SecurityDescriptor, value.InheritHandle);
        }
    }
}