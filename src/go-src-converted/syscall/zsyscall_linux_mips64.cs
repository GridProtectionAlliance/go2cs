...
// package syscall -- go2cs converted at 2020 August 29 08:40:26 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_linux_mips64.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        private static (long, error) pselect(long nfd, ref FdSet r, ref FdSet w, ref FdSet e, ref Timespec timeout, ref sigset_t sigmask)
        {
        ...
        private static error fstat(long fd, ref stat_t st)
        {
            var (_, _, e1) = Syscall(SYS_FSTAT, uintptr(fd), uintptr(@unsafe.Pointer(st)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error lstat(@string path, ref stat_t st)
        {
            ref byte _p0 = default;
            _p0, err = BytePtrFromString(path);
            if (err != null)
            ...
            var (_, _, e1) = Syscall(SYS_LSTAT, uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(st)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error stat(@string path, ref stat_t st)
        {
            ref byte _p0 = default;
            _p0, err = BytePtrFromString(path);
            if (err != null)
            ...
            var (_, _, e1) = Syscall(SYS_STAT, uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(st)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
