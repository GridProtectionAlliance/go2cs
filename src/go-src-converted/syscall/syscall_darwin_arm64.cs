...
// package syscall -- go2cs converted at 2020 October 08 03:27:14 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\syscall_darwin_arm64.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        {
            return new Timespec(Sec:int64(sec),Nsec:int64(nsec));
        }
