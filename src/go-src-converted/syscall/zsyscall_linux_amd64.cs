...
// package syscall -- go2cs converted at 2022 March 06 22:28:10 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Program Files\Go\src\syscall\zsyscall_linux_amd64.go
...
private static error fstatat(nint fd, @string path, ptr<Stat_t> _addr_stat, nint flags) {
    ...
    var (_, _, e1) = Syscall6(SYS_NEWFSTATAT, uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), uintptr(flags), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
