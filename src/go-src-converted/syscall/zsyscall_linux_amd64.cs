...
// package syscall -- go2cs converted at 2020 August 29 08:39:55 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_linux_amd64.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        private static error fstatat(long fd, @string path, ref Stat_t stat, long flags)
        {
            ref byte _p0 = default;
            _p0, err = BytePtrFromString(path);
            if (err != null)
            ...
            var (_, _, e1) = Syscall6(SYS_NEWFSTATAT, uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), uintptr(flags), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
