...
namespace go
{
    public static partial class syscall_package
    {
        ...
        private partial struct byteq
        {
            ...
            // Constructors
            public byteq(NilType _)
            {
                this.m_queueRef = new ptr<queue>(new queue(nil));
                this.data = default;
            }

            public byteq(queue queue = default, slice<byte> data = default)
            {
                this.m_queueRef = new ptr<queue>(queue);
                this.data = data;
            }

            // Enable comparisons between nil and byteq struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(byteq value, NilType nil) => value.Equals(default(byteq));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(byteq value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, byteq value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, byteq value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator byteq(NilType nil) => default(byteq);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static byteq byteq_cast(dynamic value)
        {
            return new byteq(value.queue, value.data);
        }
    }
}