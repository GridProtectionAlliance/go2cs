...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Signal
        {
            ...
            public Signal(nint value) => m_value = value;

            // Enable implicit conversions between nint and Signal struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Signal(nint value) => new Signal(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator nint(Signal value) => value.m_value;
