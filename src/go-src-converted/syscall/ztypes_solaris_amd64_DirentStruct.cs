...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Dirent
        {
            ...
            public Dirent(ulong Ino = default, long Off = default, ushort Reclen = default, array<sbyte> Name = default, array<byte> Pad_cgo_0 = default)
            {
                this.Ino = Ino;
                this.Off = Off;
                this.Reclen = Reclen;
        ...
        {
            return new Dirent(value.Ino, value.Off, value.Reclen, value.Name, value.Pad_cgo_0);
        }
    }
}