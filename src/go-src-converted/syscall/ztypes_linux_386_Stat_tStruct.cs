...
namespace go
{
    public static partial class syscall_package
    {
        ...
        {
            return new Stat_t(value.Dev, value.X__pad1, value.Pad_cgo_0, value.X__st_ino, value.Mode, value.Nlink, value.Uid, value.Gid, value.Rdev, value.X__pad2, value.Pad_cgo_1, value.Size, value.Blksize, value.Blocks, value.Atim, value.Mtim, value.Ctim, value.Ino);
        }
    }
}