...
// package syscall -- go2cs converted at 2020 August 29 08:37:47 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\syscall_darwin_386.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        private static (long, error) sendfile(long outfd, long infd, ref long offset, long count)
        {
            ...
            var (_, _, e1) = Syscall9(SYS_SENDFILE, uintptr(infd), uintptr(outfd), uintptr(offset.Value), uintptr(offset >> (int)(32L).Value), uintptr(@unsafe.Pointer(ref length)), 0L, 0L, 0L, 0L);
