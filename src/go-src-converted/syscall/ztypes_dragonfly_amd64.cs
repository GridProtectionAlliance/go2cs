...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public static readonly ulong SizeofIfMsghdr = 0xb0UL;
        public static readonly ulong SizeofIfData = 0xa0UL;
        ...
        private static readonly ulong _AT_FDCWD = 0xfffafdcdUL;
