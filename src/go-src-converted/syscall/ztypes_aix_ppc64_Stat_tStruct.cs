...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Stat_t
        {
            ...
            public Stat_t(ulong Dev = default, ulong Ino = default, uint Mode = default, short Nlink = default, ushort Flag = default, uint Uid = default, uint Gid = default, ulong Rdev = default, int Ssize = default, StTimespec_t Atim = default, StTimespec_t Mtim = default, StTimespec_t Ctim = default, long Blksize = default, long Blocks = default, int Vfstype = default, uint Vfs = default, uint Type = default, uint Gen = default, array<uint> Reserved = default, uint Padto_ll = default, long Size = default)
            {
                this.Dev = Dev;
                this.Ino = Ino;
                this.Mode = Mode;
