...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Dirent
        {
            ...
            public Dirent(long Ino = default, long Off = default, ushort Reclen = default, array<byte> Name = default)
            {
                this.Ino = Ino;
                this.Off = Off;
                this.Reclen = Reclen;
        ...
        {
            return new Dirent(value.Ino, value.Off, value.Reclen, value.Name);
        }
    }
}