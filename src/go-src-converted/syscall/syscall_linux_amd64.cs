...
// package syscall -- go2cs converted at 2022 March 06 22:27:04 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Program Files\Go\src\syscall\syscall_linux_amd64.go
...
public static error Gettimeofday(ptr<Timeval> _addr_tv) {
    ...
    if (errno != 0) {>>MARKER:FUNCTION_gettimeofday_BLOCK_PREFIX<<
