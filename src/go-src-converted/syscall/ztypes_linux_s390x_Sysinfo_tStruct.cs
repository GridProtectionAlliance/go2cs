...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Sysinfo_t
        {
            ...
            public Sysinfo_t(long Uptime = default, array<ulong> Loads = default, ulong Totalram = default, ulong Freeram = default, ulong Sharedram = default, ulong Bufferram = default, ulong Totalswap = default, ulong Freeswap = default, ushort Procs = default, ushort Pad = default, array<byte> _ = default, ulong Totalhigh = default, ulong Freehigh = default, uint Unit = default, array<byte> _ = default, array<byte> _ = default)
            {
                this.Uptime = Uptime;
                this.Loads = Loads;
        ...
        {
            return new Sysinfo_t(value.Uptime, value.Loads, value.Totalram, value.Freeram, value.Sharedram, value.Bufferram, value.Totalswap, value.Freeswap, value.Procs, value.Pad, value._, value.Totalhigh, value.Freehigh, value.Unit, value._, value._);
        }
    }
}