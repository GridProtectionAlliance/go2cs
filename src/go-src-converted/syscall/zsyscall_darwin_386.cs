...
// package syscall -- go2cs converted at 2020 August 29 08:39:00 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_darwin_386.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        private static (int, int, error) gettimeofday(ref Timeval tp)
        {
