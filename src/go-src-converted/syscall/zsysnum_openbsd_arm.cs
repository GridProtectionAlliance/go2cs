...
// Original source: C:\Program Files\Go\src\syscall\zsysnum_openbsd_arm.go
...
public static readonly nint SYS_SENDSYSLOG = 83; // { int sys_sendsyslog(const void *buf, size_t nbyte); }
