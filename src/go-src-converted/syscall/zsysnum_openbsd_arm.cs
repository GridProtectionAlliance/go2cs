...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public static readonly long SYS_GETENTROPY = 7L; // { int sys_getentropy(void *buf, size_t nbyte); }
        ...
        public static readonly long SYS_ACCESS = 33L; // { int sys_access(const char *path, int amode); }
        ...
        public static readonly long SYS_READLINK = 58L; // { ssize_t sys_readlink(const char *path, \
        ...
        public static readonly long SYS_SETPGID = 82L; // { int sys_setpgid(pid_t pid, pid_t pgid); }
        public static readonly long SYS_SENDSYSLOG = 83L; // { int sys_sendsyslog(const void *buf, size_t nbyte); }
        ...
        public static readonly long SYS_ACCEPT4 = 93L; // { int sys_accept4(int s, struct sockaddr *name, \
        ...
        public static readonly long SYS_PIPE2 = 101L; // { int sys_pipe2(int *fdp, int flags); }
        public static readonly long SYS_DUP3 = 102L; // { int sys_dup3(int from, int to, int flags); }
        ...
        public static readonly long SYS_CHFLAGSAT = 107L; // { int sys_chflagsat(int fd, const char *path, \
