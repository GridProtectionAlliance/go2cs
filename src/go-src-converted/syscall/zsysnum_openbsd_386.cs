...
// Original source: C:\Go\src\syscall\zsysnum_openbsd_386.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public static readonly long SYS_ACCESS = (long)33L; // { int sys_access(const char *path, int flags); }
        ...
        public static readonly long SYS_READLINK = (long)58L; // { int sys_readlink(const char *path, char *buf, \
        ...
        public static readonly long SYS_SETPGID = (long)82L; // { int sys_setpgid(pid_t pid, int pgid); }
