...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Termios
        {
            ...
            public Termios(ulong Iflag = default, ulong Oflag = default, ulong Cflag = default, ulong Lflag = default, array<byte> Cc = default, array<byte> Pad_cgo_0 = default, ulong Ispeed = default, ulong Ospeed = default)
            {
                this.Iflag = Iflag;
                this.Oflag = Oflag;
                this.Cflag = Cflag;
        ...
        {
            return new Termios(value.Iflag, value.Oflag, value.Cflag, value.Lflag, value.Cc, value.Pad_cgo_0, value.Ispeed, value.Ospeed);
        }
    }
}