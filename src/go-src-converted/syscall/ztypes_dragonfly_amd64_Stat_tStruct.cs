...
namespace go
{
    public static partial class syscall_package
    {
        ...
        {
            return new Stat_t(value.Ino, value.Nlink, value.Dev, value.Mode, value.Padding1, value.Uid, value.Gid, value.Rdev, value.Atim, value.Mtim, value.Ctim, value.Size, value.Blocks, value.Blksize, value.Flags, value.Gen, value.Lspare, value.Qspare1, value.Qspare2);
        }
    }
}