...
namespace go
{
    public static partial class syscall_package
    {
        ...
        {
            return new IfData(value.Type, value.Addrlen, value.Hdrlen, value.Link_state, value.Mtu, value.Metric, value.Pad, value.Baudrate, value.Ipackets, value.Ierrors, value.Opackets, value.Oerrors, value.Collisions, value.Ibytes, value.Obytes, value.Imcasts, value.Omcasts, value.Iqdrops, value.Noproto, value.Capabilities, value.Lastchange, value.Mclpool);
        }
    }
}