...
// package syscall -- go2cs converted at 2020 October 09 05:03:35 UTC
// import "syscall" ==> using syscall = go.syscall_package
// Original source: C:\Go\src\syscall\zsyscall_linux_riscv64.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        private static error renameat2(long olddirfd, @string oldpath, long newdirfd, @string newpath, ulong flags)
        {
            error err = default!;
