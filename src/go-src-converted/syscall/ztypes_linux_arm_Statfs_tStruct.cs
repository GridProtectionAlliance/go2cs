...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct Statfs_t
        {
            ...
            public Statfs_t(int Type = default, int Bsize = default, ulong Blocks = default, ulong Bfree = default, ulong Bavail = default, ulong Files = default, ulong Ffree = default, Fsid Fsid = default, int Namelen = default, int Frsize = default, int Flags = default, array<int> Spare = default, array<byte> Pad_cgo_0 = default)
            {
                this.Type = Type;
                this.Bsize = Bsize;
                this.Blocks = Blocks;
        ...
        {
            return new Statfs_t(value.Type, value.Bsize, value.Blocks, value.Bfree, value.Bavail, value.Files, value.Ffree, value.Fsid, value.Namelen, value.Frsize, value.Flags, value.Spare, value.Pad_cgo_0);
        }
    }
}