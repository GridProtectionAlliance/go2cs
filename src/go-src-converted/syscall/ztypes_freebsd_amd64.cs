...
// Original source: C:\Go\src\syscall\ztypes_freebsd_amd64.go
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        {
            public array<ulong> X__fds_bits;
        }

        private static readonly ulong sizeofIfMsghdr = 0xa8UL;
        public static readonly ulong SizeofIfMsghdr = 0xa8UL;
        private static readonly ulong sizeofIfData = 0x98UL;
        public static readonly ulong SizeofIfData = 0x98UL;
        ...
        public static readonly ulong SizeofRtMsghdr = 0x98UL;
        public static readonly ulong SizeofRtMetrics = 0x70UL;
        ...
        public static readonly ulong SizeofBpfZbuf = 0x18UL;
