...
// package syscall -- go2cs converted at 2020 August 29 08:37:54 UTC
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public static (ref IPMreqn, error) GetsockoptIPMreqn(long fd, long level, long opt)
        {
            ...
            var errno = getsockopt(fd, level, opt, @unsafe.Pointer(ref value), ref vallen);
            return (ref value, errno);
        }
