...
private static sync.Mutex funcsMu = default;private static var funcs = make_map<uint, Action<Value, slice<Value>>>();private static uint nextFuncID = 1;
...
private static void handleEvent() {
    ...
    if (cb.IsNull()) {>>MARKER:FUNCTION_setEventHandler_BLOCK_PREFIX<<
        return ;
    }
