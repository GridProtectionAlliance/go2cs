...
//
//     Generated on 2020 October 09 05:01:40 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace go
{
    public static partial class syscall_package
    {
        ...
        public partial struct SockaddrDatalink
        {
            ...
            public SockaddrDatalink(byte Len = default, byte Family = default, ushort Index = default, byte Type = default, byte Nlen = default, byte Alen = default, byte Slen = default, array<sbyte> Data = default, ushort Rcf = default, array<ushort> Route = default, RawSockaddrDatalink raw = default)
            {
                this.Len = Len;
                this.Family = Family;
                this.Index = Index;
        ...
        {
            return new SockaddrDatalink(value.Len, value.Family, value.Index, value.Type, value.Nlen, value.Alen, value.Slen, value.Data, value.Rcf, value.Route, value.raw);
        }
    }
}