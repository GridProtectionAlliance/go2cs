...
namespace export
{
    public static partial class prometheus_package
    {
        ...
        private static context.Context ProcessEvent(this ptr<Exporter> _addr_e, context.Context ctx, core.Event ev, label.Map ln) => func((defer, _, __) =>
        {
            ...
            foreach (var (_, data) in metrics)
            {
                ...
                { 
                    ...
                    var old = e.metrics;
                    e.metrics = make_slice<metric.Data>(len(old) + 1L);
                    copy(e.metrics, old[..index]);
                    copy(e.metrics[index + 1L..], old[index..]);
        ...
        private static void Serve(this ptr<Exporter> _addr_e, http.ResponseWriter w, ptr<http.Request> _addr_r) => func((defer, _, __) =>
        {
            ref Exporter e = ref _addr_e.val;
