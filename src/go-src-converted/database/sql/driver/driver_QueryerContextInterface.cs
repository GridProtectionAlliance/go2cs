...
namespace sql
{
    public static partial class driver_package
    {
        ...
        public class QueryerContext<T> : QueryerContext
        {
            ...
            private delegate (Rows, error) QueryContextByRef(ref T value, context.Context ctx, @string query, slice<NamedValue> args);
            ...
            public (Rows, error) QueryContext(context.Context ctx, @string query, slice<NamedValue> args)
            {
                ...
                return s_QueryContextByRef(ref target, ctx, query, args);
            }
