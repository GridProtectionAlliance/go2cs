...
// package ssa -- go2cs converted at 2020 October 08 04:56:56 UTC
...
namespace go
{
    public static partial class ssa_package
    {
        ...
        //
        private static void emitDebugRef(ptr<Function> _addr_f, ast.Expr e, Value v, bool isAddr) => func((_, panic, __) =>
        {
            ref Function f = ref _addr_f.val;
        ...
        //
        private static Value emitArith(ptr<Function> _addr_f, token.Token op, Value x, Value y, types.Type t, token.Pos pos) => func((_, panic, __) =>
        {
            ref Function f = ref _addr_f.val;
            ...
            if (op == token.SHL || op == token.SHR) 
                ...
                // TODO(adonovan): whence signed values?
                {
                    ...
                    if (ok && b.Info() & types.IsUnsigned == 0L)
                    {
            ...
            {
                {
                    ...
                    if (ok && yt.Info() & types.IsBoolean != 0L)
                    {
                        return y;
                    }
        ...
        //
        private static Value emitConv(ptr<Function> _addr_f, Value val, types.Type typ) => func((_, panic, __) =>
        {
            ref Function f = ref _addr_f.val;
            ...
            // Conversion to, or construction of a value of, an interface type?
            {
                ...
                { 
                    ...
                    // Convert (non-nil) "untyped" literals to their default type.
                    {
                        ...
                        if (ok && t.Info() & types.IsUntyped != 0L)
                        {
        ...
        //
        private static Value emitExtract(ptr<Function> _addr_f, Value tuple, long index)
        {
            ref Function f = ref _addr_f.val;
        ...
        // value of a field.
        //
        private static Value emitImplicitSelections(ptr<Function> _addr_f, Value v, slice<long> indices)
        {
            ref Function f = ref _addr_f.val;
        ...
        //
        private static Value emitFieldSelection(ptr<Function> _addr_f, Value v, long index, bool wantAddr, ptr<ast.Ident> _addr_id)
        {
            ref Function f = ref _addr_f.val;
