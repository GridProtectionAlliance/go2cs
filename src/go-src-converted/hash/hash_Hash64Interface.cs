...
namespace go
{
    public static partial class hash_package
    {
        ...
        public class Hash64<T> : Hash64
        {
            ...
            private delegate ulong Sum64ByRef(ref T value);
            private delegate ulong Sum64ByVal(T value);

            private static readonly Sum64ByRef s_Sum64ByRef;
            ...
            public ulong Sum64()
            {
                ...
                if (s_Sum64ByRef is null)
                    return s_Sum64ByVal!(target);

                return s_Sum64ByRef(ref target);
            }
            ...
            static Hash64()
            {
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("Sum64");

                if (!(extensionMethod is null))
                    s_Sum64ByRef = extensionMethod.CreateStaticDelegate(typeof(Sum64ByRef)) as Sum64ByRef;
                ...
                if (s_Sum64ByRef is null && s_Sum64ByVal is null)
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("Sum");
                ...
                if (s_SumByRef is null && s_SumByVal is null)
                    throw new NotImplementedException($"{targetType.FullName} does not implement Hash64.Sum method", new Exception("Sum"));
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("Reset");
                ...
                if (s_ResetByRef is null && s_ResetByVal is null)
                    throw new NotImplementedException($"{targetType.FullName} does not implement Hash64.Reset method", new Exception("Reset"));
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("Size");
                ...
                if (s_SizeByRef is null && s_SizeByVal is null)
                    throw new NotImplementedException($"{targetType.FullName} does not implement Hash64.Size method", new Exception("Size"));
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("BlockSize");
                ...
                if (s_BlockSizeByRef is null && s_BlockSizeByVal is null)
                    throw new NotImplementedException($"{targetType.FullName} does not implement Hash64.BlockSize method", new Exception("BlockSize"));
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("Write");
                ...
                if (s_WriteByRef is null && s_WriteByVal is null)
                    throw new NotImplementedException($"{targetType.FullName} does not implement Hash64.Write method", new Exception("Write"));
            }
