...
// package adler32 -- go2cs converted at 2020 August 29 08:23:14 UTC
...
namespace hash
{
    public static partial class adler32_package
    {
        ...
        private static readonly long mod = 65521L; 
        // nmax is the largest n such that
        // 255 * n * (n+1) / 2 + (n+1) * (mod-1) <= 2^32-1.
        // It is mentioned in RFC 1950 (search for "5552").
        private static readonly long nmax = 5552L;
        ...
        private static (slice<byte>, error) MarshalBinary(this ref digest d)
        {
            ...
            b = append(b, magic);
            b = appendUint32(b, uint32(d.Value));
            return (b, null);
        }
        ...
        private static error UnmarshalBinary(this ref digest d, slice<byte> b)
        {
            ...
            d.Value = digest(readUint32(b[len(magic)..]));
