...
namespace hash
{
    public static partial class adler32_package
    {
        ...
        {
            // Value of the digest struct
            private readonly uint m_value;

            public digest(uint value) => m_value = value;

            // Enable implicit conversions between uint and digest struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator digest(uint value) => new digest(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator uint(digest value) => value.m_value;
