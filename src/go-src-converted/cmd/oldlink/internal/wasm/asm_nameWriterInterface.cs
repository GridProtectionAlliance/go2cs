...
//
//     Generated on 2020 October 08 04:40:26 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace @internal
{
    public static partial class wasm_package
    {
        ...
        private partial interface nameWriter
        {
            ...
            public static nameWriter As<T>(in T target) => (nameWriter<T>)target!;

            [MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
            public static nameWriter As<T>(ptr<T> target_ptr) => (nameWriter<T>)target_ptr;

            [MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
            public static nameWriter? As(object target) =>
                typeof(nameWriter<>).CreateInterfaceHandler<nameWriter>(target);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private class nameWriter<T> : nameWriter
        {
            private T m_target;
            ...
            public nameWriter(in T target) => m_target = target;

            public nameWriter(ptr<T> target_ptr)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
            public static explicit operator nameWriter<T>(in ptr<T> target_ptr) => new nameWriter<T>(target_ptr);

            [MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
            public static explicit operator nameWriter<T>(in T target) => new nameWriter<T>(target);

            // Enable comparisons between nil and nameWriter<T> interface instance
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(nameWriter<T> value, NilType nil) => Activator.CreateInstance<nameWriter<T>>().Equals(value);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(nameWriter<T> value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, nameWriter<T> value) => value == nil;
...
namespace go
{
    public static class wasm_nameWriterExtensions
    {
        private static readonly ConcurrentDictionary<Type, MethodInfo> s_conversionOperators = new ConcurrentDictionary<Type, MethodInfo>();

        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static T _<T>(this go.cmd.oldlink.@internal.wasm_package.nameWriter target)
        {
            try
            {
                return ((go.cmd.oldlink.@internal.wasm_package.nameWriter<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.cmd.oldlink.@internal.wasm_package.nameWriter target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.cmd.oldlink.@internal.wasm_package.nameWriter target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.cmd.oldlink.@internal.wasm_package.nameWriter<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.cmd.oldlink.@internal.wasm_package.nameWriter target, Type type, out object? result)
        {
            try
            {
