...
//
//     Generated on 2020 October 08 04:40:32 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace @internal
{
    public static partial class sym_package
    {
        ...
        public partial struct Symbols
        {
            ...
            public Symbols(slice<Symbol> symbolBatch = default, slice<map<@string, ptr<Symbol>>> hash = default, slice<ptr<Symbol>> Allsym = default)
            {
