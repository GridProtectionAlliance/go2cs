...
// package ssa -- go2cs converted at 2020 October 09 05:26:44 UTC
    ...
    public static partial class ssa_package
    {
            ...
            while (true)
            {
                var t = v.Type;
                {
                    ...
                    v_1 = v_0;
                        ...
                        if (x != v_1.Args[0L] || !(c < 16L && d == int16(16L - c) && t.Size() == 2L))
                        {
                            continue;
                        }
            ...
            while (true)
            {
                t = v.Type;
                {
                    ...
                    v_1 = v_0;
                        ...
                        if (x != v_1.Args[0L] || !(c < 8L && d == int8(8L - c) && t.Size() == 1L))
                        {
                            continue;
                        }
            ...
            {
                {
                    ...
                    {
                        x = v_0;
                        if (v_1.Op != Op386SHLLconst || auxIntToInt32(v_1.AuxInt) != 3L)
                        {
                            continue;
                        _i0 = _i0 + 1L;
                    v_0 = v_1;
            ...
            {
                {
                    ...
                    {
                        x = v_0;
                        if (v_1.Op != Op386SHLLconst || auxIntToInt32(v_1.AuxInt) != 2L)
                        {
                            continue;
                        _i0 = _i0 + 1L;
                    v_0 = v_1;
            ...
            {
                {
                    ...
                    {
                        x = v_0;
                        if (v_1.Op != Op386SHLLconst || auxIntToInt32(v_1.AuxInt) != 1L)
                        {
                            continue;
                        _i0 = _i0 + 1L;
                    v_0 = v_1;
        ...
        private static bool rewriteValue386_Op386CMPBconst(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                var mem = l.Args[1L];
                var ptr = l.Args[0L];
                if (!(l.Uses == 1L && validValAndOff(int64(c), int64(off)) && clobber(l)))
                {
                    break;
                }
        ...
        private static bool rewriteValue386_Op386LEAL1(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                sym1 = auxToSym(v.Aux);
                {
                    ...
                    v_1 = v_0;
                        ...
                        y = v_1.Args[1L];
                        if (y != v_1.Args[0L] || !(is32Bit(int64(off1) + int64(off2)) && canMergeSym(sym1, sym2)))
                        {
                            continue;
                        }
            ...
            while (true)
            {
                if (auxIntToInt32(v.AuxInt) != 0L || auxToSym(v.Aux) != null)
                {
                    break;
                }
        ...
        private static bool rewriteValue386_Op386LEAL2(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                y = v_1.Args[0L];
                if (!(is32Bit(int64(c) + 2L * int64(d)) && y.Op != OpSB))
                {
                    break;
                }

                v.reset(Op386LEAL2);
                v.AuxInt = int32ToAuxInt(c + 2L * d);
                v.Aux = symToAux(s);
                v.AddArg2(x, y);
                return true;
            ...
            while (true)
            {
                ...
                y = v_1.Args[1L];
                if (y != v_1.Args[0L] || !(is32Bit(int64(off1) + 2L * int64(off2))))
                {
                    break;
                }

                v.reset(Op386LEAL4);
                v.AuxInt = int32ToAuxInt(off1 + 2L * off2);
                v.Aux = symToAux(sym);
                v.AddArg2(x, y);
                return true;
        ...
        private static bool rewriteValue386_Op386LEAL4(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                d = auxIntToInt32(v_1.AuxInt);
                y = v_1.Args[0L];
                if (!(is32Bit(int64(c) + 4L * int64(d)) && y.Op != OpSB))
                {
                    break;
                }

                v.reset(Op386LEAL4);
                v.AuxInt = int32ToAuxInt(c + 4L * d);
                v.Aux = symToAux(s);
                v.AddArg2(x, y);
                return true;
            ...
            while (true)
            {
                ...
                y = v_1.Args[1L];
                if (y != v_1.Args[0L] || !(is32Bit(int64(off1) + 4L * int64(off2))))
                {
                    break;
                }

                v.reset(Op386LEAL8);
                v.AuxInt = int32ToAuxInt(off1 + 4L * off2);
                v.Aux = symToAux(sym);
                v.AddArg2(x, y);
                return true;
        ...
        private static bool rewriteValue386_Op386LEAL8(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                d = auxIntToInt32(v_1.AuxInt);
                y = v_1.Args[0L];
                if (!(is32Bit(int64(c) + 8L * int64(d)) && y.Op != OpSB))
                {
                    break;
                }

                v.reset(Op386LEAL8);
                v.AuxInt = int32ToAuxInt(c + 8L * d);
                v.Aux = symToAux(s);
                v.AddArg2(x, y);
                return true;
        ...
        private static bool rewriteValue386_Op386MOVBLSX(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v.reset(Op386ANDLconst);
                v.AuxInt = int32ToAuxInt(c & 0x7fUL);
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_Op386MOVBLZX(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                x = v_0.Args[0L];
                v.reset(Op386ANDLconst);
                v.AuxInt = int32ToAuxInt(c & 0xffUL);
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_Op386MOVBstore(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                var s = auxToSym(v.Aux);
                var p = v_0;
                if (v_1.Op != Op386SHRWconst || auxIntToInt16(v_1.AuxInt) != 8L)
                {
                    break;
                }
                ...
                var w = v_1.Args[0L];
                x = v_2;
                if (x.Op != Op386MOVBstore || auxIntToInt32(x.AuxInt) != i - 1L || auxToSym(x.Aux) != s)
                {
                    break;
                }
            ...
            while (true)
            {
                ...
                s = auxToSym(v.Aux);
                p = v_0;
                if (v_1.Op != Op386SHRLconst || auxIntToInt32(v_1.AuxInt) != 8L)
                {
                    break;
                }
            ...
            while (true)
            {
                ...
                var x_1 = x.Args[1L];
                if (x_1.Op != Op386SHRWconst || auxIntToInt16(x_1.AuxInt) != 8L || w != x_1.Args[0L] || !(x.Uses == 1L && clobber(x)))
                {
                    break;
                }
            ...
            while (true)
            {
                ...
                x_1 = x.Args[1L];
                if (x_1.Op != Op386SHRLconst || auxIntToInt32(x_1.AuxInt) != 8L || w != x_1.Args[0L] || !(x.Uses == 1L && clobber(x)))
                {
                    break;
                }
            ...
            while (true)
            {
                ...
                var w0 = x.Args[1L];
                if (w0.Op != Op386SHRLconst || auxIntToInt32(w0.AuxInt) != j - 8L || w != w0.Args[0L] || !(x.Uses == 1L && clobber(x)))
                {
                    break;
                }
            ...
            while (true)
            {
                ...
                p1 = x.Args[0L];
                x_1 = x.Args[1L];
                if (x_1.Op != Op386SHRWconst || auxIntToInt16(x_1.AuxInt) != 8L || w != x_1.Args[0L] || !(x.Uses == 1L && sequentialAddresses(p0, p1, 1L) && clobber(x)))
                {
                    break;
                }
            ...
            while (true)
            {
                ...
                p1 = x.Args[0L];
                x_1 = x.Args[1L];
                if (x_1.Op != Op386SHRLconst || auxIntToInt32(x_1.AuxInt) != 8L || w != x_1.Args[0L] || !(x.Uses == 1L && sequentialAddresses(p0, p1, 1L) && clobber(x)))
                {
                    break;
                }
            ...
            while (true)
            {
                ...
                p0 = x.Args[0L];
                w0 = x.Args[1L];
                if (w0.Op != Op386SHRLconst || auxIntToInt32(w0.AuxInt) != j - 8L || w != w0.Args[0L] || !(x.Uses == 1L && sequentialAddresses(p0, p1, 1L) && clobber(x)))
                {
                    break;
                }
        ...
        private static bool rewriteValue386_Op386MOVBstoreconst(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                mem = x.Args[1L];
                if (p != x.Args[0L] || !(x.Uses == 1L && a.Off() + 1L == c.Off() && clobber(x)))
                {
                    break;
                }

                v.reset(Op386MOVWstoreconst);
                v.AuxInt = valAndOffToAuxInt(makeValAndOff32(int32(a.Val() & 0xffUL | c.Val() << (int)(8L)), int32(a.Off())));
                v.Aux = symToAux(s);
                v.AddArg2(p, mem);
                return true;
            ...
            while (true)
            {
                ...
                mem = x.Args[1L];
                var p0 = x.Args[0L];
                if (!(x.Uses == 1L && a.Off() == c.Off() && sequentialAddresses(p0, p1, 1L) && clobber(x)))
                {
                    break;
                }
        ...
        private static bool rewriteValue386_Op386MOVLstore(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                mem = l.Args[1L];
                if (ptr != l.Args[0L] || mem != v_2 || !(y.Uses == 1L && l.Uses == 1L && clobber(y, l) && validValAndOff(int64(c), int64(off))))
                {
                    break;
                }
        ...
        private static bool rewriteValue386_Op386MOVWLSX(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v.reset(Op386ANDLconst);
                v.AuxInt = int32ToAuxInt(c & 0x7fffUL);
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_Op386MOVWLZX(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                x = v_0.Args[0L];
                v.reset(Op386ANDLconst);
                v.AuxInt = int32ToAuxInt(c & 0xffffUL);
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_Op386MOVWstore(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                var s = auxToSym(v.Aux);
                var p = v_0;
                if (v_1.Op != Op386SHRLconst || auxIntToInt32(v_1.AuxInt) != 16L)
                {
                    break;
                }
                ...
                var w = v_1.Args[0L];
                x = v_2;
                if (x.Op != Op386MOVWstore || auxIntToInt32(x.AuxInt) != i - 2L || auxToSym(x.Aux) != s)
                {
                    break;
                }
            ...
            while (true)
            {
                ...
                var w0 = x.Args[1L];
                if (w0.Op != Op386SHRLconst || auxIntToInt32(w0.AuxInt) != j - 16L || w != w0.Args[0L] || !(x.Uses == 1L && clobber(x)))
                {
                    break;
                }
            ...
            while (true)
            {
                ...
                p0 = x.Args[0L];
                w0 = x.Args[1L];
                if (w0.Op != Op386SHRLconst || auxIntToInt32(w0.AuxInt) != j - 16L || w != w0.Args[0L] || !(x.Uses == 1L && sequentialAddresses(p0, p1, 2L) && clobber(x)))
                {
                    break;
                }
        ...
        private static bool rewriteValue386_Op386MOVWstoreconst(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                mem = x.Args[1L];
                if (p != x.Args[0L] || !(x.Uses == 1L && a.Off() + 2L == c.Off() && clobber(x)))
                {
                    break;
                }

                v.reset(Op386MOVLstoreconst);
                v.AuxInt = valAndOffToAuxInt(makeValAndOff32(int32(a.Val() & 0xffffUL | c.Val() << (int)(16L)), int32(a.Off())));
                v.Aux = symToAux(s);
                v.AddArg2(p, mem);
                return true;
            ...
            while (true)
            {
                ...
                mem = x.Args[1L];
                var p0 = x.Args[0L];
                if (!(x.Uses == 1L && a.Off() == c.Off() && sequentialAddresses(p0, p1, 2L) && clobber(x)))
                {
                    break;
                }
        ...
        private static bool rewriteValue386_Op386MULLconst(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v0.AuxInt = int32ToAuxInt(int32(log32(c + 1L)));
                v0.AddArg(x);
                v.AddArg2(v0, x);
                return true;
            ...
            while (true)
            {
                ...
                v.reset(Op386LEAL2);
                v0 = b.NewValue0(v.Pos, Op386SHLLconst, v.Type);
                v0.AuxInt = int32ToAuxInt(int32(log32(c - 2L)));
                v0.AddArg(x);
                v.AddArg2(v0, x);
                return true;
            ...
            while (true)
            {
                ...
                v.reset(Op386LEAL4);
                v0 = b.NewValue0(v.Pos, Op386SHLLconst, v.Type);
                v0.AuxInt = int32ToAuxInt(int32(log32(c - 4L)));
                v0.AddArg(x);
                v.AddArg2(v0, x);
                return true;
            ...
            while (true)
            {
                ...
                v.reset(Op386LEAL8);
                v0 = b.NewValue0(v.Pos, Op386SHLLconst, v.Type);
                v0.AuxInt = int32ToAuxInt(int32(log32(c - 8L)));
                v0.AddArg(x);
                v.AddArg2(v0, x);
                return true;
            ...
            while (true)
            {
                c = auxIntToInt32(v.AuxInt);
                x = v_0;
                if (!(c % 3L == 0L && isPowerOfTwo32(c / 3L)))
                {
                    break;
                }

                v.reset(Op386SHLLconst);
                v.AuxInt = int32ToAuxInt(int32(log32(c / 3L)));
                v0 = b.NewValue0(v.Pos, Op386LEAL2, v.Type);
                v0.AddArg2(x, x);
                v.AddArg(v0);
                return true;
            ...
            while (true)
            {
                c = auxIntToInt32(v.AuxInt);
                x = v_0;
                if (!(c % 5L == 0L && isPowerOfTwo32(c / 5L)))
                {
                    break;
                }

                v.reset(Op386SHLLconst);
                v.AuxInt = int32ToAuxInt(int32(log32(c / 5L)));
                v0 = b.NewValue0(v.Pos, Op386LEAL4, v.Type);
                v0.AddArg2(x, x);
                v.AddArg(v0);
                return true;
            ...
            while (true)
            {
                c = auxIntToInt32(v.AuxInt);
                x = v_0;
                if (!(c % 9L == 0L && isPowerOfTwo32(c / 9L)))
                {
                    break;
                }

                v.reset(Op386SHLLconst);
                v.AuxInt = int32ToAuxInt(int32(log32(c / 9L)));
                v0 = b.NewValue0(v.Pos, Op386LEAL8, v.Type);
                v0.AddArg2(x, x);
                v.AddArg(v0);
                return true;
            ...
            {
                {
                    ...
                    v_1 = v_0;
                        ...
                        var p = x0.Args[0L];
                        var s0 = v_1;
                        if (s0.Op != Op386SHLLconst || auxIntToInt32(s0.AuxInt) != 8L)
                        {
                            continue;
                        }
                        ...
                        _ = x1.Args[1L];
                        if (p != x1.Args[0L] || mem != x1.Args[1L] || !(i1 == i0 + 1L && x0.Uses == 1L && x1.Uses == 1L && s0.Uses == 1L && mergePoint(b, x0, x1) != null && clobber(x0, x1, s0)))
                        {
                            continue;
                        }
            ...
            {
                {
                    ...
                    v_1 = v_0;
                        ...
                        _ = x1.Args[1L];
                        var p1 = x1.Args[0L];
                        if (mem != x1.Args[1L] || !(x0.Uses == 1L && x1.Uses == 1L && s0.Uses == 1L && sequentialAddresses(p0, p1, 1L) && mergePoint(b, x0, x1) != null && clobber(x0, x1, s0)))
                        {
                            continue;
                        }
                    ...
                    v_1 = v_0;
                        ...
                        var o0_1 = o0.Args[1L];
                        {
                            ...
                            o0_1 = o0_0;
                                ...
                                p = x0.Args[0L];
                                s0 = o0_1;
                                if (s0.Op != Op386SHLLconst || auxIntToInt32(s0.AuxInt) != 16L)
                                {
                                    continue;
                                }
                                ...
                                var s1 = v_1;
                                if (s1.Op != Op386SHLLconst || auxIntToInt32(s1.AuxInt) != 24L)
                                {
                                    continue;
                                }
                                ...
                                _ = x2.Args[1L];
                                if (p != x2.Args[0L] || mem != x2.Args[1L] || !(i2 == i0 + 2L && i3 == i0 + 3L && x0.Uses == 1L && x1.Uses == 1L && x2.Uses == 1L && s0.Uses == 1L && s1.Uses == 1L && o0.Uses == 1L && mergePoint(b, x0, x1, x2) != null && clobber(x0, x1, x2, s0, s1, o0)))
                                {
                                    continue;
                                }
                    ...
                    v_1 = v_0;
                        ...
                        o0_1 = o0.Args[1L];
                        {
                            ...
                            o0_1 = o0_0;
                                ...
                                _ = x2.Args[1L];
                                var p2 = x2.Args[0L];
                                if (mem != x2.Args[1L] || !(x0.Uses == 1L && x1.Uses == 1L && x2.Uses == 1L && s0.Uses == 1L && s1.Uses == 1L && o0.Uses == 1L && sequentialAddresses(p0, p1, 2L) && sequentialAddresses(p1, p2, 1L) && mergePoint(b, x0, x1, x2) != null && clobber(x0, x1, x2, s0, s1, o0)))
                                {
                                    continue;
                                }
        ...
        private static bool rewriteValue386_Op386ROLLconst(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                var x = v_0.Args[0L];
                v.reset(Op386ROLLconst);
                v.AuxInt = int32ToAuxInt((c + d) & 31L);
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_Op386ROLWconst(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                var x = v_0.Args[0L];
                v.reset(Op386ROLWconst);
                v.AuxInt = int16ToAuxInt((c + d) & 15L);
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_Op386SARB(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v.AuxInt = int8ToAuxInt(int8(min(int64(c & 31L), 7L)));
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_Op386SARL(ptr<Value> _addr_v)
        {
            ...
            {
                x = v_0;
                if (v_1.Op != Op386ANDLconst || auxIntToInt32(v_1.AuxInt) != 31L)
                {
                    break;
                }
        ...
        private static bool rewriteValue386_Op386SARW(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v.AuxInt = int16ToAuxInt(int16(min(int64(c & 31L), 15L)));
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_Op386SHRB(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v.AuxInt = int8ToAuxInt(int8(c & 31L));
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_Op386SHRW(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v.AuxInt = int16ToAuxInt(int16(c & 31L));
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_OpCtz16(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v0.AuxInt = int32ToAuxInt(0x10000UL);
                v0.AddArg(x);
                v.AddArg(v0);
                return true;
            }
        ...
        private static bool rewriteValue386_OpMove(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v.reset(OpMove);
                v.AuxInt = int64ToAuxInt(s - s % 4L);
                v0 = b.NewValue0(v.Pos, Op386ADDLconst, dst.Type);
                v0.AuxInt = int32ToAuxInt(int32(s % 4L));
                v0.AddArg(dst);
                v1 = b.NewValue0(v.Pos, Op386ADDLconst, src.Type);
                v1.AuxInt = int32ToAuxInt(int32(s % 4L));
                v1.AddArg(src);
            ...
            while (true)
            {
                ...
                src = v_1;
                mem = v_2;
                if (!(s > 8L && s <= 4L * 128L && s % 4L == 0L && !config.noDuffDevice && logLargeCopy(v, s)))
                {
                    break;
                }

                v.reset(Op386DUFFCOPY);
                v.AuxInt = int64ToAuxInt(10L * (128L - s / 4L));
            ...
            while (true)
            {
                ...
                src = v_1;
                mem = v_2;
                if (!((s > 4L * 128L || config.noDuffDevice) && s % 4L == 0L && logLargeCopy(v, s)))
                {
                    break;
                }
        ...
        private static bool rewriteValue386_OpRotateLeft16(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                var c = auxIntToInt32(v_1.AuxInt);
                v.reset(Op386ROLWconst);
                v.AuxInt = int16ToAuxInt(int16(c & 15L));
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_OpRotateLeft8(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                var c = auxIntToInt32(v_1.AuxInt);
                v.reset(Op386ROLBconst);
                v.AuxInt = int8ToAuxInt(int8(c & 7L));
                v.AddArg(x);
                return true;
        ...
        private static bool rewriteValue386_OpZero(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v1.AuxInt = valAndOffToAuxInt(0L);
            ...
            while (true)
            {
                ...
                v0 = b.NewValue0(v.Pos, Op386MOVLstoreconst, types.TypeMem);
                v0.AuxInt = valAndOffToAuxInt(makeValAndOff32(0L, 4L));
            ...
            while (true)
            {
                ...
                mem = v_1;
                v.reset(Op386MOVLstoreconst);
                v.AuxInt = valAndOffToAuxInt(makeValAndOff32(0L, 12L));
                v0 = b.NewValue0(v.Pos, Op386MOVLstoreconst, types.TypeMem);
                v0.AuxInt = valAndOffToAuxInt(makeValAndOff32(0L, 8L));
                v1 = b.NewValue0(v.Pos, Op386MOVLstoreconst, types.TypeMem);
                v1.AuxInt = valAndOffToAuxInt(makeValAndOff32(0L, 4L));
            ...
            while (true)
            {
                ...
                v.AuxInt = int64ToAuxInt(1L * (128L - s / 4L));
                v0 = b.NewValue0(v.Pos, Op386MOVLconst, typ.UInt32);
        ...
        private static bool rewriteBlock386(ptr<Block> _addr_b)
        {
            ...
            if (b.Kind == Block386EQ) 
                ...
                while (b.Controls[0L].Op == Op386InvertFlags)
                {
                ...
                // match: (EQ (FlagEQ) yes no)
                // result: (First yes no)
                while (b.Controls[0L].Op == Op386FlagEQ)
                {
                    b.Reset(BlockFirst);
                    return true;
                } 
                ...
                // match: (EQ (FlagLT_ULT) yes no)
                // result: (First no yes)
                while (b.Controls[0L].Op == Op386FlagLT_ULT)
                {
                    b.Reset(BlockFirst);
                    b.swapSuccessors();
                    return true;
                ...
                // match: (EQ (FlagLT_UGT) yes no)
                // result: (First no yes)
                while (b.Controls[0L].Op == Op386FlagLT_UGT)
                {
                    b.Reset(BlockFirst);
                    b.swapSuccessors();
                    return true;
                ...
                // match: (EQ (FlagGT_ULT) yes no)
                // result: (First no yes)
                while (b.Controls[0L].Op == Op386FlagGT_ULT)
                {
                    b.Reset(BlockFirst);
                    b.swapSuccessors();
                    return true;
                ...
                // match: (EQ (FlagGT_UGT) yes no)
                // result: (First no yes)
                while (b.Controls[0L].Op == Op386FlagGT_UGT)
                {
                    b.Reset(BlockFirst);
                    b.swapSuccessors();
                    return true;
                ...
                // result: (LT cmp yes no)
                while (b.Controls[0L].Op == Op386SETL)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                    b.resetWithControl(Block386LT, cmp);
                ...
                // match: (If (SETLE cmp) yes no)
                // result: (LE cmp yes no)
                while (b.Controls[0L].Op == Op386SETLE)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                    b.resetWithControl(Block386LE, cmp);
                ...
                // match: (If (SETG cmp) yes no)
                // result: (GT cmp yes no)
                while (b.Controls[0L].Op == Op386SETG)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // match: (If (SETGE cmp) yes no)
                // result: (GE cmp yes no)
                while (b.Controls[0L].Op == Op386SETGE)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // match: (If (SETEQ cmp) yes no)
                // result: (EQ cmp yes no)
                while (b.Controls[0L].Op == Op386SETEQ)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                    b.resetWithControl(Block386EQ, cmp);
                ...
                // match: (If (SETNE cmp) yes no)
                // result: (NE cmp yes no)
                while (b.Controls[0L].Op == Op386SETNE)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // match: (If (SETB cmp) yes no)
                // result: (ULT cmp yes no)
                while (b.Controls[0L].Op == Op386SETB)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // match: (If (SETBE cmp) yes no)
                // result: (ULE cmp yes no)
                while (b.Controls[0L].Op == Op386SETBE)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // match: (If (SETA cmp) yes no)
                // result: (UGT cmp yes no)
                while (b.Controls[0L].Op == Op386SETA)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // match: (If (SETAE cmp) yes no)
                // result: (UGE cmp yes no)
                while (b.Controls[0L].Op == Op386SETAE)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // match: (If (SETO cmp) yes no)
                // result: (OS cmp yes no)
                while (b.Controls[0L].Op == Op386SETO)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // match: (If (SETGF cmp) yes no)
                // result: (UGT cmp yes no)
                while (b.Controls[0L].Op == Op386SETGF)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                    b.resetWithControl(Block386UGT, cmp);
                ...
                // match: (If (SETGEF cmp) yes no)
                // result: (UGE cmp yes no)
                while (b.Controls[0L].Op == Op386SETGEF)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                    b.resetWithControl(Block386UGE, cmp);
                ...
                // match: (If (SETEQF cmp) yes no)
                // result: (EQF cmp yes no)
                while (b.Controls[0L].Op == Op386SETEQF)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // match: (If (SETNEF cmp) yes no)
                // result: (NEF cmp yes no)
                while (b.Controls[0L].Op == Op386SETNEF)
                {
                    v_0 = b.Controls[0L];
                    cmp = v_0.Args[0L];
                ...
                // result: (LT cmp yes no)
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    v_0 = b.Controls[0L];
                    _ = v_0.Args[1L];
                    var v_0_0 = v_0.Args[0L];
                    ...
                    cmp = v_0_0.Args[0L];
                    var v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETL || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETLE || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETG || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETGE || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETEQ || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETNE || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETB || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETBE || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETA || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETAE || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETO || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETGF || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETGEF || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETEQF || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
                ...
                while (b.Controls[0L].Op == Op386TESTB)
                {
                    ...
                    cmp = v_0_0.Args[0L];
                    v_0_1 = v_0.Args[1L];
                    if (v_0_1.Op != Op386SETNEF || cmp != v_0_1.Args[0L])
                    {
                        break;
                    }
