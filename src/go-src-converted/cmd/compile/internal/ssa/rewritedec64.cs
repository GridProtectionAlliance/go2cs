    ...
    public static partial class ssa_package
    {
        ...
        private static bool rewriteValuedec64_OpArg(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v0.AuxInt = int32ToAuxInt(off + 4L);
                v0.Aux = symToAux(n);
        ...
        private static bool rewriteValuedec64_OpConst64(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v0.AuxInt = int32ToAuxInt(int32(c >> (int)(32L)));
        ...
        private static bool rewriteValuedec64_OpLsh16x64(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                var lo = v_1.Args[1L];
                v_1_0 = v_1.Args[0L];
                if (v_1_0.Op != OpConst32 || auxIntToInt32(v_1_0.AuxInt) != 0L)
                {
                    break;
                }
        ...
        private static bool rewriteValuedec64_OpRsh64x16(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v9.AddArg2(s, v6);
                v8.AddArg2(hi, v9);
                var v10 = b.NewValue0(v.Pos, OpZeromask, typ.UInt32);
                var v11 = b.NewValue0(v.Pos, OpZeroExt16to32, typ.UInt32);
                var v12 = b.NewValue0(v.Pos, OpRsh16Ux32, typ.UInt16);
                var v13 = b.NewValue0(v.Pos, OpConst32, typ.UInt32);
                v13.AuxInt = int32ToAuxInt(5L);
                v12.AddArg2(s, v13);
                v11.AddArg(v12);
                v10.AddArg(v11);
                v7.AddArg2(v8, v10);
        ...
        private static bool rewriteValuedec64_OpRsh64x32(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v8.AddArg2(hi, v9);
                var v10 = b.NewValue0(v.Pos, OpZeromask, typ.UInt32);
                var v11 = b.NewValue0(v.Pos, OpRsh32Ux32, typ.UInt32);
                var v12 = b.NewValue0(v.Pos, OpConst32, typ.UInt32);
                v12.AuxInt = int32ToAuxInt(5L);
                v11.AddArg2(s, v12);
                v10.AddArg(v11);
                v7.AddArg2(v8, v10);
                v1.AddArg2(v2, v7);
        ...
        private static bool rewriteValuedec64_OpRsh64x8(ptr<Value> _addr_v)
        {
            ...
            while (true)
            {
                ...
                v8.AddArg2(hi, v9);
                var v10 = b.NewValue0(v.Pos, OpZeromask, typ.UInt32);
                var v11 = b.NewValue0(v.Pos, OpZeroExt8to32, typ.UInt32);
                var v12 = b.NewValue0(v.Pos, OpRsh8Ux32, typ.UInt8);
                var v13 = b.NewValue0(v.Pos, OpConst32, typ.UInt32);
                v13.AuxInt = int32ToAuxInt(5L);
                v12.AddArg2(s, v13);
                v11.AddArg(v12);
