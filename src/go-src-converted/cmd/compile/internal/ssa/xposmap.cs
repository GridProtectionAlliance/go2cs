...
// package ssa -- go2cs converted at 2020 October 08 04:26:51 UTC
// import "cmd/compile/internal/ssa" ==> using ssa = go.cmd.compile.@internal.ssa_package
// Original source: C:\Go\src\cmd\compile\internal\ssa\xposmap.go
...
namespace @internal
{
    public static partial class ssa_package
    {
        ...
        private static ptr<xposmap> newXposmap(map<long, lineRange> x)
        {
        ...
        private static void set(this ptr<xposmap> _addr_m, src.XPos p, int v) => func((_, panic, __) =>
        {
            ref xposmap m = ref _addr_m.val;
        ...
        private static void foreachEntry(this ptr<xposmap> _addr_m, Action<int, ulong, int> f)
        {
            ref xposmap m = ref _addr_m.val;
