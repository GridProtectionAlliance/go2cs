...
// package ssa -- go2cs converted at 2022 March 13 06:17:00 UTC
// import "cmd/compile/internal/ssa" ==> using ssa = go.cmd.compile.@internal.ssa_package
// Original source: C:\Program Files\Go\src\cmd\compile\internal\ssa\rewriteMIPS64.go
...
private static bool rewriteValueMIPS64(ptr<Value> _addr_v) {
    ...
    if (v.Op == OpAdd16) 
        ...
        return rewriteValueMIPS64_OpAddr(_addr_v);
        ...
        return rewriteValueMIPS64_OpConst16(_addr_v);
    else if (v.Op == OpConst32) 
        return rewriteValueMIPS64_OpConst32(_addr_v);
    else if (v.Op == OpConst32F) 
        return rewriteValueMIPS64_OpConst32F(_addr_v);
    else if (v.Op == OpConst64) 
        return rewriteValueMIPS64_OpConst64(_addr_v);
    else if (v.Op == OpConst64F) 
        return rewriteValueMIPS64_OpConst64F(_addr_v);
    else if (v.Op == OpConst8) 
        return rewriteValueMIPS64_OpConst8(_addr_v);
    else if (v.Op == OpConstBool) 
        return rewriteValueMIPS64_OpConstBool(_addr_v);
    ...
    else if (v.Op == OpMIPS64MOVVnop) 
        return rewriteValueMIPS64_OpMIPS64MOVVnop(_addr_v);
...
private static bool rewriteValueMIPS64_OpAddr(ptr<Value> _addr_v) {
    ref Value v = ref _addr_v.val;
...
private static bool rewriteValueMIPS64_OpConst16(ptr<Value> _addr_v) {
    ref Value v = ref _addr_v.val;
...
private static bool rewriteValueMIPS64_OpConst32(ptr<Value> _addr_v) {
    ref Value v = ref _addr_v.val;
...
private static bool rewriteValueMIPS64_OpConst32F(ptr<Value> _addr_v) {
    ref Value v = ref _addr_v.val;
...
private static bool rewriteValueMIPS64_OpConst64(ptr<Value> _addr_v) {
    ref Value v = ref _addr_v.val;
...
private static bool rewriteValueMIPS64_OpConst64F(ptr<Value> _addr_v) {
    ref Value v = ref _addr_v.val;
...
private static bool rewriteValueMIPS64_OpConst8(ptr<Value> _addr_v) {
    ref Value v = ref _addr_v.val;
...
private static bool rewriteValueMIPS64_OpConstBool(ptr<Value> _addr_v) {
    ref Value v = ref _addr_v.val;
...
private static bool rewriteValueMIPS64_OpMIPS64MOVVnop(ptr<Value> _addr_v) {
    ref Value v = ref _addr_v.val;
...
private static bool rewriteValueMIPS64_OpMIPS64SGTUconst(ptr<Value> _addr_v) {
    ...
    while (true) {
        ...
        d = auxIntToInt64(v_0.AuxInt);
        if (!(0 < d && d <= 63 && 0xffffffffffffffff >> (int)(uint64(d)) < uint64(c))) {
            break;
        }
        v.reset(OpMIPS64MOVVconst);
        v.AuxInt = int64ToAuxInt(1);
...
private static bool rewriteValueMIPS64_OpMIPS64SGTconst(ptr<Value> _addr_v) {
    ...
    while (true) {
        ...
        d = auxIntToInt64(v_0.AuxInt);
        if (!(0 <= c && 0 < d && d <= 63 && 0xffffffffffffffff >> (int)(uint64(d)) < uint64(c))) {
            break;
        }
        v.reset(OpMIPS64MOVVconst);
        v.AuxInt = int64ToAuxInt(1);
...
private static bool rewriteBlockMIPS64(ptr<Block> _addr_b) {
    ...
    if (b.Kind == BlockMIPS64EQ) 
        ...
        while (b.Controls[0].Op == OpMIPS64FPFlagTrue) {
        ...
        while (b.Controls[0].Op == OpMIPS64FPFlagFalse) {
            v_0 = b.Controls[0];
            cmp = v_0.Args[0];
        ...
        while (b.Controls[0].Op == OpMIPS64XORconst) {
            v_0 = b.Controls[0];
        ...
        // result: (NE x yes no)
        while (b.Controls[0].Op == OpMIPS64SGTUconst) {
            v_0 = b.Controls[0];
            if (auxIntToInt64(v_0.AuxInt) != 1) {
                break;
            }
        ...
        // result: (EQ x yes no)
        while (b.Controls[0].Op == OpMIPS64SGTU) {
            v_0 = b.Controls[0];
            _ = v_0.Args[1];
            x = v_0.Args[0];
            var v_0_1 = v_0.Args[1];
        ...
        // result: (GEZ x yes no)
        while (b.Controls[0].Op == OpMIPS64SGTconst) {
            v_0 = b.Controls[0];
        ...
        // result: (LEZ x yes no)
        while (b.Controls[0].Op == OpMIPS64SGT) {
            v_0 = b.Controls[0];
            _ = v_0.Args[1];
            x = v_0.Args[0];
            v_0_1 = v_0.Args[1];
        ...
        // result: (First yes no)
        while (b.Controls[0].Op == OpMIPS64MOVVconst) {
            v_0 = b.Controls[0];
            if (auxIntToInt64(v_0.AuxInt) != 0) {
                break;
            }
