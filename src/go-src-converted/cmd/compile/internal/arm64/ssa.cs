...
// package arm64 -- go2cs converted at 2020 August 29 09:59:00 UTC
...
namespace @internal
{
    public static partial class arm64_package
    {
        ...
        private static void ssaGenValue(ref gc.SSAGenState _s, ref ssa.Value _v) => func(_s, _v, (ref gc.SSAGenState s, ref ssa.Value v, Defer _, Panic panic, Recover __) =>
        {
            ...
            if (v.Op == ssa.OpARM64ADD || v.Op == ssa.OpARM64SUB || v.Op == ssa.OpARM64AND || v.Op == ssa.OpARM64OR || v.Op == ssa.OpARM64XOR || v.Op == ssa.OpARM64BIC || v.Op == ssa.OpARM64MUL || v.Op == ssa.OpARM64MULW || v.Op == ssa.OpARM64MULH || v.Op == ssa.OpARM64UMULH || v.Op == ssa.OpARM64MULL || v.Op == ssa.OpARM64UMULL || v.Op == ssa.OpARM64DIV || v.Op == ssa.OpARM64UDIV || v.Op == ssa.OpARM64DIVW || v.Op == ssa.OpARM64UDIVW || v.Op == ssa.OpARM64MOD || v.Op == ssa.OpARM64UMOD || v.Op == ssa.OpARM64MODW || v.Op == ssa.OpARM64UMODW || v.Op == ssa.OpARM64SLL || v.Op == ssa.OpARM64SRL || v.Op == ssa.OpARM64SRA || v.Op == ssa.OpARM64FADDS || v.Op == ssa.OpARM64FADDD || v.Op == ssa.OpARM64FSUBS || v.Op == ssa.OpARM64FSUBD || v.Op == ssa.OpARM64FMULS || v.Op == ssa.OpARM64FMULD || v.Op == ssa.OpARM64FDIVS || v.Op == ssa.OpARM64FDIVD)
            {
                var r = v.Reg();
            ...
            if (v.Op == ssa.OpARM64ADDconst || v.Op == ssa.OpARM64SUBconst || v.Op == ssa.OpARM64ANDconst || v.Op == ssa.OpARM64ORconst || v.Op == ssa.OpARM64XORconst || v.Op == ssa.OpARM64BICconst || v.Op == ssa.OpARM64SLLconst || v.Op == ssa.OpARM64SRLconst || v.Op == ssa.OpARM64SRAconst || v.Op == ssa.OpARM64RORconst || v.Op == ssa.OpARM64RORWconst)
            {
                p = s.Prog(v.Op.Asm());
            ...
            if (v.Op == ssa.OpARM64ADDshiftLL || v.Op == ssa.OpARM64SUBshiftLL || v.Op == ssa.OpARM64ANDshiftLL || v.Op == ssa.OpARM64ORshiftLL || v.Op == ssa.OpARM64XORshiftLL || v.Op == ssa.OpARM64BICshiftLL)
            {
                genshift(s, v.Op.Asm(), v.Args[0L].Reg(), v.Args[1L].Reg(), v.Reg(), arm64.SHIFT_LL, v.AuxInt);
                goto __switch_break0;
            }
            if (v.Op == ssa.OpARM64ADDshiftRL || v.Op == ssa.OpARM64SUBshiftRL || v.Op == ssa.OpARM64ANDshiftRL || v.Op == ssa.OpARM64ORshiftRL || v.Op == ssa.OpARM64XORshiftRL || v.Op == ssa.OpARM64BICshiftRL)
            {
                genshift(s, v.Op.Asm(), v.Args[0L].Reg(), v.Args[1L].Reg(), v.Reg(), arm64.SHIFT_LR, v.AuxInt);
                goto __switch_break0;
            }
            if (v.Op == ssa.OpARM64ADDshiftRA || v.Op == ssa.OpARM64SUBshiftRA || v.Op == ssa.OpARM64ANDshiftRA || v.Op == ssa.OpARM64ORshiftRA || v.Op == ssa.OpARM64XORshiftRA || v.Op == ssa.OpARM64BICshiftRA)
            {
                genshift(s, v.Op.Asm(), v.Args[0L].Reg(), v.Args[1L].Reg(), v.Reg(), arm64.SHIFT_AR, v.AuxInt);
                goto __switch_break0;
            }
            ...
            if (v.Op == ssa.OpARM64CMP || v.Op == ssa.OpARM64CMPW || v.Op == ssa.OpARM64CMN || v.Op == ssa.OpARM64CMNW || v.Op == ssa.OpARM64FCMPS || v.Op == ssa.OpARM64FCMPD)
            {
                p = s.Prog(v.Op.Asm());
                p.From.Type = obj.TYPE_REG;
            ...
            if (v.Op == ssa.OpARM64CMPconst || v.Op == ssa.OpARM64CMPWconst || v.Op == ssa.OpARM64CMNconst || v.Op == ssa.OpARM64CMNWconst)
            {
                p = s.Prog(v.Op.Asm());
                p.From.Type = obj.TYPE_CONST;
                p.From.Offset = v.AuxInt;
            ...
            if (v.Op == ssa.OpARM64CMPshiftLL)
            {
                genshift(s, v.Op.Asm(), v.Args[0L].Reg(), v.Args[1L].Reg(), 0L, arm64.SHIFT_LL, v.AuxInt);
                goto __switch_break0;
            }
            if (v.Op == ssa.OpARM64CMPshiftRL)
            {
                genshift(s, v.Op.Asm(), v.Args[0L].Reg(), v.Args[1L].Reg(), 0L, arm64.SHIFT_LR, v.AuxInt);
                goto __switch_break0;
            }
            if (v.Op == ssa.OpARM64CMPshiftRA)
            {
                genshift(s, v.Op.Asm(), v.Args[0L].Reg(), v.Args[1L].Reg(), 0L, arm64.SHIFT_AR, v.AuxInt);
                goto __switch_break0;
            }
            ...
            if (v.Op == ssa.OpARM64LDAR || v.Op == ssa.OpARM64LDARW)
            {
                p = s.Prog(v.Op.Asm());
                p.From.Type = obj.TYPE_MEM;
                p.From.Reg = v.Args[0L].Reg();
            ...
            if (v.Op == ssa.OpARM64MOVBstore || v.Op == ssa.OpARM64MOVHstore || v.Op == ssa.OpARM64MOVWstore || v.Op == ssa.OpARM64MOVDstore || v.Op == ssa.OpARM64FMOVSstore || v.Op == ssa.OpARM64FMOVDstore || v.Op == ssa.OpARM64STLR || v.Op == ssa.OpARM64STLRW)
            {
                p = s.Prog(v.Op.Asm());
                p.From.Type = obj.TYPE_REG;
                p.From.Reg = v.Args[1L].Reg();
            ...
            if (fallthrough || v.Op == ssa.OpARM64MVN || v.Op == ssa.OpARM64NEG || v.Op == ssa.OpARM64FNEGS || v.Op == ssa.OpARM64FNEGD || v.Op == ssa.OpARM64FSQRTD || v.Op == ssa.OpARM64FCVTZSSW || v.Op == ssa.OpARM64FCVTZSDW || v.Op == ssa.OpARM64FCVTZUSW || v.Op == ssa.OpARM64FCVTZUDW || v.Op == ssa.OpARM64FCVTZSS || v.Op == ssa.OpARM64FCVTZSD || v.Op == ssa.OpARM64FCVTZUS || v.Op == ssa.OpARM64FCVTZUD || v.Op == ssa.OpARM64SCVTFWS || v.Op == ssa.OpARM64SCVTFWD || v.Op == ssa.OpARM64SCVTFS || v.Op == ssa.OpARM64SCVTFD || v.Op == ssa.OpARM64UCVTFWS || v.Op == ssa.OpARM64UCVTFWD || v.Op == ssa.OpARM64UCVTFS || v.Op == ssa.OpARM64UCVTFD || v.Op == ssa.OpARM64FCVTSD || v.Op == ssa.OpARM64FCVTDS || v.Op == ssa.OpARM64REV || v.Op == ssa.OpARM64REVW || v.Op == ssa.OpARM64REV16W || v.Op == ssa.OpARM64RBIT || v.Op == ssa.OpARM64RBITW || v.Op == ssa.OpARM64CLZ || v.Op == ssa.OpARM64CLZW)
            {
                p = s.Prog(v.Op.Asm());
                p.From.Type = obj.TYPE_REG;
                p.From.Reg = v.Args[0L].Reg();
            ...
            if (v.Op == ssa.OpARM64CSELULT || v.Op == ssa.OpARM64CSELULT0)
            {
            ...
            if (v.Op == ssa.OpARM64Equal || v.Op == ssa.OpARM64NotEqual || v.Op == ssa.OpARM64LessThan || v.Op == ssa.OpARM64LessEqual || v.Op == ssa.OpARM64GreaterThan || v.Op == ssa.OpARM64GreaterEqual || v.Op == ssa.OpARM64LessThanU || v.Op == ssa.OpARM64LessEqualU || v.Op == ssa.OpARM64GreaterThanU || v.Op == ssa.OpARM64GreaterEqualU) 
            {
            ...
            if (v.Op == ssa.OpARM64FlagEQ || v.Op == ssa.OpARM64FlagLT_ULT || v.Op == ssa.OpARM64FlagLT_UGT || v.Op == ssa.OpARM64FlagGT_ULT || v.Op == ssa.OpARM64FlagGT_UGT)
            {
        ...
        private static void ssaGenBlock(ref gc.SSAGenState s, ref ssa.Block b, ref ssa.Block next)
        {
            ...
            else if (b.Kind == ssa.BlockARM64EQ || b.Kind == ssa.BlockARM64NE || b.Kind == ssa.BlockARM64LT || b.Kind == ssa.BlockARM64GE || b.Kind == ssa.BlockARM64LE || b.Kind == ssa.BlockARM64GT || b.Kind == ssa.BlockARM64ULT || b.Kind == ssa.BlockARM64UGT || b.Kind == ssa.BlockARM64ULE || b.Kind == ssa.BlockARM64UGE || b.Kind == ssa.BlockARM64Z || b.Kind == ssa.BlockARM64NZ || b.Kind == ssa.BlockARM64ZW || b.Kind == ssa.BlockARM64NZW) 
