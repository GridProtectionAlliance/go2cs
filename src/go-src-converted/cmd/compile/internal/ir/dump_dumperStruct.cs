...
namespace @internal
{
    public static partial class ir_package
    {
        ...
        private partial struct dumper
        {
            ...
            public dumper(io.Writer output = default, ref ptr<regexp.Regexp> fieldrx = default, map<System.UIntPtr, nint> ptrmap = default, @string lastadr = default, nint indent = default, byte last = default, nint line = default)
            {
                this.output = output;
