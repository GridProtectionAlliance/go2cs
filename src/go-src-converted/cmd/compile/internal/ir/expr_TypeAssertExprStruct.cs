...
namespace @internal
{
    public static partial class ir_package
    {
        ...
        public partial struct TypeAssertExpr
        {
            ...
            public TypeAssertExpr(miniExpr miniExpr = default, Node X = default, Ntype Ntype = default, ref ptr<AddrExpr> Itab = default)
            {
        ...
        {
            return new TypeAssertExpr(value.miniExpr, value.X, value.Ntype, ref value.Itab);
        }
    }
}}}}