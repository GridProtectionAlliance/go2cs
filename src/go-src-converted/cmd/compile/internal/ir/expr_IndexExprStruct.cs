    ...
    public static partial class ir_package
    {
        ...
        public partial struct IndexExpr
        {
            ...
            public IndexExpr(NilType _)
            {
                ...
                this.X = default;
                this.Index = default;
                this.Assigned = default;
            }

            public IndexExpr(miniExpr miniExpr = default, Node X = default, Node Index = default, bool Assigned = default)
            {
        ...
        {
            return new IndexExpr(value.miniExpr, value.X, value.Index, value.Assigned);
        }
    }
}}}}