...
// package mips64 -- go2cs converted at 2022 March 13 06:24:37 UTC
// import "cmd/compile/internal/mips64" ==> using mips64 = go.cmd.compile.@internal.mips64_package
// Original source: C:\Program Files\Go\src\cmd\compile\internal\mips64\ssa.go
...
private static void ssaGenValue(ptr<ssagen.State> _addr_s, ptr<ssa.Value> _addr_v) {
    ...
    if (v.Op == ssa.OpMIPS64MOVBreg || v.Op == ssa.OpMIPS64MOVBUreg || v.Op == ssa.OpMIPS64MOVHreg || v.Op == ssa.OpMIPS64MOVHUreg || v.Op == ssa.OpMIPS64MOVWreg || v.Op == ssa.OpMIPS64MOVWUreg)
    {
        ...
        if (a.Op == ssa.OpLoadReg) {
            ...
            if (v.Op == ssa.OpMIPS64MOVBreg && t.Size() == 1 && t.IsSigned() || v.Op == ssa.OpMIPS64MOVBUreg && t.Size() == 1 && !t.IsSigned() || v.Op == ssa.OpMIPS64MOVHreg && t.Size() == 2 && t.IsSigned() || v.Op == ssa.OpMIPS64MOVHUreg && t.Size() == 2 && !t.IsSigned() || v.Op == ssa.OpMIPS64MOVWreg && t.Size() == 4 && t.IsSigned() || v.Op == ssa.OpMIPS64MOVWUreg && t.Size() == 4 && !t.IsSigned()) 
    ...
    if (fallthrough || v.Op == ssa.OpMIPS64MOVWF || v.Op == ssa.OpMIPS64MOVWD || v.Op == ssa.OpMIPS64TRUNCFW || v.Op == ssa.OpMIPS64TRUNCDW || v.Op == ssa.OpMIPS64MOVVF || v.Op == ssa.OpMIPS64MOVVD || v.Op == ssa.OpMIPS64TRUNCFV || v.Op == ssa.OpMIPS64TRUNCDV || v.Op == ssa.OpMIPS64MOVFD || v.Op == ssa.OpMIPS64MOVDF || v.Op == ssa.OpMIPS64NEGF || v.Op == ssa.OpMIPS64NEGD || v.Op == ssa.OpMIPS64SQRTF || v.Op == ssa.OpMIPS64SQRTD)
    {
        p = s.Prog(v.Op.Asm());
        p.From.Type = obj.TYPE_REG;
        p.From.Reg = v.Args[0].Reg();
