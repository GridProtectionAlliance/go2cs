...
// package ssagen -- go2cs converted at 2022 March 06 23:10:37 UTC
...
public static void InitTables() => func((_, panic, _) => {
            ...
            else
 {
    ...
    Func<ssa.Op, ssa.Op, types.Kind, types.Kind, atomicOpEmitter, intrinsicBuilder> makeAtomicGuardedIntrinsicARM64 = (op0, op1, typ, rtyp, emit) => {
        return (s, n, args) => { 
            ...
            else
 {
    ...
    Func<ssa.Op, Func<ptr<state>, ptr<ir.CallExpr>, slice<ptr<ssa.Value>>, ptr<ssa.Value>>> makeRoundAMD64 = op => {
        return (s, n, args) => {
    ...
    Func<ssa.Op, ssa.Op, Func<ptr<state>, ptr<ir.CallExpr>, slice<ptr<ssa.Value>>, ptr<ssa.Value>>> makeOnesCountAMD64 = (op64, op32) => {
        return (s, n, args) => {
...
public static ptr<obj.LSym> EmitArgInfo(ptr<ir.Func> _addr_f, ptr<abi.ABIParamResultInfo> _addr_abiInfo) {
    ...
    Func<ptr<types.Type>, bool> isAggregate = t => {
        return _addr_t.IsStruct() || t.IsArray() || t.IsComplex() || t.IsInterface() || t.IsString() || t.IsSlice()!;
    }; 
