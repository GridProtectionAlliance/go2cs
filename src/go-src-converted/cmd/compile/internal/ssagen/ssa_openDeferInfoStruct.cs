...
namespace @internal
{
    public static partial class ssagen_package
    {
        ...
        private partial struct openDeferInfo
        {
            ...
            public openDeferInfo(ref ptr<ir.CallExpr> n = default, ref ptr<ssa.Value> closure = default, ref ptr<ir.Name> closureNode = default, ref ptr<ssa.Value> rcvr = default, ref ptr<ir.Name> rcvrNode = default, slice<ptr<ssa.Value>> argVals = default, slice<ptr<ir.Name>> argNodes = default)
            {
                this.n = n;
