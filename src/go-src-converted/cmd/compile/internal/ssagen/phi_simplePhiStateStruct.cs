...
namespace @internal
{
    public static partial class ssagen_package
    {
        ...
        private partial struct simplePhiState
        {
            ...
            public simplePhiState(ref ptr<state> s = default, ref ptr<ssa.Func> f = default, slice<ptr<ssa.Value>> fwdrefs = default, slice<map<ir.Node, ptr<ssa.Value>>> defvars = default, slice<bool> reachable = default)
            {
                this.s = s;
                this.f = f;
