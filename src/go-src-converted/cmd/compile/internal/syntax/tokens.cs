...
private partial struct token { // : nuint
}
...
public static readonly var Tilde = 3; // ~

// precOrOr
public static readonly var OrOr = 4; // ||

// precAndAnd
public static readonly var AndAnd = 5; // &&

// precCmp
public static readonly var Eql = 6; // ==
public static readonly var Neq = 7; // !=
public static readonly var Lss = 8; // <
public static readonly var Leq = 9; // <=
public static readonly var Gtr = 10; // >
public static readonly var Geq = 11; // >=

// precAdd
public static readonly var Add = 12; // +
public static readonly var Sub = 13; // -
public static readonly var Or = 14; // |
public static readonly var Xor = 15; // ^

// precMul
public static readonly var Mul = 16; // *
public static readonly var Div = 17; // /
public static readonly var Rem = 18; // %
public static readonly var And = 19; // &
public static readonly var AndNot = 20; // &^
public static readonly var Shl = 21; // <<
public static readonly var Shr = 22; // >>
