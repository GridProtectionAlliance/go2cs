...
// package syntax -- go2cs converted at 2022 March 13 06:27:08 UTC
// import "cmd/compile/internal/syntax" ==> using syntax = go.cmd.compile.@internal.syntax_package
// Original source: C:\Program Files\Go\src\cmd\compile\internal\syntax\token_string.go
...
private static readonly @string _token_name = "EOFnameliteralopop=opop=:=<-*([{)]},;:....breakcasechanconstcontinuedefaultdeferelsefallthroughforfuncgogotoifimportinterfacemappackagerangereturnselectstructswitchtypevar";
...
private static @string String(this token i) {
    ...
    return _token_name[(int)_token_index[i]..(int)_token_index[i + 1]];
}
