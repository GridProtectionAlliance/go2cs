...
namespace @internal
{
    public static partial class syntax_package
    {
        ...
        {
            public long dummy; // not empty so we are guaranteed different Group instances
        }
...
// slice of string" error when Index[2] is missing.
        ...
        public partial interface SimpleStmt : Stmt
        {
            void aSimpleStmt();
        }
        ...
        public partial struct AssignStmt
        {
            ...
            public Expr Lhs; // Rhs == ImplicitOne means Lhs++ (Op == Add) or Lhs-- (Op == Sub)
            public Expr Rhs; // Rhs == ImplicitOne means Lhs++ (Op == Add) or Lhs-- (Op == Sub)
            public ref simpleStmt simpleStmt => ref simpleStmt_val;
        }
...
// the branch. Target is not set for fallthroughs.
        ...
        public partial struct CommentKind // : ulong
        {
        }
