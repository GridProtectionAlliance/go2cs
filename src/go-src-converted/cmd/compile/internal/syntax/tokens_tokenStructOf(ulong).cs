...
namespace @internal
{
    public static partial class syntax_package
    {
        ...
        private partial struct token
        {
            ...
            public token(ulong value) => m_value = value;

            // Enable implicit conversions between ulong and token struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator token(ulong value) => new token(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ulong(token value) => value.m_value;
