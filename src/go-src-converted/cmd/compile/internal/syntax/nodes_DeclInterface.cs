...
namespace @internal
{
    public static partial class syntax_package
    {
        ...
        public class Decl<T> : Decl
        {
            ...
            private delegate void aDeclByRef(ref T value);
            private delegate void aDeclByVal(T value);

            private static readonly aDeclByRef s_aDeclByRef;
            ...
            public void aDecl()
            {
                ...
                if (s_aDeclByRef is null)
                {
                    s_aDeclByVal!(target);
                    return;
                }

                s_aDeclByRef(ref target);
                return;
            ...
            static Decl()
            {
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("aDecl");

                if (!(extensionMethod is null))
                    s_aDeclByRef = extensionMethod.CreateStaticDelegate(typeof(aDeclByRef)) as aDeclByRef;
                ...
                if (s_aDeclByRef is null && s_aDeclByVal is null)
