...
namespace @internal
{
    public static partial class exports_package
    {
        ...
        public partial struct T3 : ISlice
        {
            ...
            public T3(slice<nint> value) => m_value = value;

            // Enable implicit conversions between slice<nint> and T3 struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator T3(slice<nint> value) => new T3(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator slice<nint>(T3 value) => value.m_value;
