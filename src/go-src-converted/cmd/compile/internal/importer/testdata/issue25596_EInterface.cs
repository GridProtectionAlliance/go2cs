...
namespace go
{
    public static class issue25596_EExtensions
    {
        ...
        public static T _<T>(this go.cmd.compile.@internal.importer.issue25596_package.E target)
        {
            try
            {
                return ((go.cmd.compile.@internal.importer.issue25596_package.E<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.cmd.compile.@internal.importer.issue25596_package.E target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.cmd.compile.@internal.importer.issue25596_package.E target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.cmd.compile.@internal.importer.issue25596_package.E<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.cmd.compile.@internal.importer.issue25596_package.E target, Type type, out object? result)
        {
            try
            {
