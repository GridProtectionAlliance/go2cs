...
private static readonly nint maxU64 = (1 << 64) - 1;
private static readonly nint maxU32 = (1 << 32) - 1;
private static readonly nint maxU16 = (1 << 16) - 1;
private static readonly nint maxU8 = (1 << 8) - 1;

private static readonly nint maxI64 = (1 << 63) - 1;
private static readonly nint maxI32 = (1 << 31) - 1;
private static readonly nint maxI16 = (1 << 15) - 1;
private static readonly nint maxI8 = (1 << 7) - 1;

private static readonly nint minI64 = -(1 << 63);
private static readonly nint minI32 = -(1 << 31);
...
private static slice<ptr<big.Int>> getValues(@string typ) {
    Func<ulong, ptr<big.Int>> Uint = v => big.NewInt(0).SetUint64(v);
    Func<long, ptr<big.Int>> Int = v => big.NewInt(0).SetInt64(v);
    ...
    sort.Slice(values, (i, j) => values[i].Cmp(values[j]) == -1);
