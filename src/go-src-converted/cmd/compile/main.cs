...
namespace go
{
    ...
    {
        private static map archInits = /* TODO: Fix this in ScannerBase_Expression::ExitCompositeLit */ new map<@string, Action<ref gc.Arch>>{"386":x86.Init,"amd64":amd64.Init,"amd64p32":amd64.Init,"arm":arm.Init,"arm64":arm64.Init,"mips":mips.Init,"mipsle":mips.Init,"mips64":mips64.Init,"mips64le":mips64.Init,"ppc64":ppc64.Init,"ppc64le":ppc64.Init,"s390x":s390x.Init,};
