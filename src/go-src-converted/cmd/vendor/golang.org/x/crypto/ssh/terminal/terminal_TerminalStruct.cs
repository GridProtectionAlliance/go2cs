...
namespace ssh
{
    public static partial class terminal_package
    {
        ...
        public partial struct Terminal
        {
            ...
            public Terminal(Func<@string, long, int, (@string, long, bool)> AutoCompleteCallback = default, ref ptr<EscapeCodes> Escape = default, sync.Mutex @lock = default, io.ReadWriter c = default, slice<int> prompt = default, slice<int> line = default, long pos = default, bool echo = default, bool pasteActive = default, long cursorX = default, long cursorY = default, long maxLine = default, long termWidth = default, long termHeight = default, slice<byte> outBuf = default, slice<byte> remainder = default, array<byte> inBuf = default, stRingBuffer history = default, long historyIndex = default, @string historyPending = default)
            {
