...
// package unix -- go2cs converted at 2022 March 06 23:27:45 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Program Files\Go\src\cmd\vendor\golang.org\x\sys\unix\zerrors_netbsd_386.go
...
public static readonly nuint AF_ARP = 0x1c;
...
public static readonly nuint AF_IEEE80211 = 0x20;
...
public static readonly nuint ARPHRD_STRIP = 0x17;
...
public static readonly nuint BIOCFEEDBACK = 0x8004427d;
...
public static readonly nuint BIOCGDLTLIST = 0xc0084277;
public static readonly nuint BIOCGETIF = 0x4090426b;
public static readonly nuint BIOCGFEEDBACK = 0x4004427c;
public static readonly nuint BIOCGHDRCMPLT = 0x40044274;
public static readonly nuint BIOCGRTIMEOUT = 0x400c427b;
...
public static readonly nuint BIOCSDLT = 0x80044276;
public static readonly nuint BIOCSETF = 0x80084267;
public static readonly nuint BIOCSETIF = 0x8090426c;
public static readonly nuint BIOCSFEEDBACK = 0x8004427d;
public static readonly nuint BIOCSHDRCMPLT = 0x80044275;
public static readonly nuint BIOCSRTIMEOUT = 0x800c427a;
public static readonly nuint BIOCSSEESENT = 0x80044279;
public static readonly nuint BIOCSTCPF = 0x80084272;
public static readonly nuint BIOCSUDPF = 0x80084273;
...
public static readonly nuint BPF_ALIGNMENT32 = 0x4;
...
public static readonly nuint CLONE_CSIGNAL = 0xff;
public static readonly nuint CLONE_FILES = 0x400;
public static readonly nuint CLONE_FS = 0x200;
public static readonly nuint CLONE_PID = 0x1000;
...
public static readonly nuint CTL_QUERY = -0x2;
public static readonly nuint DIOCBSFLUSH = 0x20006478;
...
public static readonly nuint EMUL_LINUX = 0x1;
public static readonly nuint EMUL_LINUX32 = 0x5;
public static readonly nuint EMUL_MAXID = 0x6;
public static readonly nuint EN_SW_CTL_INF = 0x1000;
public static readonly nuint EN_SW_CTL_PREC = 0x300;
public static readonly nuint EN_SW_CTL_ROUND = 0xc00;
public static readonly nuint EN_SW_DATACHAIN = 0x80;
public static readonly nuint EN_SW_DENORM = 0x2;
public static readonly nuint EN_SW_INVOP = 0x1;
public static readonly nuint EN_SW_OVERFLOW = 0x8;
public static readonly nuint EN_SW_PRECLOSS = 0x20;
public static readonly nuint EN_SW_UNDERFLOW = 0x10;
public static readonly nuint EN_SW_ZERODIV = 0x4;
public static readonly nuint ETHERCAP_JUMBO_MTU = 0x4;
public static readonly nuint ETHERCAP_VLAN_HWTAGGING = 0x2;
public static readonly nuint ETHERCAP_VLAN_MTU = 0x1;
public static readonly nuint ETHERMIN = 0x2e;
public static readonly nuint ETHERMTU = 0x5dc;
public static readonly nuint ETHERMTU_JUMBO = 0x2328;
...
public static readonly nuint ETHERTYPE_SLOWPROTOCOLS = 0x8809;
...
public static readonly nuint ETHER_MAX_LEN_JUMBO = 0x233a;
public static readonly nuint ETHER_MIN_LEN = 0x40;
public static readonly nuint ETHER_PPPOE_ENCAP_LEN = 0x8;
public static readonly nuint ETHER_TYPE_LEN = 0x2;
public static readonly nuint ETHER_VLAN_ENCAP_LEN = 0x4;
public static readonly nuint EVFILT_AIO = 0x2;
public static readonly nuint EVFILT_PROC = 0x4;
public static readonly nuint EVFILT_READ = 0x0;
public static readonly nuint EVFILT_SIGNAL = 0x5;
public static readonly nuint EVFILT_SYSCOUNT = 0x7;
public static readonly nuint EVFILT_TIMER = 0x6;
public static readonly nuint EVFILT_VNODE = 0x3;
public static readonly nuint EVFILT_WRITE = 0x1;
...
public static readonly nuint EXTATTR_CMD_START = 0x1;
public static readonly nuint EXTATTR_CMD_STOP = 0x2;
...
public static readonly nuint FD_SETSIZE = 0x100;
...
public static readonly nuint F_DUPFD_CLOEXEC = 0xc;
public static readonly nuint F_FSCTL = -0x80000000;
public static readonly nuint F_FSDIRMASK = 0x70000000;
public static readonly nuint F_FSIN = 0x10000000;
public static readonly nuint F_FSINOUT = 0x30000000;
public static readonly nuint F_FSOUT = 0x20000000;
public static readonly nuint F_FSPRIV = 0x8000;
public static readonly nuint F_FSVOID = 0x40000000;
public static readonly nuint F_GETFD = 0x1;
public static readonly nuint F_GETFL = 0x3;
public static readonly nuint F_GETLK = 0x7;
public static readonly nuint F_GETNOSIGPIPE = 0xd;
public static readonly nuint F_GETOWN = 0x5;
public static readonly nuint F_MAXFD = 0xb;
public static readonly nuint F_OK = 0x0;
public static readonly nuint F_PARAM_MASK = 0xfff;
public static readonly nuint F_PARAM_MAX = 0xfff;
...
public static readonly nuint F_SETNOSIGPIPE = 0xe;
...
public static readonly nuint IFF_CANTCHANGE = 0x8f52;
...
public static readonly nuint IPPROTO_IPV6_ICMP = 0x3a;
...
public static readonly nuint IPPROTO_VRRP = 0x70;
...
public static readonly nuint IP_EF = 0x8000;
public static readonly nuint IP_ERRORMTU = 0x15;
public static readonly nuint IP_HDRINCL = 0x2;
public static readonly nuint IP_IPSEC_POLICY = 0x16;
...
public static readonly nuint IP_MINFRAGSIZE = 0x45;
public static readonly nuint IP_MINTTL = 0x18;
...
public static readonly nuint IP_RECVTTL = 0x17;
...
public static readonly nuint MAP_ALIGNMENT_16MB = 0x18000000;
public static readonly nuint MAP_ALIGNMENT_1TB = 0x28000000;
public static readonly nuint MAP_ALIGNMENT_256TB = 0x30000000;
public static readonly nuint MAP_ALIGNMENT_4GB = 0x20000000;
public static readonly nuint MAP_ALIGNMENT_64KB = 0x10000000;
public static readonly nuint MAP_ALIGNMENT_64PB = 0x38000000;
...
public static readonly nuint MAP_INHERIT_DEFAULT = 0x1;
...
public static readonly nuint MAP_STACK = 0x2000;
public static readonly nuint MAP_TRYFIXED = 0x400;
public static readonly nuint MAP_WIRED = 0x800;
...
public static readonly nuint MNT_BASIC_FLAGS = 0xe782807f;
public static readonly nuint MNT_DEFEXPORTED = 0x200;
public static readonly nuint MNT_DISCARD = 0x800000;
public static readonly nuint MNT_EXKERB = 0x800;
public static readonly nuint MNT_EXNORESPORT = 0x8000000;
public static readonly nuint MNT_EXPORTANON = 0x400;
public static readonly nuint MNT_EXPORTED = 0x100;
public static readonly nuint MNT_EXPUBLIC = 0x10000000;
public static readonly nuint MNT_EXRDONLY = 0x80;
public static readonly nuint MNT_EXTATTR = 0x1000000;
public static readonly nuint MNT_FORCE = 0x80000;
public static readonly nuint MNT_GETARGS = 0x400000;
public static readonly nuint MNT_IGNORE = 0x100000;
public static readonly nuint MNT_LAZY = 0x3;
public static readonly nuint MNT_LOCAL = 0x1000;
public static readonly nuint MNT_LOG = 0x2000000;
public static readonly nuint MNT_NOATIME = 0x4000000;
public static readonly nuint MNT_NOCOREDUMP = 0x8000;
public static readonly nuint MNT_NODEV = 0x10;
public static readonly nuint MNT_NODEVMTIME = 0x40000000;
...
public static readonly nuint MNT_OP_FLAGS = 0x4d0000;
public static readonly nuint MNT_QUOTA = 0x2000;
public static readonly nuint MNT_RDONLY = 0x1;
public static readonly nuint MNT_RELATIME = 0x20000;
public static readonly nuint MNT_RELOAD = 0x40000;
public static readonly nuint MNT_ROOTFS = 0x4000;
public static readonly nuint MNT_SOFTDEP = 0x80000000;
public static readonly nuint MNT_SYMPERM = 0x20000000;
...
public static readonly nuint MNT_VISFLAGMASK = 0xff90ffff;
...
public static readonly nuint MSG_CONTROLMBUF = 0x2000000;
...
public static readonly nuint MSG_IOVUSRSPACE = 0x4000000;
public static readonly nuint MSG_LENUSRSPACE = 0x8000000;
public static readonly nuint MSG_MCAST = 0x200;
public static readonly nuint MSG_NAMEMBUF = 0x1000000;
public static readonly nuint MSG_NBIO = 0x1000;
...
public static readonly nuint MSG_USERFLAGS = 0xffffff;
...
public static readonly nuint NAME_MAX = 0x1ff;
public static readonly nuint NET_RT_DUMP = 0x1;
public static readonly nuint NET_RT_FLAGS = 0x2;
public static readonly nuint NET_RT_IFLIST = 0x5;
public static readonly nuint NET_RT_MAXID = 0x6;
public static readonly nuint NET_RT_OIFLIST = 0x4;
public static readonly nuint NET_RT_OOIFLIST = 0x3;
...
public static readonly nuint OFIOGETBMAP = 0xc004667a;
...
public static readonly nuint O_ALT_IO = 0x40000;
public static readonly nuint O_APPEND = 0x8;
public static readonly nuint O_ASYNC = 0x40;
public static readonly nuint O_CLOEXEC = 0x400000;
public static readonly nuint O_CREAT = 0x200;
public static readonly nuint O_DIRECT = 0x80000;
public static readonly nuint O_DIRECTORY = 0x200000;
public static readonly nuint O_DSYNC = 0x10000;
...
public static readonly nuint O_NOSIGPIPE = 0x1000000;
public static readonly nuint O_RDONLY = 0x0;
public static readonly nuint O_RDWR = 0x2;
public static readonly nuint O_RSYNC = 0x20000;
...
public static readonly nuint PRI_IOFLUSH = 0x7c;
...
public static readonly nuint RTAX_TAG = 0x8;
...
public static readonly nuint RTA_TAG = 0x100;
public static readonly nuint RTF_ANNOUNCE = 0x20000;
public static readonly nuint RTF_BLACKHOLE = 0x1000;
public static readonly nuint RTF_CLONED = 0x2000;
...
public static readonly nuint RTF_SRC = 0x10000;
...
public static readonly nuint RTM_CHGADDR = 0x15;
...
public static readonly nuint RTM_IEEE80211 = 0x11;
public static readonly nuint RTM_IFANNOUNCE = 0x10;
public static readonly nuint RTM_IFINFO = 0x14;
public static readonly nuint RTM_LLINFO_UPD = 0x13;
...
public static readonly nuint RTM_OIFINFO = 0xf;
public static readonly nuint RTM_OLDADD = 0x9;
public static readonly nuint RTM_OLDDEL = 0xa;
public static readonly nuint RTM_OOIFINFO = 0xe;
...
public static readonly nuint RTM_SETGATE = 0x12;
public static readonly nuint RTM_VERSION = 0x4;
...
public static readonly nuint SCM_CREDS = 0x4;
public static readonly nuint SCM_RIGHTS = 0x1;
public static readonly nuint SCM_TIMESTAMP = 0x8;
...
public static readonly nuint SIOCADDMULTI = 0x80906931;
public static readonly nuint SIOCADDRT = 0x8030720a;
public static readonly nuint SIOCAIFADDR = 0x8040691a;
public static readonly nuint SIOCALIFADDR = 0x8118691c;
public static readonly nuint SIOCATMARK = 0x40047307;
public static readonly nuint SIOCDELMULTI = 0x80906932;
public static readonly nuint SIOCDELRT = 0x8030720b;
public static readonly nuint SIOCDIFADDR = 0x80906919;
public static readonly nuint SIOCDIFPHYADDR = 0x80906949;
public static readonly nuint SIOCDLIFADDR = 0x8118691e;
public static readonly nuint SIOCGDRVSPEC = 0xc01c697b;
public static readonly nuint SIOCGETPFSYNC = 0xc09069f8;
public static readonly nuint SIOCGETSGCNT = 0xc0147534;
public static readonly nuint SIOCGETVIFCNT = 0xc0147533;
public static readonly nuint SIOCGHIWAT = 0x40047301;
public static readonly nuint SIOCGIFADDR = 0xc0906921;
public static readonly nuint SIOCGIFADDRPREF = 0xc0946920;
public static readonly nuint SIOCGIFALIAS = 0xc040691b;
public static readonly nuint SIOCGIFBRDADDR = 0xc0906923;
public static readonly nuint SIOCGIFCAP = 0xc0206976;
public static readonly nuint SIOCGIFCONF = 0xc0086926;
public static readonly nuint SIOCGIFDATA = 0xc0946985;
public static readonly nuint SIOCGIFDLT = 0xc0906977;
public static readonly nuint SIOCGIFDSTADDR = 0xc0906922;
public static readonly nuint SIOCGIFFLAGS = 0xc0906911;
public static readonly nuint SIOCGIFGENERIC = 0xc090693a;
public static readonly nuint SIOCGIFMEDIA = 0xc0286936;
public static readonly nuint SIOCGIFMETRIC = 0xc0906917;
public static readonly nuint SIOCGIFMTU = 0xc090697e;
public static readonly nuint SIOCGIFNETMASK = 0xc0906925;
public static readonly nuint SIOCGIFPDSTADDR = 0xc0906948;
public static readonly nuint SIOCGIFPSRCADDR = 0xc0906947;
public static readonly nuint SIOCGLIFADDR = 0xc118691d;
public static readonly nuint SIOCGLIFPHYADDR = 0xc118694b;
public static readonly nuint SIOCGLINKSTR = 0xc01c6987;
public static readonly nuint SIOCGLOWAT = 0x40047303;
public static readonly nuint SIOCGPGRP = 0x40047309;
public static readonly nuint SIOCGVH = 0xc0906983;
public static readonly nuint SIOCIFCREATE = 0x8090697a;
public static readonly nuint SIOCIFDESTROY = 0x80906979;
public static readonly nuint SIOCIFGCLONERS = 0xc00c6978;
public static readonly nuint SIOCINITIFADDR = 0xc0446984;
public static readonly nuint SIOCSDRVSPEC = 0x801c697b;
public static readonly nuint SIOCSETPFSYNC = 0x809069f7;
public static readonly nuint SIOCSHIWAT = 0x80047300;
public static readonly nuint SIOCSIFADDR = 0x8090690c;
public static readonly nuint SIOCSIFADDRPREF = 0x8094691f;
public static readonly nuint SIOCSIFBRDADDR = 0x80906913;
public static readonly nuint SIOCSIFCAP = 0x80206975;
public static readonly nuint SIOCSIFDSTADDR = 0x8090690e;
public static readonly nuint SIOCSIFFLAGS = 0x80906910;
public static readonly nuint SIOCSIFGENERIC = 0x80906939;
public static readonly nuint SIOCSIFMEDIA = 0xc0906935;
public static readonly nuint SIOCSIFMETRIC = 0x80906918;
public static readonly nuint SIOCSIFMTU = 0x8090697f;
public static readonly nuint SIOCSIFNETMASK = 0x80906916;
public static readonly nuint SIOCSIFPHYADDR = 0x80406946;
public static readonly nuint SIOCSLIFPHYADDR = 0x8118694a;
public static readonly nuint SIOCSLINKSTR = 0x801c6988;
public static readonly nuint SIOCSLOWAT = 0x80047302;
public static readonly nuint SIOCSPGRP = 0x80047308;
public static readonly nuint SIOCSVH = 0xc0906982;
public static readonly nuint SIOCZIFDATA = 0xc0946986;
public static readonly nuint SOCK_CLOEXEC = 0x10000000;
public static readonly nuint SOCK_DGRAM = 0x2;
public static readonly nuint SOCK_FLAGS_MASK = 0xf0000000;
public static readonly nuint SOCK_NONBLOCK = 0x20000000;
public static readonly nuint SOCK_NOSIGPIPE = 0x40000000;
...
public static readonly nuint SO_SNDTIMEO = 0x100b;
public static readonly nuint SO_TIMESTAMP = 0x2000;
public static readonly nuint SO_TYPE = 0x1008;
public static readonly nuint SO_USELOOPBACK = 0x40;
public static readonly nuint SYSCTL_VERSION = 0x1000000;
public static readonly nuint SYSCTL_VERS_0 = 0x0;
public static readonly nuint SYSCTL_VERS_1 = 0x1000000;
public static readonly nuint SYSCTL_VERS_MASK = 0xff000000;
public static readonly nuint S_ARCH1 = 0x10000;
public static readonly nuint S_ARCH2 = 0x20000;
...
public static readonly nuint S_LOGIN_SET = 0x1;
...
public static readonly nuint TCP_CONGCTL = 0x20;
public static readonly nuint TCP_KEEPCNT = 0x6;
public static readonly nuint TCP_KEEPIDLE = 0x3;
public static readonly nuint TCP_KEEPINIT = 0x7;
...
public static readonly nuint TIOCDCDTIMESTAMP = 0x400c7458;
...
public static readonly nuint TIOCFLAG_CDTRCTS = 0x10;
...
public static readonly nuint TIOCGLINED = 0x40207442;
public static readonly nuint TIOCGPGRP = 0x40047477;
public static readonly nuint TIOCGQSIZE = 0x40047481;
public static readonly nuint TIOCGRANTPT = 0x20007447;
...
public static readonly nuint TIOCPTMGET = 0x40287446;
public static readonly nuint TIOCPTSNAME = 0x40287448;
public static readonly nuint TIOCRCVFRAME = 0x80047445;
...
public static readonly nuint TIOCSLINED = 0x80207443;
public static readonly nuint TIOCSPGRP = 0x80047476;
public static readonly nuint TIOCSQSIZE = 0x80047480;
...
public static readonly nuint TIOCXMTFRAME = 0x80047444;
...
public static readonly nuint WALL = 0x8;
public static readonly nuint WALLSIG = 0x8;
public static readonly nuint WALTSIG = 0x4;
public static readonly nuint WCLONE = 0x4;
public static readonly nuint WCOREFLAG = 0x80;
public static readonly nuint WNOHANG = 0x1;
public static readonly nuint WNOWAIT = 0x10000;
public static readonly nuint WNOZOMBIE = 0x20000;
public static readonly nuint WOPTSCHECKED = 0x40000;
...
public static readonly var EBADMSG = syscall.Errno(0x58);
public static readonly var EBADRPC = syscall.Errno(0x48);
public static readonly var EBUSY = syscall.Errno(0x10);
public static readonly var ECANCELED = syscall.Errno(0x57);
...
public static readonly var EILSEQ = syscall.Errno(0x55);
...
public static readonly var EMULTIHOP = syscall.Errno(0x5e);
...
public static readonly var ENODATA = syscall.Errno(0x59);
...
public static readonly var ENOLINK = syscall.Errno(0x5f);
...
public static readonly var ENOSR = syscall.Errno(0x5a);
public static readonly var ENOSTR = syscall.Errno(0x5b);
...
public static readonly var ENOTSUP = syscall.Errno(0x56);
...
public static readonly var EPROTO = syscall.Errno(0x60);
...
public static readonly var ETIME = syscall.Errno(0x5c);
...
public static readonly var SIGPWR = syscall.Signal(0x20);
