...
// package unix -- go2cs converted at 2020 October 08 04:51:26 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_freebsd_arm64.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public static error Fadvise(long fd, long offset, long length, long advice)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_POSIX_FADVISE, uintptr(fd), uintptr(offset), uintptr(length), uintptr(advice), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
