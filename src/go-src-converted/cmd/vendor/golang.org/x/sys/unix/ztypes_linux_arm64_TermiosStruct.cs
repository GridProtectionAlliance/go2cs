...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Termios
        {
            ...
            public Termios(uint Iflag = default, uint Oflag = default, uint Cflag = default, uint Lflag = default, byte Line = default, array<byte> Cc = default, uint Ispeed = default, uint Ospeed = default)
            {
                this.Iflag = Iflag;
                this.Oflag = Oflag;
                this.Cflag = Cflag;
        ...
        {
            return new Termios(value.Iflag, value.Oflag, value.Cflag, value.Lflag, value.Line, value.Cc, value.Ispeed, value.Ospeed);
        }
    }
}}}}}}