...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Sysinfo_t
        {
            ...
            public Sysinfo_t(long Uptime = default, array<ulong> Loads = default, ulong Totalram = default, ulong Freeram = default, ulong Sharedram = default, ulong Bufferram = default, ulong Totalswap = default, ulong Freeswap = default, ushort Procs = default, ushort Pad = default, ulong Totalhigh = default, ulong Freehigh = default, uint Unit = default, array<sbyte> _ = default, array<byte> _ = default)
            {
                this.Uptime = Uptime;
                this.Loads = Loads;
