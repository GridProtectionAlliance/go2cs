...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Msghdr
        {
            ...
            public Msghdr(ref ptr<byte> Name = default, uint Namelen = default, ref ptr<Iovec> Iov = default, uint Iovlen = default, ref ptr<byte> Control = default, uint Controllen = default, int Flags = default)
            {
                this.Name = Name;
