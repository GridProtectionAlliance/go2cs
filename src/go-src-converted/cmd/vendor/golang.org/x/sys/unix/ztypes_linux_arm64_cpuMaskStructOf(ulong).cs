...
namespace sys
{
    public static partial class unix_package
    {
        ...
        private partial struct cpuMask
        {
            ...
            public cpuMask(ulong value) => m_value = value;

            // Enable implicit conversions between ulong and cpuMask struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator cpuMask(ulong value) => new cpuMask(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ulong(cpuMask value) => value.m_value;
