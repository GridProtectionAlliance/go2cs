...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Statfs_t
        {
            ...
            public Statfs_t(int Type = default, int Bsize = default, ulong Blocks = default, ulong Bfree = default, ulong Bavail = default, ulong Files = default, ulong Ffree = default, Fsid Fsid = default, int Namelen = default, int Frsize = default, int Flags = default, array<int> Spare = default, array<byte> _ = default)
            {
                this.Type = Type;
                this.Bsize = Bsize;
                this.Blocks = Blocks;
