...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct EpollEvent
        {
            ...
            public EpollEvent(uint Events = default, int PadFd = default, int Fd = default, int Pad = default)
            {
                this.Events = Events;
                this.PadFd = PadFd;
                this.Fd = Fd;
        ...
        {
            return new EpollEvent(value.Events, value.PadFd, value.Fd, value.Pad);
        }
    }
}}}}}}