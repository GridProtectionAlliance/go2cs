...
namespace sys
{
    public static partial class unix_package
    {
        ...
        {
            return new Taskstats(value.Version, value.Ac_exitcode, value.Ac_flag, value.Ac_nice, value._, value.Cpu_count, value.Cpu_delay_total, value.Blkio_count, value.Blkio_delay_total, value.Swapin_count, value.Swapin_delay_total, value.Cpu_run_real_total, value.Cpu_run_virtual_total, value.Ac_comm, value.Ac_sched, value.Ac_pad, value._, value.Ac_uid, value.Ac_gid, value.Ac_pid, value.Ac_ppid, value.Ac_btime, value._, value.Ac_etime, value.Ac_utime, value.Ac_stime, value.Ac_minflt, value.Ac_majflt, value.Coremem, value.Virtmem, value.Hiwater_rss, value.Hiwater_vm, value.Read_char, value.Write_char, value.Read_syscalls, value.Write_syscalls, value.Read_bytes, value.Write_bytes, value.Cancelled_write_bytes, value.Nvcsw, value.Nivcsw, value.Ac_utimescaled, value.Ac_stimescaled, value.Cpu_scaled_run_real_total, value.Freepages_count, value.Freepages_delay_total, value.Thrashing_count, value.Thrashing_delay_total, value.Ac_btime64);
        }
    }
}}}}}}