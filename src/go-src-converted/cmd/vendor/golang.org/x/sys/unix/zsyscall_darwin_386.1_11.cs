...
// package unix -- go2cs converted at 2020 October 08 04:49:54 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_darwin_386.1_11.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        private static error sendfile(long infd, long outfd, long offset, ptr<long> _addr_len, unsafe.Pointer hdtr, long flags)
        {
            ...
            var (_, _, e1) = Syscall9(SYS_SENDFILE, uintptr(infd), uintptr(outfd), uintptr(offset), uintptr(offset >> (int)(32L)), uintptr(@unsafe.Pointer(len)), uintptr(hdtr), uintptr(flags), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
