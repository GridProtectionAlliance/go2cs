...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Statfs_t
        {
            ...
            public Statfs_t(uint Type = default, ulong Bsize = default, ulong Blocks = default, ulong Bfree = default, ulong Bavail = default, uint Files = default, uint Ffree = default, ulong Fsid = default, ulong Namelen = default, ulong Frsize = default, ulong Flags = default)
            {
                this.Type = Type;
                this.Bsize = Bsize;
                this.Blocks = Blocks;
        ...
        {
            return new Statfs_t(value.Type, value.Bsize, value.Blocks, value.Bfree, value.Bavail, value.Files, value.Ffree, value.Fsid, value.Namelen, value.Frsize, value.Flags);
        }
    }
}}}}}}