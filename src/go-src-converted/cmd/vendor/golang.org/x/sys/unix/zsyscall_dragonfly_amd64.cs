...
// package unix -- go2cs converted at 2020 October 08 04:50:56 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_dragonfly_amd64.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        private static (long, error) extpread(long fd, slice<byte> p, long flags, long offset)
        {
            long n = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTPREAD, uintptr(fd), uintptr(_p0), uintptr(len(p)), uintptr(flags), uintptr(offset), 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        private static (long, error) extpwrite(long fd, slice<byte> p, long flags, long offset)
        {
            long n = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTPWRITE, uintptr(fd), uintptr(_p0), uintptr(len(p)), uintptr(flags), uintptr(offset), 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static error Mknodat(long fd, @string path, uint mode, long dev)
        {
            error err = default!;
