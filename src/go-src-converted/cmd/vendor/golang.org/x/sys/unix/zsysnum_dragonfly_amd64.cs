...
// Original source: C:\Program Files\Go\src\cmd\vendor\golang.org\x\sys\unix\zsysnum_dragonfly_amd64.go
...
public static readonly nint SYS_WAIT4 = 7; // { int wait4(int pid, int *status, int options, struct rusage *rusage); } wait4 wait_args int
...
public static readonly nint SYS_GETFSSTAT = 18; // { int getfsstat(struct statfs *buf, long bufsize, int flags); }
...
public static readonly nint SYS_RECVFROM = 29; // { int recvfrom(int s, caddr_t buf, size_t len, int flags, caddr_t from, int *fromlenaddr); }
...
public static readonly nint SYS_DUP = 41; // { int dup(int fd); }
public static readonly nint SYS_PIPE = 42; // { int pipe(void); }
public static readonly nint SYS_GETEGID = 43; // { gid_t getegid(void); }
public static readonly nint SYS_PROFIL = 44; // { int profil(caddr_t samples, size_t size, u_long offset, u_int scale); }
...
public static readonly nint SYS_GETLOGIN = 49; // { int getlogin(char *namebuf, size_t namelen); }
...
public static readonly nint SYS_SBRK = 69; // { caddr_t sbrk(size_t incr); }
public static readonly nint SYS_SSTK = 70; // { int sstk(size_t incr); }
...
public static readonly nint SYS_DUP2 = 90; // { int dup2(int from, int to); }
...
public static readonly nint SYS_EXTPREAD = 173; // { ssize_t extpread(int fd, void *buf, size_t nbyte, int flags, off_t offset); }
public static readonly nint SYS_EXTPWRITE = 174; // { ssize_t extpwrite(int fd, const void *buf, size_t nbyte, int flags, off_t offset); }
...
public static readonly nint SYS_MMAP = 197; // { caddr_t mmap(caddr_t addr, size_t len, int prot, int flags, int fd, int pad, off_t pos); }
public static readonly nint SYS_LSEEK = 199; // { off_t lseek(int fd, int pad, off_t offset, int whence); }
...
public static readonly nint SYS___SEMCTL = 220; // { int __semctl(int semid, int semnum, int cmd, union semun *arg); }
public static readonly nint SYS_SEMGET = 221; // { int semget(key_t key, int nsems, int semflg); }
public static readonly nint SYS_SEMOP = 222; // { int semop(int semid, struct sembuf *sops, u_int nsops); }
public static readonly nint SYS_MSGCTL = 224; // { int msgctl(int msqid, int cmd, struct msqid_ds *buf); }
...
public static readonly nint SYS_SHMAT = 228; // { caddr_t shmat(int shmid, const void *shmaddr, int shmflg); }
public static readonly nint SYS_SHMCTL = 229; // { int shmctl(int shmid, int cmd, struct shmid_ds *buf); }
...
public static readonly nint SYS_EXTPREADV = 289; // { ssize_t extpreadv(int fd, const struct iovec *iovp, int iovcnt, int flags, off_t offset); }
public static readonly nint SYS_EXTPWRITEV = 290; // { ssize_t extpwritev(int fd, const struct iovec *iovp, int iovcnt, int flags, off_t offset); }
...
public static readonly nint SYS_SIGACTION = 342; // { int sigaction(int sig, const struct sigaction *act, struct sigaction *oact); }
...
public static readonly nint SYS_EXTATTR_SET_FILE = 356; // { int extattr_set_file(const char *path, int attrnamespace, const char *attrname, void *data, size_t nbytes); }
public static readonly nint SYS_EXTATTR_GET_FILE = 357; // { int extattr_get_file(const char *path, int attrnamespace, const char *attrname, void *data, size_t nbytes); }
...
public static readonly nint SYS_KEVENT = 363; // { int kevent(int fd, const struct kevent *changelist, int nchanges, struct kevent *eventlist, int nevents, const struct timespec *timeout); }
...
public static readonly nint SYS_GETDIRENTRIES = 479; // { int getdirentries(int fd, char *buf, u_int count, long *basep); }
public static readonly nint SYS_GETDENTS = 480; // { int getdents(int fd, char *buf, size_t count); }
public static readonly nint SYS_USCHED_SET = 481; // { int usched_set(pid_t pid, int cmd, void *data, int bytes); }
...
public static readonly nint SYS_VMSPACE_CTL = 488; // { int vmspace_ctl(void *id, int cmd,         struct trapframe *tframe,    struct vextframe *vframe); }
public static readonly nint SYS_VMSPACE_MMAP = 489; // { int vmspace_mmap(void *id, void *addr, size_t len, int prot, int flags, int fd, off_t offset); }
public static readonly nint SYS_VMSPACE_MUNMAP = 490; // { int vmspace_munmap(void *id, void *addr,    size_t len); }
public static readonly nint SYS_VMSPACE_MCONTROL = 491; // { int vmspace_mcontrol(void *id, void *addr,     size_t len, int behav, off_t value); }
public static readonly nint SYS_VMSPACE_PREAD = 492; // { ssize_t vmspace_pread(void *id, void *buf, size_t nbyte, int flags, off_t offset); }
public static readonly nint SYS_VMSPACE_PWRITE = 493; // { ssize_t vmspace_pwrite(void *id, const void *buf, size_t nbyte, int flags, off_t offset); }
...
public static readonly nint SYS_PSELECT = 499; // { int pselect(int nd, fd_set *in, fd_set *ou, fd_set *ex, const struct timespec *ts,    const sigset_t *sigmask); }
...
public static readonly nint SYS_GETVFSSTAT = 503; // { int getvfsstat(struct statfs *buf,          struct statvfs *vbuf, long vbufsize, int flags); }
public static readonly nint SYS_OPENAT = 504; // { int openat(int fd, char *path, int flags, int mode); }
public static readonly nint SYS_FSTATAT = 505; // { int fstatat(int fd, char *path,     struct stat *sb, int flags); }
public static readonly nint SYS_FCHMODAT = 506; // { int fchmodat(int fd, char *path, int mode, int flags); }
public static readonly nint SYS_FCHOWNAT = 507; // { int fchownat(int fd, char *path, int uid, int gid, int flags); }
public static readonly nint SYS_UNLINKAT = 508; // { int unlinkat(int fd, char *path, int flags); }
public static readonly nint SYS_FACCESSAT = 509; // { int faccessat(int fd, char *path, int amode, int flags); }
public static readonly nint SYS_MQ_OPEN = 510; // { mqd_t mq_open(const char * name, int oflag, mode_t mode, struct mq_attr *attr); }
...
public static readonly nint SYS_MQ_GETATTR = 513; // { int mq_getattr(mqd_t mqdes, struct mq_attr *mqstat); }
public static readonly nint SYS_MQ_SETATTR = 514; // { int mq_setattr(mqd_t mqdes, const struct mq_attr *mqstat, struct mq_attr *omqstat); }
public static readonly nint SYS_MQ_NOTIFY = 515; // { int mq_notify(mqd_t mqdes, const struct sigevent *notification); }
public static readonly nint SYS_MQ_SEND = 516; // { int mq_send(mqd_t mqdes, const char *msg_ptr, size_t msg_len, unsigned msg_prio); }
public static readonly nint SYS_MQ_RECEIVE = 517; // { ssize_t mq_receive(mqd_t mqdes, char *msg_ptr, size_t msg_len, unsigned *msg_prio); }
public static readonly nint SYS_MQ_TIMEDSEND = 518; // { int mq_timedsend(mqd_t mqdes, const char *msg_ptr, size_t msg_len, unsigned msg_prio, const struct timespec *abs_timeout); }
public static readonly nint SYS_MQ_TIMEDRECEIVE = 519; // { ssize_t mq_timedreceive(mqd_t mqdes, char *msg_ptr, size_t msg_len, unsigned *msg_prio, const struct timespec *abs_timeout); }
...
public static readonly nint SYS_RENAMEAT = 523; // { int renameat(int oldfd, char *old, int newfd, char *new); }
...
public static readonly nint SYS_MKNODAT = 526; // { int mknodat(int fd, char *path, mode_t mode, dev_t dev); }
public static readonly nint SYS_READLINKAT = 527; // { int readlinkat(int fd, char *path, char *buf, size_t bufsize); }
...
public static readonly nint SYS_VQUOTACTL = 530; // { int vquotactl(const char *path, struct plistref *pref); }
public static readonly nint SYS_LINKAT = 531; // { int linkat(int fd1, char *path1, int fd2, char *path2, int flags); }
...
public static readonly nint SYS_PROCCTL = 536; // { int procctl(idtype_t idtype, id_t id, int cmd, void *data); }
public static readonly nint SYS_CHFLAGSAT = 537; // { int chflagsat(int fd, const char *path, u_long flags, int atflags);}
...
public static readonly nint SYS_FUTIMENS = 540; // { int futimens(int fd, const struct timespec *ts); }
public static readonly nint SYS_ACCEPT4 = 541; // { int accept4(int s, caddr_t name, int *anamelen, int flags); }
public static readonly nint SYS_LWP_SETNAME = 542; // { int lwp_setname(lwpid_t tid, const char *name); }
public static readonly nint SYS_PPOLL = 543; // { int ppoll(struct pollfd *fds, u_int nfds, const struct timespec *ts, const sigset_t *sigmask); }
public static readonly nint SYS_LWP_SETAFFINITY = 544; // { int lwp_setaffinity(pid_t pid, lwpid_t tid, const cpumask_t *mask); }
public static readonly nint SYS_LWP_GETAFFINITY = 545; // { int lwp_getaffinity(pid_t pid, lwpid_t tid, cpumask_t *mask); }
public static readonly nint SYS_LWP_CREATE2 = 546; // { int lwp_create2(struct lwp_params *params, const cpumask_t *mask); }
public static readonly nint SYS_GETCPUCLOCKID = 547; // { int getcpuclockid(pid_t pid, lwpid_t lwp_id, clockid_t *clock_id); }
...
public static readonly nint SYS_LWP_GETNAME = 549; // { int lwp_getname(lwpid_t tid, char *name, size_t len); }
public static readonly nint SYS_GETRANDOM = 550; // { ssize_t getrandom(void *buf, size_t len, unsigned flags); }
public static readonly nint SYS___REALPATH = 551; // { ssize_t __realpath(const char *path, char *buf, size_t len); }
