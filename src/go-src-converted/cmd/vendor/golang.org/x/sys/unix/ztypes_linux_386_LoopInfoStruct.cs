...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct LoopInfo
        {
            ...
            public LoopInfo(int Number = default, ushort Device = default, uint Inode = default, ushort Rdevice = default, int Offset = default, int Encrypt_type = default, int Encrypt_key_size = default, int Flags = default, array<sbyte> Name = default, array<byte> Encrypt_key = default, array<uint> Init = default, array<sbyte> Reserved = default)
            {
                this.Number = Number;
                this.Device = Device;
                this.Inode = Inode;
