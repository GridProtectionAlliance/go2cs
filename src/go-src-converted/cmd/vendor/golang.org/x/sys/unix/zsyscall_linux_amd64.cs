...
// package unix -- go2cs converted at 2020 October 09 05:59:11 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_linux_amd64.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        private static (long, error) inotifyInit()
        {
            long fd = default;
            error err = default!;
