...
// Original source: C:\Program Files\Go\src\cmd\vendor\golang.org\x\sys\unix\zerrors_dragonfly_amd64.go
...
public static readonly nuint AF_BLUETOOTH = 0x21;
...
public static readonly nuint AF_IEEE80211 = 0x23;
...
public static readonly nuint AF_MPLS = 0x22;
...
public static readonly nuint BPF_DEFAULTBUFSIZE = 0x1000;
...
public static readonly nuint BPF_MAX_CLONES = 0x80;
...
public static readonly nuint DT_DBF = 0xf;
...
public static readonly nuint EVFILT_EXCEPT = -0x8;
public static readonly nuint EVFILT_FS = -0xa;
public static readonly nuint EVFILT_MARKER = 0xf;
...
public static readonly nuint EVFILT_SYSCOUNT = 0xa;
public static readonly nuint EVFILT_TIMER = -0x7;
public static readonly nuint EVFILT_USER = -0x9;
...
public static readonly nuint EV_HUP = 0x800;
public static readonly nuint EV_NODATA = 0x1000;
public static readonly nuint EV_ONESHOT = 0x10;
public static readonly nuint EV_RECEIPT = 0x40;
public static readonly nuint EV_SYSFLAGS = 0xf800;
public static readonly nuint EXTA = 0x4b00;
public static readonly nuint EXTB = 0x9600;
public static readonly nuint EXTEXIT_LWP = 0x10000;
public static readonly nuint EXTEXIT_PROC = 0x0;
public static readonly nuint EXTEXIT_SETINT = 0x1;
public static readonly nuint EXTEXIT_SIMPLE = 0x0;
...
public static readonly nuint IFF_CANTCHANGE = 0x318e72;
public static readonly nuint IFF_DEBUG = 0x4;
public static readonly nuint IFF_IDIRECT = 0x200000;
...
public static readonly nuint IFF_NPOLLING = 0x100000;
public static readonly nuint IFF_OACTIVE = 0x400;
public static readonly nuint IFF_OACTIVE_COMPAT = 0x400;
public static readonly nuint IFF_POINTOPOINT = 0x10;
public static readonly nuint IFF_POLLING = 0x10000;
public static readonly nuint IFF_POLLING_COMPAT = 0x10000;
...
public static readonly nuint IFT_STF = 0xf3;
...
public static readonly nuint IPPROTO_UNKNOWN = 0x102;
...
public static readonly nuint IPV6_MINHLIM = 0x28;
...
public static readonly nuint IPV6_PKTOPTIONS = 0x34;
...
public static readonly nuint IP_FW_TBL_ADD = 0x2a;
public static readonly nuint IP_FW_TBL_CREATE = 0x28;
public static readonly nuint IP_FW_TBL_DEL = 0x2b;
public static readonly nuint IP_FW_TBL_DESTROY = 0x29;
public static readonly nuint IP_FW_TBL_EXPIRE = 0x2f;
public static readonly nuint IP_FW_TBL_FLUSH = 0x2c;
public static readonly nuint IP_FW_TBL_GET = 0x2d;
public static readonly nuint IP_FW_TBL_ZERO = 0x2e;
public static readonly nuint IP_FW_X = 0x31;
...
public static readonly nuint MADV_CONTROL_END = 0xb;
public static readonly nuint MADV_CONTROL_START = 0xa;
...
public static readonly nuint MADV_INVAL = 0xa;
...
public static readonly nuint MADV_SETMAP = 0xb;
...
public static readonly nuint MAP_SIZEALIGN = 0x40000;
public static readonly nuint MAP_STACK = 0x400;
public static readonly nuint MAP_TRYFIXED = 0x10000;
public static readonly nuint MAP_VPAGETABLE = 0x2000;
...
public static readonly nuint MNT_AUTOMOUNTED = 0x20;
...
public static readonly nuint MNT_LAZY = 0x4;
...
public static readonly nuint MNT_TRIM = 0x1000000;
public static readonly nuint MNT_UPDATE = 0x10000;
public static readonly nuint MNT_USER = 0x8000;
public static readonly nuint MNT_VISFLAGMASK = 0xf1f0ffff;
public static readonly nuint MNT_WAIT = 0x1;
public static readonly nuint MSG_CMSG_CLOEXEC = 0x1000;
...
public static readonly nuint MSG_FBLOCKING = 0x10000;
public static readonly nuint MSG_FMASK = 0xffff0000;
public static readonly nuint MSG_FNONBLOCKING = 0x20000;
...
public static readonly nuint MSG_SYNC = 0x800;
public static readonly nuint MSG_TRUNC = 0x10;
public static readonly nuint MSG_UNUSED09 = 0x200;
...
public static readonly nuint NET_RT_MAXID = 0x4;
...
public static readonly nuint O_CLOEXEC = 0x20000;
public static readonly nuint O_CREAT = 0x200;
public static readonly nuint O_DIRECT = 0x10000;
public static readonly nuint O_DIRECTORY = 0x8000000;
public static readonly nuint O_EXCL = 0x800;
public static readonly nuint O_EXLOCK = 0x20;
public static readonly nuint O_FAPPEND = 0x100000;
public static readonly nuint O_FASYNCWRITE = 0x800000;
public static readonly nuint O_FBLOCKING = 0x40000;
public static readonly nuint O_FMASK = 0xfc0000;
public static readonly nuint O_FNONBLOCKING = 0x80000;
public static readonly nuint O_FOFFSET = 0x200000;
public static readonly nuint O_FSYNC = 0x80;
public static readonly nuint O_FSYNCWRITE = 0x400000;
...
public static readonly nuint RTAX_MPLS1 = 0x8;
public static readonly nuint RTAX_MPLS2 = 0x9;
public static readonly nuint RTAX_MPLS3 = 0xa;
...
public static readonly nuint RTA_MPLS1 = 0x100;
public static readonly nuint RTA_MPLS2 = 0x200;
public static readonly nuint RTA_MPLS3 = 0x400;
...
public static readonly nuint RTF_MPLSOPS = 0x1000000;
...
public static readonly nuint RTM_VERSION = 0x7;
public static readonly nuint RTV_EXPIRE = 0x4;
public static readonly nuint RTV_HOPCOUNT = 0x2;
public static readonly nuint RTV_IWCAPSEGS = 0x400;
public static readonly nuint RTV_IWMAXSEGS = 0x200;
public static readonly nuint RTV_MSL = 0x100;
...
public static readonly nuint SIOCGIFALIAS = 0xc0406929;
...
public static readonly nuint SIOCGIFDATA = 0xc0206926;
...
public static readonly nuint SIOCSIFPOLLCPU = 0x8020697d;
public static readonly nuint SIOCSIFTSOLEN = 0x8020697f;
...
public static readonly nuint SO_CPUHINT = 0x1030;
...
public static readonly nuint SO_RERROR = 0x2000;
...
public static readonly nuint SO_SNDSPACE = 0x100a;
...
public static readonly nuint S_IFDB = 0x9000;
...
public static readonly nuint TCP_MINMSS = 0x100;
public static readonly nuint TCP_MIN_WINSHIFT = 0x5;
...
public static readonly nuint TCP_SIGNATURE_ENABLE = 0x10;
...
public static readonly nuint TIOCISPTMASTER = 0x20007455;
...
public static readonly nuint VCHECKPT = 0x13;
...
public static readonly nuint VM_BCACHE_SIZE_MAX = 0x0;
public static readonly nuint VM_SWZONE_SIZE_MAX = 0x4000000000;
...
public static readonly var EASYNC = syscall.Errno(0x63);
...
public static readonly var ELAST = syscall.Errno(0x63);
...
public static readonly var ENOMEDIUM = syscall.Errno(0x5d);
...
public static readonly var SIGCKPT = syscall.Signal(0x21);
public static readonly var SIGCKPTEXIT = syscall.Signal(0x22);
