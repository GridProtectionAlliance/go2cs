...
// package unix -- go2cs converted at 2022 March 06 23:26:49 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Program Files\Go\src\cmd\vendor\golang.org\x\sys\unix\syscall_dragonfly.go
...
private static readonly nint _dragonflyABIChangeVersion = 500705;
...
public static error Pipe2(slice<nint> p, nint flags) {
    ...
    p[0], p[1], err = pipe2(_addr_pp, flags);
    return error.As(err)!;
...
private static error sysctlUname(slice<_C_int> mib, ptr<byte> _addr_old, ptr<System.UIntPtr> _addr_oldlen) {
    ...
    var err = sysctl(mib, old, oldlen, null, 0);
    if (err != null) { 
...
public static error Uname(ptr<Utsname> _addr_uname) {
    ...
    ref var n = ref heap(@unsafe.Sizeof(uname.Sysname), out ptr<var> _addr_n);
    {
        ...
        var err = sysctlUname(mib, _addr_uname.Sysname[0], _addr_n);
    ...
    n = @unsafe.Sizeof(uname.Nodename);
    {
        ...
        err = sysctlUname(mib, _addr_uname.Nodename[0], _addr_n);
    ...
    n = @unsafe.Sizeof(uname.Release);
    {
        ...
        err = sysctlUname(mib, _addr_uname.Release[0], _addr_n);
    ...
    n = @unsafe.Sizeof(uname.Version);
    {
        ...
        err = sysctlUname(mib, _addr_uname.Version[0], _addr_n);
            ...
            else
 {
    ...
    n = @unsafe.Sizeof(uname.Machine);
    {
        ...
        err = sysctlUname(mib, _addr_uname.Machine[0], _addr_n);
