...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct RtMsghdr
        {
            ...
            public RtMsghdr(ushort Msglen = default, byte Version = default, byte Type = default, ushort Index = default, array<byte> Pad_cgo_0 = default, int Flags = default, int Addrs = default, int Pid = default, int Seq = default, int Errno = default, int Use = default, int Inits = default, array<byte> Pad_cgo_1 = default, RtMetrics Rmx = default)
            {
                this.Msglen = Msglen;
        ...
        {
            return new RtMsghdr(value.Msglen, value.Version, value.Type, value.Index, value.Pad_cgo_0, value.Flags, value.Addrs, value.Pid, value.Seq, value.Errno, value.Use, value.Inits, value.Pad_cgo_1, value.Rmx);
        }
    }
}}}}}}