...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct BlkpgPartition
        {
            ...
            public BlkpgPartition(long Start = default, long Length = default, int Pno = default, array<byte> Devname = default, array<byte> Volname = default)
            {
                this.Start = Start;
                this.Length = Length;
                this.Pno = Pno;
        ...
        {
            return new BlkpgPartition(value.Start, value.Length, value.Pno, value.Devname, value.Volname);
        }
    }
}}}}}}