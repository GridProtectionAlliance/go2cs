...
// package unix -- go2cs converted at 2020 October 08 04:52:36 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_netbsd_amd64.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public static error Fadvise(long fd, long offset, long length, long advice)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_POSIX_FADVISE, uintptr(fd), 0L, uintptr(offset), 0L, uintptr(length), uintptr(advice));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static error Ftruncate(long fd, long length)
        {
            ...
            var (_, _, e1) = Syscall(SYS_FTRUNCATE, uintptr(fd), 0L, uintptr(length));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static (long, error) Pread(long fd, slice<byte> p, long offset)
        {
            ...
            var (r0, _, e1) = Syscall6(SYS_PREAD, uintptr(fd), uintptr(_p0), uintptr(len(p)), 0L, uintptr(offset), 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static (long, error) Pwrite(long fd, slice<byte> p, long offset)
        {
            ...
            var (r0, _, e1) = Syscall6(SYS_PWRITE, uintptr(fd), uintptr(_p0), uintptr(len(p)), 0L, uintptr(offset), 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static (long, error) Seek(long fd, long offset, long whence)
        {
            ...
            var (r0, _, e1) = Syscall6(SYS_LSEEK, uintptr(fd), 0L, uintptr(offset), uintptr(whence), 0L, 0L);
            newoffset = int64(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static error Truncate(@string path, long length)
        {
            ...
            var (_, _, e1) = Syscall(SYS_TRUNCATE, uintptr(@unsafe.Pointer(_p0)), 0L, uintptr(length));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static (System.UIntPtr, error) mmap(System.UIntPtr addr, System.UIntPtr length, long prot, long flag, long fd, long pos)
        {
            ...
            var (r0, _, e1) = Syscall9(SYS_MMAP, uintptr(addr), uintptr(length), uintptr(prot), uintptr(flag), uintptr(fd), 0L, uintptr(pos), 0L, 0L);
            ret = uintptr(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
