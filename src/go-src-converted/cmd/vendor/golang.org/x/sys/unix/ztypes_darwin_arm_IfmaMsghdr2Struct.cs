...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct IfmaMsghdr2
        {
            ...
            public IfmaMsghdr2(ushort Msglen = default, byte Version = default, byte Type = default, int Addrs = default, int Flags = default, ushort Index = default, array<byte> _ = default, int Refcount = default)
            {
                this.Msglen = Msglen;
        ...
        {
            return new IfmaMsghdr2(value.Msglen, value.Version, value.Type, value.Addrs, value.Flags, value.Index, value._, value.Refcount);
        }
    }
}}}}}}