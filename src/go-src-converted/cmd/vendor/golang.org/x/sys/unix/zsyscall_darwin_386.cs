...
// package unix -- go2cs converted at 2020 October 08 04:50:03 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_darwin_386.go
...
;
        ...
        private static error sendfile(long infd, long outfd, long offset, ptr<long> _addr_len, unsafe.Pointer hdtr, long flags)
        {
            ...
            var (_, _, e1) = syscall_syscall9(funcPC(libc_sendfile_trampoline), uintptr(infd), uintptr(outfd), uintptr(offset), uintptr(offset >> (int)(32L)), uintptr(@unsafe.Pointer(len)), uintptr(hdtr), uintptr(flags), 0L, 0L);
            if (e1 != 0L)
...
;
        ...
        public static error Ftruncate(long fd, long length)
        {
            ...
            var (_, _, e1) = syscall_syscall(funcPC(libc_ftruncate_trampoline), uintptr(fd), uintptr(length), uintptr(length >> (int)(32L)));
            if (e1 != 0L)
...
;
        ...
        public static (long, error) Pread(long fd, slice<byte> p, long offset)
        {
            ...
            var (r0, _, e1) = syscall_syscall6(funcPC(libc_pread_trampoline), uintptr(fd), uintptr(_p0), uintptr(len(p)), uintptr(offset), uintptr(offset >> (int)(32L)), 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
...
;
        ...
        public static (long, error) Pwrite(long fd, slice<byte> p, long offset)
        {
            ...
            var (r0, _, e1) = syscall_syscall6(funcPC(libc_pwrite_trampoline), uintptr(fd), uintptr(_p0), uintptr(len(p)), uintptr(offset), uintptr(offset >> (int)(32L)), 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
...
;
        ...
        public static (long, error) Seek(long fd, long offset, long whence)
        {
            ...
            var (r0, r1, e1) = syscall_syscall6(funcPC(libc_lseek_trampoline), uintptr(fd), uintptr(offset), uintptr(offset >> (int)(32L)), uintptr(whence), 0L, 0L);
...
;
        ...
        public static error Truncate(@string path, long length)
        {
            ...
            var (_, _, e1) = syscall_syscall(funcPC(libc_truncate_trampoline), uintptr(@unsafe.Pointer(_p0)), uintptr(length), uintptr(length >> (int)(32L)));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
...
;
        ...
        private static (System.UIntPtr, error) mmap(System.UIntPtr addr, System.UIntPtr length, long prot, long flag, long fd, long pos)
        {
            ...
            var (r0, _, e1) = syscall_syscall9(funcPC(libc_mmap_trampoline), uintptr(addr), uintptr(length), uintptr(prot), uintptr(flag), uintptr(fd), uintptr(pos), uintptr(pos >> (int)(32L)), 0L, 0L);
            ret = uintptr(r0);
            if (e1 != 0L)
...
;
        ...
        private static (int, int, error) gettimeofday(ptr<Timeval> _addr_tp)
        {
            int sec = default;
            int usec = default;
            error err = default!;
