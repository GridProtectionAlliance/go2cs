...
// package unix -- go2cs converted at 2020 October 08 04:50:34 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_darwin_arm.go
...
;
        ...
        public static error Fstat(long fd, ptr<Stat_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall_syscall(funcPC(libc_fstat_trampoline), uintptr(fd), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
...
;
        ...
        public static error Fstatat(long fd, @string path, ptr<Stat_t> _addr_stat, long flags)
        {
            ...
            var (_, _, e1) = syscall_syscall6(funcPC(libc_fstatat_trampoline), uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), uintptr(flags), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
...
;
        ...
        public static error Fstatfs(long fd, ptr<Statfs_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall_syscall(funcPC(libc_fstatfs_trampoline), uintptr(fd), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {>>MARKER:FUNCTION_libc_fstatat_trampoline_BLOCK_PREFIX<<
                err = errnoErr(e1);
            }
...
;
        ...
        private static (long, error) getfsstat(unsafe.Pointer buf, System.UIntPtr size, long flags)
        {
            ...
            var (r0, _, e1) = syscall_syscall(funcPC(libc_getfsstat_trampoline), uintptr(buf), uintptr(size), uintptr(flags));
            n = int(r0);
            if (e1 != 0L)
...
;
        ...
        public static error Lstat(@string path, ptr<Stat_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall_syscall(funcPC(libc_lstat_trampoline), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
...
;
        ...
        public static error Stat(@string path, ptr<Stat_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall_syscall(funcPC(libc_stat_trampoline), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
...
;
        ...
        public static error Statfs(@string path, ptr<Statfs_t> _addr_stat)
        {
            ...
            var (_, _, e1) = syscall_syscall(funcPC(libc_statfs_trampoline), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
