...
// Original source: C:\Program Files\Go\src\cmd\vendor\golang.org\x\sys\unix\zsysnum_linux_riscv64.go
...
public static readonly nint SYS_USERFAULTFD = 282;
public static readonly nint SYS_MEMBARRIER = 283;
public static readonly nint SYS_MLOCK2 = 284;
public static readonly nint SYS_COPY_FILE_RANGE = 285;
public static readonly nint SYS_PREADV2 = 286;
public static readonly nint SYS_PWRITEV2 = 287;
public static readonly nint SYS_PKEY_MPROTECT = 288;
public static readonly nint SYS_PKEY_ALLOC = 289;
public static readonly nint SYS_PKEY_FREE = 290;
public static readonly nint SYS_STATX = 291;
public static readonly nint SYS_IO_PGETEVENTS = 292;
public static readonly nint SYS_RSEQ = 293;
public static readonly nint SYS_KEXEC_FILE_LOAD = 294;
