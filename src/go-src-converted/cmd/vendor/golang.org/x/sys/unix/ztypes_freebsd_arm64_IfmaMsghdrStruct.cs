...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct IfmaMsghdr
        {
            ...
            public IfmaMsghdr(ushort Msglen = default, byte Version = default, byte Type = default, int Addrs = default, int Flags = default, ushort Index = default, ushort _ = default)
            {
                this.Msglen = Msglen;
