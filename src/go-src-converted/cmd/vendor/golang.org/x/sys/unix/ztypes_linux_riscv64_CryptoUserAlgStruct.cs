...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct CryptoUserAlg
        {
            ...
            public CryptoUserAlg(array<byte> Name = default, array<byte> Driver_name = default, array<byte> Module_name = default, uint Type = default, uint Mask = default, uint Refcnt = default, uint Flags = default)
            {
                this.Name = Name;
