...
// package unix -- go2cs converted at 2020 October 09 05:59:09 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_linux_386.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public static error Fadvise(long fd, long offset, long length, long advice)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_FADVISE64_64, uintptr(fd), uintptr(offset), uintptr(offset >> (int)(32L)), uintptr(length), uintptr(length >> (int)(32L)), uintptr(advice));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
