...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Statfs_t
        {
            ...
            public Statfs_t(uint F_flags = default, uint F_bsize = default, uint F_iosize = default, array<byte> _ = default, ulong F_blocks = default, ulong F_bfree = default, long F_bavail = default, ulong F_files = default, ulong F_ffree = default, long F_favail = default, ulong F_syncwrites = default, ulong F_syncreads = default, ulong F_asyncwrites = default, ulong F_asyncreads = default, Fsid F_fsid = default, uint F_namemax = default, uint F_owner = default, ulong F_ctime = default, array<sbyte> F_fstypename = default, array<sbyte> F_mntonname = default, array<sbyte> F_mntfromname = default, array<sbyte> F_mntfromspec = default, array<byte> _ = default, array<byte> Mount_info = default)
            {
        ...
        {
            return new Statfs_t(value.F_flags, value.F_bsize, value.F_iosize, value._, value.F_blocks, value.F_bfree, value.F_bavail, value.F_files, value.F_ffree, value.F_favail, value.F_syncwrites, value.F_syncreads, value.F_asyncwrites, value.F_asyncreads, value.F_fsid, value.F_namemax, value.F_owner, value.F_ctime, value.F_fstypename, value.F_mntonname, value.F_mntfromname, value.F_mntfromspec, value._, value.Mount_info);
        }
    }
}}}}}}