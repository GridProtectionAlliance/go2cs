...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Flock_t
        {
            ...
            public Flock_t(short Type = default, short Whence = default, long Start = default, long Len = default, int Pid = default, short _ = default, array<byte> _ = default)
            {
                this.Type = Type;
                this.Whence = Whence;
                this.Start = Start;
        ...
        {
            return new Flock_t(value.Type, value.Whence, value.Start, value.Len, value.Pid, value._, value._);
        }
    }
}}}}}}