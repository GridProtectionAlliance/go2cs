...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Kevent_t
        {
            ...
            public Kevent_t(uint Ident = default, short Filter = default, ushort Flags = default, uint Fflags = default, array<byte> _ = default, long Data = default, ref ptr<byte> Udata = default, array<byte> _ = default)
            {
                this.Ident = Ident;
                this.Filter = Filter;
                this.Flags = Flags;
        ...
        {
            return new Kevent_t(value.Ident, value.Filter, value.Flags, value.Fflags, value._, value.Data, ref value.Udata, value._);
        }
    }
}}}}}}