...
// package unix -- go2cs converted at 2020 October 08 04:52:43 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_netbsd_arm.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public static error Dup3(long from, long to, long flags)
        {
            error err = default!;
        ...
        public static error Fadvise(long fd, long offset, long length, long advice)
        {
            ...
            var (_, _, e1) = Syscall9(SYS_POSIX_FADVISE, uintptr(fd), 0L, uintptr(offset), uintptr(offset >> (int)(32L)), 0L, uintptr(length), uintptr(length >> (int)(32L)), uintptr(advice), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static error Fstatvfs1(long fd, ptr<Statvfs_t> _addr_buf, long flags)
        {
            error err = default!;
        ...
        public static error Statvfs1(@string path, ptr<Statvfs_t> _addr_buf, long flags)
        {
            error err = default!;
            ref Statvfs_t buf = ref _addr_buf.val;
