...
// package unix -- go2cs converted at 2022 March 06 23:27:14 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Program Files\Go\src\cmd\vendor\golang.org\x\sys\unix\syscall_openbsd.go
...
private static (slice<_C_int>, error) nametomib(@string name) {
    ...
    var i = sort.Search(len(sysctlMib), i => {>>MARKER:FUNCTION_Syscall9_BLOCK_PREFIX<<
...
public static (ptr<Uvmexp>, error) SysctlUvmexp(@string name) {
    ...
    {
        var err = sysctl(mib, (byte.val)(@unsafe.Pointer(_addr_u)), _addr_n, null, 0);
