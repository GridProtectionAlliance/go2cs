...
// package unix -- go2cs converted at 2020 October 08 04:51:45 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_linux_arm.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        private static error fanotifyMark(long fd, ulong flags, ulong mask, long dirFd, ptr<byte> _addr_pathname)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_FANOTIFY_MARK, uintptr(fd), uintptr(flags), uintptr(mask), uintptr(mask >> (int)(32L)), uintptr(dirFd), uintptr(@unsafe.Pointer(pathname)));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static long Getegid()
        {
            ...
            var (r0, _) = RawSyscallNoError(SYS_GETEGID32, 0L, 0L, 0L);
            egid = int(r0);
            return ;
        }
        ...
        public static long Geteuid()
        {
            ...
            var (r0, _) = RawSyscallNoError(SYS_GETEUID32, 0L, 0L, 0L);
            euid = int(r0);
            return ;
        }
        ...
        public static long Getgid()
        {
            ...
            var (r0, _) = RawSyscallNoError(SYS_GETGID32, 0L, 0L, 0L);
            gid = int(r0);
            return ;
        }
        ...
        public static long Getuid()
        {
            ...
            var (r0, _) = RawSyscallNoError(SYS_GETUID32, 0L, 0L, 0L);
            uid = int(r0);
            return ;
        }
        ...
        private static (long, error) setfsgid(long gid)
        {
            ...
            var (r0, _, e1) = Syscall(SYS_SETFSGID32, uintptr(gid), 0L, 0L);
            prev = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        private static (long, error) setfsuid(long uid)
        {
            ...
            var (r0, _, e1) = Syscall(SYS_SETFSUID32, uintptr(uid), 0L, 0L);
            prev = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        private static error armSyncFileRange(long fd, long flags, long off, long n)
        {
            error err = default!;

            var (_, _, e1) = Syscall6(SYS_ARM_SYNC_FILE_RANGE, uintptr(fd), uintptr(flags), uintptr(off), uintptr(off >> (int)(32L)), uintptr(n), uintptr(n >> (int)(32L)));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
