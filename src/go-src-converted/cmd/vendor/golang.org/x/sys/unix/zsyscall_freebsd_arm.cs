...
// package unix -- go2cs converted at 2022 March 06 23:28:42 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Program Files\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_freebsd_arm.go
...
private static error ptrace(nint request, nint pid, System.UIntPtr addr, nint data) {
    error err = default!;
...
public static error CapEnter() {
    error err = default!;

    var (_, _, e1) = Syscall(SYS_CAP_ENTER, 0, 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static error capRightsGet(nint version, nint fd, ptr<CapRights> _addr_rightsp) {
    error err = default!;
    ref CapRights rightsp = ref _addr_rightsp.val;

    var (_, _, e1) = Syscall(SYS___CAP_RIGHTS_GET, uintptr(version), uintptr(fd), uintptr(@unsafe.Pointer(rightsp)));
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static error capRightsLimit(nint fd, ptr<CapRights> _addr_rightsp) {
    error err = default!;
    ref CapRights rightsp = ref _addr_rightsp.val;

    var (_, _, e1) = Syscall(SYS_CAP_RIGHTS_LIMIT, uintptr(fd), uintptr(@unsafe.Pointer(rightsp)), 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
public static error Fadvise(nint fd, long offset, long length, nint advice) {
    ...
    var (_, _, e1) = Syscall9(SYS_POSIX_FADVISE, uintptr(fd), 0, uintptr(offset), uintptr(offset >> 32), uintptr(length), uintptr(length >> 32), uintptr(advice), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static error fstat(nint fd, ptr<stat_freebsd11_t> _addr_stat) {
    error err = default!;
...
private static error fstat_freebsd12(nint fd, ptr<Stat_t> _addr_stat) {
    error err = default!;
    ref Stat_t stat = ref _addr_stat.val;

    var (_, _, e1) = Syscall(SYS_FSTAT_FREEBSD12, uintptr(fd), uintptr(@unsafe.Pointer(stat)), 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static error fstatat(nint fd, @string path, ptr<stat_freebsd11_t> _addr_stat, nint flags) {
    error err = default!;
    ref stat_freebsd11_t stat = ref _addr_stat.val;
...
private static error fstatat_freebsd12(nint fd, @string path, ptr<Stat_t> _addr_stat, nint flags) {
    error err = default!;
    ref Stat_t stat = ref _addr_stat.val;
    ...
    var (_, _, e1) = Syscall6(SYS_FSTATAT_FREEBSD12, uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), uintptr(flags), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static error fstatfs(nint fd, ptr<statfs_freebsd11_t> _addr_stat) {
    error err = default!;
    ref statfs_freebsd11_t stat = ref _addr_stat.val;

    var (_, _, e1) = Syscall(SYS_FSTATFS, uintptr(fd), uintptr(@unsafe.Pointer(stat)), 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static error fstatfs_freebsd12(nint fd, ptr<Statfs_t> _addr_stat) {
    error err = default!;
    ref Statfs_t stat = ref _addr_stat.val;

    var (_, _, e1) = Syscall(SYS_FSTATFS_FREEBSD12, uintptr(fd), uintptr(@unsafe.Pointer(stat)), 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
public static error Ftruncate(nint fd, long length) {
    ...
    var (_, _, e1) = Syscall6(SYS_FTRUNCATE, uintptr(fd), 0, uintptr(length), uintptr(length >> 32), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static (nint, error) getdirentries(nint fd, slice<byte> buf, ptr<System.UIntPtr> _addr_basep) {
    nint n = default;
    error err = default!;
    ...
    else
 {
    ...
    var (r0, _, e1) = Syscall6(SYS_GETDIRENTRIES, uintptr(fd), uintptr(_p0), uintptr(len(buf)), uintptr(@unsafe.Pointer(basep)), 0, 0);
    n = int(r0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
...
private static (nint, error) getdirentries_freebsd12(nint fd, slice<byte> buf, ptr<ulong> _addr_basep) {
    nint n = default;
    error err = default!;
    ...
    else
 {
    ...
    var (r0, _, e1) = Syscall6(SYS_GETDIRENTRIES_FREEBSD12, uintptr(fd), uintptr(_p0), uintptr(len(buf)), uintptr(@unsafe.Pointer(basep)), 0, 0);
    n = int(r0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
...
public static nint Getdtablesize() {
    ...
    var (r0, _, _) = Syscall(SYS_GETDTABLESIZE, 0, 0, 0);
    size = int(r0);
    return ;
}
...
private static error mknod(@string path, uint mode, nint dev) {
    error err = default!;
...
private static error mknodat(nint fd, @string path, uint mode, nint dev) {
    error err = default!;
    ...
    var (_, _, e1) = Syscall6(SYS_MKNODAT, uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(mode), uintptr(dev), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static error mknodat_freebsd12(nint fd, @string path, uint mode, ulong dev) {
    error err = default!;
    ...
    var (_, _, e1) = Syscall6(SYS_MKNODAT_FREEBSD12, uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(mode), uintptr(dev), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
public static (nint, error) Openat(nint fdat, @string path, nint mode, uint perm) {
    nint fd = default;
    error err = default!;
    ...
    var (r0, _, e1) = Syscall6(SYS_OPENAT, uintptr(fdat), uintptr(@unsafe.Pointer(_p0)), uintptr(mode), uintptr(perm), 0, 0);
    fd = int(r0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
...
public static (nint, error) Pread(nint fd, slice<byte> p, long offset) {
    ...
    else
 {
    ...
    var (r0, _, e1) = Syscall6(SYS_PREAD, uintptr(fd), uintptr(_p0), uintptr(len(p)), 0, uintptr(offset), uintptr(offset >> 32));
    n = int(r0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
...
public static (nint, error) Pwrite(nint fd, slice<byte> p, long offset) {
    ...
    else
 {
    ...
    var (r0, _, e1) = Syscall6(SYS_PWRITE, uintptr(fd), uintptr(_p0), uintptr(len(p)), 0, uintptr(offset), uintptr(offset >> 32));
    n = int(r0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
...
public static (long, error) Seek(nint fd, long offset, nint whence) {
    ...
    var (r0, r1, e1) = Syscall6(SYS_LSEEK, uintptr(fd), 0, uintptr(offset), uintptr(offset >> 32), uintptr(whence), 0);
...
public static error Setlogin(@string name) {
    ...
    var (_, _, e1) = Syscall(SYS_SETLOGIN, uintptr(@unsafe.Pointer(_p0)), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static error statfs(@string path, ptr<statfs_freebsd11_t> _addr_stat) {
    ...
    var (_, _, e1) = Syscall(SYS_STATFS, uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static error statfs_freebsd12(@string path, ptr<Statfs_t> _addr_stat) {
    ...
    var (_, _, e1) = Syscall(SYS_STATFS_FREEBSD12, uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
public static error Truncate(@string path, long length) {
    ...
    var (_, _, e1) = Syscall6(SYS_TRUNCATE, uintptr(@unsafe.Pointer(_p0)), 0, uintptr(length), uintptr(length >> 32), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
public static error Undelete(@string path) {
    ...
    var (_, _, e1) = Syscall(SYS_UNDELETE, uintptr(@unsafe.Pointer(_p0)), 0, 0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
    return ;
...
private static (System.UIntPtr, error) mmap(System.UIntPtr addr, System.UIntPtr length, nint prot, nint flag, nint fd, long pos) {
    ...
    var (r0, _, e1) = Syscall9(SYS_MMAP, uintptr(addr), uintptr(length), uintptr(prot), uintptr(flag), uintptr(fd), 0, uintptr(pos), uintptr(pos >> 32), 0);
    ret = uintptr(r0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
...
private static (nint, error) accept4(nint fd, ptr<RawSockaddrAny> _addr_rsa, ptr<_Socklen> _addr_addrlen, nint flags) {
    ...
    var (r0, _, e1) = Syscall6(SYS_ACCEPT4, uintptr(fd), uintptr(@unsafe.Pointer(rsa)), uintptr(@unsafe.Pointer(addrlen)), uintptr(flags), 0, 0);
    nfd = int(r0);
    if (e1 != 0) {
        err = errnoErr(e1);
    }
