...
// package unix -- go2cs converted at 2020 October 08 04:51:18 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_freebsd_arm.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        private static error ptrace(long request, long pid, System.UIntPtr addr, long data)
        {
            error err = default!;
        ...
        public static error CapEnter()
        {
            ...
            var (_, _, e1) = Syscall(SYS_CAP_ENTER, 0L, 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error capRightsGet(long version, long fd, ptr<CapRights> _addr_rightsp)
        {
            error err = default!;
        ...
        private static error capRightsLimit(long fd, ptr<CapRights> _addr_rightsp)
        {
            error err = default!;
            ref CapRights rightsp = ref _addr_rightsp.val;

            var (_, _, e1) = Syscall(SYS_CAP_RIGHTS_LIMIT, uintptr(fd), uintptr(@unsafe.Pointer(rightsp)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static (long, error) ExtattrGetFd(long fd, long attrnamespace, @string attrname, System.UIntPtr data, long nbytes)
        {
            long ret = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTATTR_GET_FD, uintptr(fd), uintptr(attrnamespace), uintptr(@unsafe.Pointer(_p0)), uintptr(data), uintptr(nbytes), 0L);
            ret = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static (long, error) ExtattrSetFd(long fd, long attrnamespace, @string attrname, System.UIntPtr data, long nbytes)
        {
            long ret = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTATTR_SET_FD, uintptr(fd), uintptr(attrnamespace), uintptr(@unsafe.Pointer(_p0)), uintptr(data), uintptr(nbytes), 0L);
            ret = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static error ExtattrDeleteFd(long fd, long attrnamespace, @string attrname)
        {
            error err = default!;
        ...
        public static (long, error) ExtattrListFd(long fd, long attrnamespace, System.UIntPtr data, long nbytes)
        {
            long ret = default;
            error err = default!;

            var (r0, _, e1) = Syscall6(SYS_EXTATTR_LIST_FD, uintptr(fd), uintptr(attrnamespace), uintptr(data), uintptr(nbytes), 0L, 0L);
            ret = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static (long, error) ExtattrGetFile(@string file, long attrnamespace, @string attrname, System.UIntPtr data, long nbytes)
        {
            long ret = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTATTR_GET_FILE, uintptr(@unsafe.Pointer(_p0)), uintptr(attrnamespace), uintptr(@unsafe.Pointer(_p1)), uintptr(data), uintptr(nbytes), 0L);
            ret = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static (long, error) ExtattrSetFile(@string file, long attrnamespace, @string attrname, System.UIntPtr data, long nbytes)
        {
            long ret = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTATTR_SET_FILE, uintptr(@unsafe.Pointer(_p0)), uintptr(attrnamespace), uintptr(@unsafe.Pointer(_p1)), uintptr(data), uintptr(nbytes), 0L);
            ret = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static error ExtattrDeleteFile(@string file, long attrnamespace, @string attrname)
        {
            error err = default!;
        ...
        public static (long, error) ExtattrListFile(@string file, long attrnamespace, System.UIntPtr data, long nbytes)
        {
            long ret = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTATTR_LIST_FILE, uintptr(@unsafe.Pointer(_p0)), uintptr(attrnamespace), uintptr(data), uintptr(nbytes), 0L, 0L);
            ret = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static (long, error) ExtattrGetLink(@string link, long attrnamespace, @string attrname, System.UIntPtr data, long nbytes)
        {
            long ret = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTATTR_GET_LINK, uintptr(@unsafe.Pointer(_p0)), uintptr(attrnamespace), uintptr(@unsafe.Pointer(_p1)), uintptr(data), uintptr(nbytes), 0L);
            ret = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static (long, error) ExtattrSetLink(@string link, long attrnamespace, @string attrname, System.UIntPtr data, long nbytes)
        {
            long ret = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTATTR_SET_LINK, uintptr(@unsafe.Pointer(_p0)), uintptr(attrnamespace), uintptr(@unsafe.Pointer(_p1)), uintptr(data), uintptr(nbytes), 0L);
            ret = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static error ExtattrDeleteLink(@string link, long attrnamespace, @string attrname)
        {
            error err = default!;
        ...
        public static (long, error) ExtattrListLink(@string link, long attrnamespace, System.UIntPtr data, long nbytes)
        {
            long ret = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_EXTATTR_LIST_LINK, uintptr(@unsafe.Pointer(_p0)), uintptr(attrnamespace), uintptr(data), uintptr(nbytes), 0L, 0L);
            ret = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static error Fadvise(long fd, long offset, long length, long advice)
        {
            ...
            var (_, _, e1) = Syscall9(SYS_POSIX_FADVISE, uintptr(fd), 0L, uintptr(offset), uintptr(offset >> (int)(32L)), uintptr(length), uintptr(length >> (int)(32L)), uintptr(advice), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error fstat_freebsd12(long fd, ptr<Stat_t> _addr_stat)
        {
            ...
            var (_, _, e1) = Syscall(SYS_FSTAT_FREEBSD12, uintptr(fd), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error fstatat_freebsd12(long fd, @string path, ptr<Stat_t> _addr_stat, long flags)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_FSTATAT_FREEBSD12, uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), uintptr(flags), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error fstatfs_freebsd12(long fd, ptr<Statfs_t> _addr_stat)
        {
            ...
            var (_, _, e1) = Syscall(SYS_FSTATFS_FREEBSD12, uintptr(fd), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static (long, error) getdirentries_freebsd12(long fd, slice<byte> buf, ptr<ulong> _addr_basep)
        {
            ...
            var (r0, _, e1) = Syscall6(SYS_GETDIRENTRIES_FREEBSD12, uintptr(fd), uintptr(_p0), uintptr(len(buf)), uintptr(@unsafe.Pointer(basep)), 0L, 0L);
            n = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        private static error mknodat(long fd, @string path, uint mode, long dev)
        {
            error err = default!;
            ...
            var (_, _, e1) = Syscall6(SYS_MKNODAT, uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(mode), uintptr(dev), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error mknodat_freebsd12(long fd, @string path, uint mode, ulong dev)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_MKNODAT_FREEBSD12, uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(mode), uintptr(dev), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static (long, error) Openat(long fdat, @string path, long mode, uint perm)
        {
            long fd = default;
            error err = default!;
            ...
            var (r0, _, e1) = Syscall6(SYS_OPENAT, uintptr(fdat), uintptr(@unsafe.Pointer(_p0)), uintptr(mode), uintptr(perm), 0L, 0L);
            fd = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        private static error statfs_freebsd12(@string path, ptr<Statfs_t> _addr_stat)
        {
            ...
            var (_, _, e1) = Syscall(SYS_STATFS_FREEBSD12, uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(stat)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
