...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct RtMsghdr
        {
            ...
            public RtMsghdr(ushort Msglen = default, byte Version = default, byte Type = default, ushort Index = default, int Flags = default, int Addrs = default, int Pid = default, int Seq = default, int Errno = default, int Use = default, ulong Inits = default, RtMetrics Rmx = default)
            {
                this.Msglen = Msglen;
