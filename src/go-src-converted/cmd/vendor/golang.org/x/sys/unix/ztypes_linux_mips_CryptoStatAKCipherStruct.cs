...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct CryptoStatAKCipher
        {
            ...
            public CryptoStatAKCipher(array<sbyte> Type = default, ulong Encrypt_cnt = default, ulong Encrypt_tlen = default, ulong Decrypt_cnt = default, ulong Decrypt_tlen = default, ulong Verify_cnt = default, ulong Sign_cnt = default, ulong Err_cnt = default)
            {
                this.Type = Type;
