...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct CryptoStatKPP
        {
            ...
            public CryptoStatKPP(array<byte> Type = default, ulong Setsecret_cnt = default, ulong Generate_public_key_cnt = default, ulong Compute_shared_secret_cnt = default, ulong Err_cnt = default)
            {
                this.Type = Type;
