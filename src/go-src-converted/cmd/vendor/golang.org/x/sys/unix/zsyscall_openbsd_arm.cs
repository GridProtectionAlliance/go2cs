...
// package unix -- go2cs converted at 2020 October 08 04:53:08 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_openbsd_arm.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public static (long, error) Getrtable()
        {
            long rtable = default;
            error err = default!;

            var (r0, _, e1) = RawSyscall(SYS_GETRTABLE, 0L, 0L, 0L);
            rtable = int(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
        ...
        public static error Setrtable(long rtable)
        {
            error err = default!;

            var (_, _, e1) = RawSyscall(SYS_SETRTABLE, uintptr(rtable), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
