...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public static error Fadvise(long fd, long offset, long length, long advice)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_POSIX_FADVISE, uintptr(fd), uintptr(offset), uintptr(offset >> (int)(32L)), uintptr(length), uintptr(length >> (int)(32L)), uintptr(advice));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static error Ftruncate(long fd, long length)
        {
            ...
            var (_, _, e1) = Syscall(SYS_FTRUNCATE, uintptr(fd), uintptr(length), uintptr(length >> (int)(32L)));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static error mknodat_freebsd12(long fd, @string path, uint mode, ulong dev)
        {
            ...
            var (_, _, e1) = Syscall6(SYS_MKNODAT_FREEBSD12, uintptr(fd), uintptr(@unsafe.Pointer(_p0)), uintptr(mode), uintptr(dev), uintptr(dev >> (int)(32L)), 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        public static (long, error) Seek(long fd, long offset, long whence)
        {
            ...
            var (r0, r1, e1) = Syscall6(SYS_LSEEK, uintptr(fd), uintptr(offset), uintptr(offset >> (int)(32L)), uintptr(whence), 0L, 0L);
        ...
        public static error Truncate(@string path, long length)
        {
            ...
            var (_, _, e1) = Syscall(SYS_TRUNCATE, uintptr(@unsafe.Pointer(_p0)), uintptr(length), uintptr(length >> (int)(32L)));
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
        ...
        private static (System.UIntPtr, error) mmap(System.UIntPtr addr, System.UIntPtr length, long prot, long flag, long fd, long pos)
        {
            ...
            var (r0, _, e1) = Syscall9(SYS_MMAP, uintptr(addr), uintptr(length), uintptr(prot), uintptr(flag), uintptr(fd), uintptr(pos), uintptr(pos >> (int)(32L)), 0L, 0L);
            ret = uintptr(r0);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
