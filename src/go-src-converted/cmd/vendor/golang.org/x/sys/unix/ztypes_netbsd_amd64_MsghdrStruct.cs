...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Msghdr
        {
            ...
            public Msghdr(ref ptr<byte> Name = default, uint Namelen = default, array<byte> Pad_cgo_0 = default, ref ptr<Iovec> Iov = default, int Iovlen = default, array<byte> Pad_cgo_1 = default, ref ptr<byte> Control = default, uint Controllen = default, int Flags = default)
            {
                this.Name = Name;
        ...
        {
            return new Msghdr(ref value.Name, value.Namelen, value.Pad_cgo_0, ref value.Iov, value.Iovlen, value.Pad_cgo_1, ref value.Control, value.Controllen, value.Flags);
        }
    }
}}}}}}