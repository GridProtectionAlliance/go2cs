...
namespace sys
{
    public static partial class unix_package
    {
        ...
        public partial struct Stat_t
        {
            ...
            public Stat_t(uint Mode = default, int Dev = default, ulong Ino = default, uint Nlink = default, uint Uid = default, uint Gid = default, int Rdev = default, Timespec Atim = default, Timespec Mtim = default, Timespec Ctim = default, long Size = default, long Blocks = default, uint Blksize = default, uint Flags = default, uint Gen = default, Timespec X__st_birthtim = default)
            {
                this.Mode = Mode;
                this.Dev = Dev;
                this.Ino = Ino;
