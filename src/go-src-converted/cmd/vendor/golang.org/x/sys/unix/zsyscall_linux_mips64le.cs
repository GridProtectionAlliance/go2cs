...
// package unix -- go2cs converted at 2020 October 09 05:59:22 UTC
// import "cmd/vendor/golang.org/x/sys/unix" ==> using unix = go.cmd.vendor.golang.org.x.sys.unix_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\sys\unix\zsyscall_linux_mips64le.go
...
namespace sys
{
    public static partial class unix_package
    {
        ...
        private static error fstatat(long dirfd, @string path, ptr<stat_t> _addr_st, long flags)
        {
            error err = default!;
            ref stat_t st = ref _addr_st.val;
            ...
            var (_, _, e1) = Syscall6(SYS_NEWFSTATAT, uintptr(dirfd), uintptr(@unsafe.Pointer(_p0)), uintptr(@unsafe.Pointer(st)), uintptr(flags), 0L, 0L);
            if (e1 != 0L)
            {
                err = errnoErr(e1);
            }
