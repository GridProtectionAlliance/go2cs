...
//
//     Generated on 2020 October 08 04:58:35 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace go
{
    public static class xerrors_WrapperExtensions
    {
        ...
        public static T _<T>(this go.cmd.vendor.golang.org.x.xerrors_package.Wrapper target)
        {
            try
            {
                return ((go.cmd.vendor.golang.org.x.xerrors_package.Wrapper<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.cmd.vendor.golang.org.x.xerrors_package.Wrapper target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.cmd.vendor.golang.org.x.xerrors_package.Wrapper target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.cmd.vendor.golang.org.x.xerrors_package.Wrapper<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.cmd.vendor.golang.org.x.xerrors_package.Wrapper target, Type type, out object? result)
        {
            try
            {
