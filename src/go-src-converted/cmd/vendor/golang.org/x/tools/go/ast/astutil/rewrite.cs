...
private static nint Index(this ptr<Cursor> _addr_c) {
    ref Cursor c = ref _addr_c.val;
...
private static void Replace(this ptr<Cursor> _addr_c, ast.Node n) => func((_, panic, _) => {
    ref Cursor c = ref _addr_c.val;
...
private static void Delete(this ptr<Cursor> _addr_c) => func((_, panic, _) => {
    ref Cursor c = ref _addr_c.val;
...
private static void InsertAfter(this ptr<Cursor> _addr_c, ast.Node n) => func((_, panic, _) => {
    ref Cursor c = ref _addr_c.val;
...
private static void InsertBefore(this ptr<Cursor> _addr_c, ast.Node n) => func((_, panic, _) => {
    ref Cursor c = ref _addr_c.val;
...
private static void apply(this ptr<application> _addr_a, ast.Node parent, @string name, ptr<iterator> _addr_iter, ast.Node n) => func((_, panic, _) => {
