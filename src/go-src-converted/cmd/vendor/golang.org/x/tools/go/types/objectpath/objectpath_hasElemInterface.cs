...
namespace go
{
    public static class objectpath_hasElemExtensions
    {
        ...
        public static T _<T>(this go.cmd.vendor.golang.org.x.tools.go.types.objectpath_package.hasElem target)
        {
            try
            {
                return ((go.cmd.vendor.golang.org.x.tools.go.types.objectpath_package.hasElem<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.cmd.vendor.golang.org.x.tools.go.types.objectpath_package.hasElem target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.cmd.vendor.golang.org.x.tools.go.types.objectpath_package.hasElem target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.cmd.vendor.golang.org.x.tools.go.types.objectpath_package.hasElem<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.cmd.vendor.golang.org.x.tools.go.types.objectpath_package.hasElem target, Type type, out object? result)
        {
            try
            {
