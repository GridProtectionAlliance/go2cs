...
namespace go
{
    public static partial class analysis_package
    {
        ...
        {
            return new Pass(ref value.Analyzer, ref value.Fset, value.Files, value.OtherFiles, ref value.Pkg, ref value.TypesInfo, value.TypesSizes, value.Report, value.ImportObjectFact, value.ImportPackageFact, value.ExportObjectFact, value.ExportPackageFact, value.AllPackageFacts, value.AllObjectFacts, value.typeErrors);
        }
    }
}}}}}}}