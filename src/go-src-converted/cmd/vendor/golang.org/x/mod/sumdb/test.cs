...
// package sumdb -- go2cs converted at 2020 October 08 04:45:59 UTC
// import "cmd/vendor/golang.org/x/mod/sumdb" ==> using sumdb = go.cmd.vendor.golang.org.x.mod.sumdb_package
// Original source: C:\Go\src\cmd\vendor\golang.org\x\mod\sumdb\test.go
...
namespace mod
{
    public static partial class sumdb_package
    {
        ...
        private static (slice<byte>, error) Signed(this ptr<TestServer> _addr_s, context.Context ctx) => func((defer, _, __) =>
        {
        ...
        private static (slice<slice<byte>>, error) ReadRecords(this ptr<TestServer> _addr_s, context.Context ctx, long id, long n) => func((defer, _, __) =>
        {
        ...
        private static (slice<byte>, error) ReadTileData(this ptr<TestServer> _addr_s, context.Context ctx, tlog.Tile t) => func((defer, _, __) =>
        {
            slice<byte> _p0 = default;
            error _p0 = default!;
            ref TestServer s = ref _addr_s.val;
