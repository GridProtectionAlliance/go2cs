...
namespace go
{
    public static class sumdb_ClientOpsExtensions
    {
        ...
        public static T _<T>(this go.cmd.vendor.golang.org.x.mod.sumdb_package.ClientOps target)
        {
            try
            {
                return ((go.cmd.vendor.golang.org.x.mod.sumdb_package.ClientOps<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.2.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.cmd.vendor.golang.org.x.mod.sumdb_package.ClientOps target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.2.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.cmd.vendor.golang.org.x.mod.sumdb_package.ClientOps target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.cmd.vendor.golang.org.x.mod.sumdb_package.ClientOps<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.2.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.cmd.vendor.golang.org.x.mod.sumdb_package.ClientOps target, Type type, out object? result)
        {
            try
            {
