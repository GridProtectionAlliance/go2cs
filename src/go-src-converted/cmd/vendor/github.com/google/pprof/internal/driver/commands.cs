...
;
        ...
        private partial struct variables // : map<@string, ptr<variable>>
        {
        }
        ...
        private static bool boolValue(this ptr<variable> _addr_v) => func((_, panic, __) =>
        {
            ref variable v = ref _addr_v.val;
        ...
        private static long intValue(this ptr<variable> _addr_v) => func((_, panic, __) =>
        {
            ref variable v = ref _addr_v.val;
        ...
        private static double floatValue(this ptr<variable> _addr_v) => func((_, panic, __) =>
        {
            ref variable v = ref _addr_v.val;
        ...
        private static @string stringValue(this ptr<variable> _addr_v)
        {
            ref variable v = ref _addr_v.val;
        ...
        private static variables makeCopy(this variables vars)
        {
            ...
            {
                ref var vcopy = ref heap(v.val, out ptr<var> _addr_vcopy);
                _addr_varscopy[n] = _addr_vcopy;
                varscopy[n] = ref _addr_varscopy[n].val;
