...
// package profile -- go2cs converted at 2020 August 29 10:06:34 UTC
...
namespace pprof
{
    public static partial class profile_package
    {
        ...
        { 
            ...
            encodeVarint(b, uint64(tag) << (int)(3L));
            encodeVarint(b, x);
        }
        ...
        private static (slice<byte>, error) decodeField(ref buffer b, slice<byte> data)
        {
            ...
            switch (b.typ)
            {
                ...
                case 5L: 
                    ...
                    break;
                default: 
                    return (null, errors.New("unknown wire type: " + string(b.typ)));
                    break;
            }
