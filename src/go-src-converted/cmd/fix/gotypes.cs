...
// package main -- go2cs converted at 2020 August 29 10:00:16 UTC
...
namespace go
{
    public static partial class main_package
    {
        ...
        private static bool gotypes(ref ast.File f)
        {
            var truth = fixGoTypes(f);
            if (fixGoExact(f))
            {
                truth = true;
            }
        ...
        { 
            ...
            walk(f, n =>
            {
                ...
                ref ast.ImportSpec (spec, ok) = n._<ref ast.ImportSpec>();
                if (!ok)
                {
                    return;
                }
