...
namespace @internal
{
    public static partial class dwarf_package
    {
        ...
        public partial struct InlCall
        {
            ...
            public InlCall(long InlIndex = default, Sym CallFile = default, uint CallLine = default, Sym AbsFunSym = default, slice<long> Children = default, slice<ref Var> InlVars = default, slice<Range> Ranges = default, bool Root = default)
            {
