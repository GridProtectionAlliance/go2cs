...
namespace @internal
{
    ...
    {
        private static readonly long progMaxLiteral = (long)127L; // maximum n for literal n bit code
 ...
 // maximum n for literal n bit code
        ...
        private static void End(this ptr<Writer> _addr_w) => func((_, panic, __) =>
        {
            ref Writer w = ref _addr_w.val;
        ...
        private static void Ptr(this ptr<Writer> _addr_w, long index) => func((_, panic, __) =>
        {
            ref Writer w = ref _addr_w.val;
        ...
        private static void ZeroUntil(this ptr<Writer> _addr_w, long index) => func((_, panic, __) =>
        {
            ref Writer w = ref _addr_w.val;
        ...
        private static void Append(this ptr<Writer> _addr_w, slice<byte> prog, long n) => func((_, panic, __) =>
        {
            ref Writer w = ref _addr_w.val;
        ...
        private static void varint(this ptr<Writer> _addr_w, long x) => func((_, panic, __) =>
        {
            ref Writer w = ref _addr_w.val;
