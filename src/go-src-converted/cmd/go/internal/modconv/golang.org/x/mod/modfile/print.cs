...
// package modfile -- go2cs converted at 2020 October 09 05:46:40 UTC
...
namespace mod
{
    public static partial class modfile_package
    {
        ...
        private partial struct printer
        {
            ...
            public long margin; // left margin (indent), a number of tabs
        }
        ...
        private static long indent(this ptr<printer> _addr_p)
        {
            ref printer p = ref _addr_p.val;

            var b = p.Bytes();
            long n = 0L;
            while (n < len(b) && b[len(b) - 1L - n] != '\n')
            {
                n++;
            }
        ...
        private static void expr(this ptr<printer> _addr_p, Expr x) => func((_, panic, __) =>
        {
            ref printer p = ref _addr_p.val;
