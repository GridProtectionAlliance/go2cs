...
namespace modfetch
{
    public static partial class codehost_package
    {
        ...
        public static readonly long MaxGoMod = (long)16L << (int)(20L); // maximum size of go.mod file
        public static readonly long MaxLICENSE = (long)16L << (int)(20L); // maximum size of LICENSE file
        public static readonly long MaxZipFile = (long)500L << (int)(20L); // maximum size of downloaded zip file
...
// An empty major string matches any major version.
            (bool, error) RecentTag(@string rev, @string prefix, @string major); // DescendsFrom reports whether rev or any of its ancestors has the given tag.
//
...
// same revision.
        ...
        public static (@string, @string, error) WorkDir(@string typ, @string name) => func((defer, _, __) =>
        {
            @string dir = default;
...

            {
                ...
                var err = os.MkdirAll(filepath.Dir(dir), 0777L);
            ...
            var (data, err) = ioutil.ReadFile(dir + ".info");
...

            {
                ...
                err = ioutil.WriteFile(dir + ".info", (slice<byte>)key, 0666L);
        ...
        public static (slice<byte>, error) RunWithStdin(@string dir, io.Reader stdin, params object[] cmdline) => func((defer, _, __) =>
        {
            slice<byte> _p0 = default;
            error _p0 = default!;
            cmdline = cmdline.Clone();
            ...
            var c = exec.Command(cmd[0L], cmd[1L..]);
            c.Dir = dir;
            c.Stdin = stdin;
