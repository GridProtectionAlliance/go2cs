...
// package storage -- go2cs converted at 2022 March 06 23:19:10 UTC
...
private static error ReadOnly(this ptr<Mem> _addr_m, context.Context ctx, Func<context.Context, Transaction, error> f) => func((defer, _, _) => {
...
private static error ReadWrite(this ptr<Mem> _addr_m, context.Context ctx, Func<context.Context, Transaction, error> f) => func((defer, _, _) => {
    ref Mem m = ref _addr_m.val;
...
private static error BufferWrites(this ptr<memTx> _addr_tx, slice<Write> list) => func((_, panic, _) => {
    ref memTx tx = ref _addr_tx.val;
