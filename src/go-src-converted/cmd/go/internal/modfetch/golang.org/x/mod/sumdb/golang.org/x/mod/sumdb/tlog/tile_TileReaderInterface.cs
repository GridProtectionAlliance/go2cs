...
namespace go
{
    public static class tlog_TileReaderExtensions
    {
        ...
        public static T _<T>(this go.golang.org.x.mod.sumdb.tlog_package.TileReader target)
        {
            try
            {
                return ((go.golang.org.x.mod.sumdb.tlog_package.TileReader<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.golang.org.x.mod.sumdb.tlog_package.TileReader target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.golang.org.x.mod.sumdb.tlog_package.TileReader target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.golang.org.x.mod.sumdb.tlog_package.TileReader<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.golang.org.x.mod.sumdb.tlog_package.TileReader target, Type type, out object? result)
        {
            try
            {
