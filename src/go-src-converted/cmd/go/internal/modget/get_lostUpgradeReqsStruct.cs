...
namespace @internal
{
    public static partial class modget_package
    {
        ...
        private partial struct lostUpgradeReqs
        {
            ...
            static lostUpgradeReqs()
            {
                Type targetType = typeof(lostUpgradeReqs);
            ...
            // Constructors
            public lostUpgradeReqs(NilType _)
            {
                this.Reqs = default;
                this.lost = default;
            }
            ...
            // Enable comparisons between nil and lostUpgradeReqs struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(lostUpgradeReqs value, NilType nil) => value.Equals(default(lostUpgradeReqs));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(lostUpgradeReqs value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, lostUpgradeReqs value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, lostUpgradeReqs value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator lostUpgradeReqs(NilType nil) => default(lostUpgradeReqs);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static lostUpgradeReqs lostUpgradeReqs_cast(dynamic value)
        {
            return new lostUpgradeReqs(value.Reqs, value.lost);
        }
    }
}}}}