...
namespace @internal
{
    public static partial class load_package
    {
        ...
        public partial struct TargetDir
        {
            ...
            public TargetDir(long value) => m_value = value;

            // Enable implicit conversions between long and TargetDir struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TargetDir(long value) => new TargetDir(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(TargetDir value) => value.m_value;
