...
// package web -- go2cs converted at 2022 March 06 23:17:20 UTC
// import "cmd/go/internal/web" ==> using web = go.cmd.go.@internal.web_package
// Original source: C:\Program Files\Go\src\cmd\go\internal\web\url_windows.go
...
private static (@string, error) convertFileURLPath(@string host, @string path) {
    ...
    {
        var vol = filepath.VolumeName(path[(int)1..]);
    ...
    return (path[(int)1..], error.As(null!)!);
