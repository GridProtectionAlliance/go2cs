...
// package modload -- go2cs converted at 2020 October 08 04:35:16 UTC
// import "cmd/go/internal/modload" ==> using modload = go.cmd.go.@internal.modload_package
// Original source: C:\Go\src\cmd\go\internal\modload\help.go
...
namespace @internal
{
    public static partial class modload_package
    {
        ...
        public static ptr<base.Command> HelpModules = addr(new base.Command(UsageLine:"modules",Short:"modules, module versions, and more",Long:`
...
locations other than the main module's root directory.
	`,));
        ...
        public static ptr<base.Command> HelpGoMod = addr(new base.Command(UsageLine:"go.mod",Short:"the go.mod file",Long:`
