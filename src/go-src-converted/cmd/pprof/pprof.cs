...
namespace go
{
    public static partial class main_package
    {
        ...
        private static (ptr<profile.Profile>, error) getProfile(@string source, time.Duration timeout) => func((defer, _, __) =>
        {
            ptr<profile.Profile> _p0 = default!;
            error _p0 = default!;
        ...
        private static readonly @string cpuProfileHandler = (@string)"/debug/pprof/profile";
        ...
        private static (slice<driver.Inst>, error) Disasm(this ptr<objTool> _addr_t, @string file, ulong start, ulong end)
        {
        ...
        private static (ptr<objfile.Disasm>, error) cachedDisasm(this ptr<objTool> _addr_t, @string file) => func((defer, _, __) =>
        {
