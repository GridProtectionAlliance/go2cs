...
// package main -- go2cs converted at 2020 October 08 04:33:02 UTC
...
namespace go
{
    public static partial class main_package
    {
        ...
        private static void dirsInit(params Dir[] extra)
        {
            ...
            dirs.hist = make_slice<Dir>(0L, 1000L);
            ...
            while (len(next) > 0L)
            {
                ...
                foreach (var (_, dir) in this)
                {
                    ...
                    foreach (var (_, entry) in entries)
                    {
                        ...
                        if (name[0L] == '.' || name[0L] == '_' || name == "testdata")
                        {
                            continue;
                        } 
                    ...
                    { 
                        ...
                        if (len(dir) > len(root.dir))
                        {
                            ...
                            importPath += filepath.ToSlash(dir[len(root.dir) + 1L..]);
    ...
    "}}{{.}}{{end}}{{end}}\n";
            ...
            return (_addr_mod!, lines[3L] == "go1.14", error.As(null!)!);
