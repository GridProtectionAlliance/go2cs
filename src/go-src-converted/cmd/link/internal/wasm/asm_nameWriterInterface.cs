...
//
//     Generated on 2020 October 08 04:37:38 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace go
{
    public static class wasm_nameWriterExtensions
    {
        ...
        public static T _<T>(this go.cmd.link.@internal.wasm_package.nameWriter target)
        {
            try
            {
                return ((go.cmd.link.@internal.wasm_package.nameWriter<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.cmd.link.@internal.wasm_package.nameWriter target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.cmd.link.@internal.wasm_package.nameWriter target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.cmd.link.@internal.wasm_package.nameWriter<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.cmd.link.@internal.wasm_package.nameWriter target, Type type, out object? result)
        {
            try
            {
