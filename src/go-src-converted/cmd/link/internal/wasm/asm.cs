...
// package wasm -- go2cs converted at 2020 October 09 05:48:38 UTC
// import "cmd/link/internal/wasm" ==> using wasm = go.cmd.link.@internal.wasm_package
// Original source: C:\Go\src\cmd\link\internal\wasm\asm.go
...
namespace @internal
{
 ...
 // TODO(neelance): make function addresses play nice with heap addresses
        ...
        private static (ptr<sym.Section>, long, ulong) assignAddress(ptr<loader.Loader> _addr_ldr, ptr<sym.Section> _addr_sect, long n, loader.Sym s, ulong va, bool isTramp)
        {
            ...
            ldr.SetSymValue(s, int64(funcValueOffset + va / ld.MINFUNC) << (int)(16L)); // va starts at zero
