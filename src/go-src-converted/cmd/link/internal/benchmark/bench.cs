...
namespace @internal
{
    ...
    {
        public partial struct Flags // : long
        {
        }

        public static readonly long GC = (long)1L << (int)(iota);
        public static readonly Flags NoGC = (Flags)0L;
        ...
        private static void Start(this ptr<Metrics> _addr_m, @string name) => func((_, panic, __) =>
        {
            ref Metrics m = ref _addr_m.val;
        ...
        private static void closeMark(this ptr<Metrics> _addr_m) => func((_, panic, __) =>
        {
            ref Metrics m = ref _addr_m.val;
        ...
        private static bool shouldPProf(this ptr<Metrics> _addr_m)
        {
            ...
            return m != null && len(m.filebase) > 0L;
        }
