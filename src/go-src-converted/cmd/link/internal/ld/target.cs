...
// package ld -- go2cs converted at 2020 October 09 05:50:29 UTC
// import "cmd/link/internal/ld" ==> using ld = go.cmd.link.@internal.ld_package
// Original source: C:\Go\src\cmd\link\internal\ld\target.go
...
namespace @internal
{
    public static partial class ld_package
    {
        ...
        private static void mustSetHeadType(this ptr<Target> _addr_t) => func((_, panic, __) =>
        {
            ref Target t = ref _addr_t.val;
