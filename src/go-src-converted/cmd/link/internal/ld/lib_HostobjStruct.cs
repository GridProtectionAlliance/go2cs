...
namespace @internal
{
    public static partial class ld_package
    {
        ...
        public partial struct Hostobj
        {
            ...
            public Hostobj(Action<ref Link, ref bio.Reader, @string, long, @string> ld = default, @string pkg = default, @string pn = default, @string file = default, long off = default, long length = default)
            {
                this.ld = ld;
                this.pkg = pkg;
                this.pn = pn;
