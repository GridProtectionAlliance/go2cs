...
namespace @internal
{
    public static partial class loader_package
    {
        ...
        public partial struct Aux
        {
            ...
            public Aux(ref ptr<goobj.Aux> Aux> = default, ref ptr<oReader> r = default, ref ptr<Loader> l = default)
            {
                this.Aux> = Aux>;
                this.r = r;
                this.l = l;
        ...
        [GeneratedCode("go2cs", "0.1.0.0")]
        public static Aux Aux_cast(dynamic value)
        {
            return new Aux(ref value.Aux>, ref value.r, ref value.l);
        }
    }
}}}}