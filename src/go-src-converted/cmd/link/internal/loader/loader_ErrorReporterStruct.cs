...
namespace @internal
{
    public static partial class loader_package
    {
        ...
        public partial struct ErrorReporter
        {
            ...
            {
                this.ldr = default;
                this.AfterErrorAction = default;
            }

            public ErrorReporter(ref ptr<Loader> ldr = default, Action AfterErrorAction = default)
            {
                this.ldr = ldr;
                this.AfterErrorAction = AfterErrorAction;
            }
        ...
        {
            return new ErrorReporter(ref value.ldr, value.AfterErrorAction);
        }
    }
}}}}