...
namespace @internal
{
    public static partial class sym_package
    {
        ...
        public partial struct InlinedCall
        {
            ...
            public InlinedCall(int Parent = default, ref ptr<Symbol> File = default, int Line = default, ref ptr<Symbol> Func = default)
            {
                this.Parent = Parent;
                this.File = File;
                this.Line = Line;
        ...
        {
            return new InlinedCall(value.Parent, ref value.File, value.Line, ref value.Func);
        }
    }
}}}}