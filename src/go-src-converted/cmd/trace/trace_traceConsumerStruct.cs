...
namespace go
{
    public static partial class main_package
    {
        ...
        private partial struct traceConsumer
        {
            ...
            public traceConsumer(Action<@string> consumeTimeUnit = default, Action<ptr<traceviewer.Event>, bool> consumeViewerEvent = default, Action<@string, traceviewer.Frame> consumeViewerFrame = default, Action flush = default)
            {
