...
namespace go
{
    public static partial class main_package
    {
        ...
        private partial struct d
        {
            ...
            public d(long value) => m_value = value;

            // Enable implicit conversions between long and d struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator d(long value) => new d(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(d value) => value.m_value;
