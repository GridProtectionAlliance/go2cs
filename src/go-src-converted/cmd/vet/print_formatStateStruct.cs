...
//
//     Generated on 2020 August 29 10:09:27 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace go
{
    public static partial class main_package
    {
        ...
        private partial struct formatState
        {
            ...
            public formatState(int verb = default, @string format = default, @string name = default, slice<byte> flags = default, slice<long> argNums = default, long firstArg = default, ref ptr<File> file = default, ref ptr<ast.CallExpr> call = default, long argNum = default, bool hasIndex = default, bool indexPending = default, long nbytes = default)
            {
                this.verb = verb;
                this.format = format;
                this.name = name;
        ...
        {
            return new formatState(value.verb, value.format, value.name, value.flags, value.argNums, value.firstArg, ref value.file, ref value.call, value.argNum, value.hasIndex, value.indexPending, value.nbytes);
        }
    }
}