...
namespace testdata
{
    public static partial class print_package
    {
        ...
        private partial struct recursivePtrStringer
        {
            ...
            public recursivePtrStringer(nint value) => m_value = value;

            // Enable implicit conversions between nint and recursivePtrStringer struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator recursivePtrStringer(nint value) => new recursivePtrStringer(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator nint(recursivePtrStringer value) => value.m_value;
