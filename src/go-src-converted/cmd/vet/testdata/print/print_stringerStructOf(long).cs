...
namespace testdata
{
    public static partial class print_package
    {
        ...
        private partial struct stringer
        {
            ...
            public stringer(long value) => m_value = value;

            // Enable implicit conversions between long and stringer struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator stringer(long value) => new stringer(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(stringer value) => value.m_value;
