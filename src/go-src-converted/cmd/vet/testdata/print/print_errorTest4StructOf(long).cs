...
namespace testdata
{
    public static partial class print_package
    {
        ...
        private partial struct errorTest4
        {
            ...
            public errorTest4(long value) => m_value = value;

            // Enable implicit conversions between long and errorTest4 struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator errorTest4(long value) => new errorTest4(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(errorTest4 value) => value.m_value;
