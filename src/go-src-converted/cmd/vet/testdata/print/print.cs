...
private partial struct errorTest1 { // : nint
}
...
private partial struct errorTest2 { // : nint
} // Analogous to testing's *T type.
private static void Error(this errorTest2 _p0, params object _p0) {
}

private partial struct errorTest3 { // : nint
}

private static void Error(this errorTest3 _p0) { // No return value.
}

private partial struct errorTest4 { // : nint
}
...
private static void error(this errorTest5 _p0) { // niladic; don't complain if no args (was bug)
}
...
public static void Errorf(nint i, @string format, params object[] args) {
    args = args.Clone();
...
private static slice<object> multi() => func((_, panic, _) => {
    panic("don't call - testing only");
});

private partial struct stringer { // : nint
}
...
private static @string Warn2(this ptr<ptrStringer> _addr_p, nint x, params object[] args) {
    args = args.Clone();
...
private static @string Warnf2(this ptr<ptrStringer> _addr_p, nint x, @string format, params object[] args) {
    args = args.Clone();
    ref ptrStringer p = ref _addr_p.val;
...
private static @string Warn(this ptr<ptrStringer> _addr__p0, nint x, params object[] args) {
    args = args.Clone();
    ref ptrStringer _p0 = ref _addr__p0.val;
...
private static @string Warnf(this ptr<ptrStringer> _addr__p0, nint x, @string format, params object[] args) {
    args = args.Clone();
    ref ptrStringer _p0 = ref _addr__p0.val;
...
private static @string Wrap2(this ptr<ptrStringer> _addr_p, nint x, params object[] args) {
    args = args.Clone();
    ref ptrStringer p = ref _addr_p.val;
...
private static @string Wrapf2(this ptr<ptrStringer> _addr_p, nint x, @string format, params object[] args) {
    args = args.Clone();
    ref ptrStringer p = ref _addr_p.val;
...
private static @string Wrap(this ptr<ptrStringer> _addr__p0, nint x, params object[] args) {
    args = args.Clone();
    ref ptrStringer _p0 = ref _addr__p0.val;
...
private static @string Wrapf(this ptr<ptrStringer> _addr__p0, nint x, @string format, params object[] args) {
    args = args.Clone();
    ref ptrStringer _p0 = ref _addr__p0.val;
...
private static @string BadWrap(this ptr<ptrStringer> _addr__p0, nint x, params object[] args) {
    args = args.Clone();
    ref ptrStringer _p0 = ref _addr__p0.val;
...
private static @string BadWrapf(this ptr<ptrStringer> _addr__p0, nint x, @string format, params object[] args) {
    args = args.Clone();
    ref ptrStringer _p0 = ref _addr__p0.val;
...
private static @string WrapfFalsePositive(this ptr<ptrStringer> _addr__p0, nint x, @string arg1, params object[] arg2) {
    arg2 = arg2.Clone();
    ref ptrStringer _p0 = ref _addr__p0.val;
...
private partial struct recursiveStringer { // : nint
}
...
private partial struct recursivePtrStringer { // : nint
}
...
public partial struct RecursiveMap { // : map<nint, RecursiveMap>
}
...
public static void UnexportedStringerOrError() {
    ...
    nint intSlice = new slice<nint>(new nint[] { 3, 4 });
...
public static void PointersToCompoundTypes() {
    ...
    ref nint intSlice = ref heap(new slice<nint>(new nint[] { 3, 4 }), out ptr<nint> _addr_intSlice);
    ...
    ref array<nint> intArray = ref heap(new array<nint>(new nint[] { 3, 4 }), out ptr<array<nint>> _addr_intArray);
    ...
    ref map intMap = ref heap(/* TODO: Fix this in ScannerBase_Expression::ExitCompositeLit */ new map<nint, nint>{3:4}, out ptr<map> _addr_intMap);
