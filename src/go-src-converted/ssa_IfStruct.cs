...
namespace go
{
    public static partial class ssa_package
    {
        ...
        public partial struct If
        {
            ...
            // Enable comparisons between nil and If struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(If value, NilType nil) => value.Equals(default(If));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(If value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, If value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, If value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator If(NilType nil) => default(If);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        public static If If_cast(dynamic value)
        {
            return new If(value.anInstruction, value.Cond);
        }
    }
}}}}}