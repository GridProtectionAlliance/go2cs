...
namespace go
{
    public static partial class io_package
    {
        ...
        private partial struct pipe
        {
            ...
            public pipe(sync.Mutex wrMu = default, channel<slice<byte>> wrCh = default, channel<nint> rdCh = default, sync.Once once = default, channel<object> done = default, onceError rerr = default, onceError werr = default)
            {
                this.wrMu = wrMu;
                this.wrCh = wrCh;
                this.rdCh = rdCh;
