...
namespace go
{
    public static partial class io_package
    {
        ...
        public partial interface ReadWriteCloser
        {
            ...
            public static ReadWriteCloser As<T>(in T target) => (ReadWriteCloser<T>)target!;

            [MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
            public static ReadWriteCloser As<T>(ptr<T> target_ptr) => (ReadWriteCloser<T>)target_ptr;

            [MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
            public static ReadWriteCloser? As(object target) =>
                typeof(ReadWriteCloser<>).CreateInterfaceHandler<ReadWriteCloser>(target);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        public class ReadWriteCloser<T> : ReadWriteCloser
        {
            private T m_target;
            ...
            public ReadWriteCloser(in T target) => m_target = target;

            public ReadWriteCloser(ptr<T> target_ptr)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
            public static explicit operator ReadWriteCloser<T>(in ptr<T> target_ptr) => new ReadWriteCloser<T>(target_ptr);

            [MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
            public static explicit operator ReadWriteCloser<T>(in T target) => new ReadWriteCloser<T>(target);

            // Enable comparisons between nil and ReadWriteCloser<T> interface instance
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(ReadWriteCloser<T> value, NilType nil) => Activator.CreateInstance<ReadWriteCloser<T>>().Equals(value);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(ReadWriteCloser<T> value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, ReadWriteCloser<T> value) => value == nil;
...
namespace go
{
    public static class io_ReadWriteCloserExtensions
    {
        private static readonly ConcurrentDictionary<Type, MethodInfo> s_conversionOperators = new ConcurrentDictionary<Type, MethodInfo>();

        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static T _<T>(this go.io_package.ReadWriteCloser target)
        {
            try
            {
                return ((go.io_package.ReadWriteCloser<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.io_package.ReadWriteCloser target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.io_package.ReadWriteCloser target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.io_package.ReadWriteCloser<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.io_package.ReadWriteCloser target, Type type, out object? result)
        {
            try
            {
