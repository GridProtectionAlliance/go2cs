...
// package bzip2 -- go2cs converted at 2020 August 29 10:10:41 UTC
...
namespace compress
{
    public static partial class bzip2_package
    {
        ...
        private static ulong ReadBits64(this ref bitReader br, ulong bits)
        {
            while (bits > br.bits)
            {
        ...
        private static long ReadBits(this ref bitReader br, ulong bits)
        {
            var n64 = br.ReadBits64(bits);
            return int(n64);
        }

        private static bool ReadBit(this ref bitReader br)
        {
            var n = br.ReadBits(1L);
            return n != 0L;
        }

        private static error Err(this ref bitReader br)
        {
