...
// package gzip -- go2cs converted at 2020 August 29 08:23:37 UTC
...
namespace compress
{
    public static partial class gzip_package
    {
        ...
        public static (ref Writer, error) NewWriterLevel(io.Writer w, long level)
        {
            ...
            {
                return (null, fmt.Errorf("gzip: invalid compression level: %d", level));
            }
        ...
        private static void init(this ref Writer z, io.Writer w, long level)
        {
            ...
            z.Value = new Writer(Header:Header{OS:255,},w:w,level:level,compressor:compressor,);
        }
        ...
        private static error writeBytes(this ref Writer z, slice<byte> b)
        {
            if (len(b) > 0xffffUL)
            {
        ...
        private static error writeString(this ref Writer z, @string s)
        { 
