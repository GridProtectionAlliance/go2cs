...
namespace go
{
    ...
    {
        private static readonly long kindBool = 1L + iota;
        ...
        private static readonly kindDirectIface kindUnsafePointer = 1L << (int)(5L);
        private static readonly long kindGCProg = 1L << (int)(6L);
        private static readonly long kindNoPointers = 1L << (int)(7L);
        private static readonly long kindMask = (1L << (int)(5L)) - 1L;

        // isDirectIface reports whether t is stored directly in an interface value.
        private static bool isDirectIface(ref _type t)
        {
