...
namespace go
{
    public static partial class runtime_package
    {
        ...
        {
            return new floatstate32(value.fpu_reserved, value.fpu_fcw, value.fpu_fsw, value.fpu_ftw, value.fpu_rsrv1, value.fpu_fop, value.fpu_ip, value.fpu_cs, value.fpu_rsrv2, value.fpu_dp, value.fpu_ds, value.fpu_rsrv3, value.fpu_mxcsr, value.fpu_mxcsrmask, value.fpu_stmm0, value.fpu_stmm1, value.fpu_stmm2, value.fpu_stmm3, value.fpu_stmm4, value.fpu_stmm5, value.fpu_stmm6, value.fpu_stmm7, value.fpu_xmm0, value.fpu_xmm1, value.fpu_xmm2, value.fpu_xmm3, value.fpu_xmm4, value.fpu_xmm5, value.fpu_xmm6, value.fpu_xmm7, value.fpu_rsrv4, value.fpu_reserved1);
        }
    }
}