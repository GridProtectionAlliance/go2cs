...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private static readonly ulong _REG_GS = 0x0UL;
        private static readonly ulong _REG_FS = 0x1UL;
        private static readonly ulong _REG_ES = 0x2UL;
        private static readonly ulong _REG_DS = 0x3UL;
        private static readonly ulong _REG_EDI = 0x4UL;
        private static readonly ulong _REG_ESI = 0x5UL;
        private static readonly ulong _REG_EBP = 0x6UL;
        private static readonly ulong _REG_ESP = 0x7UL;
        private static readonly ulong _REG_EBX = 0x8UL;
        private static readonly ulong _REG_EDX = 0x9UL;
        private static readonly ulong _REG_ECX = 0xaUL;
        private static readonly ulong _REG_EAX = 0xbUL;
        private static readonly ulong _REG_TRAPNO = 0xcUL;
        private static readonly ulong _REG_ERR = 0xdUL;
        private static readonly ulong _REG_EIP = 0xeUL;
        private static readonly ulong _REG_CS = 0xfUL;
        private static readonly ulong _REG_EFL = 0x10UL;
        private static readonly ulong _REG_UESP = 0x11UL;
        private static readonly ulong _REG_SS = 0x12UL;
    }
}
