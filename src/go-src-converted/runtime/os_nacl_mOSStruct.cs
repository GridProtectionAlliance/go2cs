    ...
    public static partial class runtime_package
    {
        ...
        private partial struct mOS
        {
            ...
            public mOS(NilType _)
            {
                ...
                this.waitsemalock = default;
            }

            public mOS(int waitsema = default, int waitsemacount = default, int waitsemalock = default)
            {
                this.waitsema = waitsema;
                this.waitsemacount = waitsemacount;
                this.waitsemalock = waitsemalock;
            }
        ...
        {
            return new mOS(value.waitsema, value.waitsemacount, value.waitsemalock);
        }
    }
}