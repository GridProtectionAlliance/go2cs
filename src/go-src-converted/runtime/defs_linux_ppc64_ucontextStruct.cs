...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct ucontext
        {
            ...
            public ucontext(ulong uc_flags = default, ref ptr<ucontext> uc_link = default, stackt uc_stack = default, ulong uc_sigmask = default, array<ulong> __unused = default, sigcontext uc_mcontext = default)
            {
        ...
        {
            return new ucontext(value.uc_flags, ref value.uc_link, value.uc_stack, value.uc_sigmask, value.__unused, value.uc_mcontext);
        }
    }
}