...
// Original source: C:\Program Files\Go\src\runtime\os2_aix.go
...
private static libFunc libc___n_pthreads = default;private static libFunc libc___mod_init = default;
...
private static void exit(int code) {
    ...
    // newosproc0.
    if (_g_ != null) {>>MARKER:FUNCTION_exit1_BLOCK_PREFIX<<
...
private static int write1(System.UIntPtr fd, unsafe.Pointer p, int n) {
    ...
    // Check the validity of g because without a g during
    // newosproc0.
    if (_g_ != null) {>>MARKER:FUNCTION_write2_BLOCK_PREFIX<<
...
private static (int, int, int) pipe() {
    ...
    array<int> p = new array<int>(2);
    var (_, err) = syscall1(_addr_libc_pipe, uintptr(noescape(@unsafe.Pointer(_addr_p[0]))));
...
//go:nosplit
private static (unsafe.Pointer, nint) mprotect(unsafe.Pointer addr, System.UIntPtr n, int prot) {
    unsafe.Pointer _p0 = default;
    nint _p0 = default;
...
private static void sigaction(System.UIntPtr sig, ptr<sigactiont> _addr_@new, ptr<sigactiont> _addr_old) {
    ...
    // Check the validity of g because without a g during
    // runtime.libpreinit.
    if (_g_ != null) {>>MARKER:FUNCTION_sigaction1_BLOCK_PREFIX<<
...
private static nuint internal_cpu_getsystemcfg(nuint label) {
...
private static void usleep(uint us) {
    ...
    if (int32(r) == -1) {>>MARKER:FUNCTION_usleep1_BLOCK_PREFIX<<
...
private static void osyield() {
    ...
    if (int32(r) == -1) {>>MARKER:FUNCTION_osyield1_BLOCK_PREFIX<<
...
private static int pthread_attr_init(ptr<pthread_attr> _addr_attr) {
    ...
    // Check the validity of g because without a g during
    // newosproc0.
    if (_g_ != null) {>>MARKER:FUNCTION_pthread_attr_init1_BLOCK_PREFIX<<
...
private static int pthread_attr_setdetachstate(ptr<pthread_attr> _addr_attr, int state) {
    ...
    // Check the validity of g because without a g during
    // newosproc0.
    if (_g_ != null) {>>MARKER:FUNCTION_pthread_attr_setdetachstate1_BLOCK_PREFIX<<
...
private static int pthread_attr_setstacksize(ptr<pthread_attr> _addr_attr, ulong size) {
    ...
    // Check the validity of g because without a g during
    // newosproc0.
    if (_g_ != null) {>>MARKER:FUNCTION_pthread_attr_setstacksize1_BLOCK_PREFIX<<
...
private static int pthread_create(ptr<pthread> _addr_tid, ptr<pthread_attr> _addr_attr, ptr<funcDescriptor> _addr_fn, unsafe.Pointer arg) {
    ...
    // Check the validity of g because without a g during
    // newosproc0.
    if (_g_ != null) {>>MARKER:FUNCTION_pthread_create1_BLOCK_PREFIX<<
...
private static void sigprocmask(int how, ptr<sigset> _addr_@new, ptr<sigset> _addr_old) {
    ...
    if (_g_ != null && _g_.m != null) {>>MARKER:FUNCTION_sigprocmask1_BLOCK_PREFIX<<
