...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct thread
        {
            ...
            public thread(int value) => m_value = value;

            // Enable implicit conversions between int and thread struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator thread(int value) => new thread(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator int(thread value) => value.m_value;
