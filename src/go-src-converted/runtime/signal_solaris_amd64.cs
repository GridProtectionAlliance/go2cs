...
// package runtime -- go2cs converted at 2020 October 09 04:48:33 UTC
// import "runtime" ==> using runtime = go.runtime_package
// Original source: C:\Go\src\runtime\signal_solaris_amd64.go
...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private static ulong sigaddr(this ptr<sigctxt> _addr_c)
        {
            ...
            return new ptr<ptr<ptr<ulong>>>(@unsafe.Pointer(_addr_c.info.__data[0L]));
        }
        ...
        private static void set_sigaddr(this ptr<sigctxt> _addr_c, ulong x)
        {
            ...
            (uintptr.val)(@unsafe.Pointer(_addr_c.info.__data[0L])).val;
