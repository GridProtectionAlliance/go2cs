...
// package runtime -- go2cs converted at 2020 August 29 08:20:36 UTC
...
namespace go
{
    public static unsafe partial class runtime_package
    {
        ...
        {
            return @unsafe.Pointer(ref c.info.__data[0L]).Value;
        }
        ...
        {
            (uintptr.Value)(@unsafe.Pointer(ref c.info.__data[0L])).Value;
