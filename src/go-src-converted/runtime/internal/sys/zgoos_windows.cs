...
// Original source: C:\Go\src\runtime\internal\sys\zgoos_windows.go
...
namespace @internal
{
    ...
    {
        public static readonly @string GOOS = (@string)"windows";
        ...
        public static readonly long GoosWindows = (long)1L;
