...
// Original source: C:\Go\src\runtime\internal\sys\zgoos_android.go
...
namespace @internal
{
    ...
    {
        public static readonly @string GOOS = (@string)"android";



        public static readonly long GoosAix = (long)0L;

        public static readonly long GoosAndroid = (long)1L;
