...
// Original source: C:\Go\src\runtime\internal\sys\zgoos_darwin.go
...
namespace @internal
{
    ...
    {
        public static readonly @string GOOS = (@string)"darwin";
        ...
        public static readonly long GoosDarwin = (long)1L;
