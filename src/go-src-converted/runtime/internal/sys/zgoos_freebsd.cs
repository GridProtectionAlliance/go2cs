...
// Original source: C:\Go\src\runtime\internal\sys\zgoos_freebsd.go
...
namespace @internal
{
    ...
    {
        public static readonly @string GOOS = (@string)"freebsd";
        ...
        public static readonly long GoosFreebsd = (long)1L;
