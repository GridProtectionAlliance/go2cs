...
// Original source: C:\Go\src\runtime\internal\sys\zgoarch_wasm.go
...
namespace @internal
{
    ...
    {
        public static readonly @string GOARCH = (@string)"wasm";
        ...
        public static readonly long GoarchWasm = (long)1L;
