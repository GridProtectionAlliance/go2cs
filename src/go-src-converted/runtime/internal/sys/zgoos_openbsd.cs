...
// Original source: C:\Go\src\runtime\internal\sys\zgoos_openbsd.go
...
namespace @internal
{
    ...
    {
        public static readonly @string GOOS = (@string)"openbsd";
        ...
        public static readonly long GoosOpenbsd = (long)1L;
