...
// Original source: C:\Go\src\runtime\internal\sys\zgoarch_riscv.go
...
namespace @internal
{
    ...
    {
        public static readonly @string GOARCH = (@string)"riscv";
        ...
        public static readonly long GoarchRiscv = (long)1L;
