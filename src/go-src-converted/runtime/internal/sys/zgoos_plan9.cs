...
// Original source: C:\Go\src\runtime\internal\sys\zgoos_plan9.go
...
namespace @internal
{
    ...
    {
        public static readonly @string GOOS = (@string)"plan9";
        ...
        public static readonly long GoosPlan9 = (long)1L;
