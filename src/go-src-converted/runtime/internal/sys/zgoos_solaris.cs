...
// Original source: C:\Go\src\runtime\internal\sys\zgoos_solaris.go
...
namespace @internal
{
    ...
    {
        public static readonly @string GOOS = (@string)"solaris";
        ...
        public static readonly long GoosSolaris = (long)1L;
