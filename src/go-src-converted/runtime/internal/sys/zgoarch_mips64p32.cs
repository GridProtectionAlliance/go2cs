...
namespace @internal
{
    ...
    {
        public static readonly @string GOARCH = (@string)"mips64p32";
        ...
        public static readonly long GoarchMips64p32 = (long)1L;

        public static readonly long GoarchMips64p32le = (long)0L;
