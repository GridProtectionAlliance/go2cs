...
namespace @internal
{
    public static partial class sys_package
    {
        ...
        public static readonly long PtrSize = 4L << (int)((~uintptr(0L) >> (int)(63L))); // unsafe.Sizeof(uintptr(0)) but an ideal const
 // unsafe.Sizeof(uintptr(0)) but an ideal const
        public static readonly long RegSize = 4L << (int)((~Uintreg(0L) >> (int)(63L))); // unsafe.Sizeof(uintreg(0)) but an ideal const
 // unsafe.Sizeof(uintreg(0)) but an ideal const
        public static readonly long SpAlign = 1L * (1L - GoarchArm64) + 16L * GoarchArm64; // SP alignment: 1 normally, 16 for ARM64
