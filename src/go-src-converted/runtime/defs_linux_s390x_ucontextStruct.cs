...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct ucontext
        {
            ...
            public ucontext(ulong uc_flags = default, ref ptr<ucontext> uc_link = default, stackt uc_stack = default, sigcontext uc_mcontext = default, ulong uc_sigmask = default)
            {
