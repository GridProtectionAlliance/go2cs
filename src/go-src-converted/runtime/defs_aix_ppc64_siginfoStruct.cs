    ...
    public static partial class runtime_package
    {
        ...
        private partial struct siginfo
        {
            ...
            public siginfo(NilType _)
            {
                ...
                this.__si_flags = default;
                this.__pad = default;
            }

            public siginfo(int si_signo = default, int si_errno = default, int si_code = default, int si_pid = default, uint si_uid = default, int si_status = default, System.UIntPtr si_addr = default, long si_band = default, array<int> si_value = default, int __si_flags = default, array<int> __pad = default)
            {
        ...
        {
            return new siginfo(value.si_signo, value.si_errno, value.si_code, value.si_pid, value.si_uid, value.si_status, value.si_addr, value.si_band, value.si_value, value.__si_flags, value.__pad);
        }
    }
}