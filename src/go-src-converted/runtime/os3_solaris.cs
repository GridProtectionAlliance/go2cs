...
// package runtime -- go2cs converted at 2020 October 08 03:21:46 UTC
...
;
        ...
        private static void newosproc(ptr<m> _addr_mp)
        {
            ...
            if (pthread_attr_setstack(_addr_attr, 0L, 0x200000UL) != 0L)
            {
                throw("pthread_attr_setstack");
            } 
            // Read back the allocated stack.
            if (pthread_attr_getstack(_addr_attr, @unsafe.Pointer(_addr_mp.g0.stack.hi), _addr_size) != 0L)
            {
...
;
        ...
        private static void semacreate(ptr<m> _addr_mp)
        {
            ...
            _g_.m.scratch.v[0L] = @unsafe.Sizeof(sem.val);
        ...
        private static int semasleep(long ns)
        {
            ...
            if (ns >= 0L)
            {
                ...
                _m_.scratch.v[1L] = uintptr(@unsafe.Pointer(_addr__m_.ts));
        ...
        private static void semawakeup(ptr<m> _addr_mp)
        {
            ...
            if (sem_post(_addr_(semt.val)(@unsafe.Pointer(mp.waitsema))) != 0L)
            {
                throw("sem_post");
            }
        ...
        private static readonly long _CLOCK_REALTIME = (long)3L;
        private static readonly long _CLOCK_MONOTONIC = (long)4L;
...
;
        ...
        private static readonly long _AT_SUN_EXECNAME = (long)2014L; // exec() path name
