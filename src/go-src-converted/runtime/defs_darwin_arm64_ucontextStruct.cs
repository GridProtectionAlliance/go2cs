...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct ucontext
        {
            ...
            {
                this.uc_onstack = default;
                this.uc_sigmask = default;
                this.uc_stack = default;
                this.uc_link = default;
                this.uc_mcsize = default;
                this.uc_mcontext = default;
            }

            public ucontext(int uc_onstack = default, uint uc_sigmask = default, stackt uc_stack = default, ref ptr<ucontext> uc_link = default, ulong uc_mcsize = default, ref ptr<mcontext64> uc_mcontext = default)
            {
                this.uc_onstack = uc_onstack;
                this.uc_sigmask = uc_sigmask;
                this.uc_stack = uc_stack;
                this.uc_link = uc_link;
                this.uc_mcsize = uc_mcsize;
        ...
        {
            return new ucontext(value.uc_onstack, value.uc_sigmask, value.uc_stack, ref value.uc_link, value.uc_mcsize, ref value.uc_mcontext);
        }
    }
}