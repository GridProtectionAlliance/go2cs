...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct exceptionrecord
        {
            ...
            public exceptionrecord(uint exceptioncode = default, uint exceptionflags = default, ref ptr<exceptionrecord> exceptionrecord = default, ref ptr<byte> exceptionaddress = default, uint numberparameters = default, array<byte> pad_cgo_0 = default, array<ulong> exceptioninformation = default)
            {
        ...
        {
            return new exceptionrecord(value.exceptioncode, value.exceptionflags, ref value.exceptionrecord, ref value.exceptionaddress, value.numberparameters, value.pad_cgo_0, value.exceptioninformation);
        }
    }
}