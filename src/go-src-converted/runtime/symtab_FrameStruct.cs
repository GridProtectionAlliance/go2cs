...
namespace go
{
    public static partial class runtime_package
    {
        ...
        public partial struct Frame
        {
            ...
            public Frame(System.UIntPtr PC = default, ref ptr<Func> Func = default, @string Function = default, @string File = default, nint Line = default, System.UIntPtr Entry = default, funcInfo funcInfo = default)
            {
                this.PC = PC;
                this.Func = Func;
