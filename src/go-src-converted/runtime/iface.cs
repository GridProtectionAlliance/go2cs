...
// package runtime -- go2cs converted at 2020 October 09 04:46:04 UTC
...
namespace go
{
    ...
    {
        private static readonly long itabInitSize = (long)512L;
        ...
        private static ptr<itab> getitab(ptr<interfacetype> _addr_inter, ptr<_type> _addr_typ, bool canfail) => func((_, panic, __) =>
        {
            ref interfacetype inter = ref _addr_inter.val;
            ref _type typ = ref _addr_typ.val;
            ...
            m = (itab.val)(persistentalloc(@unsafe.Sizeof(new itab()) + uintptr(len(inter.mhdr) - 1L) * sys.PtrSize, 0L, _addr_memstats.other_sys));
            m.inter = inter;
            m._type = typ; 
...
finish:
        ...
        private static void itabAdd(ptr<itab> _addr_m)
        {
            ...
            { // 75% load factor
                ...
                var t2 = (itabTableType.val)(mallocgc((2L + 2L * t.size) * sys.PtrSize, null, true));
                t2.size = t.size * 2L; 
        ...
        private static @string init(this ptr<itab> _addr_m)
        {
            ...
            long j = 0L;
            ptr<array<unsafe.Pointer>> methods = new ptr<ptr<array<unsafe.Pointer>>>(@unsafe.Pointer(_addr_m.fun[0L])).slice(-1, ni, ni);
...
imethods:
        ...
        private static void panicdottypeE(ptr<_type> _addr_have, ptr<_type> _addr_want, ptr<_type> _addr_iface) => func((_, panic, __) =>
        {
        ...
        // want = the static type we're trying to convert to.
        private static void panicnildottype(ptr<_type> _addr_want) => func((_, panic, __) =>
        {
            ref _type want = ref _addr_want.val;
        ...
        private static unsafe.Pointer convT16(ushort val)
        {
            ...
            {
                x = mallocgc(2L, uint16Type, false) * (uint16.val)(x);
        ...
        private static unsafe.Pointer convT32(uint val)
        {
            ...
            {
                x = mallocgc(4L, uint32Type, false) * (uint32.val)(x);
        ...
        private static unsafe.Pointer convT64(ulong val)
        {
            ...
            {
                x = mallocgc(8L, uint64Type, false) * (uint64.val)(x);
        ...
        private static unsafe.Pointer convTstring(@string val)
        {
            ...
            if (val == "")
            {
                x = @unsafe.Pointer(_addr_zeroVal[0L]);
            }
            else
            {
        ...
        private static iface assertI2I(ptr<interfacetype> _addr_inter, iface i) => func((_, panic, __) =>
        {
            iface r = default;
            ref interfacetype inter = ref _addr_inter.val;
        ...
        private static (iface, bool) assertI2I2(ptr<interfacetype> _addr_inter, iface i)
        {
            iface r = default;
            bool b = default;
            ref interfacetype inter = ref _addr_inter.val;
        ...
        private static iface assertE2I(ptr<interfacetype> _addr_inter, eface e) => func((_, panic, __) =>
        {
            iface r = default;
            ref interfacetype inter = ref _addr_inter.val;
            ...
            r.tab = getitab(_addr_inter, _addr_t, false);
            r.data = e.data;
            return ;

        });

        private static (iface, bool) assertE2I2(ptr<interfacetype> _addr_inter, eface e)
        {
            iface r = default;
            bool b = default;
            ref interfacetype inter = ref _addr_inter.val;
