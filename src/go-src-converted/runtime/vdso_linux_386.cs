...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private static readonly long vdsoArrayMax = 1L << (int)(31L) - 1L;

        private static symbol_key sym_keys = new slice<symbol_key>(new symbol_key[] { {"__vdso_clock_gettime",0xd35ec75,0x6e43a318,&__vdso_clock_gettime_sym} });

        // initialize to fall back to syscall
        private static System.UIntPtr __vdso_clock_gettime_sym = 0L;
    }
}
