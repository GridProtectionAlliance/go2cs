...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct elfShdr
        {
            ...
            public elfShdr(uint sh_name = default, uint sh_type = default, ulong sh_flags = default, ulong sh_addr = default, ulong sh_offset = default, ulong sh_size = default, uint sh_link = default, uint sh_info = default, ulong sh_addralign = default, ulong sh_entsize = default)
            {
