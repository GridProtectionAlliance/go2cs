...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct hmap
        {
            ...
            public hmap(nint count = default, byte flags = default, byte B = default, ushort noverflow = default, uint hash0 = default, unsafe.Pointer buckets = default, unsafe.Pointer oldbuckets = default, System.UIntPtr nevacuate = default, ref ptr<mapextra> extra = default)
            {
                this.count = count;
                this.flags = flags;
                this.B = B;
