...
// Original source: C:\Program Files\Go\src\runtime\defs_freebsd_arm64.go
...
private partial struct fpregs {
    public array<ulong> fp_q; // actually [32]uint128
    public uint fp_sr;
    public uint fp_cr;
    public int fp_flags;
    public int fp_pad;
...
private partial struct mcontext {
    public gpregs mc_gpregs;
    public fpregs mc_fpregs;
    public int mc_flags;
    public int mc_pad;
