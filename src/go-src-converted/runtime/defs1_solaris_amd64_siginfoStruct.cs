...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct siginfo
        {
            ...
            public siginfo(int si_signo = default, int si_code = default, int si_errno = default, int si_pad = default, array<byte> __data = default)
            {
        ...
        {
            return new siginfo(value.si_signo, value.si_code, value.si_errno, value.si_pad, value.__data);
        }
    }
}