...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct ucontext
        {
            ...
            public ucontext(int uc_onstack = default, uint uc_sigmask = default, stackt uc_stack = default, ref ptr<ucontext> uc_link = default, uint uc_mcsize = default, ref ptr<mcontext32> uc_mcontext = default)
            {
