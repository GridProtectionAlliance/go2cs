...
// package runtime -- go2cs converted at 2022 March 06 22:12:04 UTC
// import "runtime" ==> using runtime = go.runtime_package
// Original source: C:\Program Files\Go\src\runtime\syscall_solaris.go
...
private static void pipe1(); // declared for vet; do NOT call
...
private static readonly nuint _F_DUP2FD = 0x9;
...
private static (System.UIntPtr, System.UIntPtr) syscall_forkx(System.UIntPtr flags) {
    ...
    asmcgocall(@unsafe.Pointer(_addr_asmsysvicall6x), @unsafe.Pointer(_addr_call));
    if (int(call.r1) != -1) {>>MARKER:FUNCTION_pipe1_BLOCK_PREFIX<<
        call.err = 0;
    }
    return (call.r1, call.err);
...
private static (@string, System.UIntPtr) syscall_gethostname() {
    ...
    return (gostringnocopy(_addr_cname[0]), 0);
...
private static (System.UIntPtr, System.UIntPtr, System.UIntPtr) syscall_rawsyscall(System.UIntPtr trap, System.UIntPtr a1, System.UIntPtr a2, System.UIntPtr a3) => func((_, panic, _) => {
    System.UIntPtr r1 = default;
    System.UIntPtr r2 = default;
    System.UIntPtr err = default;
...
private static (System.UIntPtr, System.UIntPtr, System.UIntPtr) syscall_rawsyscall6(System.UIntPtr trap, System.UIntPtr a1, System.UIntPtr a2, System.UIntPtr a3, System.UIntPtr a4, System.UIntPtr a5, System.UIntPtr a6) => func((_, panic, _) => {
    System.UIntPtr r1 = default;
    System.UIntPtr r2 = default;
    System.UIntPtr err = default;
...
private static (nint, System.UIntPtr) syscall_wait4(System.UIntPtr pid, ptr<uint> _addr_wstatus, System.UIntPtr options, unsafe.Pointer rusage) {
    nint wpid = default;
    System.UIntPtr err = default;
