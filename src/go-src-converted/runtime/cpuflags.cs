...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private static readonly var offsetX86HasAVX = (var)@unsafe.Offsetof(cpu.X86.HasAVX);
        private static readonly var offsetX86HasAVX2 = (var)@unsafe.Offsetof(cpu.X86.HasAVX2);
        private static readonly var offsetX86HasERMS = (var)@unsafe.Offsetof(cpu.X86.HasERMS);
        private static readonly var offsetX86HasSSE2 = (var)@unsafe.Offsetof(cpu.X86.HasSSE2);

        private static readonly var offsetARMHasIDIVA = (var)@unsafe.Offsetof(cpu.ARM.HasIDIVA);

        private static readonly var offsetMIPS64XHasMSA = (var)@unsafe.Offsetof(cpu.MIPS64X.HasMSA);
