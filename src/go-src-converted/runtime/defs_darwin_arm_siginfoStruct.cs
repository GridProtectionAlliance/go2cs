...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct siginfo
        {
            ...
            public siginfo(int si_signo = default, int si_errno = default, int si_code = default, int si_pid = default, uint si_uid = default, int si_status = default, uint si_addr = default, array<byte> si_value = default, int si_band = default, array<uint> __pad = default)
            {
