...
// package runtime -- go2cs converted at 2020 October 08 03:23:19 UTC
...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private static uint sigaddr(this ptr<sigctxt> _addr_c)
        {
            ...
            return new ptr<ptr<ptr<uint>>>(@unsafe.Pointer(_addr_c.info._reason[0L]));
        }
        ...
        private static void set_sigaddr(this ptr<sigctxt> _addr_c, uint x)
        {
            ...
            (uint32.val)(@unsafe.Pointer(_addr_c.info._reason[0L])).val;
