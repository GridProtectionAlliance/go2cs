...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct siginfo
        {
            ...
            public siginfo(int si_signo = default, int si_code = default, int si_errno = default, array<byte> pad_cgo_0 = default, array<byte> _data = default)
            {
        ...
        {
            return new siginfo(value.si_signo, value.si_code, value.si_errno, value.pad_cgo_0, value._data);
        }
    }
}