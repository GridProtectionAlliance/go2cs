...
// package profile -- go2cs converted at 2020 August 29 08:23:43 UTC
// import "runtime/pprof/internal/profile" ==> using profile = go.runtime.pprof.@internal.profile_package
// Original source: C:\Go\src\runtime\pprof\internal\profile\encode.go
...
namespace @internal
{
    public static partial class profile_package
    {
        ...
        private static error postDecode(this ref Profile p)
        {
            ...
            var mappings = make_map<ulong, ref Mapping>();
            foreach (var (_, m) in p.Mapping)
            {
            ...
            var functions = make_map<ulong, ref Function>();
            foreach (var (_, f) in p.Function)
            {
        ...
        public static void encode(this Label p, ref buffer b)
        {
