...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct siginfo
        {
            ...
            public siginfo(int si_signo = default, int si_errno = default, int si_code = default, int si_pid = default, uint si_uid = default, int si_status = default, ref ptr<byte> si_addr = default, array<byte> si_value = default, long si_band = default, array<ulong> __pad = default)
            {
        ...
        {
            return new siginfo(value.si_signo, value.si_errno, value.si_code, value.si_pid, value.si_uid, value.si_status, ref value.si_addr, value.si_value, value.si_band, value.__pad);
        }
    }
}