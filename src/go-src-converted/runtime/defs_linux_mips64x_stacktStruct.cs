...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct stackt
        {
            ...
            public stackt(ref ptr<byte> ss_sp = default, System.UIntPtr ss_size = default, int ss_flags = default)
            {
                this.ss_sp = ss_sp;
        ...
        {
            return new stackt(ref value.ss_sp, value.ss_size, value.ss_flags);
        }
    }
}