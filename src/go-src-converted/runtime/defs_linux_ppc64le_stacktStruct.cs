...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct stackt
        {
            ...
            public stackt(ref ptr<byte> ss_sp = default, int ss_flags = default, array<byte> pad_cgo_0 = default, System.UIntPtr ss_size = default)
            {
                this.ss_sp = ss_sp;
        ...
        {
            return new stackt(ref value.ss_sp, value.ss_flags, value.pad_cgo_0, value.ss_size);
        }
    }
}