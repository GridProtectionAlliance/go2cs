...
private static ulong lastTaskID = 0; // task id issued last time
...
public static void WithRegion(context.Context ctx, @string regionType, Action fn) => func((defer, _, _) => { 
    // NOTE:
