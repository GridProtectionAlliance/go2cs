...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct keventt
        {
            ...
            public keventt(ulong ident = default, uint filter = default, uint flags = default, uint fflags = default, array<byte> pad_cgo_0 = default, long data = default, ref ptr<byte> udata = default)
            {
                this.ident = ident;
                this.filter = filter;
                this.flags = flags;
        ...
        {
            return new keventt(value.ident, value.filter, value.flags, value.fflags, value.pad_cgo_0, value.data, ref value.udata);
        }
    }
}