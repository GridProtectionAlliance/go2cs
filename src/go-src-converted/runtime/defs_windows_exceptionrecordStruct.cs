...
namespace go
{
    public static partial class runtime_package
    {
        ...
        private partial struct exceptionrecord
        {
            ...
            public exceptionrecord(uint exceptioncode = default, uint exceptionflags = default, ref ptr<exceptionrecord> exceptionrecord = default, ref ptr<byte> exceptionaddress = default, uint numberparameters = default, array<System.UIntPtr> exceptioninformation = default)
            {
