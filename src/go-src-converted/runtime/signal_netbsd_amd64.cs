...
// Original source: C:\Program Files\Go\src\runtime\signal_netbsd_amd64.go
...
private static ulong sigaddr(this ptr<sigctxt> _addr_c) {
    ...
    return new ptr<ptr<ptr<ulong>>>(@unsafe.Pointer(_addr_c.info._reason[0]));
}
...
private static void set_sigaddr(this ptr<sigctxt> _addr_c, ulong x) {
    ...
    (uint64.val)(@unsafe.Pointer(_addr_c.info._reason[0])).val;
