...
// package stdmethods -- go2cs converted at 2020 October 09 06:04:14 UTC
// import "golang.org/x/tools/go/analysis/passes/stdmethods" ==> using stdmethods = go.golang.org.x.tools.go.analysis.passes.stdmethods_package
// Original source: C:\Users\ritchie\go\src\golang.org\x\tools\go\analysis\passes\stdmethods\stdmethods.go
...
namespace passes
{
    ...
    {
        public static readonly @string Doc = (@string)@"check signature of methods of well-known interfaces
...
";
        ...
        private static void canonicalMethod(ptr<analysis.Pass> _addr_pass, ptr<ast.Ident> _addr_id)
        {
            ...
            if (id.Name == "WriteTo" && args.Len() > 1L)
            {
                return ;
            } 
        ...
        {
            return types.TypeString(typ, ptr<types.Package>);
        }
