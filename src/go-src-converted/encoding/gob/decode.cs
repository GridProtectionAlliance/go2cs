...
// package gob -- go2cs converted at 2020 August 29 08:35:25 UTC
...
namespace encoding
{
    public static partial class gob_package
    {
        ...
        public delegate  bool decHelper(ref decoderState,  reflect.Value,  long,  error);
...
// if we load a type during decode (when reading an interface value).
        ...
        private static (long, error) Read(this ref decBuffer d, slice<byte> p)
        {
        ...
        private static void Drop(this ref decBuffer _d, long n) => func(_d, (ref decBuffer d, Defer _, Panic panic, Recover __) =>
        {
            if (n > d.Len())
            {
                panic("drop");
        ...
        private static void Size(this ref decBuffer d, long n)
        {
            d.Reset();
            if (cap(d.data) < n)
            {
        ...
        private static (byte, error) ReadByte(this ref decBuffer d)
        {
        ...
        private static long Len(this ref decBuffer d)
        {
            return len(d.data) - d.offset;
        }

        private static slice<byte> Bytes(this ref decBuffer d)
        {
            return d.data[d.offset..];
        }

        private static void Reset(this ref decBuffer d)
        {
            d.data = d.data[0L..0L];
            d.offset = 0L;
        }
        ...
        private static ref decoderState newDecoderState(this ref Decoder dec, ref decBuffer buf)
        {
            var d = dec.freeList;
            if (d == null)
            {
        ...
        private static void freeDecoderState(this ref Decoder dec, ref decoderState d)
        {
            d.next = dec.freeList;
            dec.freeList = d;
        }
        ...
        private static ulong decodeUint(this ref decoderState state)
        {
        ...
        // Does not check for overflow.
        private static long decodeInt(this ref decoderState state)
        {
        ...
        private static (long, bool) getLength(this ref decoderState state)
        {
        ...
        public delegate void decOp(ref decInstr, ref decoderState, reflect.Value);
        ...
        private static void ignoreUint(ref decInstr i, ref decoderState state, reflect.Value v)
        {
            state.decodeUint();
        }
        ...
        // complex values.
        private static void ignoreTwoUints(ref decInstr i, ref decoderState state, reflect.Value v)
        {
            state.decodeUint();
            state.decodeUint();
        }
        ...
        private static void decBool(ref decInstr i, ref decoderState state, reflect.Value value)
        {
            value.SetBool(state.decodeUint() != 0L);
        }

        // decInt8 decodes an integer and stores it as an int8 in value.
        private static void decInt8(ref decInstr i, ref decoderState state, reflect.Value value)
        {
        ...
        private static void decUint8(ref decInstr i, ref decoderState state, reflect.Value value)
        {
        ...
        private static void decInt16(ref decInstr i, ref decoderState state, reflect.Value value)
        {
            var v = state.decodeInt();
        ...
        private static void decUint16(ref decInstr i, ref decoderState state, reflect.Value value)
        {
            var v = state.decodeUint();
            if (math.MaxUint16 < v)
            {
        ...
        private static void decInt32(ref decInstr i, ref decoderState state, reflect.Value value)
        {
            var v = state.decodeInt();
        ...
        private static void decUint32(ref decInstr i, ref decoderState state, reflect.Value value)
        {
            var v = state.decodeUint();
            if (math.MaxUint32 < v)
            {
        ...
        private static void decInt64(ref decInstr i, ref decoderState state, reflect.Value value)
        {
            var v = state.decodeInt();
            value.SetInt(v);
        }
        ...
        private static void decUint64(ref decInstr i, ref decoderState state, reflect.Value value)
        {
            var v = state.decodeUint();
            value.SetUint(v);
        }
        ...
        private static void decFloat32(ref decInstr i, ref decoderState state, reflect.Value value)
        {
        ...
        // number, and stores it in value.
        private static void decFloat64(ref decInstr i, ref decoderState state, reflect.Value value)
        {
        ...
        private static void decComplex64(ref decInstr i, ref decoderState state, reflect.Value value)
        {
        ...
        // The real part comes first.
        private static void decComplex128(ref decInstr i, ref decoderState state, reflect.Value value)
        {
        ...
        private static void decUint8Slice(ref decInstr i, ref decoderState state, reflect.Value value)
        {
        ...
        private static void decString(ref decInstr i, ref decoderState state, reflect.Value value)
        {
            var (n, ok) = state.getLength();
            if (!ok)
            {
        ...
        private static void ignoreUint8Array(ref decInstr i, ref decoderState state, reflect.Value value)
        {
            var (n, ok) = state.getLength();
            if (!ok)
            {
        ...
        private static void decodeSingle(this ref Decoder _dec, ref decEngine _engine, reflect.Value value) => func(_dec, _engine, (ref Decoder dec, ref decEngine engine, Defer defer, Panic _, Recover __) =>
        {
            var state = dec.newDecoderState(ref dec.buf);
        ...
        private static void decodeStruct(this ref Decoder _dec, ref decEngine _engine, reflect.Value value) => func(_dec, _engine, (ref Decoder dec, ref decEngine engine, Defer defer, Panic _, Recover __) =>
        {
            var state = dec.newDecoderState(ref dec.buf);
            defer(dec.freeDecoderState(state));
            state.fieldnum = -1L;
            while (state.b.Len() > 0L)
            {
                ...
                var instr = ref engine.instr[fieldnum];
        ...
        private static void ignoreStruct(this ref Decoder _dec, ref decEngine _engine) => func(_dec, _engine, (ref Decoder dec, ref decEngine engine, Defer defer, Panic _, Recover __) =>
        {
            var state = dec.newDecoderState(ref dec.buf);
            defer(dec.freeDecoderState(state));
            state.fieldnum = -1L;
        ...
        private static void ignoreSingle(this ref Decoder _dec, ref decEngine _engine) => func(_dec, _engine, (ref Decoder dec, ref decEngine engine, Defer defer, Panic _, Recover __) =>
        {
            var state = dec.newDecoderState(ref dec.buf);
            defer(dec.freeDecoderState(state));
            state.fieldnum = singletonField;
        ...
        private static void decodeArrayHelper(this ref Decoder dec, ref decoderState state, reflect.Value value, decOp elemOp, long length, error ovfl, decHelper helper)
        {
            if (helper != null && helper(state, value, length, ovfl))
            {
                return;
            }
            decInstr instr = ref new decInstr(elemOp,0,nil,ovfl);
        ...
        private static void decodeArray(this ref Decoder dec, ref decoderState state, reflect.Value value, decOp elemOp, long length, error ovfl, decHelper helper)
        {
            {
        ...
        private static reflect.Value decodeIntoValue(ref decoderState state, decOp op, bool isPtr, reflect.Value value, ref decInstr instr)
        {
            var v = value;
            if (isPtr)
            {
        ...
        private static void decodeMap(this ref Decoder dec, reflect.Type mtyp, ref decoderState state, reflect.Value value, decOp keyOp, decOp elemOp, error ovfl)
        {
            var n = int(state.decodeUint());
            if (value.IsNil())
            {
            ...
            decInstr keyInstr = ref new decInstr(keyOp,0,nil,ovfl);
            decInstr elemInstr = ref new decInstr(elemOp,0,nil,ovfl);
            ...
            for (long i = 0L; i < n; i++)
            {
                var key = decodeIntoValue(state, keyOp, keyIsPtr, keyP.Elem(), keyInstr);
                var elem = decodeIntoValue(state, elemOp, elemIsPtr, elemP.Elem(), elemInstr);
        ...
        private static void ignoreArrayHelper(this ref Decoder dec, ref decoderState state, decOp elemOp, long length)
        {
            decInstr instr = ref new decInstr(elemOp,0,nil,errors.New("no error"));
            for (long i = 0L; i < length; i++)
            {
                if (state.b.Len() == 0L)
                {
        ...
        private static void ignoreArray(this ref Decoder dec, ref decoderState state, decOp elemOp, long length)
        {
            {
                var n = state.decodeUint();
        ...
        private static void ignoreMap(this ref Decoder dec, ref decoderState state, decOp keyOp, decOp elemOp)
        {
            var n = int(state.decodeUint());
            decInstr keyInstr = ref new decInstr(keyOp,0,nil,errors.New("no error"));
            decInstr elemInstr = ref new decInstr(elemOp,0,nil,errors.New("no error"));
            for (long i = 0L; i < n; i++)
            {
        ...
        private static void decodeSlice(this ref Decoder dec, ref decoderState state, reflect.Value value, decOp elemOp, error ovfl, decHelper helper)
        {
        ...
        private static void ignoreSlice(this ref Decoder dec, ref decoderState state, decOp elemOp)
        {
        ...
        private static void decodeInterface(this ref Decoder dec, reflect.Type ityp, ref decoderState state, reflect.Value value)
        { 
        ...
        private static void ignoreInterface(this ref Decoder dec, ref decoderState state)
        { 
            // Read the name of the concrete type.
            var (n, ok) = state.getLength();
            if (!ok)
        ...
        private static void decodeGobDecoder(this ref Decoder dec, ref userTypeInfo ut, ref decoderState state, reflect.Value value)
        { 
        ...
        private static void ignoreGobDecoder(this ref Decoder dec, ref decoderState state)
        { 
            // Read the bytes for the value.
            var (n, ok) = state.getLength();
            if (!ok)
        ...
        private static ref decOp decOpFor(this ref Decoder dec, typeId wireId, reflect.Type rt, @string name, map<reflect.Type, ref decOp> inProgress)
        {
            var ut = userType(rt); 
            ...
            if (op == null)
            {
                ...
                // Special cases
                {
                    ...
                    if (t.Kind() == reflect.Array) 
                        ...
                        op = (i, state, value) =>
                        {
                            state.dec.decodeArray(state, value, elemOp.Value, t.Len(), ovfl, helper);
                        }
;
                        ...
                        op = (i, state, value) =>
                        {
                            state.dec.decodeMap(t, state, value, keyOp.Value, elemOp.Value, ovfl);
                        }
;
                        ...
                        elemId = default;
                        {
                            ...
                            if (ok)
                            {
                                elemId = tt._<ref sliceType>().Elem;
                            }
                            else
                            {
                        ...
                        op = (i, state, value) =>
                        {
                            state.dec.decodeSlice(state, value, elemOp.Value, ovfl, helper);
                        }
;
                        ...
                        { 
                            ...
                            dec.decodeStruct(enginePtr.Value, value);
                        }
;
...
;
        ...
        private static ref decOp decIgnoreOpFor(this ref Decoder dec, typeId wireId, map<typeId, ref decOp> inProgress)
        { 
            // If this type is already in progress, it's a recursive type (e.g. map[string]*T).
            // Return the pointer to the op we're already building.
            {
...
;
                ...
                if (wire == null) 
                    ...
                    op = (i, state, value) =>
                    {
                        state.dec.ignoreArray(state, elemOp.Value, wire.ArrayT.Len);
                    }
;
                    ...
                    op = (i, state, value) =>
                    {
                        state.dec.ignoreMap(state, keyOp.Value, elemOp.Value);
                    }
;
                    ...
                    op = (i, state, value) =>
                    {
                        state.dec.ignoreSlice(state, elemOp.Value);
                    }
;
                    ...
                    { 
                        // indirect through enginePtr to delay evaluation for recursive structs
                        state.dec.ignoreStruct(enginePtr.Value);
                    }
;
...
;
        ...
        // GobDecoder.
        private static ref decOp gobDecodeOpFor(this ref Decoder dec, ref userTypeInfo ut)
        {
...
;
        ...
        private static bool compatibleType(this ref Decoder dec, reflect.Type fr, typeId fw, map<reflect.Type, typeId> inProgress)
        {
            {
            ...
            }
            {
                ...
                if (t.Kind() == reflect.Bool) 
                    ...
                    ref sliceType sw = default;
                    {
                        var (tt, ok) = builtinIdToType[fw];

                        if (ok)
                        {
                            sw, _ = tt._<ref sliceType>();
                        }
                        else if (wire != null)
                        {
                            sw = wire.SliceT;
        ...
        private static @string typeString(this ref Decoder _dec, typeId remoteId) => func(_dec, (ref Decoder dec, Defer defer, Panic _, Recover __) =>
        {
            typeLock.Lock();
        ...
        // GobDecoders.
        private static (ref decEngine, error) compileSingle(this ref Decoder dec, typeId remoteId, ref userTypeInfo ut)
        {
            var rt = ut.user;
            ...
            if (!dec.compatibleType(rt, remoteId, make_map<reflect.Type, typeId>()))
            {
                ...
                {
                    return (null, errors.New("gob: local interface type " + name + " can only be decoded from remote interface type; received concrete type " + remoteType));
                }
                return (null, errors.New("gob: decoding into local type " + name + ", received remote type " + remoteType));
            }
            var op = dec.decOpFor(remoteId, rt, name, make_map<reflect.Type, ref decOp>());
        ...
        private static (ref decEngine, error) compileIgnoreSingle(this ref Decoder dec, typeId remoteId)
        {
            engine = @new<decEngine>();
            engine.instr = make_slice<decInstr>(1L); // one item
            var op = dec.decIgnoreOpFor(remoteId, make_map<typeId, ref decOp>());
        ...
        private static (ref decEngine, error) compileDec(this ref Decoder _dec, typeId remoteId, ref userTypeInfo _ut) => func(_dec, _ut, (ref Decoder dec, ref userTypeInfo ut, Defer defer, Panic _, Recover __) =>
        {
            defer(catchError(ref err));
            var rt = ut.@base;
            var srt = rt;
            ...
            ref structType wireStruct = default; 
            ...
            // Also we know we're decoding a struct now, so the client must have sent one.
            {
                ...
                if (ok)
                {
                    wireStruct, _ = t._<ref structType>();
                }
                else
                {
            ...
            var seen = make_map<reflect.Type, ref decOp>(); 
            ...
            for (long fieldnum = 0L; fieldnum < len(wireStruct.Field); fieldnum++)
            {
                ...
                {
                    var op = dec.decIgnoreOpFor(wireField.Id, make_map<typeId, ref decOp>());
        ...
        private static (ptr<ptr<decEngine>>, error) getDecEnginePtr(this ref Decoder dec, typeId remoteId, ref userTypeInfo ut)
        {
            var rt = ut.user;
            ...
            { 
                ...
                enginePtr = @new<decEngine.Value>();
                decoderMap[remoteId] = enginePtr;
                enginePtr.Value, err = dec.compileDec(remoteId, ut);
                if (err != null)
                {
        ...
        private static (ptr<ptr<decEngine>>, error) getIgnoreEnginePtr(this ref Decoder dec, typeId wireId)
        {
            bool ok = default;
            ...
            { 
                ...
                {
                    enginePtr.Value, err = dec.compileDec(wireId, userType(emptyStructType));
                }
                else
                {
                    enginePtr.Value, err = dec.compileIgnoreSingle(wireId);
                }
                if (err != null)
                {
        ...
        private static void decodeValue(this ref Decoder _dec, typeId wireId, reflect.Value value) => func(_dec, (ref Decoder dec, Defer defer, Panic _, Recover __) =>
        {
            defer(catchError(ref dec.err)); 
        ...
        private static void decodeIgnoredValue(this ref Decoder dec, typeId wireId)
        {
            ptr<ptr<decEngine>> enginePtr = default;
            ...
            if (wire != null && wire.StructT != null)
            {
                dec.ignoreStruct(enginePtr.Value);
            }
            else
            {
                dec.ignoreSingle(enginePtr.Value);
            }
        }
