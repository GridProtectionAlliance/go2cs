...
namespace encoding
{
    public static partial class gob_package
    {
        ...
        private partial struct userTypeInfo
        {
            ...
            public userTypeInfo(reflect.Type user = default, reflect.Type @base = default, nint indir = default, nint externalEnc = default, nint externalDec = default, sbyte encIndir = default, sbyte decIndir = default)
            {
                this.user = user;
                this.@base = @base;
                this.indir = indir;
