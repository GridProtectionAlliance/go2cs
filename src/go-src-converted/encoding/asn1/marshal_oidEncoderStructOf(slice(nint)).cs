...
namespace encoding
{
    public static partial class asn1_package
    {
        ...
        private partial struct oidEncoder : ISlice
        {
            ...
            public oidEncoder(slice<nint> value) => m_value = value;

            // Enable implicit conversions between slice<nint> and oidEncoder struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator oidEncoder(slice<nint> value) => new oidEncoder(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator slice<nint>(oidEncoder value) => value.m_value;
