...
private partial struct scanner {
    public Func<ptr<scanner>, byte, nint> step; // Reached end of top-level value.
    public bool endTop; // Stack of what we're in the middle of - array values, object keys, object values.
    public slice<nint> parseState; // Error that happened, if any.
...
private static readonly nint maxNestingDepth = 10000;
...
private static void reset(this ptr<scanner> _addr_s) {
    ...
    s.parseState = s.parseState[(int)0..(int)0];
    s.err = null;
    s.endTop = false;
}
...
private static nint eof(this ptr<scanner> _addr_s) {
    ref scanner s = ref _addr_s.val;
...
private static nint pushParseState(this ptr<scanner> _addr_s, byte c, nint newParseState, nint successState) {
    ref scanner s = ref _addr_s.val;
...
private static void popParseState(this ptr<scanner> _addr_s) {
    ...
    var n = len(s.parseState) - 1;
    s.parseState = s.parseState[(int)0..(int)n];
    if (n == 0) {
        s.step = stateEndTop;
        s.endTop = true;
    }
...
private static nint stateBeginValueOrEmpty(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateBeginValue(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateBeginStringOrEmpty(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateBeginString(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateEndValue(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateEndTop(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateInString(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateInStringEsc(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateInStringEscU(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateInStringEscU1(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateInStringEscU12(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateInStringEscU123(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateNeg(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint state1(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint state0(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateDot(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateDot0(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateE(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
// such as after reading `314e-` or `0.314e+`.
private static nint stateESign(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateE0(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateT(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateTr(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateTru(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateF(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateFa(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateFal(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateFals(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateN(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateNu(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateNul(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint stateError(ptr<scanner> _addr_s, byte c) {
    ref scanner s = ref _addr_s.val;
...
private static nint error(this ptr<scanner> _addr_s, byte c, @string context) {
    ref scanner s = ref _addr_s.val;
