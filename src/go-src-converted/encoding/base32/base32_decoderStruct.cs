...
namespace encoding
{
    public static partial class base32_package
    {
        ...
        private partial struct decoder
        {
            ...
            public decoder(error err = default, ref ptr<Encoding> enc = default, io.Reader r = default, bool end = default, array<byte> buf = default, nint nbuf = default, slice<byte> @out = default, array<byte> outbuf = default)
            {
                this.err = err;
                this.enc = enc;
                this.r = r;
