...
namespace encoding
{
    public static partial class base32_package
    {
        ...
        public partial struct Encoding
        {
            ...
            public Encoding(array<byte> encode = default, array<byte> decodeMap = default, int padChar = default)
            {
                this.encode = encode;
        ...
        {
            return new Encoding(value.encode, value.decodeMap, value.padChar);
        }
    }
}}