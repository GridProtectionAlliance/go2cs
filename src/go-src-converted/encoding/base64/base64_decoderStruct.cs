...
namespace encoding
{
    public static partial class base64_package
    {
        ...
        private partial struct decoder
        {
            ...
            public decoder(error err = default, error readErr = default, ref ptr<Encoding> enc = default, io.Reader r = default, array<byte> buf = default, nint nbuf = default, slice<byte> @out = default, array<byte> outbuf = default)
            {
                this.err = err;
