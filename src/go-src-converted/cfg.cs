...
//
// package cfg -- go2cs converted at 2022 March 06 23:33:56 UTC
// import "golang.org/x/tools/go/cfg" ==> using cfg = go.golang.org.x.tools.go.cfg_package
// Original source: C:\Users\ritchie\go\src\golang.org\x\tools\go\cfg\cfg.go
...
public static ptr<CFG> New(ptr<ast.BlockStmt> _addr_body, Func<ptr<ast.CallExpr>, bool> mayReturn) {
    ...
    var q = make_slice<ptr<Block>>(0, len(b.cfg.Blocks));
