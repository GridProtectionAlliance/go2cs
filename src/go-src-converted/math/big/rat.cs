...
namespace math
{
    public static partial class big_package
    {
        ...
        private static ptr<Rat> SetFloat64(this ptr<Rat> _addr_z, double f)
        {
            ...
            const long expMask = (long)1L << (int)(11L) - 1L;
        ...
        private static ptr<Rat> SetFrac(this ptr<Rat> _addr_z, ptr<Int> _addr_a, ptr<Int> _addr_b) => func((_, panic, __) =>
        {
            ref Rat z = ref _addr_z.val;
        ...
        private static ptr<Rat> SetFrac64(this ptr<Rat> _addr_z, long a, long b) => func((_, panic, __) =>
        {
            ref Rat z = ref _addr_z.val;
        ...
        // If x == 0, Inv panics.
        private static ptr<Rat> Inv(this ptr<Rat> _addr_z, ptr<Rat> _addr_x) => func((_, panic, __) =>
        {
            ref Rat z = ref _addr_z.val;
            ref Rat x = ref _addr_x.val;
        ...
        //    +1 if x >  0
        //
        private static long Sign(this ptr<Rat> _addr_x)
        {
            ref Rat x = ref _addr_x.val;
        ...
        private static ptr<Rat> norm(this ptr<Rat> _addr_z)
        {
            ...
            // default: 
                ...
                z.b.neg = false;
                {
                    var f = NewInt(0L).lehmerGCD(null, null, _addr_z.a, _addr_z.b);
        ...
        //   +1 if x >  y
        //
        private static long Cmp(this ptr<Rat> _addr_x, ptr<Rat> _addr_y)
        {
            ref Rat x = ref _addr_x.val;
        ...
        // If y == 0, Quo panics.
        private static ptr<Rat> Quo(this ptr<Rat> _addr_z, ptr<Rat> _addr_x, ptr<Rat> _addr_y) => func((_, panic, __) =>
        {
            ref Rat z = ref _addr_z.val;
            ref Rat x = ref _addr_x.val;
            ref Rat y = ref _addr_y.val;
