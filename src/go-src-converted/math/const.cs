...
namespace go
{
    public static partial class math_package
    {
        ...
        public static readonly long Log2E = 1L / Ln2;
        ...
        public static readonly long Log10E = 1L / Ln10;

        // Floating-point limit values.
        // Max is the largest finite value representable by the type.
        // SmallestNonzero is the smallest positive, non-zero value representable by the type.
        public static readonly float MaxFloat32 = 3.40282346638528859811704183484516925440e+38F; // 2**127 * (2**24 - 1) / 2**23
        public static readonly float SmallestNonzeroFloat32 = 1.401298464324817070923729583289916131280e-45F; // 1 / 2**(127 - 1 + 23)

        public static readonly float MaxFloat64 = 1.797693134862315708145274237317043567981e+308F; // 2**1023 * (2**53 - 1) / 2**52
        public static readonly float SmallestNonzeroFloat64 = 4.940656458412465441765687928682213723651e-324F; // 1 / 2**(1023 - 1 + 52)

        // Integer limit values.
        public static readonly long MaxInt8 = 1L << (int)(7L) - 1L;
        public static readonly long MinInt8 = -1L << (int)(7L);
        public static readonly long MaxInt16 = 1L << (int)(15L) - 1L;
        public static readonly long MinInt16 = -1L << (int)(15L);
        public static readonly long MaxInt32 = 1L << (int)(31L) - 1L;
        public static readonly long MinInt32 = -1L << (int)(31L);
        public static readonly long MaxInt64 = 1L << (int)(63L) - 1L;
        public static readonly long MinInt64 = -1L << (int)(63L);
        public static readonly long MaxUint8 = 1L << (int)(8L) - 1L;
        public static readonly long MaxUint16 = 1L << (int)(16L) - 1L;
        public static readonly long MaxUint32 = 1L << (int)(32L) - 1L;
        public static readonly long MaxUint64 = 1L << (int)(64L) - 1L;
    }
}
