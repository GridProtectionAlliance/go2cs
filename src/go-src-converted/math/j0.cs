        ...
        */
        ...
        public static double J0(double x)
        {
            ...
            { // |x| < ~1.2207e-4
                if (x < TwoM27)
                {
                    return 1L; // |x| < ~7.4506e-9
                }
                return 1L - 0.25F * x * x; // ~7.4506e-9 < |x| < ~1.2207e-4
            }
            z = x * x;
            var r = z * (R02 + z * (R03 + z * (R04 + z * R05)));
            long s = 1L + z * (S01 + z * (S02 + z * (S03 + z * S04)));
            if (x < 1L)
            {
                return 1L + z * (-0.25F + (r / s)); // |x| < 1.00
            }
            u = 0.5F * x;
            return (1L + u) * (1L - u) + z * (r / s); // 1.0 < |x| < 2.0
        }
        ...
        public static double Y0(double x)
        {
            ...
            return u / v + (2L / Pi) * J0(x) * Log(x); // ~7.4506e-9 < |x| < 2.0
        }
