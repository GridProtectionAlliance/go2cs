...
namespace go
{
    public static partial class testing_package
    {
        ...
        private partial struct testContext
        {
            ...
            public testContext(ref ptr<matcher> match = default, time.Time deadline = default, sync.Mutex mu = default, channel<bool> startParallel = default, nint running = default, nint numWaiting = default, nint maxParallel = default)
            {
                this.match = match;
