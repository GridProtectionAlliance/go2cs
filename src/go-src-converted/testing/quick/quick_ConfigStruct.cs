...
namespace testing
{
    public static partial class quick_package
    {
        ...
        public partial struct Config
        {
            ...
            public Config(nint MaxCount = default, double MaxCountScale = default, ref ptr<rand.Rand> Rand = default, Action<slice<reflect.Value>, ptr<rand.Rand>> Values = default)
            {
