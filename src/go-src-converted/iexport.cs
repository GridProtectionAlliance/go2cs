...
// package gcimporter -- go2cs converted at 2022 March 06 23:32:11 UTC
...
public static partial class gcimporter_package {
    ...
    // 0: Go1.11 encoding
private static readonly nint iexportVersion = 0;
...
private static void doDecl(this ptr<iexporter> _addr_p, types.Object obj) => func((_, panic, _) => {
    ref iexporter p = ref _addr_p.val;
...
private static void doTyp(this ptr<exportWriter> _addr_w, types.Type t, ptr<types.Package> _addr_pkg) => func((_, panic, _) => {
    ref exportWriter w = ref _addr_w.val;
    ref types.Package pkg = ref _addr_pkg.val;
...
private static void value(this ptr<exportWriter> _addr_w, types.Type typ, constant.Value v) => func((_, panic, _) => {
    ref exportWriter w = ref _addr_w.val;
...
private static void mpint(this ptr<exportWriter> _addr_w, ptr<big.Int> _addr_x, types.Type typ) => func((_, panic, _) => {
    ref exportWriter w = ref _addr_w.val;
...
private static void mpfloat(this ptr<exportWriter> _addr_w, ptr<big.Float> _addr_f, types.Type typ) => func((_, panic, _) => {
    ref exportWriter w = ref _addr_w.val;
...
private static void pushTail(this ptr<objQueue> _addr_q, types.Object obj) {
    ...
    if (len(q.ring) == 0) {
        q.ring = make_slice<types.Object>(16);
    }
    else if (q.head + len(q.ring) == q.tail) { 
        // Grow the ring.
        var nring = make_slice<types.Object>(len(q.ring) * 2); 
...
private static types.Object popHead(this ptr<objQueue> _addr_q) => func((_, panic, _) => {
    ref objQueue q = ref _addr_q.val;
