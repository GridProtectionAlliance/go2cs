...
namespace go
{
    public static partial class ssa_package
    {
        ...
        public partial struct Select
        {
            ...
            public Select(register register = default, slice<ptr<SelectState>> States = default, bool Blocking = default)
            {
            ...
            // Enable comparisons between nil and Select struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(Select value, NilType nil) => value.Equals(default(Select));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(Select value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, Select value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, Select value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Select(NilType nil) => default(Select);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        public static Select Select_cast(dynamic value)
        {
            return new Select(value.register, value.States, value.Blocking);
        }
    }
}}}}}