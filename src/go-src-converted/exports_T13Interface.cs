...
namespace go
{
    public static class exports_T13Extensions
    {
        ...
        public static T _<T>(this go.golang.org.x.tools.go.@internal.gcimporter.exports_package.T13 target)
        {
            try
            {
                return ((go.golang.org.x.tools.go.@internal.gcimporter.exports_package.T13<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.golang.org.x.tools.go.@internal.gcimporter.exports_package.T13 target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.golang.org.x.tools.go.@internal.gcimporter.exports_package.T13 target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.golang.org.x.tools.go.@internal.gcimporter.exports_package.T13<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.golang.org.x.tools.go.@internal.gcimporter.exports_package.T13 target, Type type, out object? result)
        {
            try
            {
