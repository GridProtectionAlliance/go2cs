...
// package unsafeptr -- go2cs converted at 2020 October 09 06:04:20 UTC
...
namespace passes
{
    ...
    {
        public static readonly @string Doc = (@string)@"check for invalid conversions of uintptr to unsafe.Pointer
...
invisible to stack copying and to the garbage collector.";
        ...
        private static (object, error) run(ptr<analysis.Pass> _addr_pass)
        {
            ...
            inspect.Preorder(nodeFilter, n =>
            {
                ...
                if (hasBasicType(_addr_pass.TypesInfo, x.Fun, types.UnsafePointer) && hasBasicType(_addr_pass.TypesInfo, x.Args[0L], types.Uintptr) && !isSafeUintptr(_addr_pass.TypesInfo, x.Args[0L]))
                {
                ...
                case ptr<ast.CallExpr> x:
                    switch (len(x.Args))
                    {
                        ...
                        case 1L: 
                            ...
                            return hasBasicType(_addr_info, x.Fun, types.Uintptr) && hasBasicType(_addr_info, x.Args[0L], types.UnsafePointer);
                            break;
                    }
                    break;
