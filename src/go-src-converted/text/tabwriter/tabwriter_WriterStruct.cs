...
namespace text
{
    public static partial class tabwriter_package
    {
        ...
        public partial struct Writer
        {
            ...
            public Writer(io.Writer output = default, long minwidth = default, long tabwidth = default, long padding = default, array<byte> padbytes = default, ulong flags = default, bytes.Buffer buf = default, long pos = default, cell cell = default, byte endChar = default, slice<slice<cell>> lines = default, slice<long> widths = default)
            {
                this.output = output;
