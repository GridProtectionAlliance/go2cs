...
// package tabwriter -- go2cs converted at 2020 August 29 08:22:56 UTC
...
namespace text
{
    public static partial class tabwriter_package
    {
        ...
        public partial struct Writer
        {
            ...
            public bytes.Buffer buf; // collected text excluding tabs or line breaks
        ...
        private static void addLine(this ref Writer b)
        {
            b.lines = append(b.lines, new slice<cell>(new cell[] {  }));

        }

        // Reset the current state.
        private static void reset(this ref Writer b)
        {
            b.buf.Reset();
            b.pos = 0L;
            b.cell = new cell();
        ...
        public static readonly ulong FilterHTML = 1L << (int)(iota); 
        ...
        //
        private static ref Writer Init(this ref Writer _b, io.Writer output, long minwidth, long tabwidth, long padding, byte padchar, ulong flags) => func(_b, (ref Writer b, Defer _, Panic panic, Recover __) =>
        {
        ...
        private static void dump(this ref Writer b)
        {
            long pos = 0L;
        ...
        private static void write0(this ref Writer _b, slice<byte> buf) => func(_b, (ref Writer b, Defer _, Panic panic, Recover __) =>
        {
        ...
        private static void writeN(this ref Writer b, slice<byte> src, long n)
        {
            while (n > len(src))
            {
                b.write0(src);
        ...
        private static void writePadding(this ref Writer _b, long textw, long cellw, bool useTabs) => func(_b, (ref Writer b, Defer _, Panic panic, Recover __) =>
        {
        ...
        private static long writeLines(this ref Writer b, long pos0, long line0, long line1)
        {
            pos = pos0;
        ...
        //
        private static long format(this ref Writer b, long pos0, long line0, long line1)
        {
            pos = pos0;
        ...
        private static void append(this ref Writer b, slice<byte> text)
        {
            b.buf.Write(text);
        ...
        private static void updateWidth(this ref Writer b)
        {
        ...
        //
        public static readonly char Escape = '\xff';

        // Start escaped mode.


        // Start escaped mode.
        private static void startEscape(this ref Writer b, byte ch)
        {
        ...
        //
        private static void endEscape(this ref Writer b)
        {
        ...
        //
        private static long terminateCell(this ref Writer b, bool htab)
        {
            b.cell.htab = htab;
            var line = ref b.lines[len(b.lines) - 1L];
            line.Value = append(line.Value, b.cell);
            b.cell = new cell();
            return len(line.Value);
        }

        private static void handlePanic(ref error _err, @string op) => func(_err, (ref error err, Defer _, Panic panic, Recover __) =>
        {
            {
                var e = recover();
        ...
        private static error flush(this ref Writer _b) => func(_b, (ref Writer b, Defer defer, Panic _, Recover __) =>
        {
            defer(b.reset()); // even in the presence of errors
            defer(handlePanic(ref err, "Flush")); 
        ...
        //
        private static (long, error) Write(this ref Writer _b, slice<byte> buf) => func(_b, (ref Writer b, Defer defer, Panic _, Recover __) =>
        {
            defer(handlePanic(ref err, "Write")); 
        ...
        //
        public static ref Writer NewWriter(io.Writer output, long minwidth, long tabwidth, long padding, byte padchar, ulong flags)
        {
