...
namespace net
{
    public static partial class idna_package
    {
        ...
        public partial struct Profile
        {
            ...
            public ref bool checkHyphens => ref m_optionsRef.Value.checkHyphens;

            public ref bool checkJoiners => ref m_optionsRef.Value.checkJoiners;
            ...
            public ref Func<ptr<Profile>, @string, (@string, error)> mapping => ref m_optionsRef.Value.mapping;
