...
//
//     Generated on 2020 October 09 06:07:38 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace net
{
    public static partial class lif_package
    {
        ...
        private class binaryByteOrder<T> : binaryByteOrder
        {
            ...
            private delegate ulong PutUint64ByPtr(ptr<T> value, slice<byte> _p0, ulong _p0);
...
namespace go
{
    public static class lif_binaryByteOrderExtensions
    {
        ...
        public static T _<T>(this go.vendor.golang.org.x.net.lif_package.binaryByteOrder target)
        {
            try
            {
                return ((go.vendor.golang.org.x.net.lif_package.binaryByteOrder<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.vendor.golang.org.x.net.lif_package.binaryByteOrder target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.vendor.golang.org.x.net.lif_package.binaryByteOrder target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.vendor.golang.org.x.net.lif_package.binaryByteOrder<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.vendor.golang.org.x.net.lif_package.binaryByteOrder target, Type type, out object? result)
        {
            try
            {
