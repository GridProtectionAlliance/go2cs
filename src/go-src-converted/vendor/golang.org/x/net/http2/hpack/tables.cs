...
// package hpack -- go2cs converted at 2020 October 08 05:00:36 UTC
...
// entry with the same name and value. See above for a definition of "unique id".
        ...
        private static void init(this ptr<headerFieldTable> _addr_t)
        {
            ref headerFieldTable t = ref _addr_t.val;
        ...
        private static long len(this ptr<headerFieldTable> _addr_t)
        {
            ref headerFieldTable t = ref _addr_t.val;
        ...
        private static void addEntry(this ptr<headerFieldTable> _addr_t, HeaderField f)
        {
            ref headerFieldTable t = ref _addr_t.val;
        ...
        private static void evictOldest(this ptr<headerFieldTable> _addr_t, long n) => func((_, panic, __) =>
        {
            ref headerFieldTable t = ref _addr_t.val;
        ...
        //
        // See Section 2.3.3.
        private static (ulong, bool) search(this ptr<headerFieldTable> _addr_t, HeaderField f)
        {
            ulong i = default;
        ...
        // See Section 2.3.3.
        private static ulong idToIndex(this ptr<headerFieldTable> _addr_t, ulong id) => func((_, panic, __) =>
        {
            ref headerFieldTable t = ref _addr_t.val;
