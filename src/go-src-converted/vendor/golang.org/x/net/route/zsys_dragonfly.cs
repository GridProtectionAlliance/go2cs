...
namespace net
{
    public static partial class route_package
    {
        ...
        private static readonly ulong sysNET_RT_MAXID = (ulong)0x4UL;
        ...
        private static readonly ulong sysCTL_LWKT = (ulong)0xaUL;
        private static readonly ulong sysCTL_MAXID = (ulong)0xbUL;


        private static readonly ulong sysRTM_VERSION = (ulong)0x6UL;
        ...
        private static readonly ulong sysRTA_MPLS1 = (ulong)0x100UL;
        private static readonly ulong sysRTA_MPLS2 = (ulong)0x200UL;
        private static readonly ulong sysRTA_MPLS3 = (ulong)0x400UL;
        ...
        private static readonly ulong sysRTAX_MPLS1 = (ulong)0x8UL;
        private static readonly ulong sysRTAX_MPLS2 = (ulong)0x9UL;
        private static readonly ulong sysRTAX_MPLS3 = (ulong)0xaUL;
        private static readonly ulong sysRTAX_MAX = (ulong)0xbUL;


        private static readonly ulong sizeofIfMsghdrDragonFlyBSD4 = (ulong)0xb0UL;
        private static readonly ulong sizeofIfaMsghdrDragonFlyBSD4 = (ulong)0x14UL;
        private static readonly ulong sizeofIfmaMsghdrDragonFlyBSD4 = (ulong)0x10UL;
        private static readonly ulong sizeofIfAnnouncemsghdrDragonFlyBSD4 = (ulong)0x18UL;

        private static readonly ulong sizeofIfaMsghdrDragonFlyBSD58 = (ulong)0x18UL;

        private static readonly ulong sizeofRtMsghdrDragonFlyBSD4 = (ulong)0x98UL;
        private static readonly ulong sizeofRtMetricsDragonFlyBSD4 = (ulong)0x70UL;
