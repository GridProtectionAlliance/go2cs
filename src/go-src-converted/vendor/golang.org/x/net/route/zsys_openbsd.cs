...
namespace net
{
    public static partial class route_package
    {
        ...
        private static readonly ulong sysNET_RT_STATS = (ulong)0x4UL;
        private static readonly ulong sysNET_RT_TABLE = (ulong)0x5UL;
        private static readonly ulong sysNET_RT_IFNAMES = (ulong)0x6UL;
        private static readonly ulong sysNET_RT_MAXID = (ulong)0x7UL;
        ...
        private static readonly ulong sysCTL_FS = (ulong)0x3UL;
        ...
        private static readonly ulong sysCTL_VFS = (ulong)0xaUL;
        private static readonly ulong sysCTL_MAXID = (ulong)0xbUL;
        ...
        private static readonly ulong sysRTM_IFANNOUNCE = (ulong)0xfUL;
        private static readonly ulong sysRTM_DESYNC = (ulong)0x10UL;
        private static readonly ulong sysRTM_INVALIDATE = (ulong)0x11UL;
        private static readonly ulong sysRTM_BFD = (ulong)0x12UL;
        private static readonly ulong sysRTM_PROPOSAL = (ulong)0x13UL;
        ...
        private static readonly ulong sysRTA_SRC = (ulong)0x100UL;
        private static readonly ulong sysRTA_SRCMASK = (ulong)0x200UL;
        private static readonly ulong sysRTA_LABEL = (ulong)0x400UL;
        private static readonly ulong sysRTA_BFD = (ulong)0x800UL;
        private static readonly ulong sysRTA_DNS = (ulong)0x1000UL;
        private static readonly ulong sysRTA_STATIC = (ulong)0x2000UL;
        private static readonly ulong sysRTA_SEARCH = (ulong)0x4000UL;
        ...
        private static readonly ulong sysRTAX_SRC = (ulong)0x8UL;
        private static readonly ulong sysRTAX_SRCMASK = (ulong)0x9UL;
        private static readonly ulong sysRTAX_LABEL = (ulong)0xaUL;
        private static readonly ulong sysRTAX_BFD = (ulong)0xbUL;
        private static readonly ulong sysRTAX_DNS = (ulong)0xcUL;
        private static readonly ulong sysRTAX_STATIC = (ulong)0xdUL;
        private static readonly ulong sysRTAX_SEARCH = (ulong)0xeUL;
        private static readonly ulong sysRTAX_MAX = (ulong)0xfUL;


        private static readonly ulong sizeofRtMsghdr = (ulong)0x60UL;

        private static readonly ulong sizeofSockaddrStorage = (ulong)0x100UL;
