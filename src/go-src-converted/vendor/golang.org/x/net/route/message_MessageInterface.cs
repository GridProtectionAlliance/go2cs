...
//
//     Generated on 2020 October 08 05:01:38 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace net
{
    public static partial class route_package
    {
        ...
        public class Message<T> : Message
        {
            ...
            private delegate slice<Sys> SysByPtr(ptr<T> value);
            private delegate slice<Sys> SysByVal(T value);

            private static readonly SysByPtr s_SysByPtr;
            private static readonly SysByVal s_SysByVal;

            [DebuggerNonUserCode, MethodImpl(MethodImplOptions.AggressiveInlining)]
            public slice<Sys> Sys()
            {
                T target = m_target;
                ...
                if (s_SysByPtr is null || !m_target_is_ptr)
                    return s_SysByVal!(target);

                return s_SysByPtr(m_target_ptr);
            }
            ...
            static Message()
            {
               ...
               extensionMethod = targetTypeByPtr.GetExtensionMethod("Sys");
                ...
                if (s_SysByPtr is null && s_SysByVal is null)
                    throw new NotImplementedException($"{targetType.FullName} does not implement Message.Sys method", new Exception("Sys"));
            }
...
namespace go
{
    public static class route_MessageExtensions
    {
        private static readonly ConcurrentDictionary<Type, MethodInfo> s_conversionOperators = new ConcurrentDictionary<Type, MethodInfo>();

        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static T _<T>(this go.vendor.golang.org.x.net.route_package.Message target)
        {
            try
            {
                return ((go.vendor.golang.org.x.net.route_package.Message<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.vendor.golang.org.x.net.route_package.Message target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.vendor.golang.org.x.net.route_package.Message target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.vendor.golang.org.x.net.route_package.Message<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.vendor.golang.org.x.net.route_package.Message target, Type type, out object? result)
        {
            try
            {
