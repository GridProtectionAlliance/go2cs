...
namespace net
{
    public static partial class route_package
    {
        ...
        public partial struct InterfaceMulticastAddrMessage
        {
            ...
            public InterfaceMulticastAddrMessage(nint Version = default, nint Type = default, nint Flags = default, nint Index = default, slice<Addr> Addrs = default, slice<byte> raw = default)
            {
