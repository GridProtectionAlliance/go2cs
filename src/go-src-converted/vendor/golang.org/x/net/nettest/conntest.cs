...
// package nettest -- go2cs converted at 2020 October 08 05:01:30 UTC
...
namespace net
{
    public static partial class nettest_package
    {
        ...
        private static void timeoutWrapper(ptr<testing.T> _addr_t, MakePipe mp, connTester f) => func((defer, _, __) =>
        {
            ref testing.T t = ref _addr_t.val;
        ...
        private static void testPingPong(ptr<testing.T> _addr_t, net.Conn c1, net.Conn c2) => func((defer, _, __) =>
        {
            ref testing.T t = ref _addr_t.val;
...
;
        ...
        private static void testRacyRead(ptr<testing.T> _addr_t, net.Conn c1, net.Conn c2) => func((defer, _, __) =>
        {
            ref testing.T t = ref _addr_t.val;
        ...
        // immediately after cancelation has occurred.
        private static void testRacyWrite(ptr<testing.T> _addr_t, net.Conn c1, net.Conn c2) => func((defer, _, __) =>
        {
            ref testing.T t = ref _addr_t.val;
        ...
        private static void testPresentTimeout(ptr<testing.T> _addr_t, net.Conn c1, net.Conn c2) => func((defer, _, __) =>
        {
            ref testing.T t = ref _addr_t.val;
        ...
        private static void testFutureTimeout(ptr<testing.T> _addr_t, net.Conn c1, net.Conn c2) => func((defer, _, __) =>
        {
            ref testing.T t = ref _addr_t.val;
        ...
        // Read and Write operations.
        private static void testCloseTimeout(ptr<testing.T> _addr_t, net.Conn c1, net.Conn c2) => func((defer, _, __) =>
        {
            ref testing.T t = ref _addr_t.val;
        ...
        private static void testConcurrentMethods(ptr<testing.T> _addr_t, net.Conn c1, net.Conn c2) => func((defer, _, __) =>
        {
            ref testing.T t = ref _addr_t.val;
