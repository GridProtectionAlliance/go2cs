...
// package cryptobyte -- go2cs converted at 2020 October 08 05:00:01 UTC
// import "vendor/golang.org/x/crypto/cryptobyte" ==> using cryptobyte = go.vendor.golang.org.x.crypto.cryptobyte_package
// Original source: C:\Go\src\vendor\golang.org\x\crypto\cryptobyte\builder.go
...
namespace crypto
{
    public static partial class cryptobyte_package
    {
        ...
        private static (slice<byte>, error) Bytes(this ptr<Builder> _addr_b)
        {
            ...
            return (b.result[b.offset..], error.As(null!)!);

        }

        // BytesOrPanic returns the bytes written by the builder or panics if an error
        // has occurred during building.
        private static slice<byte> BytesOrPanic(this ptr<Builder> _addr_b) => func((_, panic, __) =>
        {
            ref Builder b = ref _addr_b.val;
        ...
        private static void addLengthPrefixed(this ptr<Builder> _addr_b, long lenLen, bool isASN1, BuilderContinuation f) => func((_, panic, __) =>
        {
            ref Builder b = ref _addr_b.val;
        ...
        private static void flushChild(this ptr<Builder> _addr_b) => func((_, panic, __) =>
        {
            ref Builder b = ref _addr_b.val;
            ...
            if (b.fixedSize && _addr_b.result[0L] != _addr_child.result[0L])
            {
        ...
        private static void add(this ptr<Builder> _addr_b, params byte[] bytes) => func((_, panic, __) =>
        {
            bytes = bytes.Clone();
            ref Builder b = ref _addr_b.val;
        ...
        // panic.
        private static void Unwrite(this ptr<Builder> _addr_b, long n) => func((_, panic, __) =>
        {
            ref Builder b = ref _addr_b.val;
