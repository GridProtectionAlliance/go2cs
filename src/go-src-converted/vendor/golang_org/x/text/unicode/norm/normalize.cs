...
// package norm -- go2cs converted at 2020 August 29 10:13:10 UTC
...
// import "golang_org/x/text/unicode/norm"
...
namespace unicode
{
    public static partial class norm_package
    {
        ...
        public static slice<byte> Bytes(this Form f, slice<byte> b)
        {
            ...
            copy(out, b[0L..n]);
            reorderBuffer rb = new reorderBuffer(f:*ft,src:src,nsrc:len(b),out:out,flushF:appendFlush);
            return doAppendInner(ref rb, n);
        }
        ...
        public static @string String(this Form f, @string s)
        {
            ...
            copy(out, s[0L..n]);
            reorderBuffer rb = new reorderBuffer(f:*ft,src:src,nsrc:len(s),out:out,flushF:appendFlush);
            return string(doAppendInner(ref rb, n));
        }
        ...
        public static bool IsNormal(this Form f, slice<byte> b)
        {
            ...
            reorderBuffer rb = new reorderBuffer(f:*ft,src:src,nsrc:len(b));
            rb.setFlusher(null, cmpNormalBytes);
            while (bp < len(b))
            {
                rb.@out = b[bp..];
                bp = decomposeSegment(ref rb, bp, true);
        ...
        private static bool cmpNormalBytes(ref reorderBuffer rb)
        {
            var b = rb.@out;
        ...
        public static bool IsNormalString(this Form f, @string s)
        {
            ...
            reorderBuffer rb = new reorderBuffer(f:*ft,src:src,nsrc:len(s));
        ...
        private static bool patchTail(ref reorderBuffer rb)
        {
            var (info, p) = lastRuneStart(ref rb.f, rb.@out);
        ...
        private static long appendQuick(ref reorderBuffer rb, long i)
        {
            if (rb.nsrc == i)
            {
                return i;
        ...
        public static slice<byte> doAppend(this Form f, slice<byte> @out, input src, long n)
        {
            ...
            if (len(out) == 0L)
            {
                ...
                reorderBuffer rb = new reorderBuffer(f:*ft,src:src,nsrc:n,out:out,flushF:appendFlush);
                return doAppendInner(ref rb, p);
            }
            rb = new reorderBuffer(f:*ft,src:src,nsrc:n);
            return doAppend(ref rb, out, 0L);
        }

        private static slice<byte> doAppend(ref reorderBuffer rb, slice<byte> @out, long p)
        {
        ...
        private static slice<byte> doAppendInner(ref reorderBuffer rb, long p)
        {
            {
                var n = rb.nsrc;
        ...
        private static (long, bool) quickSpan(this ref formInfo f, input src, long i, long end, bool atEOF)
        {
            byte lastCC = default;
        ...
        private static long lastBoundary(ref formInfo fd, slice<byte> b)
        {
            var i = len(b);
            var (info, p) = lastRuneStart(fd, b);
            if (p == -1L)
            {
                return -1L;
            }
        ...
        private static long decomposeSegment(ref reorderBuffer rb, long sp, bool atEOF)
        { 
        ...
        private static (Properties, long) lastRuneStart(ref formInfo fd, slice<byte> buf)
        {
            var p = len(buf) - 1L;
        ...
        private static void decomposeToLastBoundary(ref reorderBuffer rb)
        {
            var fd = ref rb.f;
