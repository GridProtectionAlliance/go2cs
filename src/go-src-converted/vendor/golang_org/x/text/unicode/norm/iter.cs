...
// package norm -- go2cs converted at 2020 August 29 10:13:07 UTC
...
namespace unicode
{
    public static partial class norm_package
    {
        ...
        public delegate  slice<byte> iterFunc(ref Iter);

        // Init initializes i to iterate over src after normalizing it to Form f.
        private static void Init(this ref Iter i, Form f, slice<byte> src)
        {
            i.p = 0L;
            if (len(src) == 0L)
            {
        ...
        private static void InitString(this ref Iter i, Form f, @string src)
        {
            i.p = 0L;
            if (len(src) == 0L)
            {
        ...
        // start of a segment.
        private static (long, error) Seek(this ref Iter i, long offset, long whence)
        {
            long abs = default;
            switch (whence)
            {
                ...
                case 2L: 
                    ...
                    break;
                default: 
                    return (0L, fmt.Errorf("norm: invalid whence"));
                    break;
            }
            if (abs < 0L)
            {
                return (0L, fmt.Errorf("norm: negative position"));
            }
            if (int(abs) >= i.rb.nsrc)
            {
                i.setDone();
                return (int64(i.p), null);
            }
            i.p = int(abs);
            i.multiSeg = null;
            i.next = i.rb.f.nextMain;
        ...
        // and return that.
        private static slice<byte> returnSlice(this ref Iter i, long a, long b)
        {
        ...
        private static long Pos(this ref Iter i)
        {
            return i.p;
        }

        private static void setDone(this ref Iter i)
        {
            i.next = nextDone;
            i.p = i.rb.nsrc;
        }
        ...
        private static bool Done(this ref Iter i)
        {
        ...
        private static slice<byte> Next(this ref Iter i)
        {
            return i.next(i);
        }

        private static slice<byte> nextASCIIBytes(ref Iter i)
        {
            var p = i.p + 1L;
            if (p >= i.rb.nsrc)
            {
        ...
        private static slice<byte> nextASCIIString(ref Iter i)
        {
            var p = i.p + 1L;
            if (p >= i.rb.nsrc)
            {
        ...
        private static slice<byte> nextHangul(ref Iter i)
        {
            var p = i.p;
        ...
        private static slice<byte> nextDone(ref Iter i)
        {
            return null;
        }
        ...
        private static slice<byte> nextMulti(ref Iter i)
        {
            long j = 0L;
            var d = i.multiSeg; 
            // skip first rune
        ...
        private static slice<byte> nextMultiNorm(ref Iter i)
        {
            long j = 0L;
            var d = i.multiSeg;
            while (j < len(d))
        ...
        private static slice<byte> nextDecomposed(ref Iter i)
        {
            long outp = 0L;
            var inCopyStart = i.p;
...
doNorm:
        ...
        private static slice<byte> doNormDecomposed(ref Iter i)
        {
            while (true)
            {
        ...
        private static slice<byte> nextCGJDecompose(ref Iter i)
        {
            i.rb.ss = 0L;
            i.rb.insertCGJ();
            i.next = nextDecomposed;
            i.rb.ss.first(i.info);
            var buf = doNormDecomposed(i);
            return buf;
        }

        // nextComposed is the implementation of Next for forms NFC and NFKC.
        private static slice<byte> nextComposed(ref Iter i)
        {
            long outp = 0L;
            var startp = i.p;
            byte prevCC = default;
...
doNorm:
        ...
        private static slice<byte> doNormComposed(ref Iter i)
        { 
        ...
        private static slice<byte> nextCGJCompose(ref Iter i)
        {
