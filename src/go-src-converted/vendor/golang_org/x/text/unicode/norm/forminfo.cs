...
namespace unicode
{
    public static partial class norm_package
    {
        ...
        private static readonly ulong qcInfoMask = 0x3FUL; // to clear all but the relevant bits in a qcInfo
        private static readonly ulong headerLenMask = 0x3FUL; // extract the length value from the header byte
        private static readonly ulong headerFlagsMask = 0xC0UL; // extract the qcInfo bits from the header byte
        ...
        private static ref formInfo formTable = new slice<ref formInfo>(new ref formInfo[] { {form:NFC,composing:true,compatibility:false,info:lookupInfoNFC,nextMain:nextComposed,}, {form:NFD,composing:false,compatibility:false,info:lookupInfoNFC,nextMain:nextDecomposed,}, {form:NFKC,composing:true,compatibility:true,info:lookupInfoNFKC,nextMain:nextComposed,}, {form:NFKD,composing:false,compatibility:true,info:lookupInfoNFKC,nextMain:nextDecomposed,} });
