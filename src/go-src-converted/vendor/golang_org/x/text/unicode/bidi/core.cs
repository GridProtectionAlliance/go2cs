...
// package bidi -- go2cs converted at 2020 August 29 10:12:51 UTC
// import "vendor/golang_org/x/text/unicode/bidi" ==> using bidi = go.vendor.golang_org.x.text.unicode.bidi_package
// Original source: C:\Go\src\vendor\golang_org\x\text\unicode\bidi\core.go
...
namespace unicode
{
    public static partial class bidi_package
    {
        ...
        private static readonly level implicitLevel = -1L;
...
// matchingIsolateInitiator will be set to -1.
        ...
        private static ref paragraph newParagraph(slice<Class> types, slice<bracketType> pairTypes, slice<int> pairValues, level levels)
        {
            validateTypes(types);
            ...
            paragraph p = ref new paragraph(initialTypes:append([]Class(nil),types...),embeddingLevel:levels,pairTypes:pairTypes,pairValues:pairValues,resultTypes:append([]Class(nil),types...),);
            p.run();
            return p;
        }

        private static long Len(this ref paragraph p)
        {
        ...
        private static void run(this ref paragraph p)
        {
        ...
        //    it is set to -1.
        private static void determineMatchingIsolates(this ref paragraph p)
        {
        ...
        private static level determineParagraphEmbeddingLevel(this ref paragraph p, long start, long end)
        {
        ...
        private static readonly long maxDepth = 125L;
        ...
        private static void empty(this ref directionalStatusStack s)
        {
            s.stackCounter = 0L;

        }
        private static void pop(this ref directionalStatusStack s)
        {
            s.stackCounter--;

        }
        private static long depth(this ref directionalStatusStack s)
        {
            return s.stackCounter;
        }

        private static void push(this ref directionalStatusStack s, level level, Class overrideStatus, bool isolateStatus)
        {
        ...
        private static level lastEmbeddingLevel(this ref directionalStatusStack s)
        {
            return s.embeddingLevelStack[s.stackCounter - 1L];
        }

        private static Class lastDirectionalOverrideStatus(this ref directionalStatusStack s)
        {
            return s.overrideStatusStack[s.stackCounter - 1L];
        }

        private static bool lastDirectionalIsolateStatus(this ref directionalStatusStack s)
        {
            return s.isolateStatusStack[s.stackCounter - 1L];
        }

        // Determine explicit levels using rules X1 - X8
        private static void determineExplicitEmbeddingLevels(this ref paragraph p)
        {
        ...
        private static long Len(this ref isolatingRunSequence i)
        {
        ...
        private static ref isolatingRunSequence isolatingRunSequence(this ref paragraph p, slice<long> indexes)
        {
            ...
            return ref new isolatingRunSequence(p:p,indexes:indexes,types:types,level:level,sos:typeForLevel(maxLevel(prevLevel,level)),eos:typeForLevel(maxLevel(succLevel,level)),);
        }
        ...
        // complete.
        private static void resolveWeakTypes(this ref isolatingRunSequence s)
        {
            ...
            // Rule W1.
            // Changes all NSMs.
            var preceedingCharacterType = s.sos;
            {
                var i__prev1 = i;
                var t__prev1 = t;
        ...
        private static void resolveNeutralTypes(this ref isolatingRunSequence s)
        {
        ...
        private static void resolveImplicitLevels(this ref isolatingRunSequence s)
        {
            // on entry, only these types can be in resultTypes
        ...
        // resultLevels array.
        private static void applyLevelsAndTypes(this ref isolatingRunSequence s)
        {
        ...
        private static long findRunLimit(this ref isolatingRunSequence s, long index, params Class[] validSet)
        {
loop:
        ...
        // provided set.
        private static void assertOnly(this ref isolatingRunSequence s, params Class[] codes)
        {
loop:
            foreach (var (i, t) in s.types)
            {
        ...
        private static slice<slice<long>> determineLevelRuns(this ref paragraph p)
        {
        ...
        private static slice<ref isolatingRunSequence> determineIsolatingRunSequences(this ref paragraph p)
        {
            ...
            ref isolatingRunSequence sequences = new slice<ref isolatingRunSequence>(new ref isolatingRunSequence[] {  });
        ...
        private static void assignLevelsToCharactersRemovedByX9(this ref paragraph p)
        {
            {
                var i__prev1 = i;
        ...
        private static slice<level> getLevels(this ref paragraph p, slice<long> linebreaks)
        { 
        ...
        // in strictly increasing order (no duplicates) between 1 and the length of
        // the text, inclusive. The last value must be the length of the text.
        private static slice<long> getReordering(this ref paragraph p, slice<long> linebreaks)
        {
            validateLineBreaks(linebreaks, p.Len());
