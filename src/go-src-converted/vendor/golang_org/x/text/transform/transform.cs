...
// package transform -- go2cs converted at 2020 August 29 10:12:46 UTC
// import "vendor/golang_org/x/text/transform" ==> using transform = go.vendor.golang_org.x.text.transform_package
// Original source: C:\Go\src\vendor\golang_org\x\text\transform\transform.go
// import "golang_org/x/text/transform"
...
// regardless of whether or not it was successful.
        ...
        // NewReader returns a new Reader that wraps r by transforming the bytes read
        // via t. It calls Reset on t.
        public static ref Reader NewReader(io.Reader r, Transformer t)
        {
            t.Reset();
            return ref new Reader(r:r,t:t,dst:make([]byte,defaultBufSize),src:make([]byte,defaultBufSize),);
        }
        ...
        // via t. It calls Reset on t.
        public static ref Writer NewWriter(io.Writer w, Transformer t)
        {
            t.Reset();
            return ref new Writer(w:w,t:t,dst:make([]byte,defaultBufSize),src:make([]byte,defaultBufSize),);
        }
...
// errStart > 0, chain will not consume any more source bytes.
        ...
        private static void fatalError(this ref chain c, long errIndex, error err)
        {
            {
                var i = errIndex + 1L;
        ...
        private static slice<byte> src(this ref link l)
        {
            return l.b[l.p..l.n];
        }

        private static slice<byte> dst(this ref link l)
        {
            return l.b[l.n..];
        }
        ...
        public static Transformer Chain(params Transformer[] t)
        {
            ...
            chain c = ref new chain(link:make([]link,len(t)+1));
            {
                var i__prev1 = i;
        ...
        private static void Reset(this ref chain c)
        {
        ...
        private static (long, long, error) Transform(this ref chain c, slice<byte> dst, slice<byte> src, bool atEOF)
        { 
            // Set up src and dst in the chain.
            var srcL = ref c.link[0L];
            var dstL = ref c.link[len(c.link) - 1L];
            srcL.b = src;
            srcL.p = 0L;
            srcL.n = len(src);
            dstL.b = dst;
 ...
 // for detecting progress
        ...
        private static readonly long initialBufSize = 128L;
