...
//
//     Generated on 2020 August 29 10:12:34 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace net
{
    public static partial class route_package
    {
        ...
        public class Sys<T> : Sys
        {
            ...
            private delegate SysType SysTypeByRef(ref T value);
            private delegate SysType SysTypeByVal(T value);

            private static readonly SysTypeByRef s_SysTypeByRef;
            ...
            public SysType SysType()
            {
                ...
                if (s_SysTypeByRef is null)
                    return s_SysTypeByVal!(target);

                return s_SysTypeByRef(ref target);
            }
            ...
            static Sys()
            {
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("SysType");

                if (!(extensionMethod is null))
                    s_SysTypeByRef = extensionMethod.CreateStaticDelegate(typeof(SysTypeByRef)) as SysTypeByRef;
                ...
                if (s_SysTypeByRef is null && s_SysTypeByVal is null)
...
namespace go
{
    public static class route_SysExtensions
    {
        ...
        public static T _<T>(this go.vendor.golang_org.x.net.route_package.Sys target)
        {
            try
            {
                return ((go.vendor.golang_org.x.net.route_package.Sys<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.vendor.golang_org.x.net.route_package.Sys target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.vendor.golang_org.x.net.route_package.Sys target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.vendor.golang_org.x.net.route_package.Sys<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.vendor.golang_org.x.net.route_package.Sys target, Type type, out object? result)
        {
            try
            {
