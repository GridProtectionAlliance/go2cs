...
namespace net
{
    public static partial class route_package
    {
        ...
        private static readonly ulong sizeofIfMsghdrFreeBSD7 = 0x70UL;
        private static readonly ulong sizeofIfMsghdrFreeBSD8 = 0x70UL;
        private static readonly ulong sizeofIfMsghdrFreeBSD9 = 0x70UL;
        private static readonly ulong sizeofIfMsghdrFreeBSD10 = 0x70UL;
        private static readonly ulong sizeofIfMsghdrFreeBSD11 = 0xa8UL;

        private static readonly ulong sizeofIfDataFreeBSD7 = 0x60UL;
        private static readonly ulong sizeofIfDataFreeBSD8 = 0x60UL;
        private static readonly ulong sizeofIfDataFreeBSD9 = 0x60UL;
        private static readonly ulong sizeofIfDataFreeBSD10 = 0x60UL;
        private static readonly ulong sizeofIfDataFreeBSD11 = 0x98UL;

        private static readonly ulong sizeofIfMsghdrlFreeBSD10Emu = 0x68UL;
        private static readonly ulong sizeofIfaMsghdrFreeBSD10Emu = 0x14UL;
        private static readonly ulong sizeofIfaMsghdrlFreeBSD10Emu = 0x6cUL;
        ...
        private static readonly ulong sizeofRtMsghdrFreeBSD10Emu = 0x5cUL;
        private static readonly ulong sizeofRtMetricsFreeBSD10Emu = 0x38UL;

        private static readonly ulong sizeofIfMsghdrFreeBSD7Emu = 0x70UL;
        private static readonly ulong sizeofIfMsghdrFreeBSD8Emu = 0x70UL;
        private static readonly ulong sizeofIfMsghdrFreeBSD9Emu = 0x70UL;
        private static readonly ulong sizeofIfMsghdrFreeBSD10Emu = 0x70UL;
        private static readonly ulong sizeofIfMsghdrFreeBSD11Emu = 0xa8UL;

        private static readonly ulong sizeofIfDataFreeBSD7Emu = 0x60UL;
        private static readonly ulong sizeofIfDataFreeBSD8Emu = 0x60UL;
        private static readonly ulong sizeofIfDataFreeBSD9Emu = 0x60UL;
        private static readonly ulong sizeofIfDataFreeBSD10Emu = 0x60UL;
