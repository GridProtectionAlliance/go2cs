...
namespace net
{
    public static partial class route_package
    {
        ...
        public class Message<T> : Message
        {
            ...
            private delegate slice<Sys> SysByRef(ref T value);
...
namespace go
{
    public static class route_MessageExtensions
    {
        ...
        public static T _<T>(this go.vendor.golang_org.x.net.route_package.Message target)
        {
            try
            {
                return ((go.vendor.golang_org.x.net.route_package.Message<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.vendor.golang_org.x.net.route_package.Message target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.vendor.golang_org.x.net.route_package.Message target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.vendor.golang_org.x.net.route_package.Message<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.vendor.golang_org.x.net.route_package.Message target, Type type, out object? result)
        {
            try
            {
