...
//
//     Generated on 2020 August 29 10:11:43 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace http2
{
    public static partial class hpack_package
    {
        ...
        private partial struct node
        {
            ...
            public node(slice<ref node> children = default, byte codeLen = default, byte sym = default)
            {
        ...
        {
            return new node(value.children, value.codeLen, value.sym);
        }
    }
}}}}}}