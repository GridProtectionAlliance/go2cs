...
namespace http2
{
    public static partial class hpack_package
    {
        ...
        public partial struct Decoder
        {
            ...
            public Decoder(dynamicTable dynTab = default, Action<HeaderField> emit = default, bool emitEnabled = default, long maxStrLen = default, slice<byte> buf = default, bytes.Buffer saveBuf = default)
            {
                this.dynTab = dynTab;
                this.emit = emit;
        ...
        {
            return new Decoder(value.dynTab, value.emit, value.emitEnabled, value.maxStrLen, value.buf, value.saveBuf);
        }
    }
}}}}}}