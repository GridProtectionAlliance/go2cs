...
namespace net
{
    public static partial class lif_package
    {
        ...
        private class binaryByteOrder<T> : binaryByteOrder
        {
            ...
            private delegate ulong PutUint64ByRef(ref T value, slice<byte> _p0, ulong _p0);
            private delegate ulong PutUint64ByVal(T value, slice<byte> _p0, ulong _p0);

            private static readonly PutUint64ByRef s_PutUint64ByRef;
            private static readonly PutUint64ByVal s_PutUint64ByVal;

            [DebuggerNonUserCode, MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ulong PutUint64(slice<byte> _p0, ulong _p0)
            {
                T target = m_target;
            ...
            static binaryByteOrder()
            {
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("PutUint64");
                ...
                if (s_PutUint64ByRef is null && s_PutUint64ByVal is null)
                    throw new NotImplementedException($"{targetType.FullName} does not implement binaryByteOrder.PutUint64 method", new Exception("PutUint64"));
            }
...
namespace go
{
    public static class lif_binaryByteOrderExtensions
    {
        private static readonly ConcurrentDictionary<Type, MethodInfo> s_conversionOperators = new ConcurrentDictionary<Type, MethodInfo>();

        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static T _<T>(this go.vendor.golang_org.x.net.lif_package.binaryByteOrder target)
        {
            try
            {
                return ((go.vendor.golang_org.x.net.lif_package.binaryByteOrder<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.vendor.golang_org.x.net.lif_package.binaryByteOrder target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.vendor.golang_org.x.net.lif_package.binaryByteOrder target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.vendor.golang_org.x.net.lif_package.binaryByteOrder<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.vendor.golang_org.x.net.lif_package.binaryByteOrder target, Type type, out object? result)
        {
            try
            {
