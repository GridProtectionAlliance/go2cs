...
//
//     Generated on 2020 August 29 10:12:14 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace go
{
    public static class lif_AddrExtensions
    {
        ...
        public static T _<T>(this go.vendor.golang_org.x.net.lif_package.Addr target)
        {
            try
            {
                return ((go.vendor.golang_org.x.net.lif_package.Addr<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.vendor.golang_org.x.net.lif_package.Addr target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.vendor.golang_org.x.net.lif_package.Addr target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.vendor.golang_org.x.net.lif_package.Addr<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.vendor.golang_org.x.net.lif_package.Addr target, Type type, out object? result)
        {
            try
            {
