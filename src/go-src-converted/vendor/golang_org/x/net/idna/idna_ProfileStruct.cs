...
namespace net
{
    public static partial class idna_package
    {
        ...
        public partial struct Profile
        {
            ...
            public ref Func<ref Profile, @string, error> fromPuny => ref m_optionsRef.Value.fromPuny;

            public ref Func<ref Profile, @string, (@string, bool, error)> mapping => ref m_optionsRef.Value.mapping;
