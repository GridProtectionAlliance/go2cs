...
// package idna -- go2cs converted at 2020 August 29 10:11:47 UTC
// import "vendor/golang_org/x/net/idna" ==> using idna = go.vendor.golang_org.x.net.idna_package
// Original source: C:\Go\src\vendor\golang_org\x\net\idna\idna.go
// import "golang_org/x/text/internal/export/idna"
...
;
        ...
        private partial struct options
        {
            ...
            public Func<ref Profile, @string, error> fromPuny; // mapping implements a validation and mapping step as defined in RFC 5895
// or UTS 46, tailored to, for example, domain registration or lookup.
            public Func<ref Profile, @string, (@string, bool, error)> mapping; // bidirule, if specified, checks whether s conforms to the Bidi Rule
// defined in RFC 5893.
        ...
        private static void apply(ref options o, slice<Option> opts)
        {
        ...
        // options.
        public static ref Profile New(params Option[] o)
        {
            o = o.Clone();

            Profile p = ref new Profile();
            apply(ref p.options, o);
            return p;
        }
        ...
        private static (@string, error) ToASCII(this ref Profile p, @string s)
        {
        ...
        // an error and a (partially) processed result.
        private static (@string, error) ToUnicode(this ref Profile p, @string s)
        {
            var pp = p.Value;
        ...
        // of validation.
        public static ref Profile Punycode = punycode;        public static ref Profile Lookup = lookup;        public static ref Profile Display = display;        public static ref Profile Registration = registration;        private static Profile punycode = ref new Profile();        private static Profile lookup = ref new Profile(options{transitional:true,useSTD3Rules:true,validateLabels:true,trie:trie,fromPuny:validateFromPunycode,mapping:validateAndMap,bidirule:bidirule.ValidString,});        private static Profile display = ref new Profile(options{useSTD3Rules:true,validateLabels:true,trie:trie,fromPuny:validateFromPunycode,mapping:validateAndMap,bidirule:bidirule.ValidString,});        private static Profile registration = ref new Profile(options{useSTD3Rules:true,validateLabels:true,verifyDNSLength:true,trie:trie,fromPuny:validateFromPunycode,mapping:validateRegistration,bidirule:bidirule.ValidString,});
        ...
        private static (@string, error) process(this ref Profile p, @string s, bool toASCII)
        {
            error err = default;
            bool isBidi = default;
            if (p.mapping != null)
            ...
            {
                err = error.As(ref new labelError(s,"A4"));
            }
            ...
            if (isBidi && p.bidirule != null && err == null)
            {
                ...
                while (!labels.done())
                {
                    ...
                    {
                        err = error.As(ref new labelError(s,"B"));
                        break;
                    labels.next();
                    }
                }
            ...
            if (toASCII)
            {
                ...
                while (!labels.done())
                {
                    ...
                    {
                        err = error.As(ref new labelError(label,"A4"));
                    }
                }
        ...
        private static (@string, bool, error) normalize(ref Profile p, @string s)
        { 
            ...
            return (mapped, isBidi, null);
        }

        private static (@string, bool, error) validateRegistration(ref Profile p, @string s)
        { 
            // TODO: filter need for normalization in loop below.
            if (!norm.NFC.IsNormalString(s))
            {
                return (s, false, ref new labelError(s,"V1"));
            }
            {
                long i = 0L;
        ...
        private static (@string, bool, error) validateAndMap(ref Profile p, @string s)
        {
            slice<byte> b = default;            long k = default; 
            ...
            { 
                // No changes so far.
                if (combinedInfoBits & mayNeedNorm != 0L)
                {
                    s = norm.NFC.String(s);
                }
            }
        ...
        private static void reset(this ref labelIter l)
        {
            l.curStart = 0L;
            l.curEnd = 0L;
            l.i = 0L;
        ...
        private static bool done(this ref labelIter l)
        {
            return l.curStart >= len(l.orig);
        }

        private static @string result(this ref labelIter l)
        {
            if (l.slice != null)
            {
        ...
        private static @string label(this ref labelIter l)
        {
            if (l.slice != null)
            {
                return l.slice[l.i];
        ...
        private static void next(this ref labelIter l)
        {
            l.i++;
            if (l.slice != null)
            {
        ...
        private static void set(this ref labelIter l, @string s)
        {
            if (l.slice == null)
            {
        ...
        private static category simplify(this ref Profile p, category cat)
        {
        ...
        private static error validateFromPunycode(ref Profile p, @string s)
        {
            if (!norm.NFC.IsNormalString(s))
            {
                return error.As(ref new labelError(s,"V1"));
            } 
            ...
            // loop.
            {
                ...
                while (i < len(s))
                {
                    ...
                    }
                    {
                        ...
                        {
                            return error.As(ref new labelError(s,"V6"));
                        }
        ...
        private static error validateLabel(this ref Profile p, @string s)
        {
            if (s == "")
            {
                if (p.verifyDNSLength)
                {
                    return error.As(ref new labelError(s,"A4"));
                }
                return error.As(null);
            }
            if (!p.validateLabels)
            ...
            {
                return error.As(ref new labelError(s,"V2"));
            }
            if (s[0L] == '-' || s[len(s) - 1L] == '-')
            {
                return error.As(ref new labelError(s,"V3"));
            } 
            ...
            if (x.isModifier())
            {
                return error.As(ref new labelError(s,"V5"));
            } 
            ...
            {
                return error.As(ref new labelError(s,"C"));
            }
            return error.As(null);
        }
