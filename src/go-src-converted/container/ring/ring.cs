...
//
private static ptr<Ring> Move(this ptr<Ring> _addr_r, nint n) {
    ref Ring r = ref _addr_r.val;
...
public static ptr<Ring> New(nint n) {
    if (n <= 0) {
        return _addr_null!;
    }
    ptr<Ring> r = @new<Ring>();
...
//
private static ptr<Ring> Unlink(this ptr<Ring> _addr_r, nint n) {
    ref Ring r = ref _addr_r.val;
...
//
private static nint Len(this ptr<Ring> _addr_r) {
    ref Ring r = ref _addr_r.val;
