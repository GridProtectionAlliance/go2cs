...
namespace @event
{
    public static partial class export_package
    {
        ...
        private partial struct contextKeyType // : long
        {
        }
        ...
        private static core.Event Finish(this ptr<Span> _addr_s) => func((defer, _, __) =>
        {
            ref Span s = ref _addr_s.val;
        ...
        private static slice<core.Event> Events(this ptr<Span> _addr_s) => func((defer, _, __) =>
        {
            ref Span s = ref _addr_s.val;
        ...
        private static void Format(this ptr<Span> _addr_s, fmt.State f, int r) => func((defer, _, __) =>
        {
            ref Span s = ref _addr_s.val;
