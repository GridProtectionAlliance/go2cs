...
// package main -- go2cs converted at 2022 March 06 23:33:40 UTC
...
private static void assert(bool b) => func((_, panic, _) => {
    if (!b) {
        panic("oops");
    }
});
...
public static nint add(this I i, nint x) {
    return int(i) + x;
}
...
private static nint get(this ptr<S> _addr_s) {
    ref S s = ref _addr_s.val;
