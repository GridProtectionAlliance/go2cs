...
namespace go
{
    public static partial class sort_package
    {
        ...
        //    }
        //
        public static long Search(long n, Func<long, bool> f)
        { 
            ...
            while (i < j)
            {
                var h = int(uint(i + j) >> (int)(1L)); // avoid overflow when computing h
                // i ≤ h < j
                if (!f(h))
                {
        ...
        public static long Search(this StringSlice p, @string x)
        {
