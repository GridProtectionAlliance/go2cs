...
namespace regexp
{
    public static partial class syntax_package
    {
        ...
        private partial struct parser
        {
            ...
            public parser(Flags flags = default, slice<ptr<Regexp>> stack = default, ref ptr<Regexp> free = default, nint numCap = default, @string wholeRegexp = default, slice<int> tmpClass = default)
            {
                this.flags = flags;
                this.stack = stack;
                this.free = free;
