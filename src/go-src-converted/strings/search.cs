...
// package strings -- go2cs converted at 2020 August 29 08:42:42 UTC
...
// goodSuffixSkip[3] == shift+len(suffix) == 6+5 == 11.
        ...
        private static ref stringFinder makeStringFinder(@string pattern)
        {
            stringFinder f = ref new stringFinder(pattern:pattern,goodSuffixSkip:make([]int,len(pattern)),); 
        ...
        private static long next(this ref stringFinder f, @string text)
        {
