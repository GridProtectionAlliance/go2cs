...
namespace go
{
    public static partial class strings_package
    {
        ...
        private static void copyCheck(this ptr<Builder> _addr_b) => func((_, panic, __) =>
        {
        ...
        private static long Len(this ptr<Builder> _addr_b)
        {
            ref Builder b = ref _addr_b.val;
        ...
        // already written.
        private static long Cap(this ptr<Builder> _addr_b)
        {
            ref Builder b = ref _addr_b.val;
        ...
        private static void grow(this ptr<Builder> _addr_b, long n)
        {
            ref Builder b = ref _addr_b.val;
        ...
        private static void Grow(this ptr<Builder> _addr_b, long n) => func((_, panic, __) =>
        {
            ref Builder b = ref _addr_b.val;
        ...
        private static (long, error) Write(this ptr<Builder> _addr_b, slice<byte> p)
        {
            long _p0 = default;
            error _p0 = default!;
            ref Builder b = ref _addr_b.val;
        ...
        private static (long, error) WriteRune(this ptr<Builder> _addr_b, int r)
        {
            long _p0 = default;
            error _p0 = default!;
            ref Builder b = ref _addr_b.val;
        ...
        private static (long, error) WriteString(this ptr<Builder> _addr_b, @string s)
        {
            long _p0 = default;
            error _p0 = default!;
            ref Builder b = ref _addr_b.val;
