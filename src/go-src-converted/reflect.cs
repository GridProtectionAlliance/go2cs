...
namespace ssa
{
    public static partial class interp_package
    {
        ...
        private static value ext۰reflect۰rtype۰Bits(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
 
            // Signature: func (t reflect.rtype) int
            rtype rt = args[0L]._<rtype>().t;
            ...
            return int(fr.i.sizes.Sizeof(basic)) * 8L;
        ...
        private static value ext۰reflect۰rtype۰Field(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            ptr<types.Struct> st = args[0L]._<rtype>().t.Underlying()._<ptr<types.Struct>>();
            long i = args[1L]._<long>();
            var f = st.Field(i);
        ...
        private static value ext۰reflect۰rtype۰Kind(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            return uint(reflectKind(args[0L]._<rtype>().t));
        ...
        private static value ext۰reflect۰rtype۰NumField(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            // Signature: func (t reflect.rtype) int
            return args[0L]._<rtype>().t.Underlying()._<ptr<types.Struct>>().NumFields();
        ...
        private static value ext۰reflect۰rtype۰NumIn(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            // Signature: func (t reflect.rtype) int
            return args[0L]._<rtype>().t._<ptr<types.Signature>>().Params().Len();
        ...
        private static value ext۰reflect۰rtype۰NumMethod(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            // Signature: func (t reflect.rtype) int
            return fr.i.prog.MethodSets.MethodSet(args[0L]._<rtype>().t).Len();
        ...
        private static value ext۰reflect۰rtype۰NumOut(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            // Signature: func (t reflect.rtype) int
            return args[0L]._<rtype>().t._<ptr<types.Signature>>().Results().Len();
        ...
        private static value ext۰reflect۰rtype۰Size(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            return uintptr(fr.i.sizes.Sizeof(args[0L]._<rtype>().t));
        ...
        private static value ext۰reflect۰rtype۰String(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            return args[0L]._<rtype>().t.String();
        ...
        private static value ext۰reflect۰New(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            rtype t = args[0L]._<iface>().v._<rtype>().t;
        ...
        private static reflect.Kind reflectKind(types.Type t) => func((_, panic, __) =>
        {
            switch (t.type())
            {
        ...
        private static value ext۰reflect۰Value۰Kind(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            return uint(reflectKind(rV2T(args[0L]).t));
        ...
        private static value ext۰reflect۰Value۰Type(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            return makeReflectType(rV2T(args[0L]));

        }

        private static value ext۰reflect۰Value۰Uint(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
 
            // Signature: func (reflect.Value) uint64
            switch (rV2V(args[0L]).type())
            {
                case ulong v:
                    return uint64(v);
                    break;
        ...
        private static value ext۰reflect۰Value۰Len(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
        ...
        private static value ext۰reflect۰Value۰MapIndex(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
 
            // Signature: func (reflect.Value) Value
            ptr<types.Map> tValue = rV2T(args[0L]).t.Underlying()._<ptr<types.Map>>().Key();
            var k = rV2V(args[1L]);
            switch (rV2V(args[0L]).type())
            {
        ...
        private static value ext۰reflect۰Value۰MapKeys(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
 
            // Signature: func (reflect.Value) []Value
            slice<value> keys = default;
            ptr<types.Map> tKey = rV2T(args[0L]).t.Underlying()._<ptr<types.Map>>().Key();
            switch (rV2V(args[0L]).type())
            {
                case map<value, value> v:
                    foreach (var (k) in v)
        ...
        private static value ext۰reflect۰Value۰NumField(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            // Signature: func (reflect.Value) int
            return len(rV2V(args[0L])._<structure>());
        ...
        private static value ext۰reflect۰Value۰NumMethod(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            // Signature: func (reflect.Value) int
            return fr.i.prog.MethodSets.MethodSet(rV2T(args[0L]).t).Len();

        }

        private static value ext۰reflect۰Value۰Pointer(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
        ...
        private static value ext۰reflect۰Value۰Index(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
 
            // Signature: func (v reflect.Value, i int) Value
            long i = args[1L]._<long>();
            var t = rV2T(args[0L]).t.Underlying();
            switch (rV2V(args[0L]).type())
            {
                case array v:
        ...
        private static value ext۰reflect۰Value۰Elem(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
            ...
            switch (rV2V(args[0L]).type())
            {
                case iface x:
                    ...
                    break;
                case ptr<value> x:
                    return makeReflectValue(rV2T(args[0L]).t.Underlying()._<ptr<types.Pointer>>().Elem(), x.val);
                    break;
                default:
                {
                    var x = rV2V(args[0L]).type();
        ...
        private static value ext۰reflect۰Value۰Float(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
        ...
        private static value ext۰reflect۰Value۰Int(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
        ...
        private static value ext۰reflect۰Value۰IsNil(ptr<frame> _addr_fr, slice<value> args) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
        ...
        private static value ext۰reflect۰valueInterface(ptr<frame> _addr_fr, slice<value> args)
        {
            ...
            structure v = args[0L]._<structure>();
