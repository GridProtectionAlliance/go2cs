...
namespace ssa
{
    ...
    {
        private partial struct continuation // : long
        {
        }
        ...
        private static value get(this ptr<frame> _addr_fr, ssa.Value key) => func((_, panic, __) =>
        {
        ...
        //
        private static void runDefer(this ptr<frame> _addr_fr, ptr<deferred> _addr_d) => func((defer, _, __) =>
        {
            ref frame fr = ref _addr_fr.val;
            ref deferred d = ref _addr_d.val;

            if (fr.i.mode & EnableTracing != 0L)
            {
        ...
        //
        private static void runDefers(this ptr<frame> _addr_fr) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
        ...
        private static continuation visitInstr(ptr<frame> _addr_fr, ssa.Instruction instr) => func((_, panic, __) =>
        {
            ref frame fr = ref _addr_fr.val;
            ...
            switch (instr.type())
            {
                ...
                case ptr<ssa.Return> instr:
                    switch (len(instr.Results))
                    {
                        case 0L: 
                            break;
                        case 1L: 
                            fr.result = fr.get(instr.Results[0L]);
                            break;
                        default: 
                ...
                case ptr<ssa.If> instr:
                    ...
                    fr.block = fr.block.Succs[succ];
                    return kJump;
                    break;
                case ptr<ssa.Jump> instr:
                    fr.prevBlock = fr.block;
                    fr.block = fr.block.Succs[0L];
                    return kJump;
                    break;
                ...
                case ptr<ssa.Go> instr:
                    (fn, args) = prepareCall(_addr_fr, _addr_instr.Call);
                    atomic.AddInt32(_addr_fr.i.goroutines, 1L);
                    go_(() => () =>
                    {
        ...
        //
        private static (value, slice<value>) prepareCall(ptr<frame> _addr_fr, ptr<ssa.CallCommon> _addr_call) => func((_, panic, __) =>
        {
            value fn = default;
        ...
        //
        private static value call(ptr<interpreter> _addr_i, ptr<frame> _addr_caller, token.Pos callpos, value fn, slice<value> args) => func((_, panic, __) =>
        {
            ref interpreter i = ref _addr_i.val;
        ...
        // control.
        //
        private static void runFrame(ptr<frame> _addr_fr) => func((defer, _, __) =>
        {
            ref frame fr = ref _addr_fr.val;
            ...
            defer(() =>
            {
                ...
                if (fr.i.mode & DisableRecover != 0L)
                {
...
block:
        ...
        private static value doRecover(ptr<frame> _addr_caller) => func((_, panic, __) =>
        {
            ref frame caller = ref _addr_caller.val;
            ...
            // "defer f() -> g() -> recover()".
            if (caller.i.mode & DisableRecover == 0L && caller != null && !caller.panicking && caller.caller != null && caller.caller.panicking)
            {
        ...
        private static void setGlobal(ptr<interpreter> _addr_i, ptr<ssa.Package> _addr_pkg, @string name, value v) => func((_, panic, __) =>
        {
            ref interpreter i = ref _addr_i.val;
        ...
        //
        public static long Interpret(ptr<ssa.Package> _addr_mainpkg, Mode mode, types.Sizes sizes, @string filename, slice<@string> args) => func((defer, panic, _) =>
        {
            ...
            defer(() =>
            {
                if (exitCode != 2L || i.mode & DisableRecover != 0L)
                {
                    return ;
                }
