...
namespace @internal
{
    public static partial class gocommand_package
    {
        ...
        // go.mod changes.
        private static (ptr<bytes.Buffer>, ptr<bytes.Buffer>, error, error) RunRaw(this ptr<Runner> _addr_runner, context.Context ctx, Invocation inv) => func((defer, _, __) =>
        {
            ptr<bytes.Buffer> _p0 = default!;
            ptr<bytes.Buffer> _p0 = default!;
            error _p0 = default!;
        ...
        private static error RunPiped(this ptr<Invocation> _addr_i, context.Context ctx, io.Writer stdout, io.Writer stderr) => func((defer, _, __) =>
        {
            ref Invocation i = ref _addr_i.val;
...
;
            ...
            switch (i.Verb)
            {
                case "mod": 
                    ...
                    goArgs = append(goArgs, i.Args[0L]);
                    goArgs = append(goArgs, i.BuildFlags);
                    goArgs = append(goArgs, i.Args[1L..]);
                    break;
                case "env": 
        ...
        private static error runCmdContext(context.Context ctx, ptr<exec.Cmd> _addr_cmd)
        {
            ...
            var resChan = make_channel<error>(1L);
            go_(() => () =>
            {
