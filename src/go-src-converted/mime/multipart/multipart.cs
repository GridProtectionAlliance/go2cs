...
*/
// package multipart -- go2cs converted at 2020 October 08 03:38:30 UTC
...
namespace mime
{
    public static partial class multipart_package
    {
        ...
        private static readonly long peekBufferSize = (long)4096L;
...
// Content-Transfer-Encoding
        ...
        private static (long, error) Read(this ptr<stickyErrorReader> _addr_r, slice<byte> p)
        {
            long n = default;
            error _ = default!;
        ...
        private static (ptr<Part>, error) newPart(ptr<Reader> _addr_mr, bool rawPart)
        {
            ...
            if (!rawPart)
            {
                const @string cte = (@string)"Content-Transfer-Encoding";
        ...
        private static (long, error) Read(this ptr<Part> _addr_p, slice<byte> d)
        {
            long n = default;
            error err = default!;
            ref Part p = ref _addr_p.val;
