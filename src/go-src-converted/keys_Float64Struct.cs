...
namespace @event
{
    public static partial class keys_package
    {
        ...
        {
            // Constructors
            public Float64(NilType _)
            {
                this.name = default;
                this.description = default;
            }

            public Float64(@string name = default, @string description = default)
            {
                this.name = name;
        ...
        [GeneratedCode("go2cs", "0.1.0.0")]
        public static Float64 Float64_cast(dynamic value)
        {
            return new Float64(value.name, value.description);
        }
    }
}}}}}}