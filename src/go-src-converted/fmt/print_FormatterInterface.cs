...
namespace go
{
    public static partial class fmt_package
    {
        ...
        public class Formatter<T> : Formatter
        {
            ...
            private delegate void FormatByPtr(ptr<T> value, State f, int verb);
            private delegate void FormatByVal(T value, State f, int verb);

            private static readonly FormatByPtr? s_FormatByPtr;
            private static readonly FormatByVal? s_FormatByVal;

            [DebuggerNonUserCode, MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void Format(State f, int verb)
            {
                T target = m_target;
                ...
                {
                    s_FormatByVal!(target, f, verb);
                    return;
                }

                s_FormatByPtr(m_target_ptr!, f, verb);
                return;
            }
