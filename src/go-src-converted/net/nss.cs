...
// package net -- go2cs converted at 2020 October 08 03:34:06 UTC
...
namespace go
{
    public static partial class net_package
    {
        ...
        private static ptr<nssConf> parseNSSConfFile(@string file) => func((defer, _, __) =>
        {
            ...
            conf.err = foreachLine(slurp, line =>
            {
                ...
                while (true)
                {
                    ...
                    if (len(srcs) > 0L && srcs[0L] == '[')
                    {
                        ...
                        if (err != null)
                        {
                            return _addr_errors.New("invalid criteria: " + string(srcs[1L..bclose]))!;
                        }
