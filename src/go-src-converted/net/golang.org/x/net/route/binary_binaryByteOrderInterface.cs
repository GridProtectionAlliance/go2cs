...
namespace go
{
    public static class route_binaryByteOrderExtensions
    {
        ...
        public static T _<T>(this go.golang.org.x.net.route_package.binaryByteOrder target)
        {
            try
            {
                return ((go.golang.org.x.net.route_package.binaryByteOrder<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.golang.org.x.net.route_package.binaryByteOrder target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.golang.org.x.net.route_package.binaryByteOrder target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.golang.org.x.net.route_package.binaryByteOrder<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.golang.org.x.net.route_package.binaryByteOrder target, Type type, out object? result)
        {
            try
            {
