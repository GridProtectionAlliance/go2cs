...
// package route -- go2cs converted at 2020 October 08 03:33:24 UTC
...
namespace net
{
    public static partial class route_package
    {
        ...
        private static (long, map<long, ptr<wireFormat>>) probeRoutingStack()
        {
            ...
            return (int(@unsafe.Sizeof(p)), /* TODO: Fix this in ScannerBase_Expression::ExitCompositeLit */ new map<long, ptr<wireFormat>>{sysRTM_ADD:rtm,sysRTM_DELETE:rtm,sysRTM_CHANGE:rtm,sysRTM_GET:rtm,sysRTM_LOSING:rtm,sysRTM_REDIRECT:rtm,sysRTM_MISS:rtm,sysRTM_LOCK:rtm,sysRTM_RESOLVE:rtm,sysRTM_NEWADDR:ifam,sysRTM_DELADDR:ifam,sysRTM_IFINFO:ifm,sysRTM_NEWMADDR:ifmam,sysRTM_DELMADDR:ifmam,sysRTM_IFANNOUNCE:ifanm,});
