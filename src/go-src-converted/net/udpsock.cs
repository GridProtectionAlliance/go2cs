...
private static (nint, ptr<UDPAddr>, error) ReadFromUDP(this ptr<UDPConn> _addr_c, slice<byte> b) {
    nint n = default;
...
private static (nint, ptr<UDPAddr>, error) readFromUDP(this ptr<UDPConn> _addr_c, slice<byte> b, ptr<UDPAddr> _addr_addr) {
    nint _p0 = default;
    ptr<UDPAddr> _p0 = default!;
    error _p0 = default!;
    ref UDPConn c = ref _addr_c.val;
    ...
    var (n, addr, err) = c.readFrom(b, addr);
    if (err != null) {
...
private static (nint, Addr, error) ReadFrom(this ptr<UDPConn> _addr_c, slice<byte> b) {
    nint _p0 = default;
    Addr _p0 = default;
    error _p0 = default!;
    ref UDPConn c = ref _addr_c.val;

    var (n, addr, err) = c.readFromUDP(b, addr(new UDPAddr()));
    if (addr == null) { 
...
private static (nint, nint, nint, ptr<UDPAddr>, error) ReadMsgUDP(this ptr<UDPConn> _addr_c, slice<byte> b, slice<byte> oob) {
    nint n = default;
    nint oobn = default;
    nint flags = default;
    ptr<UDPAddr> addr = default!;
...
private static (nint, error) WriteToUDP(this ptr<UDPConn> _addr_c, slice<byte> b, ptr<UDPAddr> _addr_addr) {
    nint _p0 = default;
    error _p0 = default!;
    ref UDPConn c = ref _addr_c.val;
    ref UDPAddr addr = ref _addr_addr.val;
...
private static (nint, error) WriteTo(this ptr<UDPConn> _addr_c, slice<byte> b, Addr addr) {
    nint _p0 = default;
    error _p0 = default!;
    ref UDPConn c = ref _addr_c.val;
...
// The packages golang.org/x/net/ipv4 and golang.org/x/net/ipv6 can be
// used to manipulate IP-level socket options in oob.
private static (nint, nint, error) WriteMsgUDP(this ptr<UDPConn> _addr_c, slice<byte> b, slice<byte> oob, ptr<UDPAddr> _addr_addr) {
    nint n = default;
    nint oobn = default;
    error err = default!;
    ref UDPConn c = ref _addr_c.val;
