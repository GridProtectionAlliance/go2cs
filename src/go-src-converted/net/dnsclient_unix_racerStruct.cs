...
namespace go
{
    public static partial class net_package
    {
        ...
        private partial struct racer
        {
            ...
            public racer(@string cname = default, slice<dnsRR> rrs = default, error error = default)
            {
                this.cname = cname;
                this.rrs = rrs;
                this.error = error;
            ...
            // Enable comparisons between nil and racer struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(racer value, NilType nil) => value.Equals(default(racer));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(racer value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, racer value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, racer value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator racer(NilType nil) => default(racer);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static racer racer_cast(dynamic value)
        {
            return new racer(value.cname, value.rrs, value.error);
        }
    }
}