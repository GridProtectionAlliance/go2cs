...
private static nuint Next(this ptr<Pipeline> _addr_p) {
...
private static void StartRequest(this ptr<Pipeline> _addr_p, nuint id) {
    ref Pipeline p = ref _addr_p.val;
...
private static void EndRequest(this ptr<Pipeline> _addr_p, nuint id) {
    ref Pipeline p = ref _addr_p.val;
...
// the request with the given id.
private static void StartResponse(this ptr<Pipeline> _addr_p, nuint id) {
    ref Pipeline p = ref _addr_p.val;
...
private static void EndResponse(this ptr<Pipeline> _addr_p, nuint id) {
    ref Pipeline p = ref _addr_p.val;
...
private partial struct sequencer {
    public sync.Mutex mu;
    public nuint id;
    public map<nuint, channel<object>> wait;
}

// Start waits until it is time for the event numbered id to begin.
// That is, except for the first event, it waits until End(id-1) has
// been called.
private static void Start(this ptr<sequencer> _addr_s, nuint id) {
    ...
    if (s.wait == null) {
        s.wait = make_map<nuint, channel<object>>();
    }
    s.wait[id] = c;
    s.mu.Unlock().Send(c);
...
private static void End(this ptr<sequencer> _addr_s, nuint id) => func((_, panic, _) => {
    ref sequencer s = ref _addr_s.val;
