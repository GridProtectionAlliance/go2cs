...
private static void set(this ptr<pipeDeadline> _addr_d, time.Time t) => func((defer, _, _) => {
...
private static channel<object> wait(this ptr<pipeDeadline> _addr_d) => func((defer, _, _) => {
    ref pipeDeadline d = ref _addr_d.val;
...
// Successful receive on rdRx is always followed by send on rdTx.
    ...
    public channel<nint> rdTx; // Used by local Write to interact with remote Read.
// Successful send on wrTx is always followed by receive on wrRx.
    public channel<slice<byte>> wrTx;
    public channel<nint> wrRx;
...
public static (Conn, Conn) Pipe() {
    ...
    var cn1 = make_channel<nint>();
    var cn2 = make_channel<nint>();
