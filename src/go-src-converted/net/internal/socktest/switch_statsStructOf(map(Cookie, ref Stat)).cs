...
namespace @internal
{
    public static partial class socktest_package
    {
        ...
        private partial struct stats
        {
            ...
            private readonly map<Cookie, ref Stat> m_value;

            public stats(map<Cookie, ref Stat> value) => m_value = value;

            // Enable implicit conversions between map<Cookie, ref Stat> and stats struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator stats(map<Cookie, ref Stat> value) => new stats(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator map<Cookie, ref Stat>(stats value) => value.m_value;
