...
namespace @internal
{
    public static partial class socktest_package
    {
        ...
        private static ptr<Status> sockso(this ptr<Switch> _addr_sw, long s) => func((defer, _, __) =>
        {
        ...
        private static ptr<Status> addLocked(this ptr<Switch> _addr_sw, long s, long family, long sotype, long proto)
        {
            ref Switch sw = ref _addr_sw.val;
