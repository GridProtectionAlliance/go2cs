...
namespace @internal
{
    public static partial class socktest_package
    {
        ...
        private static ref Status sockso(this ref Switch _sw, long s) => func(_sw, (ref Switch sw, Defer defer, Panic _, Recover __) =>
        {
            sw.smu.RLock();
        ...
        private static ref Status addLocked(this ref Switch sw, long s, long family, long sotype, long proto)
        {
            sw.once.Do(sw.init);
