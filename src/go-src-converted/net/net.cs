...
// A zero value for t means Write will not time out.
        ...
        private static (long, error) Read(this ptr<conn> _addr_c, slice<byte> b)
        {
            long _p0 = default;
            error _p0 = default!;
            ref conn c = ref _addr_c.val;
        ...
        private static (long, error) Write(this ptr<conn> _addr_c, slice<byte> b)
        {
            long _p0 = default;
            error _p0 = default!;
            ref conn c = ref _addr_c.val;
        ...
        private static error SetReadBuffer(this ptr<conn> _addr_c, long bytes)
        {
            ref conn c = ref _addr_c.val;
        ...
        private static error SetWriteBuffer(this ptr<conn> _addr_c, long bytes)
        {
            ref conn c = ref _addr_c.val;
...
// A zero value for t means WriteTo will not time out.
        ...
        private static long listenerBacklog()
        {
...
// The Error method panics if the error is nil.
        ...
        private static (long, error) Read(this ptr<Buffers> _addr_v, slice<byte> p)
        {
            long n = default;
            error err = default!;
            ref Buffers v = ref _addr_v.val;

            while (len(p) > 0L && len(v.val) > 0L)
            {
                var n0 = copy(p, (v.val)[0L]);
                v.consume(int64(n0));
                p = p[n0..];
                n += n0;
            }
