...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct timeoutWriter
        {
            ...
            public timeoutWriter(ResponseWriter w = default, Header h = default, bytes.Buffer wbuf = default, ref ptr<Request> req = default, sync.Mutex mu = default, bool timedOut = default, bool wroteHeader = default, nint code = default)
            {
                this.w = w;
                this.h = h;
                this.wbuf = wbuf;
