...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct http2PushPromiseFrame
        {
            ...
            // Constructors
            public http2PushPromiseFrame(NilType _)
            {
            ...
            public http2PushPromiseFrame(http2FrameHeader http2FrameHeader = default, uint PromiseID = default, slice<byte> headerFragBuf = default)
            {
            ...
            // Enable comparisons between nil and http2PushPromiseFrame struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(http2PushPromiseFrame value, NilType nil) => value.Equals(default(http2PushPromiseFrame));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(http2PushPromiseFrame value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, http2PushPromiseFrame value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, http2PushPromiseFrame value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator http2PushPromiseFrame(NilType nil) => default(http2PushPromiseFrame);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static http2PushPromiseFrame http2PushPromiseFrame_cast(dynamic value)
        {
            return new http2PushPromiseFrame(value.http2FrameHeader, value.PromiseID, value.headerFragBuf);
        }
    }
}}