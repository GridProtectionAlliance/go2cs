...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct httpError
        {
            ...
            public httpError(@string err = default, bool timeout = default)
            {
                this.err = err;
        ...
        [GeneratedCode("go2cs", "0.1.0.0")]
        private static httpError httpError_cast(dynamic value)
        {
            return new httpError(value.err, value.timeout);
        }
    }
}}