...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct http2RSTStreamFrame
        {
            ...
            // Constructors
            public http2RSTStreamFrame(NilType _)
            {
                this.m_http2FrameHeaderRef = new ptr<http2FrameHeader>(new http2FrameHeader(nil));
                this.ErrCode = default;
            }

            public http2RSTStreamFrame(http2FrameHeader http2FrameHeader = default, http2ErrCode ErrCode = default)
            {
                this.m_http2FrameHeaderRef = new ptr<http2FrameHeader>(http2FrameHeader);
                this.ErrCode = ErrCode;
            }

            // Enable comparisons between nil and http2RSTStreamFrame struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(http2RSTStreamFrame value, NilType nil) => value.Equals(default(http2RSTStreamFrame));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(http2RSTStreamFrame value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, http2RSTStreamFrame value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, http2RSTStreamFrame value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator http2RSTStreamFrame(NilType nil) => default(http2RSTStreamFrame);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static http2RSTStreamFrame http2RSTStreamFrame_cast(dynamic value)
        {
            return new http2RSTStreamFrame(value.http2FrameHeader, value.ErrCode);
        }
    }
}}