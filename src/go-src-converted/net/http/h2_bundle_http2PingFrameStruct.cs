...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct http2PingFrame
        {
            ...
            // Constructors
            public http2PingFrame(NilType _)
            {
                this.m_http2FrameHeaderRef = new ptr<http2FrameHeader>(new http2FrameHeader(nil));
                this.Data = default;
            }

            public http2PingFrame(http2FrameHeader http2FrameHeader = default, array<byte> Data = default)
            {
                this.m_http2FrameHeaderRef = new ptr<http2FrameHeader>(http2FrameHeader);
                this.Data = Data;
            }

            // Enable comparisons between nil and http2PingFrame struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(http2PingFrame value, NilType nil) => value.Equals(default(http2PingFrame));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(http2PingFrame value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, http2PingFrame value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, http2PingFrame value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator http2PingFrame(NilType nil) => default(http2PingFrame);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static http2PingFrame http2PingFrame_cast(dynamic value)
        {
            return new http2PingFrame(value.http2FrameHeader, value.Data);
        }
    }
}}