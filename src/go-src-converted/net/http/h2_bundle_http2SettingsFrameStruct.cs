...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct http2SettingsFrame
        {
            ...
            // Constructors
            public http2SettingsFrame(NilType _)
            {
                this.m_http2FrameHeaderRef = new ptr<http2FrameHeader>(new http2FrameHeader(nil));
                this.p = default;
            }

            public http2SettingsFrame(http2FrameHeader http2FrameHeader = default, slice<byte> p = default)
            {
                this.m_http2FrameHeaderRef = new ptr<http2FrameHeader>(http2FrameHeader);
                this.p = p;
            }

            // Enable comparisons between nil and http2SettingsFrame struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(http2SettingsFrame value, NilType nil) => value.Equals(default(http2SettingsFrame));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(http2SettingsFrame value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, http2SettingsFrame value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, http2SettingsFrame value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator http2SettingsFrame(NilType nil) => default(http2SettingsFrame);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static http2SettingsFrame http2SettingsFrame_cast(dynamic value)
        {
            return new http2SettingsFrame(value.http2FrameHeader, value.p);
        }
    }
}}