...
// package hpack -- go2cs converted at 2022 March 06 22:22:47 UTC
...
private static nint len(this ptr<headerFieldTable> _addr_t) {
    ref headerFieldTable t = ref _addr_t.val;
...
private static void evictOldest(this ptr<headerFieldTable> _addr_t, nint n) => func((_, panic, _) => {
    ref headerFieldTable t = ref _addr_t.val;
...
// See Section 2.3.3.
private static ulong idToIndex(this ptr<headerFieldTable> _addr_t, ulong id) => func((_, panic, _) => {
    ref headerFieldTable t = ref _addr_t.val;
