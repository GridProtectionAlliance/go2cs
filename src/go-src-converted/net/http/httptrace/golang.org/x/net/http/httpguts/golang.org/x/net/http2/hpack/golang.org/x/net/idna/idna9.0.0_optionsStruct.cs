...
namespace net
{
    public static partial class idna_package
    {
        ...
        private partial struct options
        {
            ...
            public options(bool transitional = default, bool useSTD3Rules = default, bool validateLabels = default, bool verifyDNSLength = default, bool removeLeadingDots = default, ref ptr<idnaTrie> trie = default, Func<ptr<Profile>, @string, error> fromPuny = default, Func<ptr<Profile>, @string, (@string, error)> mapping = default, Func<@string, bool> bidirule = default)
            {
