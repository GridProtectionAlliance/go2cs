...
// be called first.
public static context.Context WithClientTrace(context.Context ctx, ptr<ClientTrace> _addr_trace) => func((_, panic, _) => {
...
// If it returns an error, the client request is aborted with that error value.
    public Func<nint, textproto.MIMEHeader, error> Got1xxResponse; // DNSStart is called when a DNS lookup begins.
