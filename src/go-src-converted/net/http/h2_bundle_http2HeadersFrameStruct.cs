...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct http2HeadersFrame
        {
            ...
            // Constructors
            public http2HeadersFrame(NilType _)
            {
            ...
            public http2HeadersFrame(http2FrameHeader http2FrameHeader = default, http2PriorityParam Priority = default, slice<byte> headerFragBuf = default)
            {
            ...
            // Enable comparisons between nil and http2HeadersFrame struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(http2HeadersFrame value, NilType nil) => value.Equals(default(http2HeadersFrame));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(http2HeadersFrame value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, http2HeadersFrame value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, http2HeadersFrame value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator http2HeadersFrame(NilType nil) => default(http2HeadersFrame);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static http2HeadersFrame http2HeadersFrame_cast(dynamic value)
        {
            return new http2HeadersFrame(value.http2FrameHeader, value.Priority, value.headerFragBuf);
        }
    }
}}