...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct http2frameWriteResult
        {
            ...
            // Enable comparisons between nil and http2frameWriteResult struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(http2frameWriteResult value, NilType nil) => value.Equals(default(http2frameWriteResult));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(http2frameWriteResult value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, http2frameWriteResult value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, http2frameWriteResult value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator http2frameWriteResult(NilType nil) => default(http2frameWriteResult);
        }
