...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct http2MetaHeadersFrame
        {
            ...
            // Enable comparisons between nil and http2MetaHeadersFrame struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(http2MetaHeadersFrame value, NilType nil) => value.Equals(default(http2MetaHeadersFrame));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(http2MetaHeadersFrame value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, http2MetaHeadersFrame value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, http2MetaHeadersFrame value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator http2MetaHeadersFrame(NilType nil) => default(http2MetaHeadersFrame);
        }
