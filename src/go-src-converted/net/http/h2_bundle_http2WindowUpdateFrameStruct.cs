...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct http2WindowUpdateFrame
        {
            ...
            // Constructors
            public http2WindowUpdateFrame(NilType _)
            {
                this.m_http2FrameHeaderRef = new ptr<http2FrameHeader>(new http2FrameHeader(nil));
                this.Increment = default;
            }

            public http2WindowUpdateFrame(http2FrameHeader http2FrameHeader = default, uint Increment = default)
            {
                this.m_http2FrameHeaderRef = new ptr<http2FrameHeader>(http2FrameHeader);
                this.Increment = Increment;
            }

            // Enable comparisons between nil and http2WindowUpdateFrame struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(http2WindowUpdateFrame value, NilType nil) => value.Equals(default(http2WindowUpdateFrame));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(http2WindowUpdateFrame value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, http2WindowUpdateFrame value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, http2WindowUpdateFrame value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator http2WindowUpdateFrame(NilType nil) => default(http2WindowUpdateFrame);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static http2WindowUpdateFrame http2WindowUpdateFrame_cast(dynamic value)
        {
            return new http2WindowUpdateFrame(value.http2FrameHeader, value.Increment);
        }
    }
}}