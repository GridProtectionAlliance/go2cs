...
namespace net
{
    public static partial class http_package
    {
        ...
        // MaxIdleConnsPerHost.
        public static readonly long DefaultMaxIdleConnsPerHost = (long)2L;
        ...
        public partial struct Transport
        {
            ...
            public map<connectMethodKey, long> connsPerHost;
...
// DefaultMaxIdleConnsPerHost is used.
            public long MaxIdleConnsPerHost; // MaxConnsPerHost optionally limits the total number of
// connections per host, including connections in the dialing,
// active, and idle states. On limit violation, dials will block.
//
// Zero means no limit.
            public long MaxConnsPerHost; // IdleConnTimeout is the maximum amount of time an idle
...
// If zero, a default (currently 4KB) is used.
            public long WriteBufferSize; // ReadBufferSize specifies the size of the read buffer used
// when reading from the transport.
// If zero, a default (currently 4KB) is used.
            public long ReadBufferSize; // nextProtoOnce guards initialization of TLSNextProto and
...
// upgrades, set this to true.
        ...
        private static long writeBufferSize(this ptr<Transport> _addr_t)
        {
            ref Transport t = ref _addr_t.val;

            if (t.WriteBufferSize > 0L)
            {
        ...
        private static long readBufferSize(this ptr<Transport> _addr_t)
        {
            ref Transport t = ref _addr_t.val;

            if (t.ReadBufferSize > 0L)
            {
        ...
        private static void onceSetNextProtoDefaults(this ptr<Transport> _addr_t)
        {
            ...
            map<@string, RoundTripper> (altProto, _) = t.altProto.Load()._<map<@string, RoundTripper>>();
            {
                ...
                if (rv.IsValid() && rv.Type().Kind() == reflect.Struct && rv.Type().NumField() == 1L)
                {
                    {
                        var v = rv.Field(0L);
            ...
            // a +build go1.7 build tag:
            {
                ...
                {
                    const long h2max = (long)1L << (int)(32L) - 1L;
        ...
        private static (long, error) Read(this ptr<readTrackingBody> _addr_r, slice<byte> data)
        {
            long _p0 = default;
            error _p0 = default!;
        ...
        private static (ptr<Request>, error) rewindBody(ptr<Request> _addr_req)
        {
            ...
            if (req.Body == null || req.Body == NoBody || !req.Body._<ptr<readTrackingBody>>().didRead)
            {
        ...
        private static void cancelRequest(this ptr<Transport> _addr_t, cancelKey key, error err)
        {
            ref Transport t = ref _addr_t.val;
        ...
        private static long maxIdleConnsPerHost(this ptr<Transport> _addr_t)
        {
            ref Transport t = ref _addr_t.val;
        ...
        private static error tryPutIdleConn(this ptr<Transport> _addr_t, ptr<persistConn> _addr_pconn) => func((defer, _, __) =>
        {
            ref Transport t = ref _addr_t.val;
            ref persistConn pconn = ref _addr_pconn.val;
            ...
            if (t.IdleConnTimeout > 0L && pconn.alt == null)
            {
        ...
        private static bool queueForIdleConn(this ptr<Transport> _addr_t, ptr<wantConn> _addr_w) => func((defer, _, __) =>
        {
            ...
            // Look for most recently-used idle connection.
            {
                ...
                if (ok)
                {
                    var stop = false;
                    var delivered = false;
                    while (len(list) > 0L && !stop)
                    {
                        var pconn = list[len(list) - 1L]; 

                        // See whether this connection has been idle too long, considering
                        // only the wall time (the Round(0)), in case this is a laptop or VM
                        // coming out of suspend with previously cached idle connections.
                        var tooOld = !oldTime.IsZero() && pconn.idleAt.Round(0L).Before(oldTime);
                        if (tooOld)
                        { 
        ...
        private static bool removeIdleConn(this ptr<Transport> _addr_t, ptr<persistConn> _addr_pconn) => func((defer, _, __) =>
        {
            ref Transport t = ref _addr_t.val;
            ref persistConn pconn = ref _addr_pconn.val;
        ...
        private static void setReqCanceler(this ptr<Transport> _addr_t, cancelKey key, Action<error> fn) => func((defer, _, __) =>
        {
            ref Transport t = ref _addr_t.val;
        ...
        private static bool replaceReqCanceler(this ptr<Transport> _addr_t, cancelKey key, Action<error> fn) => func((defer, _, __) =>
        {
            ref Transport t = ref _addr_t.val;
...
// afterDial is called when the dial is completed or cancelled.
        ...
        private static long len(this ptr<wantConnQueue> _addr_q)
        {
        ...
        private static (ptr<persistConn>, error) getConn(this ptr<Transport> _addr_t, ptr<transportRequest> _addr_treq, connectMethod cm) => func((defer, _, __) =>
        {
        ...
        private static void queueForDial(this ptr<Transport> _addr_t, ptr<wantConn> _addr_w) => func((defer, _, __) =>
        {
            ref Transport t = ref _addr_t.val;
            ref wantConn w = ref _addr_w.val;

            w.beforeDial();
            if (t.MaxConnsPerHost <= 0L)
            {
                go_(() => t.dialConnFor(w));
                return ;
            }
...

            {
                ...
                if (n < t.MaxConnsPerHost)
                {
                    ...
                    {
                        t.connsPerHost = make_map<connectMethodKey, long>();
                    }

                    t.connsPerHost[w.key] = n + 1L;
                    go_(() => t.dialConnFor(w));
                    return ;
        ...
        private static void dialConnFor(this ptr<Transport> _addr_t, ptr<wantConn> _addr_w) => func((defer, _, __) =>
        {
            ref Transport t = ref _addr_t.val;
            ref wantConn w = ref _addr_w.val;
        ...
        private static error addTLS(this ptr<persistConn> _addr_pconn, @string name, ptr<httptrace.ClientTrace> _addr_trace)
        {
            ref persistConn pconn = ref _addr_pconn.val;
        ...
        private static (ptr<persistConn>, error) dialConn(this ptr<Transport> _addr_t, context.Context ctx, connectMethod cm) => func((defer, _, __) =>
        {
...
;
                ...
                if (ctx.Done() == null)
                {
                    var (newCtx, cancel) = context.WithTimeout(ctx, 1L * time.Minute);
                    defer(cancel());
                    connectCtx = newCtx;
                }
                ...
                if (resp.StatusCode != 200L)
                {
                    ...
                    return (_addr_null!, error.As(errors.New(f[1L]))!);
                ...
                {
                    {
                        ...
                        if (ok)
                        {
                            ...
                            {
                                http2erringRoundTripper (e, ok) = alt._<http2erringRoundTripper>();

                                if (ok)
                                { 
                                    // pconn.conn was closed by next (http2configureTransport.upgradeFn).
                                    return (_addr_null!, error.As(e.err)!);
...
// original Request given to RoundTrip is not modified)
        ...
        private static (long, error) Read(this ptr<persistConn> _addr_pc, slice<byte> p)
        {
            long n = default;
            error err = default!;
            ref persistConn pc = ref _addr_pc.val;
            ...
            if (pc.readLimit <= 0L)
            {
                return (0L, error.As(fmt.Errorf("read limit of %d bytes exhausted", pc.maxHeaderResponseSize()))!);
            }
        ...
        private static error canceled(this ptr<persistConn> _addr_pc) => func((defer, _, __) =>
        {
            ref persistConn pc = ref _addr_pc.val;
        ...
        private static httptrace.GotConnInfo gotIdleConnTrace(this ptr<persistConn> _addr_pc, time.Time idleAt) => func((defer, _, __) =>
        {
        ...
        private static void cancelRequest(this ptr<persistConn> _addr_pc, error err) => func((defer, _, __) =>
        {
            ref persistConn pc = ref _addr_pc.val;
        ...
        // own goroutine.
        private static void closeConnIfStillIdle(this ptr<persistConn> _addr_pc) => func((defer, _, __) =>
        {
            ref persistConn pc = ref _addr_pc.val;
        ...
        private static void readLoop(this ptr<persistConn> _addr_pc) => func((defer, _, __) =>
        {
            ref persistConn pc = ref _addr_pc.val;
...
; 
            ...
            while (alive)
            {
                ...
                if (resp.Close || rc.req.Close || resp.StatusCode <= 199L || bodyWritable)
                { 
                ...
                {
                    pc.t.setReqCanceler(rc.cancelKey, null); 
                ...
                return ;
                pc.t.setReqCanceler(rc.cancelKey, null); // before pc might return to idle pool
        ...
        private static bool is408Message(slice<byte> buf)
        {
            ...
            if (string(buf[..7L]) != "HTTP/1.")
            {
                return false;
            }

            return string(buf[8L..12L]) == " 408";
        ...
        private static (ptr<Response>, error) readResponse(this ptr<persistConn> _addr_pc, requestAndChan rc, ptr<httptrace.ClientTrace> _addr_trace)
        {
            ...
            long num1xx = 0L; // number of informational 1xx headers received
            const long max1xxResponses = (long)5L; // arbitrary bound on number of informational responses
 ...
 // arbitrary bound on number of informational responses
            ...
            while (true)
            {
                ...
                long is1xx = 100L <= resCode && resCode <= 199L; 
        ...
        private static Func<bool> waitForContinue(this ptr<persistConn> _addr_pc, channel<object> continueCh) => func((defer, _, __) =>
        {
            ref persistConn pc = ref _addr_pc.val;
        ...
        private static (long, error) Read(this ptr<readWriteCloserBody> _addr_b, slice<byte> p)
        {
            long n = default;
            error err = default!;
        ...
        private static void writeLoop(this ptr<persistConn> _addr_pc) => func((defer, _, __) =>
        {
            ref persistConn pc = ref _addr_pc.val;
        ...
        private static readonly long maxWriteWaitBeforeConnReuse = (long)50L * time.Millisecond;
        ...
        // wroteRequest is a check before recycling a connection that the previous write
        // (from writeLoop above) happened and was successful.
        private static bool wroteRequest(this ptr<persistConn> _addr_pc) => func((defer, _, __) =>
        {
            ref persistConn pc = ref _addr_pc.val;
...
// it receives from this chan.
        ...
        private static void close(this ptr<persistConn> _addr_pc, error err) => func((defer, _, __) =>
        {
            ref persistConn pc = ref _addr_pc.val;
        ...
        private static void closeLocked(this ptr<persistConn> _addr_pc, error err) => func((_, panic, __) =>
        {
            ref persistConn pc = ref _addr_pc.val;
        ...
        private static (long, error) Read(this ptr<bodyEOFSignal> _addr_es, slice<byte> p) => func((defer, _, __) =>
        {
            long n = default;
            error err = default!;
            ...
            if (closed)
            {
                return (0L, error.As(errReadOnClosedResBody)!);
            }

            if (rerr != null)
            {
                return (0L, error.As(rerr)!);
            }
        ...
        private static error Close(this ptr<bodyEOFSignal> _addr_es) => func((defer, _, __) =>
        {
            ref bodyEOFSignal es = ref _addr_es.val;
        ...
        private static (long, error) Read(this ptr<gzipReader> _addr_gz, slice<byte> p)
        {
            long n = default;
            error err = default!;
        ...
        private static void add(this ptr<connLRU> _addr_cl, ptr<persistConn> _addr_pc) => func((_, panic, __) =>
        {
        ...
        private static long len(this ptr<connLRU> _addr_cl)
        {
            ref connLRU cl = ref _addr_cl.val;
