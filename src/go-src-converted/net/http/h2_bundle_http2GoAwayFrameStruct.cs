...
namespace net
{
    public static partial class http_package
    {
        ...
        private partial struct http2GoAwayFrame
        {
            ...
            // Constructors
            public http2GoAwayFrame(NilType _)
            {
                this.m_http2FrameHeaderRef = new ptr<http2FrameHeader>(new http2FrameHeader(nil));
                this.LastStreamID = default;
                this.ErrCode = default;
                this.debugData = default;
            }

            public http2GoAwayFrame(http2FrameHeader http2FrameHeader = default, uint LastStreamID = default, http2ErrCode ErrCode = default, slice<byte> debugData = default)
            {
            ...
            // Enable comparisons between nil and http2GoAwayFrame struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(http2GoAwayFrame value, NilType nil) => value.Equals(default(http2GoAwayFrame));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(http2GoAwayFrame value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, http2GoAwayFrame value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, http2GoAwayFrame value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator http2GoAwayFrame(NilType nil) => default(http2GoAwayFrame);
        }

        [GeneratedCode("go2cs", "0.1.2.0")]
        private static http2GoAwayFrame http2GoAwayFrame_cast(dynamic value)
        {
            return new http2GoAwayFrame(value.http2FrameHeader, value.LastStreamID, value.ErrCode, value.debugData);
        }
    }
}}