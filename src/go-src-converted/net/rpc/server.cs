...
*/
// package rpc -- go2cs converted at 2022 March 06 22:25:52 UTC
...
private static nuint NumCalls(this ptr<methodType> _addr_m) {
    nuint n = default;
...
private static void call(this ptr<service> _addr_s, ptr<Server> _addr_server, ptr<sync.Mutex> _addr_sending, ptr<sync.WaitGroup> _addr_wg, ptr<methodType> _addr_mtype, ptr<Request> _addr_req, reflect.Value argv, reflect.Value replyv, ServerCodec codec) => func((defer, _, _) => {
...
private static (ptr<service>, ptr<methodType>, ptr<Request>, bool, error) readRequestHeader(this ptr<Server> _addr_server, ServerCodec codec) {
    ...
    var serviceName = req.ServiceMethod[..(int)dot];
    var methodName = req.ServiceMethod[(int)dot + 1..]; 
