...
private static Value address(this ptr<element> _addr_e, ptr<Function> _addr_fn) => func((_, panic, _) => {
    ref element e = ref _addr_e.val;
    ref Function fn = ref _addr_fn.val;
...
private static Value load(this blank bl, ptr<Function> _addr_fn) => func((_, panic, _) => {
    ref Function fn = ref _addr_fn.val;
...
private static Value address(this blank bl, ptr<Function> _addr_fn) => func((_, panic, _) => {
    ref Function fn = ref _addr_fn.val;

    panic("blank var is not addressable");
});

private static types.Type typ(this blank bl) => func((_, panic, _) => { 
