...
// package main -- go2cs converted at 2022 March 06 23:32:16 UTC
...
private static void Main() {
    tool.Main(context.Background(), addr(new application(Mode:"imports")), os.Args[(int)1..]);
}
...
private static void print(this ptr<application> _addr_app, ptr<packages.Package> _addr_lpkg) {
    ...
    else
 {
    ...
    if (lpkg.Types != null && lpkg.IllTyped && len(lpkg.Errors) == 0) {
