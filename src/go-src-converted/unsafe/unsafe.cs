...
//
public partial struct Pointer { // : ptr<ArbitraryType>
}
...
public static Pointer Add(Pointer ptr, IntegerType len);
...
public static slice<ArbitraryType> Slice(ptr<ArbitraryType> ptr, IntegerType len);
