...
// package span -- go2cs converted at 2020 October 08 04:54:38 UTC
...
namespace @internal
{
    public static partial class span_package
    {
        ...
        private static (@string, long, long, error) position(ptr<token.File> _addr_f, token.Pos pos)
        {
            @string _p0 = default;
            long _p0 = default;
            long _p0 = default;
        ...
        private static (@string, long, long, error) positionFromOffset(ptr<token.File> _addr_f, long offset)
        {
            @string _p0 = default;
            long _p0 = default;
            long _p0 = default;
            ...
            if (offset > f.Size())
            {
                return ("", 0L, 0L, error.As(fmt.Errorf("offset %v is past the end of the file %v", offset, f.Size()))!);
            }
            ...
            if (offset == f.Size())
            {
                return (p.Filename, p.Line + 1L, 1L, error.As(null!)!);
            }
        ...
        private static (long, error) offset(ptr<token.File> _addr_f, token.Pos pos)
        {
            long _p0 = default;
            error _p0 = default!;
            ref token.File f = ref _addr_f.val;
            ...
            {
                return (0L, error.As(fmt.Errorf("invalid pos"))!);
            }
        ...
        private static (long, long, error) ToPosition(this ptr<TokenConverter> _addr_l, long offset)
        {
            long _p0 = default;
            long _p0 = default;
            error _p0 = default!;
        ...
        private static (long, error) ToOffset(this ptr<TokenConverter> _addr_l, long line, long col)
        {
            long _p0 = default;
            error _p0 = default!;
            ref TokenConverter l = ref _addr_l.val;
            ...
            if (line < 0L)
            {
                return (-1L, error.As(fmt.Errorf("line is not valid"))!);
            }

            var lineMax = l.file.LineCount() + 1L;
            if (line > lineMax)
            {
                return (-1L, error.As(fmt.Errorf("line is beyond end of file %v", lineMax))!);
            }
            else if (line == lineMax)
            {
                if (col > 1L)
                {
                    return (-1L, error.As(fmt.Errorf("column is beyond end of file"))!);
                } 
            ...
            if (!pos.IsValid())
            {
                return (-1L, error.As(fmt.Errorf("line is not in file"))!);
            } 
            // we assume that column is in bytes here, and that the first byte of a
            // line is at column 1
            pos += token.Pos(col - 1L);
