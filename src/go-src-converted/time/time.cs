...
//
// package time -- go2cs converted at 2020 August 29 08:42:25 UTC
...
// All UTC times are represented with loc==nil, never loc==&utcLoc.
        ...
        private static readonly long hasMonotonic = 1L << (int)(63L);
        ...
        private static readonly long nsecMask = 1L << (int)(30L) - 1L;
        private static readonly long nsecShift = 30L;
        ...
        private static int nsec(this ref Time t)
        {
            return int32(t.wall & nsecMask);
        }

        // sec returns the time's seconds since Jan 1 year 1.
        private static long sec(this ref Time t)
        {
        ...
        private static long unixSec(this ref Time t)
        {
            return t.sec() + internalToUnix;
        }

        // addSec adds d seconds to the time.
        private static void addSec(this ref Time t, long d)
        {
            if (t.wall & hasMonotonic != 0L)
            {
        ...
        private static void setLoc(this ref Time t, ref Location loc)
        {
            if (loc == ref utcLoc)
            {
                loc = null;
        ...
        private static void stripMono(this ref Time t)
        {
            if (t.wall & hasMonotonic != 0L)
            {
                t.ext = t.sec();
        ...
        // setMono is a no-op.
        private static void setMono(this ref Time t, long m)
        {
            if (t.wall & hasMonotonic == 0L)
            {
                var sec = int64(t.ext);
        ...
        private static long mono(this ref Time t)
        {
            if (t.wall & hasMonotonic == 0L)
            {
                return 0L;
        ...
        public static readonly Month January = 1L + iota;
        ...
        private static array<@string> months = new array<@string>(new @string[] { "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" });
        ...
        private static array<@string> days = new array<@string>(new @string[] { "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" });
        ...
        private static readonly long absoluteZeroYear = -292277022399L; 

        // The year of the zero Time.
        // Assumed by the unixToInternal computation below.
        private static readonly long internalYear = 1L; 
        ...
        {
            var (year, month, day, yday) = t.date(true);
            var wday = int(t.Weekday() + 6L) % 7L; // weekday but Monday = 0.
            const long Mon = iota;
            const var Tue = 0;
            const var Wed = 1;
            const var Thu = 2;
            ...
            // round incorrectly.
            week = (yday - wday + 7L) / 7L; 

            // The week number is now correct under the assumption
            // that the first Monday of the year is in week 1.
            // If Jan 1 is a Tuesday, Wednesday, or Thursday, the first Monday
            // is actually in week 2.
            var jan1wday = (wday - yday + 7L * 53L) % 7L;
            ...
            if (month == December && day >= 29L && wday < Thu)
            {
                {
                    var dec31wday = (wday + 31L - day) % 7L;
        ...
        private static readonly Duration minDuration = -1L << (int)(63L);
        private static readonly Duration maxDuration = 1L << (int)(63L) - 1L;
        ...
        //
        public static readonly Duration Nanosecond = 1L;
        public static readonly long Microsecond = 1000L * Nanosecond;
        public static readonly long Millisecond = 1000L * Microsecond;
        public static readonly long Second = 1000L * Millisecond;
        public static readonly long Minute = 60L * Second;
        public static readonly long Hour = 60L * Minute;
        ...
        public static Time Add(this Time t, Duration d)
        {
            ...
            if (t.wall & hasMonotonic != 0L)
            {
                ...
                if (d < 0L && te > int64(t.ext) || d > 0L && te < int64(t.ext))
                { 
        ...
        private static readonly long secondsPerMinute = 60L;
        private static readonly long secondsPerHour = 60L * 60L;
        private static readonly long secondsPerDay = 24L * secondsPerHour;
        private static readonly long secondsPerWeek = 7L * secondsPerDay;
        private static readonly long daysPer400Years = 365L * 400L + 97L;
        private static readonly long daysPer100Years = 365L * 100L + 24L;
        private static readonly long daysPer4Years = 365L * 4L + 1L;
...
;
        ...
        public static Time In(this Time t, ref Location _loc) => func(_loc, (ref Location loc, Defer _, Panic panic, Recover __) =>
        {
            if (loc == null)
            {
        ...
        public static ref Location Location(this Time t)
        {
            var l = t.loc;
            if (l == null)
            {
        ...
        private static readonly byte timeBinaryVersion = 1L;
        ...
        public static (slice<byte>, error) MarshalBinary(this Time t)
        {
            ...
            else
            {
                ...
                if (offset % 60L != 0L)
                {
                    return (null, errors.New("Time.MarshalBinary: zone offset has fractional minute"));
                }
                offset /= 60L;
                if (offset < -32768L || offset == -1L || offset > 32767L)
                {
                    return (null, errors.New("Time.MarshalBinary: unexpected zone offset"));
                }
        ...
        private static error UnmarshalBinary(this ref Time t, slice<byte> data)
        {
            var buf = data;
            if (len(buf) == 0L)
            {
        ...
        private static error GobDecode(this ref Time t, slice<byte> data)
        {
        ...
        {
            {
                ...
                { 
                    ...
                    return (null, errors.New("Time.MarshalJSON: year outside of range [0,9999]"));
                }
        ...
        private static error UnmarshalJSON(this ref Time t, slice<byte> data)
        { 
            ...
            error err = default;
            t.Value, err = Parse("\"" + RFC3339 + "\"", string(data));
            return error.As(err);
        }
        ...
        {
            {
                ...
                if (y < 0L || y >= 10000L)
                {
                    return (null, errors.New("Time.MarshalText: year outside of range [0,9999]"));
                }

            }

            var b = make_slice<byte>(0L, len(RFC3339Nano));
            return (t.AppendFormat(b, RFC3339Nano), null);
        }

        // UnmarshalText implements the encoding.TextUnmarshaler interface.
        // The time is expected to be in RFC 3339 format.
        private static error UnmarshalText(this ref Time t, slice<byte> data)
        { 
            // Fractional seconds are handled implicitly by Parse.
            error err = default;
            t.Value, err = Parse(RFC3339, string(data));
        ...
        public static Time Date(long year, Month month, long day, long hour, long min, long sec, long nsec, ref Location _loc) => func(_loc, (ref Location loc, Defer _, Panic panic, Recover __) =>
        {
            if (loc == null)
            {
            ...
            var (_, offset, _, start, end) = loc.lookup(unix);
            if (offset != 0L)
            {
                {
                    ...
                    if (utc < start) 
                        _, offset, _, _, _ = loc.lookup(start - 1L);
                    else if (utc >= end) 
