...
//
private static ptr<Function> LookupMethod(this ptr<Program> _addr_prog, types.Type T, ptr<types.Package> _addr_pkg, @string name) => func((_, panic, _) => {
    ref Program prog = ref _addr_prog.val;
...
// EXCLUSIVE_LOCKS_REQUIRED(prog.methodsMu)
private static ptr<Function> addMethod(this ptr<Program> _addr_prog, ptr<methodSet> _addr_mset, ptr<types.Selection> _addr_sel) => func((_, panic, _) => {
    ref Program prog = ref _addr_prog.val;
    ...
    if (fn == null) {
        ...
        var needsPromotion = len(sel.Index()) > 1;
...
// EXCLUSIVE_LOCKS_ACQUIRED(prog.methodsMu)
//
private static slice<types.Type> RuntimeTypes(this ptr<Program> _addr_prog) => func((defer, _, _) => {
    ref Program prog = ref _addr_prog.val;
...
//
private static ptr<Function> declaredFunc(this ptr<Program> _addr_prog, ptr<types.Func> _addr_obj) => func((_, panic, _) => {
    ref Program prog = ref _addr_prog.val;
...
// EXCLUSIVE_LOCKS_REQUIRED(prog.methodsMu)
//
private static void needMethods(this ptr<Program> _addr_prog, types.Type T, bool skip) => func((_, panic, _) => {
    ref Program prog = ref _addr_prog.val;
