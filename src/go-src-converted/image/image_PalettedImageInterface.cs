...
namespace go
{
    public static partial class image_package
    {
        ...
        public class PalettedImage<T> : PalettedImage
        {
            ...
            private delegate byte ColorIndexAtByRef(ref T value, long x, long y);
            private delegate byte ColorIndexAtByVal(T value, long x, long y);

            private static readonly ColorIndexAtByRef s_ColorIndexAtByRef;
            ...
            public byte ColorIndexAt(long x, long y)
            {
                ...
                if (s_ColorIndexAtByRef is null)
                    return s_ColorIndexAtByVal!(target, x, y);

                return s_ColorIndexAtByRef(ref target, x, y);
            }
            ...
            static PalettedImage()
            {
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("ColorIndexAt");

                if (!(extensionMethod is null))
                    s_ColorIndexAtByRef = extensionMethod.CreateStaticDelegate(typeof(ColorIndexAtByRef)) as ColorIndexAtByRef;
                ...
                if (s_ColorIndexAtByRef is null && s_ColorIndexAtByVal is null)
