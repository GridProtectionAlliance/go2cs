...
namespace go
{
    public static partial class image_package
    {
        ...
        public class Image<T> : Image
        {
            ...
            private delegate color.Color AtByPtr(ptr<T> value, nint x, nint y);
            private delegate color.Color AtByVal(T value, nint x, nint y);

            private static readonly AtByPtr? s_AtByPtr;
            private static readonly AtByVal? s_AtByVal;

            [DebuggerNonUserCode, MethodImpl(MethodImplOptions.AggressiveInlining)]
            public color.Color At(nint x, nint y)
            {
                T target = m_target;
...
namespace go
{
    public static class image_ImageExtensions
    {
        private static readonly ConcurrentDictionary<Type, MethodInfo> s_conversionOperators = new ConcurrentDictionary<Type, MethodInfo>();

        [GeneratedCode("go2cs", "0.1.2.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static T _<T>(this go.image_package.Image target)
        {
            try
            {
                return ((go.image_package.Image<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.2.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.image_package.Image target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.2.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.image_package.Image target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.image_package.Image<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.2.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.image_package.Image target, Type type, out object? result)
        {
            try
            {
