...
private static readonly nint w1 = 2841; // 2048*sqrt(2)*cos(1*pi/16)
private static readonly nint w2 = 2676; // 2048*sqrt(2)*cos(2*pi/16)
private static readonly nint w3 = 2408; // 2048*sqrt(2)*cos(3*pi/16)
private static readonly nint w5 = 1609; // 2048*sqrt(2)*cos(5*pi/16)
private static readonly nint w6 = 1108; // 2048*sqrt(2)*cos(6*pi/16)
private static readonly nint w7 = 565; // 2048*sqrt(2)*cos(7*pi/16)
...
private static readonly nint r2 = 181; // 256/sqrt(2)
...
private static void idct(ptr<block> _addr_src) {
    ...
    for (nint y = 0; y < 8; y++) {
        var y8 = y * 8;
        var s = src.slice(y8, y8 + 8, y8 + 8); // Small cap improves performance, see https://golang.org/issue/27857
    ...
    for (nint x = 0; x < 8; x++) { 
        ...
        s = src.slice(x, x + 57, x + 57); // Small cap improves performance, see https://golang.org/issue/27857
