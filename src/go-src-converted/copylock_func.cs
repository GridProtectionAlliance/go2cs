...
// package a -- go2cs converted at 2022 March 06 23:33:55 UTC
...
namespace go.golang.org.x.tools.go.analysis.passes.copylock.testdata.src;
...
public static void FuncCallInterfaceArg(Action<nint, object> f) {
    sync.Mutex m = default;
    ref var t = ref heap(out ptr<var> _addr_t);

    f(1, "foo");
    f(2, _addr_t);
    f(3, addr(new sync.Mutex()));
...
public static (nint, object) ReturnViaInterface(nint x) {
    nint _p0 = default;
    object _p0 = default;
