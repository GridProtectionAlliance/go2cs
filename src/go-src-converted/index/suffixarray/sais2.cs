...
// package suffixarray -- go2cs converted at 2020 October 09 06:06:09 UTC
// import "index/suffixarray" ==> using suffixarray = go.index.suffixarray_package
// Original source: C:\Go\src\index\suffixarray\sais2.go
...
namespace index
{
    ...
    {
        private static void text_64(slice<byte> text, slice<long> sa) => func((_, panic, __) =>
        {
            if (int(int64(len(text))) != len(text) || len(text) != len(sa))
            {
                panic("suffixarray: misuse of text_64");
            }
            sais_8_64(text, 256L, sa, make_slice<long>(2L * 256L));

        });

        private static void sais_8_64(slice<byte> text, long textMax, slice<long> sa, slice<long> tmp) => func((_, panic, __) =>
        {
        ...
        private static void sais_32(slice<int> text, long textMax, slice<int> sa, slice<int> tmp) => func((_, panic, __) =>
        {
            if (len(sa) != len(text) || len(tmp) < int(textMax))
            {
        ...
        private static void sais_64(slice<long> text, long textMax, slice<long> sa, slice<long> tmp) => func((_, panic, __) =>
        {
            if (len(sa) != len(text) || len(tmp) < int(textMax))
            {
        ...
        private static long placeLMS_8_64(slice<byte> text, slice<long> sa, slice<long> freq, slice<long> bucket)
        {
        ...
        private static long placeLMS_32(slice<int> text, slice<int> sa, slice<int> freq, slice<int> bucket)
        {
        ...
        private static long placeLMS_64(slice<long> text, slice<long> sa, slice<long> freq, slice<long> bucket)
        {
        ...
        private static void length_8_64(slice<byte> text, slice<long> sa, long numLMS)
        {
            ...
            for (var i = len(text) - 1L; i >= 0L; i--)
            {
                c0 = text[i];
                c1 = c0;
                cx = cx << (int)(8L) | uint64(c1 + 1L); // byte-only
                if (c0 < c1)
                {
                    isTypeS = true;
                }
                else if (c0 > c1 && isTypeS)
                {
                    ...
                    {
                        code = int64(end - j);
                        if (code <= 64L / 8L && ~cx >= uint64(len(text)))
                        { // byte-only
        ...
        private static void length_32(slice<int> text, slice<int> sa, long numLMS)
        {
            long end = 0L; // index of current LMS-substring end (0 indicates final LMS-substring)
        ...
        private static void length_64(slice<long> text, slice<long> sa, long numLMS)
        {
            long end = 0L; // index of current LMS-substring end (0 indicates final LMS-substring)
        ...
        private static long assignID_8_64(slice<byte> text, slice<long> sa, long numLMS)
        {
            long id = 0L;
            var lastLen = int64(-1L); // impossible
            var lastPos = int64(0L);
...
Same:
        ...
        private static long assignID_32(slice<int> text, slice<int> sa, long numLMS)
        {
            long id = 0L;
...
Same:
        ...
        private static long assignID_64(slice<long> text, slice<long> sa, long numLMS)
        {
            long id = 0L;
            var lastLen = int64(-1L); // impossible
            var lastPos = int64(0L);
...
Same:
        ...
        private static void map_64(slice<long> sa, long numLMS)
        {
            var w = len(sa);
        ...
        private static void recurse_64(slice<long> sa, slice<long> oldTmp, long numLMS, long maxID)
        {
            var dst = sa[..numLMS];
        ...
        private static void unmap_8_64(slice<byte> text, slice<long> sa, long numLMS)
        {
        ...
        private static void unmap_32(slice<int> text, slice<int> sa, long numLMS)
        {
            var unmap = sa[len(sa) - numLMS..];
            var j = len(unmap); 
        ...
        private static void unmap_64(slice<long> text, slice<long> sa, long numLMS)
        {
            var unmap = sa[len(sa) - numLMS..];
            var j = len(unmap); 
        ...
        private static void expand_8_64(slice<byte> text, slice<long> freq, slice<long> bucket, slice<long> sa, long numLMS)
        {
            bucketMax_8_64(text, freq, bucket);
        ...
        private static void expand_32(slice<int> text, slice<int> freq, slice<int> bucket, slice<int> sa, long numLMS)
        {
            bucketMax_32(text, freq, bucket); 
        ...
        private static void expand_64(slice<long> text, slice<long> freq, slice<long> bucket, slice<long> sa, long numLMS)
        {
            bucketMax_64(text, freq, bucket); 
