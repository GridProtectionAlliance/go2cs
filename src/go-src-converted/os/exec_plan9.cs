...
// package os -- go2cs converted at 2022 March 06 22:13:28 UTC
// import "os" ==> using os = go.os_package
// Original source: C:\Program Files\Go\src\os\exec_plan9.go
...
private static error writeProcFile(this ptr<Process> _addr_p, @string file, @string data) => func((defer, _, _) => {
    ref Process p = ref _addr_p.val;

    var (f, e) = OpenFile("/proc/" + itoa.Itoa(p.Pid) + "/" + file, O_WRONLY, 0);
    if (e != null) {
        return error.As(e)!;
    }
    defer(f.Close());
