...
// package os -- go2cs converted at 2020 October 08 03:45:03 UTC
// import "os" ==> using os = go.os_package
// Original source: C:\Go\src\os\stat_darwin.go
...
namespace go
{
    public static partial class os_package
    {
        private static void fillFileStatFromSys(ptr<fileStat> _addr_fs, @string name)
        {
            ...
            if (fs.sys.Mode & syscall.S_IFMT == syscall.S_IFBLK || fs.sys.Mode & syscall.S_IFMT == syscall.S_IFWHT) 
                fs.mode |= ModeDevice;
