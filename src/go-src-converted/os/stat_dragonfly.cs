...
// package os -- go2cs converted at 2020 August 29 08:44:17 UTC
// import "os" ==> using os = go.os_package
// Original source: C:\Go\src\os\stat_dragonfly.go
...
namespace go
{
    public static partial class os_package
    {
        ...
        {
            return timespecToTime(fi.Sys()._<ref syscall.Stat_t>().Atim);
        }
    }
}
