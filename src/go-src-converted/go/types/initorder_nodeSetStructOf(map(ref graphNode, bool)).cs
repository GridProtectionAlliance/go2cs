...
namespace go
{
    public static partial class types_package
    {
        ...
        private partial struct nodeSet
        {
            ...
            private readonly map<ref graphNode, bool> m_value;

            public nodeSet(map<ref graphNode, bool> value) => m_value = value;

            // Enable implicit conversions between map<ref graphNode, bool> and nodeSet struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator nodeSet(map<ref graphNode, bool> value) => new nodeSet(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator map<ref graphNode, bool>(nodeSet value) => value.m_value;
