...
namespace go
{
    public static partial class build_package
    {
        ...
        public partial struct ImportMode
        {
            ...
            public ImportMode(nuint value) => m_value = value;

            // Enable implicit conversions between nuint and ImportMode struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ImportMode(nuint value) => new ImportMode(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator nuint(ImportMode value) => value.m_value;
