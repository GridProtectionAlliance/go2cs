...
// Original source: C:\Go\src\go\build\read.go
...
namespace go
{
    public static partial class build_package
    {
        ...
        private static (slice<byte>, error) readImports(io.Reader f, bool reportSyntaxError, ref slice<@string> imports)
        {
            importReader r = ref new importReader(b:bufio.NewReader(f));
            ...
            if (r.err == null && !r.eof)
            {
                return (r.buf[..len(r.buf) - 1L], null);
            } 
