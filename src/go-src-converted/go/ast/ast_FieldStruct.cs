...
namespace go
{
    public static partial class ast_package
    {
        ...
        public partial struct Field
        {
            ...
            public Field(ref ptr<CommentGroup> Doc = default, slice<ref Ident> Names = default, Expr Type = default, ref ptr<BasicLit> Tag = default, ref ptr<CommentGroup> Comment = default)
            {
                this.Doc = Doc;
                this.Names = Names;
                this.Type = Type;
