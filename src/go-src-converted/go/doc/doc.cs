...
// provided to NewFromFiles.
        ...
        public static readonly Mode AllDecls = (Mode)1L << (int)(iota); 
        ...
        //
        public static (ptr<Package>, error) NewFromFiles(ptr<token.FileSet> _addr_fset, slice<ptr<ast.File>> files, @string importPath, params object[] opts) => func((_, panic, __) =>
        {
        ...
        private static (ptr<ast.Object>, error) simpleImporter(map<@string, ptr<ast.Object>> imports, @string path)
        {
            ...
            { 
                ...
                pkg = ast.NewObj(ast.Pkg, path[strings.LastIndex(path, "/") + 1L..]);
