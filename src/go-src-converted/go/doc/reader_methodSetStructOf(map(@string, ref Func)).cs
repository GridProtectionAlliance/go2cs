...
namespace go
{
    public static partial class doc_package
    {
        ...
        private partial struct methodSet
        {
            ...
            private readonly map<@string, ref Func> m_value;

            public methodSet(map<@string, ref Func> value) => m_value = value;

            // Enable implicit conversions between map<@string, ref Func> and methodSet struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator methodSet(map<@string, ref Func> value) => new methodSet(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator map<@string, ref Func>(methodSet value) => value.m_value;
