...
namespace @internal
{
    public static partial class exports_package
    {
        ...
        public class T14<T> : T14
        {
            ...
            private delegate slice<T9> m3ByRef(ref T value, params object[] x);
            private delegate slice<T9> m3ByVal(T value, params object[] x);

            private static readonly m3ByRef s_m3ByRef;
            ...
            public slice<T9> m3(params object[] x)
            {
                ...
                if (s_m3ByRef is null)
                    return s_m3ByVal!(target, x);

                return s_m3ByRef(ref target, x);
            }
            ...
            static T14()
            {
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("m3");

                if (!(extensionMethod is null))
                    s_m3ByRef = extensionMethod.CreateStaticDelegate(typeof(m3ByRef)) as m3ByRef;
                ...
                if (s_m3ByRef is null && s_m3ByVal is null)
...
namespace go
{
    public static class exports_T14Extensions
    {
        ...
        public static T _<T>(this go.go.@internal.gcimporter.exports_package.T14 target)
        {
            try
            {
                return ((go.go.@internal.gcimporter.exports_package.T14<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.go.@internal.gcimporter.exports_package.T14 target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.go.@internal.gcimporter.exports_package.T14 target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.go.@internal.gcimporter.exports_package.T14<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.go.@internal.gcimporter.exports_package.T14 target, Type type, out object? result)
        {
            try
            {
