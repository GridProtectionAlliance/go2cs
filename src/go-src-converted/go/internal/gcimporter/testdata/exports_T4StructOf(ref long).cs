...
namespace @internal
{
    public static partial class exports_package
    {
        ...
        public partial struct T4
        {
            ...
            private readonly ref long m_value;

            public T4(ref long value) => m_value = value;

            // Enable implicit conversions between ref long and T4 struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator T4(ref long value) => new T4(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ref long(T4 value) => value.m_value;
