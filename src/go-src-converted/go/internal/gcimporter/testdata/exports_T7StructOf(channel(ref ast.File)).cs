...
namespace @internal
{
    public static partial class exports_package
    {
        ...
        public partial struct T7
        {
            ...
            private readonly channel<ref ast.File> m_value;

            public T7(channel<ref ast.File> value) => m_value = value;

            // Enable implicit conversions between channel<ref ast.File> and T7 struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator T7(channel<ref ast.File> value) => new T7(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator channel<ref ast.File>(T7 value) => value.m_value;
