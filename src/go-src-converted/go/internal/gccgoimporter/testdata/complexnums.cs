...
public static readonly nint NN = -1 - 1i;

public static readonly nint NP = -1 + 1i;

public static readonly nint PN = 1 - 1i;

public static readonly nint PP = 1 + 1i;


} // end complexnums_package
