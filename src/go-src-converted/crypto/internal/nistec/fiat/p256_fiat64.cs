...
internal static void p256Mul(ж<p256MontgomeryDomainFieldElement> Ꮡout1, ж<p256MontgomeryDomainFieldElement> Ꮡarg1, ж<p256MontgomeryDomainFieldElement> Ꮡarg2) {
    ...
    uint64 x20 = default!;
    uint64 x21 = default!;
    (x21, x20) = bits.Mul64(x11, (nuint)0xffffffff00000001UL);
    uint64 x22 = default!;
    uint64 x23 = default!;
    (x23, x22) = bits.Mul64(x11, 0xffffffffU);
    uint64 x24 = default!;
    uint64 x25 = default!;
    (x25, x24) = bits.Mul64(x11, (nuint)0xffffffffffffffffUL);
    uint64 x26 = default!;
    uint64 x27 = default!;
    ...
    uint64 x64 = default!;
    uint64 x65 = default!;
    (x65, x64) = bits.Mul64(x54, (nuint)0xffffffff00000001UL);
    uint64 x66 = default!;
    uint64 x67 = default!;
    (x67, x66) = bits.Mul64(x54, 0xffffffffU);
    uint64 x68 = default!;
    uint64 x69 = default!;
    (x69, x68) = bits.Mul64(x54, (nuint)0xffffffffffffffffUL);
    uint64 x70 = default!;
    uint64 x71 = default!;
    ...
    uint64 x109 = default!;
    uint64 x110 = default!;
    (x110, x109) = bits.Mul64(x99, (nuint)0xffffffff00000001UL);
    uint64 x111 = default!;
    uint64 x112 = default!;
    (x112, x111) = bits.Mul64(x99, 0xffffffffU);
    uint64 x113 = default!;
    uint64 x114 = default!;
    (x114, x113) = bits.Mul64(x99, (nuint)0xffffffffffffffffUL);
    uint64 x115 = default!;
    uint64 x116 = default!;
    ...
    uint64 x154 = default!;
    uint64 x155 = default!;
    (x155, x154) = bits.Mul64(x144, (nuint)0xffffffff00000001UL);
    uint64 x156 = default!;
    uint64 x157 = default!;
    (x157, x156) = bits.Mul64(x144, 0xffffffffU);
    uint64 x158 = default!;
    uint64 x159 = default!;
    (x159, x158) = bits.Mul64(x144, (nuint)0xffffffffffffffffUL);
    uint64 x160 = default!;
    uint64 x161 = default!;
    ...
    uint64 x174 = default!;
    uint64 x175 = default!;
    (x174, x175) = bits.Sub64(x165, (nuint)0xffffffffffffffffUL, (uint64)0x0);
    uint64 x176 = default!;
    uint64 x177 = default!;
    ...
    uint64 x180 = default!;
    uint64 x181 = default!;
    (x180, x181) = bits.Sub64(x171, (nuint)0xffffffff00000001UL, (uint64)((p256Uint1)x179));
    uint64 x183 = default!;
...
internal static void p256Add(ж<p256MontgomeryDomainFieldElement> Ꮡout1, ж<p256MontgomeryDomainFieldElement> Ꮡarg1, ж<p256MontgomeryDomainFieldElement> Ꮡarg2) {
    ...
    uint64 x9 = default!;
    uint64 x10 = default!;
    (x9, x10) = bits.Sub64(x1, (nuint)0xffffffffffffffffUL, (uint64)0x0);
    uint64 x11 = default!;
    uint64 x12 = default!;
    ...
    uint64 x15 = default!;
    uint64 x16 = default!;
    (x15, x16) = bits.Sub64(x7, (nuint)0xffffffff00000001UL, (uint64)((p256Uint1)x14));
    uint64 x18 = default!;
...
internal static void p256Sub(ж<p256MontgomeryDomainFieldElement> Ꮡout1, ж<p256MontgomeryDomainFieldElement> Ꮡarg1, ж<p256MontgomeryDomainFieldElement> Ꮡarg2) {
    ...
    p256CmovznzU64(Ꮡx9, ((p256Uint1)x8), (uint64)0x0, (nuint)0xffffffffffffffffUL);
    uint64 x10 = default!;
    uint64 x11 = default!;
    ...
    uint64 x16 = default!;
    (x16, _) = bits.Add64(x7, ((uint64)(x9 & (nuint)0xffffffff00000001UL)), (uint64)((p256Uint1)x15));
    out1[0] = x10;
    out1[1] = x12;
    out1[2] = x14;
    out1[3] = x16;
...
internal static void p256SetOne(ж<p256MontgomeryDomainFieldElement> Ꮡout1) {
    ...
    out1[0] = (uint64)0x1;
    out1[1] = (nuint)0xffffffff00000000UL;
    out1[2] = (nuint)0xffffffffffffffffUL;
    out1[3] = 0xfffffffeU;
}
...
internal static void p256FromMontgomery(ж<p256NonMontgomeryDomainFieldElement> Ꮡout1, ж<p256MontgomeryDomainFieldElement> Ꮡarg1) {
    ...
    uint64 x2 = default!;
    uint64 x3 = default!;
    (x3, x2) = bits.Mul64(x1, (nuint)0xffffffff00000001UL);
    uint64 x4 = default!;
    uint64 x5 = default!;
    ...
    uint64 x16 = default!;
    uint64 x17 = default!;
    (x17, x16) = bits.Mul64(x14, (nuint)0xffffffff00000001UL);
    uint64 x18 = default!;
    uint64 x19 = default!;
    (x19, x18) = bits.Mul64(x14, 0xffffffffU);
    uint64 x20 = default!;
    uint64 x21 = default!;
    (x21, x20) = bits.Mul64(x14, (nuint)0xffffffffffffffffUL);
    uint64 x22 = default!;
    uint64 x23 = default!;
    ...
    uint64 x38 = default!;
    uint64 x39 = default!;
    (x39, x38) = bits.Mul64(x32, (nuint)0xffffffff00000001UL);
    uint64 x40 = default!;
    uint64 x41 = default!;
    (x41, x40) = bits.Mul64(x32, 0xffffffffU);
    uint64 x42 = default!;
    uint64 x43 = default!;
    (x43, x42) = bits.Mul64(x32, (nuint)0xffffffffffffffffUL);
    uint64 x44 = default!;
    uint64 x45 = default!;
    ...
    uint64 x60 = default!;
    uint64 x61 = default!;
    (x61, x60) = bits.Mul64(x54, (nuint)0xffffffff00000001UL);
    uint64 x62 = default!;
    uint64 x63 = default!;
    (x63, x62) = bits.Mul64(x54, 0xffffffffU);
    uint64 x64 = default!;
    uint64 x65 = default!;
    (x65, x64) = bits.Mul64(x54, (nuint)0xffffffffffffffffUL);
    uint64 x66 = default!;
    uint64 x67 = default!;
    ...
    uint64 x77 = default!;
    uint64 x78 = default!;
    (x77, x78) = bits.Sub64(x70, (nuint)0xffffffffffffffffUL, (uint64)0x0);
    uint64 x79 = default!;
    uint64 x80 = default!;
    ...
    uint64 x83 = default!;
    uint64 x84 = default!;
    (x83, x84) = bits.Sub64(x76, (nuint)0xffffffff00000001UL, (uint64)((p256Uint1)x82));
    uint64 x86 = default!;
...
internal static void p256ToMontgomery(ж<p256MontgomeryDomainFieldElement> Ꮡout1, ж<p256NonMontgomeryDomainFieldElement> Ꮡarg1) {
    ...
    uint64 x7 = default!;
    uint64 x8 = default!;
    (x8, x7) = bits.Mul64(x4, (nuint)0xfffffffffffffffeUL);
    uint64 x9 = default!;
    uint64 x10 = default!;
    (x10, x9) = bits.Mul64(x4, (nuint)0xfffffffbffffffffUL);
    uint64 x11 = default!;
    uint64 x12 = default!;
    ...
    uint64 x19 = default!;
    uint64 x20 = default!;
    (x20, x19) = bits.Mul64(x11, (nuint)0xffffffff00000001UL);
    uint64 x21 = default!;
    uint64 x22 = default!;
    (x22, x21) = bits.Mul64(x11, 0xffffffffU);
    uint64 x23 = default!;
    uint64 x24 = default!;
    (x24, x23) = bits.Mul64(x11, (nuint)0xffffffffffffffffUL);
    uint64 x25 = default!;
    uint64 x26 = default!;
    ...
    uint64 x39 = default!;
    uint64 x40 = default!;
    (x40, x39) = bits.Mul64(x1, (nuint)0xfffffffffffffffeUL);
    uint64 x41 = default!;
    uint64 x42 = default!;
    (x42, x41) = bits.Mul64(x1, (nuint)0xfffffffbffffffffUL);
    uint64 x43 = default!;
    uint64 x44 = default!;
    ...
    uint64 x59 = default!;
    uint64 x60 = default!;
    (x60, x59) = bits.Mul64(x51, (nuint)0xffffffff00000001UL);
    uint64 x61 = default!;
    uint64 x62 = default!;
    (x62, x61) = bits.Mul64(x51, 0xffffffffU);
    uint64 x63 = default!;
    uint64 x64 = default!;
    (x64, x63) = bits.Mul64(x51, (nuint)0xffffffffffffffffUL);
    uint64 x65 = default!;
    uint64 x66 = default!;
    ...
    uint64 x79 = default!;
    uint64 x80 = default!;
    (x80, x79) = bits.Mul64(x2, (nuint)0xfffffffffffffffeUL);
    uint64 x81 = default!;
    uint64 x82 = default!;
    (x82, x81) = bits.Mul64(x2, (nuint)0xfffffffbffffffffUL);
    uint64 x83 = default!;
    uint64 x84 = default!;
    ...
    uint64 x99 = default!;
    uint64 x100 = default!;
    (x100, x99) = bits.Mul64(x91, (nuint)0xffffffff00000001UL);
    uint64 x101 = default!;
    uint64 x102 = default!;
    (x102, x101) = bits.Mul64(x91, 0xffffffffU);
    uint64 x103 = default!;
    uint64 x104 = default!;
    (x104, x103) = bits.Mul64(x91, (nuint)0xffffffffffffffffUL);
    uint64 x105 = default!;
    uint64 x106 = default!;
    ...
    uint64 x119 = default!;
    uint64 x120 = default!;
    (x120, x119) = bits.Mul64(x3, (nuint)0xfffffffffffffffeUL);
    uint64 x121 = default!;
    uint64 x122 = default!;
    (x122, x121) = bits.Mul64(x3, (nuint)0xfffffffbffffffffUL);
    uint64 x123 = default!;
    uint64 x124 = default!;
    ...
    uint64 x139 = default!;
    uint64 x140 = default!;
    (x140, x139) = bits.Mul64(x131, (nuint)0xffffffff00000001UL);
    uint64 x141 = default!;
    uint64 x142 = default!;
    (x142, x141) = bits.Mul64(x131, 0xffffffffU);
    uint64 x143 = default!;
    uint64 x144 = default!;
    (x144, x143) = bits.Mul64(x131, (nuint)0xffffffffffffffffUL);
    uint64 x145 = default!;
    uint64 x146 = default!;
    ...
    uint64 x157 = default!;
    uint64 x158 = default!;
    (x157, x158) = bits.Sub64(x149, (nuint)0xffffffffffffffffUL, (uint64)0x0);
    uint64 x159 = default!;
    uint64 x160 = default!;
    ...
    uint64 x163 = default!;
    uint64 x164 = default!;
    (x163, x164) = bits.Sub64(x155, (nuint)0xffffffff00000001UL, (uint64)((p256Uint1)x162));
    uint64 x166 = default!;
