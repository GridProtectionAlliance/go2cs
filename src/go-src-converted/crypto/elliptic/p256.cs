...
private static (ptr<big.Int>, ptr<big.Int>) ScalarBaseMult(this p256Curve _p0, slice<byte> scalar) {
    ...
    ref array<byte> scalarReversed = ref heap(new array<byte>(32), out ptr<array<byte>> _addr_scalarReversed);
...
private static readonly nint two30p13m2 = 1 << 30 + 1 << 13 - 1 << 2;
...
private static void p256ReduceDegree(ptr<array<uint>> _addr_@out, array<ulong> tmp) {
    ...
    array<uint> tmp2 = new array<uint>(18);
...
private static void p256Square(ptr<array<uint>> _addr_@out, ptr<array<uint>> _addr_@in) {
    ...
    array<ulong> tmp = new array<ulong>(17);

    tmp[0] = uint64(in[0]) * uint64(in[0]);
    tmp[1] = uint64(in[0]) * (uint64(in[1]) << 1);
    tmp[2] = uint64(in[0]) * (uint64(in[2]) << 1) + uint64(in[1]) * (uint64(in[1]) << 1);
    tmp[3] = uint64(in[0]) * (uint64(in[3]) << 1) + uint64(in[1]) * (uint64(in[2]) << 1);
    tmp[4] = uint64(in[0]) * (uint64(in[4]) << 1) + uint64(in[1]) * (uint64(in[3]) << 2) + uint64(in[2]) * uint64(in[2]);
    tmp[5] = uint64(in[0]) * (uint64(in[5]) << 1) + uint64(in[1]) * (uint64(in[4]) << 1) + uint64(in[2]) * (uint64(in[3]) << 1);
    tmp[6] = uint64(in[0]) * (uint64(in[6]) << 1) + uint64(in[1]) * (uint64(in[5]) << 2) + uint64(in[2]) * (uint64(in[4]) << 1) + uint64(in[3]) * (uint64(in[3]) << 1);
    tmp[7] = uint64(in[0]) * (uint64(in[7]) << 1) + uint64(in[1]) * (uint64(in[6]) << 1) + uint64(in[2]) * (uint64(in[5]) << 1) + uint64(in[3]) * (uint64(in[4]) << 1); 
    // tmp[8] has the greatest value of 2**61 + 2**60 + 2**61 + 2**60 + 2**60,
    // which is < 2**64 as required.
    tmp[8] = uint64(in[0]) * (uint64(in[8]) << 1) + uint64(in[1]) * (uint64(in[7]) << 2) + uint64(in[2]) * (uint64(in[6]) << 1) + uint64(in[3]) * (uint64(in[5]) << 2) + uint64(in[4]) * uint64(in[4]);
    tmp[9] = uint64(in[1]) * (uint64(in[8]) << 1) + uint64(in[2]) * (uint64(in[7]) << 1) + uint64(in[3]) * (uint64(in[6]) << 1) + uint64(in[4]) * (uint64(in[5]) << 1);
    tmp[10] = uint64(in[2]) * (uint64(in[8]) << 1) + uint64(in[3]) * (uint64(in[7]) << 2) + uint64(in[4]) * (uint64(in[6]) << 1) + uint64(in[5]) * (uint64(in[5]) << 1);
    tmp[11] = uint64(in[3]) * (uint64(in[8]) << 1) + uint64(in[4]) * (uint64(in[7]) << 1) + uint64(in[5]) * (uint64(in[6]) << 1);
    tmp[12] = uint64(in[4]) * (uint64(in[8]) << 1) + uint64(in[5]) * (uint64(in[7]) << 2) + uint64(in[6]) * uint64(in[6]);
    tmp[13] = uint64(in[5]) * (uint64(in[8]) << 1) + uint64(in[6]) * (uint64(in[7]) << 1);
    tmp[14] = uint64(in[6]) * (uint64(in[8]) << 1) + uint64(in[7]) * (uint64(in[7]) << 1);
...
private static void p256Mul(ptr<array<uint>> _addr_@out, ptr<array<uint>> _addr_@in, ptr<array<uint>> _addr_in2) {
    ...
    tmp[1] = uint64(in[0]) * (uint64(in2[1]) << 0) + uint64(in[1]) * (uint64(in2[0]) << 0);
    tmp[2] = uint64(in[0]) * (uint64(in2[2]) << 0) + uint64(in[1]) * (uint64(in2[1]) << 1) + uint64(in[2]) * (uint64(in2[0]) << 0);
    tmp[3] = uint64(in[0]) * (uint64(in2[3]) << 0) + uint64(in[1]) * (uint64(in2[2]) << 0) + uint64(in[2]) * (uint64(in2[1]) << 0) + uint64(in[3]) * (uint64(in2[0]) << 0);
    tmp[4] = uint64(in[0]) * (uint64(in2[4]) << 0) + uint64(in[1]) * (uint64(in2[3]) << 1) + uint64(in[2]) * (uint64(in2[2]) << 0) + uint64(in[3]) * (uint64(in2[1]) << 1) + uint64(in[4]) * (uint64(in2[0]) << 0);
    tmp[5] = uint64(in[0]) * (uint64(in2[5]) << 0) + uint64(in[1]) * (uint64(in2[4]) << 0) + uint64(in[2]) * (uint64(in2[3]) << 0) + uint64(in[3]) * (uint64(in2[2]) << 0) + uint64(in[4]) * (uint64(in2[1]) << 0) + uint64(in[5]) * (uint64(in2[0]) << 0);
    tmp[6] = uint64(in[0]) * (uint64(in2[6]) << 0) + uint64(in[1]) * (uint64(in2[5]) << 1) + uint64(in[2]) * (uint64(in2[4]) << 0) + uint64(in[3]) * (uint64(in2[3]) << 1) + uint64(in[4]) * (uint64(in2[2]) << 0) + uint64(in[5]) * (uint64(in2[1]) << 1) + uint64(in[6]) * (uint64(in2[0]) << 0);
    tmp[7] = uint64(in[0]) * (uint64(in2[7]) << 0) + uint64(in[1]) * (uint64(in2[6]) << 0) + uint64(in[2]) * (uint64(in2[5]) << 0) + uint64(in[3]) * (uint64(in2[4]) << 0) + uint64(in[4]) * (uint64(in2[3]) << 0) + uint64(in[5]) * (uint64(in2[2]) << 0) + uint64(in[6]) * (uint64(in2[1]) << 0) + uint64(in[7]) * (uint64(in2[0]) << 0); 
    // tmp[8] has the greatest value but doesn't overflow. See logic in
    // p256Square.
    tmp[8] = uint64(in[0]) * (uint64(in2[8]) << 0) + uint64(in[1]) * (uint64(in2[7]) << 1) + uint64(in[2]) * (uint64(in2[6]) << 0) + uint64(in[3]) * (uint64(in2[5]) << 1) + uint64(in[4]) * (uint64(in2[4]) << 0) + uint64(in[5]) * (uint64(in2[3]) << 1) + uint64(in[6]) * (uint64(in2[2]) << 0) + uint64(in[7]) * (uint64(in2[1]) << 1) + uint64(in[8]) * (uint64(in2[0]) << 0);
    tmp[9] = uint64(in[1]) * (uint64(in2[8]) << 0) + uint64(in[2]) * (uint64(in2[7]) << 0) + uint64(in[3]) * (uint64(in2[6]) << 0) + uint64(in[4]) * (uint64(in2[5]) << 0) + uint64(in[5]) * (uint64(in2[4]) << 0) + uint64(in[6]) * (uint64(in2[3]) << 0) + uint64(in[7]) * (uint64(in2[2]) << 0) + uint64(in[8]) * (uint64(in2[1]) << 0);
    tmp[10] = uint64(in[2]) * (uint64(in2[8]) << 0) + uint64(in[3]) * (uint64(in2[7]) << 1) + uint64(in[4]) * (uint64(in2[6]) << 0) + uint64(in[5]) * (uint64(in2[5]) << 1) + uint64(in[6]) * (uint64(in2[4]) << 0) + uint64(in[7]) * (uint64(in2[3]) << 1) + uint64(in[8]) * (uint64(in2[2]) << 0);
    tmp[11] = uint64(in[3]) * (uint64(in2[8]) << 0) + uint64(in[4]) * (uint64(in2[7]) << 0) + uint64(in[5]) * (uint64(in2[6]) << 0) + uint64(in[6]) * (uint64(in2[5]) << 0) + uint64(in[7]) * (uint64(in2[4]) << 0) + uint64(in[8]) * (uint64(in2[3]) << 0);
    tmp[12] = uint64(in[4]) * (uint64(in2[8]) << 0) + uint64(in[5]) * (uint64(in2[7]) << 1) + uint64(in[6]) * (uint64(in2[6]) << 0) + uint64(in[7]) * (uint64(in2[5]) << 1) + uint64(in[8]) * (uint64(in2[4]) << 0);
    tmp[13] = uint64(in[5]) * (uint64(in2[8]) << 0) + uint64(in[6]) * (uint64(in2[7]) << 0) + uint64(in[7]) * (uint64(in2[6]) << 0) + uint64(in[8]) * (uint64(in2[5]) << 0);
    tmp[14] = uint64(in[6]) * (uint64(in2[8]) << 0) + uint64(in[7]) * (uint64(in2[7]) << 1) + uint64(in[8]) * (uint64(in2[6]) << 0);
    tmp[15] = uint64(in[7]) * (uint64(in2[8]) << 0) + uint64(in[8]) * (uint64(in2[7]) << 0);
...
private static uint p256GetBit(ptr<array<byte>> _addr_scalar, nuint bit) {
    ref array<byte> scalar = ref _addr_scalar.val;

    return uint32(((scalar[bit >> 3]) >> (int)((bit & 7))) & 1);
}
...

    {
        ...
        for (var i = uint(0); i < 32; i++) {
            ...
            tableOffset = 0;
            {
                ...
                while (j <= 32) {
                    var bit0 = p256GetBit(_addr_scalar, 31 - i + j);
                    var bit1 = p256GetBit(_addr_scalar, 95 - i + j);
                    var bit2 = p256GetBit(_addr_scalar, 159 - i + j);
                    var bit3 = p256GetBit(_addr_scalar, 223 - i + j);
                    var index = bit0 | (bit1 << 1) | (bit2 << 2) | (bit3 << 3);

                    p256SelectAffinePoint(_addr_px, _addr_py, p256Precomputed[(int)tableOffset..], index);
...
private static void p256ScalarMult(ptr<array<uint>> _addr_xOut, ptr<array<uint>> _addr_yOut, ptr<array<uint>> _addr_zOut, ptr<array<uint>> _addr_x, ptr<array<uint>> _addr_y, ptr<array<byte>> _addr_scalar) {
    ...
    ref array<array<array<uint>>> precomp = ref heap(new array<array<array<uint>>>(16), out ptr<array<array<array<uint>>>> _addr_precomp);
...

    {
        ...
        while (i < 16) {
            p256PointDouble(_addr_precomp[i][0], _addr_precomp[i][1], _addr_precomp[i][2], _addr_precomp[i / 2][0], _addr_precomp[i / 2][1], _addr_precomp[i / 2][2]);
            p256PointAddMixed(_addr_precomp[i + 1][0], _addr_precomp[i + 1][1], _addr_precomp[i + 1][2], _addr_precomp[i][0], _addr_precomp[i][1], _addr_precomp[i][2], _addr_x, _addr_y);
            i += 2;
        }
...
private static void p256FromBig(ptr<array<uint>> _addr_@out, ptr<big.Int> _addr_@in) {
    ...
    ptr<big.Int> tmp = @new<big.Int>().Lsh(in, 257);
