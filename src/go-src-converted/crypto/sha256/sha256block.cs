        ...
        private static void blockGeneric(ptr<digest> _addr_dig, slice<byte> p)
        {
            ...
            { 
                ...
                }
                {
                    ...
                    {
                        var v1 = w[i - 2L];
                        var t1 = (bits.RotateLeft32(v1, -17L)) ^ (bits.RotateLeft32(v1, -19L)) ^ (v1 >> (int)(10L));
                        var v2 = w[i - 15L];
                        var t2 = (bits.RotateLeft32(v2, -7L)) ^ (bits.RotateLeft32(v2, -18L)) ^ (v2 >> (int)(3L));
...

                {
                    ...
                    for (i = 0L; i < 64L; i++)
                    {
                        t1 = h + ((bits.RotateLeft32(e, -6L)) ^ (bits.RotateLeft32(e, -11L)) ^ (bits.RotateLeft32(e, -25L))) + ((e & f) ^ (~e & g)) + _K[i] + w[i];

                        t2 = ((bits.RotateLeft32(a, -2L)) ^ (bits.RotateLeft32(a, -13L)) ^ (bits.RotateLeft32(a, -22L))) + ((a & b) ^ (a & c) ^ (b & c));
