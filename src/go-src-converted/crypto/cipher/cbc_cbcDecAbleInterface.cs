...
//
//     Generated on 2020 August 29 08:28:32 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace crypto
{
    public static partial class cipher_package
    {
        ...
        private class cbcDecAble<T> : cbcDecAble
        {
            ...
            private delegate BlockMode NewCBCDecrypterByRef(ref T value, slice<byte> iv);
            private delegate BlockMode NewCBCDecrypterByVal(T value, slice<byte> iv);

            private static readonly NewCBCDecrypterByRef s_NewCBCDecrypterByRef;
            private static readonly NewCBCDecrypterByVal s_NewCBCDecrypterByVal;

            [DebuggerNonUserCode, MethodImpl(MethodImplOptions.AggressiveInlining)]
            public BlockMode NewCBCDecrypter(slice<byte> iv)
            {
                T target = m_target;

                if (m_target_is_ptr && !(m_target_ptr is null))
                    target = m_target_ptr.Value;
                if (s_NewCBCDecrypterByRef is null)
                    return s_NewCBCDecrypterByVal!(target, iv);

                return s_NewCBCDecrypterByRef(ref target, iv);
            }
            ...
            static cbcDecAble()
            {
               ...
               extensionMethod = targetTypeByRef.GetExtensionMethod("NewCBCDecrypter");

                if (!(extensionMethod is null))
                    s_NewCBCDecrypterByRef = extensionMethod.CreateStaticDelegate(typeof(NewCBCDecrypterByRef)) as NewCBCDecrypterByRef;
                ...
                if (s_NewCBCDecrypterByRef is null && s_NewCBCDecrypterByVal is null)
...
namespace go
{
    public static class cipher_cbcDecAbleExtensions
    {
        private static readonly ConcurrentDictionary<Type, MethodInfo> s_conversionOperators = new ConcurrentDictionary<Type, MethodInfo>();

        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static T _<T>(this go.crypto.cipher_package.cbcDecAble target)
        {
            try
            {
                return ((go.crypto.cipher_package.cbcDecAble<T>)target).Target;
            }
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _<T>(this go.crypto.cipher_package.cbcDecAble target, out T result)
        {
            try
            {
                result = target._<T>();
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static object? _(this go.crypto.cipher_package.cbcDecAble target, Type type)
        {
            try
            {
                MethodInfo? conversionOperator = s_conversionOperators.GetOrAdd(type, _ => typeof(go.crypto.cipher_package.cbcDecAble<>).GetExplicitGenericConversionOperator(type));
        ...
        [GeneratedCode("go2cs", "0.1.0.0"), MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static bool _(this go.crypto.cipher_package.cbcDecAble target, Type type, out object? result)
        {
            try
            {
