...
// Original source: C:\Program Files\Go\src\crypto\cipher\xor_arm64.go
...
private static nint xorBytes(slice<byte> dst, slice<byte> a, slice<byte> b) {
    ...
    xorBytesARM64(_addr_dst[0], _addr_a[0], _addr_b[0], n);
    return n;
...
//go:noescape
private static void xorBytesARM64(ptr<byte> dst, ptr<byte> a, ptr<byte> b, nint n);
