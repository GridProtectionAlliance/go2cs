...
// package tls -- go2cs converted at 2020 October 09 04:56:00 UTC
// import "crypto/tls" ==> using tls = go.crypto.tls_package
// Original source: C:\Go\src\crypto\tls\key_schedule.go
...
namespace crypto
{
    public static partial class tls_package
    {
        ...
        private static readonly @string resumptionBinderLabel = (@string)"res binder";
        private static readonly @string clientHandshakeTrafficLabel = (@string)"c hs traffic";
        private static readonly @string serverHandshakeTrafficLabel = (@string)"s hs traffic";
        private static readonly @string clientApplicationTrafficLabel = (@string)"c ap traffic";
        private static readonly @string serverApplicationTrafficLabel = (@string)"s ap traffic";
        private static readonly @string exporterLabel = (@string)"exp master";
        private static readonly @string resumptionLabel = (@string)"res master";
        private static readonly @string trafficUpdateLabel = (@string)"traffic upd";


        // expandLabel implements HKDF-Expand-Label from RFC 8446, Section 7.1.
        private static slice<byte> expandLabel(this ptr<cipherSuiteTLS13> _addr_c, slice<byte> secret, @string label, slice<byte> context, long length) => func((_, panic, __) =>
        {
        ...
        private static Func<@string, slice<byte>, long, (slice<byte>, error)> exportKeyingMaterial(this ptr<cipherSuiteTLS13> _addr_c, slice<byte> masterSecret, hash.Hash transcript)
        {
            ref cipherSuiteTLS13 c = ref _addr_c.val;
        ...
        private static slice<byte> SharedKey(this ptr<nistParameters> _addr_p, slice<byte> peerPublicKey)
        {
            ...
            var sharedKey = make_slice<byte>((curve.Params().BitSize + 7L) / 8L);
