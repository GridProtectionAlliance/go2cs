...
//
//     Generated on 2020 October 09 04:54:37 UTC
// </auto-generated>
//---------------------------------------------------------
using System;
...
namespace crypto
{
    public static partial class sha1_package
    {
        ...
        private partial struct digest
        {
            ...
            public digest(array<uint> h = default, array<byte> x = default, long nx = default, ulong len = default)
            {
                this.h = h;
                this.x = x;
                this.nx = nx;
        ...
        {
            return new digest(value.h, value.x, value.nx, value.len);
        }
    }
}}