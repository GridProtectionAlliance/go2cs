...
namespace crypto
{
    public static partial class aes_package
    {
        ...
        private partial struct code
        {
            ...
            public code(nint value) => m_value = value;

            // Enable implicit conversions between nint and code struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator code(nint value) => new code(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator nint(code value) => value.m_value;
