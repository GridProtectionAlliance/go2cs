...
namespace crypto
{
    public static partial class x509_package
    {
        ...
        private partial struct tbsCertificateRequest
        {
            ...
            public tbsCertificateRequest(asn1.RawContent Raw = default, nint Version = default, asn1.RawValue Subject = default, publicKeyInfo PublicKey = default, slice<asn1.RawValue> RawAttributes = default)
            {
                this.Raw = Raw;
