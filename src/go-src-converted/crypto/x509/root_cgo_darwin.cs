...
// Original source: C:\Go\src\crypto\x509\root_cgo_darwin.go
/*
...
namespace crypto
{
    public static partial class x509_package
    {
        private static (ref CertPool, error) loadSystemRoots() => func((defer, _, __) =>
        {
            ...
            C.CFDataRef data = 0L;
            C.CFDataRef untrustedData = 0L;
            var err = C.FetchPEMRoots(ref data, ref untrustedData);
            if (err == -1L)
            { 
                // TODO: better error message
                return (null, errors.New("crypto/x509: failed to load darwin system roots with cgo"));
            }
