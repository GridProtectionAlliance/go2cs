...
namespace crypto
{
    public static partial class x509_package
    {
        ...
        {
            // Constructors
            public certificateRequest(NilType _)
            {
                this.Raw = default;
                this.TBSCSR = default;
            ...
            // Enable comparisons between nil and certificateRequest struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(certificateRequest value, NilType nil) => value.Equals(default(certificateRequest));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(certificateRequest value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, certificateRequest value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, certificateRequest value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator certificateRequest(NilType nil) => default(certificateRequest);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static certificateRequest certificateRequest_cast(dynamic value)
        {
            return new certificateRequest(value.Raw, value.TBSCSR, value.SignatureAlgorithm, value.SignatureValue);
        }
    }
}}