...
namespace crypto
{
    public static partial class x509_package
    {
        ...
        {
            // Constructors
            public pkcs10Attribute(NilType _)
            {
                this.Id = default;
                this.Values = default;
            }
            ...
            // Enable comparisons between nil and pkcs10Attribute struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(pkcs10Attribute value, NilType nil) => value.Equals(default(pkcs10Attribute));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(pkcs10Attribute value, NilType nil) => !(value == nil);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator ==(NilType nil, pkcs10Attribute value) => value == nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool operator !=(NilType nil, pkcs10Attribute value) => value != nil;

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator pkcs10Attribute(NilType nil) => default(pkcs10Attribute);
        }

        [GeneratedCode("go2cs", "0.1.0.0")]
        private static pkcs10Attribute pkcs10Attribute_cast(dynamic value)
        {
            return new pkcs10Attribute(value.Id, value.Values);
        }
    }
}}