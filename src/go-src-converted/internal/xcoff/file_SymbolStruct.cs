...
namespace @internal
{
    public static partial class xcoff_package
    {
        ...
        public partial struct Symbol
        {
            ...
            public Symbol(@string Name = default, ulong Value = default, long SectionNumber = default, long StorageClass = default, AuxiliaryFcn AuxFcn = default, AuxiliaryCSect AuxCSect = default)
            {
                this.Name = Name;
                this.Value = Value;
