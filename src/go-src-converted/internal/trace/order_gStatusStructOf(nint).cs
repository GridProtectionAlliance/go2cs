...
namespace @internal
{
    public static partial class trace_package
    {
        ...
        private partial struct gStatus
        {
            ...
            public gStatus(nint value) => m_value = value;

            // Enable implicit conversions between nint and gStatus struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator gStatus(nint value) => new gStatus(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator nint(gStatus value) => value.m_value;
