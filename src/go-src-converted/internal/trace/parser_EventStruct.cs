...
namespace @internal
{
    public static partial class trace_package
    {
        ...
        public partial struct Event
        {
            ...
            public Event(nint Off = default, byte Type = default, long seq = default, long Ts = default, nint P = default, ulong G = default, ulong StkID = default, slice<ptr<Frame>> Stk = default, array<ulong> Args = default, slice<@string> SArgs = default, ref ptr<Event> Link = default)
            {
                this.Off = Off;
                this.Type = Type;
                this.seq = seq;
