...
namespace @internal
{
    public static partial class trace_package
    {
        ...
        private partial struct mud
        {
            ...
            public mud(slice<edge> sorted = default, slice<edge> unsorted = default, double trackMass = default, long trackBucket = default, double trackSum = default, array<double> hist = default)
            {
                this.sorted = sorted;
