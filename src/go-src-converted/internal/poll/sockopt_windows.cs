...
// package poll -- go2cs converted at 2020 October 09 04:51:23 UTC
...
namespace @internal
{
    public static partial class poll_package
    {
        ...
        private static error Setsockopt(this ptr<FD> _addr_fd, int level, int optname, ptr<byte> _addr_optval, int optlen) => func((defer, _, __) =>
        {
        ...
        private static error WSAIoctl(this ptr<FD> _addr_fd, uint iocc, ptr<byte> _addr_inbuf, uint cbif, ptr<byte> _addr_outbuf, uint cbob, ptr<uint> _addr_cbbr, ptr<syscall.Overlapped> _addr_overlapped, System.UIntPtr completionRoutine) => func((defer, _, __) =>
        {
            ref FD fd = ref _addr_fd.val;
