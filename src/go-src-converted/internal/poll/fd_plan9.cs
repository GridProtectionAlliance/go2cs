...
// package poll -- go2cs converted at 2022 March 06 22:13:01 UTC
// import "internal/poll" ==> using poll = go.@internal.poll_package
// Original source: C:\Program Files\Go\src\internal\poll\fd_plan9.go
...
private static (nint, error) Read(this ptr<FD> _addr_fd, Func<slice<byte>, (nint, error)> fn, slice<byte> b) => func((defer, _, _) => {
    nint _p0 = default;
    error _p0 = default!;
    ref FD fd = ref _addr_fd.val;
    ...
    if (fd.rtimedout.isSet()) {
        fd.rmu.Unlock();
        return (0, error.As(ErrDeadlineExceeded)!);
    }
...
private static (nint, error) Write(this ptr<FD> _addr_fd, Func<slice<byte>, (nint, error)> fn, slice<byte> b) => func((defer, _, _) => {
    nint _p0 = default;
    error _p0 = default!;
    ref FD fd = ref _addr_fd.val;
