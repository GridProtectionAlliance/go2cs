...
// Original source: C:\Program Files\Go\src\internal\syscall\windows\reparse_windows.go
...
public static readonly nuint FSCTL_SET_REPARSE_POINT = 0x000900A4;
public static readonly nuint IO_REPARSE_TAG_MOUNT_POINT = 0xA0000003;

public static readonly nint SYMLINK_FLAG_RELATIVE = 1;
...
private static @string Path(this ptr<SymbolicLinkReparseBuffer> _addr_rb) {
    ...
    return syscall.UTF16ToString(new ptr<ptr<array<ushort>>>(@unsafe.Pointer(_addr_rb.PathBuffer[0])).slice(n1, n2, n2));
}
