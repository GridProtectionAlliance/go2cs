...
// package unix -- go2cs converted at 2020 August 29 08:30:49 UTC
...
namespace syscall
{
    public static partial class unix_package
    {
        ...
        private static readonly System.UIntPtr entropyTrap = 7L;
        ...
        {
            var (_, _, errno) = syscall.Syscall(entropyTrap, uintptr(@unsafe.Pointer(ref p[0L])), uintptr(len(p)), 0L);
            if (errno != 0L)
            {
