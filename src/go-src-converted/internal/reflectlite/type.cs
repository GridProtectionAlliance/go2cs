...
// (ptr to object A, ptr to object B) -> ==?
        ...
        private partial struct chanDir // : long
        {
        }

        private static readonly chanDir recvDir = (chanDir)1L << (int)(iota); // <-chan
        private static readonly bothDir sendDir = (bothDir)recvDir | sendDir; // chan
