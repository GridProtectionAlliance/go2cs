...
// package typeutil -- go2cs converted at 2022 March 06 23:32:19 UTC
...
public partial struct Map {
    ...
    public nint length; // number of map entries
}
...
private static nint Len(this ptr<Map> _addr_m) {
    ref Map m = ref _addr_m.val;
...
private static slice<types.Type> Keys(this ptr<Map> _addr_m) {
    ...
    var keys = make_slice<types.Type>(0, m.Len());
    m.Iterate((key, _) => {
...
public static uint hashFor(this Hasher h, types.Type t) => func((_, panic, _) => { 
