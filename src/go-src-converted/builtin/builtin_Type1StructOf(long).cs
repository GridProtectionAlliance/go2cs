...
namespace go
{
    public static partial class builtin_package
    {
        ...
        public partial struct Type1
        {
            ...
            public Type1(long value) => m_value = value;

            // Enable implicit conversions between long and Type1 struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Type1(long value) => new Type1(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(Type1 value) => value.m_value;
