...
namespace go
{
    public static partial class builtin_package
    {
        ...
        private partial struct @int // : long
        {
        }

        // uint is an unsigned integer type that is at least 32 bits in size. It is a
        // distinct type, however, and not an alias for, say, uint32.
        private partial struct @uint // : ulong
        {
        }
 ...
 // Untyped int.
        ...
        // invocation.
        public partial struct Type1 // : long
        {
        }

        // IntegerType is here for the purposes of documentation only. It is a stand-in
        // for any integer type: int, uint, int8 etc.
        public partial struct IntegerType // : long
        {
        }
...
;
        ...
        // len(src) and len(dst).
        private static long copy(slice<Type> dst, slice<Type> src)
;
