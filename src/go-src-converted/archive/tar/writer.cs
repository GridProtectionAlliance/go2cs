...
;
        ...
        private static error writeGNUHeader(this ptr<Writer> _addr_tw, ptr<Header> _addr_hdr)
        {
            ...
            const @string longName = (@string)"././@LongLink";
        ...
        private static (long, error) Write(this ptr<Writer> _addr_tw, slice<byte> b)
        {
            long _p0 = default;
            error _p0 = default!;
            ref Writer tw = ref _addr_tw.val;
        ...
        private static (long, error) Write(this ptr<regFileWriter> _addr_fw, slice<byte> b)
        {
            long n = default;
            error err = default!;
        ...
        private static (long, error) Write(this ptr<sparseFileWriter> _addr_sw, slice<byte> b)
        {
            long n = default;
            error err = default!;
