...
namespace go
{
    public static partial class gcexportdata_package
    {
        ...
        private static (ptr<types.Package>, error) Import(this importer imp, @string importPath)
        {
            ...
            return _addr_imp.ImportFrom(importPath, "", 0L)!;
        }

        private static (ptr<types.Package>, error) ImportFrom(this importer imp, @string importPath, @string srcDir, types.ImportMode mode) => func((defer, _, __) =>
        {
