...
namespace go
{
    public static partial class main_package
    {
        ...
        public partial struct M : IMap
        {
            ...
            private readonly map<@string, nint> m_value;
            ...
            public (nint, bool) this[@string key, bool _]
            {
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                get => m_value.TryGetValue(key, out nint value) ? (value!, true) : (default!, false);
            }

            public M(map<@string, nint> value) => m_value = value;

            // Enable implicit conversions between map<@string, nint> and M struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator M(map<@string, nint> value) => new M(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator map<@string, nint>(M value) => value.m_value;
