...
namespace go
{
    public static partial class main_package
    {
        ...
        public partial struct M
        {
            ...
            // Enable implicit conversions between map<long, long> and M struct
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator M(map<long, long> value) => new M(value);
            
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator map<long, long>(M value) => value.m_value;
