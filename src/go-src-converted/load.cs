...
// package ssautil -- go2cs converted at 2020 October 08 04:57:35 UTC
...
namespace ssa
{
    public static partial class ssautil_package
    {
        ...
        //
        public static (ptr<ssa.Package>, ptr<types.Info>, error) BuildPackage(ptr<types.Config> _addr_tc, ptr<token.FileSet> _addr_fset, ptr<types.Package> _addr_pkg, slice<ptr<ast.File>> files, ssa.BuilderMode mode) => func((_, panic, __) =>
        {
