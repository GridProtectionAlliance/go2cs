...
public static partial class abi_package
{
    ...
    public partial struct Uncommon_uᴛ2
    {
        ...
        private readonly ж<global::go.@internal.abi_package.SliceType> ᏑʗSliceType;

        // Promoted Struct Accessors
        public partial ref global::go.@internal.abi_package.SliceType SliceType => ref ᏑʗSliceType.val;

        // Promoted Struct Field Accessors
        public ref global::go.@internal.abi_package.Type Type => ref SliceType.Type;
        public ref global::go.ж<global::go.@internal.abi_package.Type> Elem => ref SliceType.Elem;

        // Promoted Struct Field Accessor References
        public static ref global::go.@internal.abi_package.Type ᏑType(ref Uncommon_uᴛ2 instance) => ref instance.SliceType.Type;
        public static ref global::go.ж<global::go.@internal.abi_package.Type> ᏑElem(ref Uncommon_uᴛ2 instance) => ref instance.SliceType.Elem;

        // Field References
        public static ref global::go.@internal.abi_package.SliceType ᏑSliceType(ref Uncommon_uᴛ2 instance) => ref instance.SliceType;
        public static ref global::go.@internal.abi_package.UncommonType Ꮡu(ref Uncommon_uᴛ2 instance) => ref instance.u;
        
        // Constructors
        public Uncommon_uᴛ2(NilType _)
        {
            ᏑʗSliceType = new ж<global::go.@internal.abi_package.SliceType>(new global::go.@internal.abi_package.SliceType(nil));
            this.u = default!;
        }
