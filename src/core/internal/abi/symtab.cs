...
public const nint ArgsSizeUnknown = /* -0x80000000 */ -2147483648;

// IDs for PCDATA and FUNCDATA tables in Go binaries.
//
// These must agree with ../../../runtime/funcdata.h.
public const nint PCDATA_UnsafePoint = 0;

public const nint PCDATA_StackMapIndex = 1;

public const nint PCDATA_InlTreeIndex = 2;

public const nint PCDATA_ArgLiveIndex = 3;

public const nint FUNCDATA_ArgsPointerMaps = 0;

public const nint FUNCDATA_LocalsPointerMaps = 1;

public const nint FUNCDATA_StackObjects = 2;

public const nint FUNCDATA_InlTree = 3;

public const nint FUNCDATA_OpenCodedDeferInfo = 4;

public const nint FUNCDATA_ArgInfo = 5;

public const nint FUNCDATA_ArgLiveInfo = 6;

public const nint FUNCDATA_WrapInfo = 7;

// Special values for the PCDATA_UnsafePoint table.
public const nint UnsafePointSafe = -1; // Safe for async preemption

public const nint UnsafePointUnsafe = -2; // Unsafe for async preemption

public const nint UnsafePointRestart1 = -3;

public const nint UnsafePointRestart2 = -4;

public const nint UnsafePointRestartAtEntry = -5;

public const nint MINFUNC = 16; // minimum size for a function

public const nint FuncTabBucketSize = /* 256 * MINFUNC */ 4096; // size of bucket in the pc->func lookup table
