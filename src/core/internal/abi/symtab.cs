...
public static readonly UntypedInt UnsafePointSafe = -1; // Safe for async preemption

public static readonly UntypedInt UnsafePointUnsafe = -2; // Unsafe for async preemption
