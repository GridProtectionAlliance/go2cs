...
public const nint PtrSize = /* 4 << (^uintptr(0) >> 63) */ 8;
...
public const nint DefaultPhysPageSize = /* _DefaultPhysPageSize */ 4096;

// PCQuantum is the minimal unit for a program counter (1 on x86, 4 on most other systems).
// The various PC tables record PC deltas pre-divided by PCQuantum.
public const nint PCQuantum = /* _PCQuantum */ 1;

// Int64Align is the required alignment for a 64-bit integer (4 on 32-bit systems, 8 on 64-bit).
public const nint Int64Align = /* PtrSize */ 8;
...
public const nint MinFrameSize = /* _MinFrameSize */ 0;

// StackAlign is the required alignment of the SP register.
// The stack must be at least word aligned, but some architectures require more.
public const nint StackAlign = /* _StackAlign */ 8;
