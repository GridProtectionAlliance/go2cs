...
internal static void idct(ж<block> Ꮡsrc) {
    ...
    for (nint y = 0; y < 8; y++) {
        ...
        x3 = x0 + x2;
        x0 -= x2;
        x2 = (r2 * (x4 + x5) + 128) >> (int)(8);
        x4 = (r2 * (x4 - x5) + 128) >> (int)(8);
        // Stage 4.
        s[0] = (x7 + x1) >> (int)(8);
        s[1] = (x3 + x2) >> (int)(8);
        s[2] = (x0 + x4) >> (int)(8);
    ...
    for (nint x = 0; x < 8; x++) {
        ...
        // Stage 1.
        var y8 = w7 * (y4 + y5) + 4;
        y4 = (y8 + w1mw7 * y4) >> (int)(3);
        y5 = (y8 - w1pw7 * y5) >> (int)(3);
        y8 = w3 * (y6 + y7) + 4;
        y6 = (y8 - w3mw5 * y6) >> (int)(3);
        y7 = (y8 - w3pw5 * y7) >> (int)(3);
        // Stage 2.
        y8 = y0 + y1;
        y0 -= y1;
        y1 = w6 * (y3 + y2) + 4;
        y2 = (y1 - w2pw6 * y2) >> (int)(3);
        y3 = (y1 + w2mw6 * y3) >> (int)(3);
        y1 = y4 + y6;
        y4 -= y6;
        y6 = y5 + y7;
        y5 -= y7;
        ...
        y3 = y0 + y2;
        y0 -= y2;
        y2 = (r2 * (y4 + y5) + 128) >> (int)(8);
        y4 = (r2 * (y4 - y5) + 128) >> (int)(8);
        // Stage 4.
        s[8 * 0] = (y7 + y1) >> (int)(14);
        s[8 * 1] = (y3 + y2) >> (int)(14);
        s[8 * 2] = (y0 + y4) >> (int)(14);
