...
public static partial class sort_package
{
    ...
    public class Interface<T> : Interface
    {
        ...
        public Interface(ж<T> target_ptr)
        {
            m_target_ptr = target_ptr;
            m_target_is_ptr = true;
        }

        private delegate nint LenByPtr(ж<T> value);
        ...
        private delegate bool LessByPtr(ж<T> value, nint i, nint j);
        ...
        private delegate void SwapByPtr(ж<T> value, nint i, nint j);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining), DebuggerNonUserCode]
        public static explicit operator Interface<T>(in ж<T> target_ptr) => new Interface<T>(target_ptr);
